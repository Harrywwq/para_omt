...
(declare-fun sigaction_oldact_920_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26545) true))))
(assert
 (let ((?x52707 ((_ extract 127 120) sigaction_oldact_920_1216)))
 (let ((?x52715 (bvand ?x52707 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x52715) true))))
...
(minimize args_0_8)
(minimize sigaction_oldact_920_1216)
(check-sat)
(get-objectives)
