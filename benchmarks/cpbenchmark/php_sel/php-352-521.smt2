...
(declare-fun sigaction_oldact_1042_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x33777))))
(assert
 (let ((?x59658 ((_ extract 127 120) sigaction_oldact_1042_1216)))
 (let ((?x59678 (bvand ?x59658 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x59678) true))))
...
(maximize sigaction_oldact_1042_1216)
...
(minimize args_1_8)
(minimize sigaction_oldact_1042_1216)
(check-sat)
(get-objectives)
