...
(declare-fun sigaction_oldact_1056_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x34210))))
(assert
 (let ((?x60570 ((_ extract 127 120) sigaction_oldact_1056_1216)))
 (let ((?x60586 (bvand ?x60570 (_ bv4 8))))
 (= (_ bv0 8) ?x60586))))
...
(maximize sigaction_oldact_1056_1216)
...
(minimize sigaction_oldact_1056_1216)
