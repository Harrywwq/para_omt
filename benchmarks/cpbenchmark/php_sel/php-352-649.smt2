...
(declare-fun sigaction_oldact_903_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26116) true))))
(assert
 (let ((?x5943 ((_ extract 127 120) sigaction_oldact_903_1216)))
 (let ((?x51803 (bvand ?x5943 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x51803) true))))
(maximize sigaction_oldact_171_1216)
(minimize sigaction_oldact_199_1216)
(maximize args_0_8)
(maximize sigaction_oldact_175_1216)
(minimize args_0_8)
(minimize sigaction_oldact_903_1216)
...
(maximize sigaction_oldact_903_1216)
(check-sat)
(get-objectives)
