...
(declare-fun sigaction_oldact_452_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_729_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x11441))))
(assert
 (let ((?x21739 ((_ extract 127 120) sigaction_oldact_452_1216)))
 (let ((?x21756 (bvand ?x21739 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21756) true))))
(assert
 (let ((?x41592 ((_ extract 127 120) sigaction_oldact_729_1216)))
 (let ((?x41612 (bvand ?x41592 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x41612) true))))
(minimize sigaction_oldact_452_1216)
(maximize strlen_85_64)
(maximize strlen_72_64)
(maximize args_1_8)
(minimize sigaction_oldact_243_1216)
(maximize sigaction_oldact_452_1216)
(minimize args_4_8)
(minimize args_0_8)
(minimize sigaction_oldact_188_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_313_1216)
(check-sat)
(get-objectives)
