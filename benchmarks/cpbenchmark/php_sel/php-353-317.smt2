...
(declare-fun sigaction_oldact_776_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x23910))))
(assert
 (let ((?x44428 ((_ extract 127 120) sigaction_oldact_776_1216)))
 (let ((?x44453 (bvand ?x44428 (_ bv4 8))))
 (= (_ bv0 8) ?x44453))))
...
(minimize sigaction_oldact_776_1216)
(minimize args_1_8)
(maximize args_0_8)
(maximize args_2_8)
...
(maximize sigaction_oldact_776_1216)
