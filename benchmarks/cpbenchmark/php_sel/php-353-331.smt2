...
(declare-fun sigaction_oldact_926_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26965) true))))
(assert
 (let ((?x53174 ((_ extract 127 120) sigaction_oldact_926_1216)))
 (let ((?x7797 (bvand ?x53174 (_ bv4 8))))
 (= (_ bv0 8) ?x7797))))
(maximize sigaction_oldact_345_1216)
(minimize sigaction_oldact_256_1216)
(maximize sigaction_oldact_215_1216)
(minimize args_1_8)
(minimize sigaction_oldact_531_1216)
...
(minimize sigaction_oldact_926_1216)
...
(maximize sigaction_oldact_926_1216)
