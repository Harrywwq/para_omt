...
(declare-fun sigaction_oldact_720_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21811))))
(assert
 (let ((?x40740 ((_ extract 127 120) sigaction_oldact_720_1216)))
 (let ((?x40760 (bvand ?x40740 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40760) true))))
