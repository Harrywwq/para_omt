...
(declare-fun sigaction_oldact_458_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_748_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x11469) true))))
(assert
 (let ((?x22198 ((_ extract 127 120) sigaction_oldact_458_1216)))
 (let ((?x22223 (bvand ?x22198 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x22223) true))))
(assert
 (let ((?x42812 ((_ extract 127 120) sigaction_oldact_748_1216)))
 (let ((?x42818 (bvand ?x42812 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x42818) true))))
(minimize sigaction_oldact_748_1216)
