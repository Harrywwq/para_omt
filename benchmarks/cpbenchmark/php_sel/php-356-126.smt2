...
(declare-fun sigaction_oldact_1266_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41443))))
(assert
 (let ((?x73640 ((_ extract 127 120) sigaction_oldact_1266_1216)))
 (let ((?x73656 (bvand ?x73640 (_ bv4 8))))
 (= (_ bv0 8) ?x73656))))
(minimize args_0_8)
(maximize args_4_8)
...
(minimize sigaction_oldact_1266_1216)
...
(minimize args_4_8)
(maximize sigaction_oldact_1266_1216)
