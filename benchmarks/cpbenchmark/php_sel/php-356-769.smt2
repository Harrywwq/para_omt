...
(declare-fun sigaction_oldact_1134_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x34384) true))))
(assert
 (let ((?x65147 ((_ extract 127 120) sigaction_oldact_1134_1216)))
 (let ((?x23211 (bvand ?x65147 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x23211) true))))
