...
(declare-fun sigaction_oldact_1244_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40760))))
(assert
 (let ((?x72009 ((_ extract 127 120) sigaction_oldact_1244_1216)))
 (let ((?x72029 (bvand ?x72009 (_ bv4 8))))
 (= (_ bv0 8) ?x72029))))
...
(maximize sigaction_oldact_1244_1216)
...
(maximize args_0_8)
(minimize sigaction_oldact_1244_1216)
