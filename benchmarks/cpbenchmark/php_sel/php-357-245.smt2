...
(declare-fun sigaction_oldact_1282_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x40859) true))))
(assert
 (let ((?x74407 ((_ extract 127 120) sigaction_oldact_1282_1216)))
 (let ((?x74424 (bvand ?x74407 (_ bv4 8))))
 (= (_ bv0 8) ?x74424))))
(maximize args_0_8)
...
(minimize sigaction_oldact_1282_1216)
(check-sat)
(get-objectives)
