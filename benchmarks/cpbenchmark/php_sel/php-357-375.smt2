...
(declare-fun sigaction_oldact_847_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x48959 ((_ extract 127 120) sigaction_oldact_847_1216)))
 (let ((?x48974 (bvand ?x48959 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x48974) true))))
