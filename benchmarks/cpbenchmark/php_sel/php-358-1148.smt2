...
(declare-fun sigaction_oldact_1012_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x32767))))
(assert
 (let ((?x57661 ((_ extract 127 120) sigaction_oldact_1012_1216)))
 (let ((?x57676 (bvand ?x57661 (_ bv4 8))))
 (= (_ bv0 8) ?x57676))))
...
(minimize args_0_8)
(maximize sigaction_oldact_1012_1216)
...
(maximize args_1_8)
(minimize sigaction_oldact_1012_1216)
