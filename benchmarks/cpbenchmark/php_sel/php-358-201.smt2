...
(declare-fun sigaction_oldact_1354_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x44827))))
(assert
 (let ((?x78360 ((_ extract 127 120) sigaction_oldact_1354_1216)))
 (let ((?x78371 (bvand ?x78360 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x78371) true))))
(maximize sigaction_oldact_208_1216)
(maximize sigaction_oldact_1354_1216)
...
(minimize sigaction_oldact_1354_1216)
