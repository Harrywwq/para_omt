...
(declare-fun sigaction_oldact_752_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1311_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22389) true))))
(assert
 (let ((?x43100 ((_ extract 127 120) sigaction_oldact_752_1216)))
 (let ((?x43110 (bvand ?x43100 (_ bv4 8))))
 (= (_ bv0 8) ?x43110))))
(assert
 (let ((?x76162 ((_ extract 127 120) sigaction_oldact_1311_1216)))
 (let ((?x76182 (bvand ?x76162 (_ bv4 8))))
 (= (_ bv0 8) ?x76182))))
(maximize sigaction_oldact_245_1216)
(minimize sigaction_oldact_245_1216)
(minimize sigaction_oldact_1311_1216)
...
(maximize sigaction_oldact_1311_1216)
(check-sat)
(get-objectives)
