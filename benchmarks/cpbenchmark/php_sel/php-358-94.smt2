...
(declare-fun sigaction_oldact_700_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1233_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21117))))
(assert
 (let ((?x39054 ((_ extract 127 120) sigaction_oldact_700_1216)))
 (let ((?x39074 (bvand ?x39054 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x39074) true))))
(assert
 (let ((?x71513 ((_ extract 127 120) sigaction_oldact_1233_1216)))
 (let ((?x71531 (bvand ?x71513 (_ bv4 8))))
 (= (_ bv0 8) ?x71531))))
...
(maximize sigaction_oldact_444_1216)
(maximize strlen_77_64)
(minimize sigaction_oldact_444_1216)
(maximize sigaction_oldact_1233_1216)
(check-sat)
(get-objectives)
