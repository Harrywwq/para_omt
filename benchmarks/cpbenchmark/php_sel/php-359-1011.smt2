...
(declare-fun sigaction_oldact_1560_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x6023))))
(assert
 (let ((?x89046 ((_ extract 127 120) sigaction_oldact_1560_1216)))
 (let ((?x89066 (bvand ?x89046 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x89066) true))))
(minimize args_1_8)
