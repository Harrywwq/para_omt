...
(declare-fun sigaction_oldact_1351_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x78182 ((_ extract 127 120) sigaction_oldact_1351_1216)))
 (let ((?x39892 (bvand ?x78182 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x39892) true))))
(maximize sigaction_oldact_748_1216)
(minimize args_2_8)
(minimize args_0_8)
(maximize sigaction_oldact_314_1216)
(minimize sigaction_oldact_1351_1216)
(minimize args_4_8)
(maximize args_1_8)
(minimize sigaction_oldact_458_1216)
(maximize strlen_77_64)
(maximize sigaction_oldact_1351_1216)
