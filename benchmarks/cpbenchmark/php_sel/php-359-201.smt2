...
(declare-fun sigaction_oldact_1353_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x42937) true))))
(assert
 (let ((?x78313 ((_ extract 127 120) sigaction_oldact_1353_1216)))
 (let ((?x78319 (bvand ?x78313 (_ bv4 8))))
 (= (_ bv0 8) ?x78319))))
(maximize args_3_8)
(minimize args_1_8)
(minimize args_3_8)
(minimize args_0_8)
(minimize sigaction_oldact_1353_1216)
...
(maximize sigaction_oldact_1353_1216)
