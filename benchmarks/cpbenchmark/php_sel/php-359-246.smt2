...
(declare-fun sigaction_oldact_1359_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43244) true))))
(assert
 (let ((?x78695 ((_ extract 127 120) sigaction_oldact_1359_1216)))
 (let ((?x40600 (bvand ?x78695 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40600) true))))
(minimize args_2_8)
(maximize sigaction_oldact_754_1216)
(minimize strlen_80_64)
(minimize args_0_8)
(maximize args_3_8)
(minimize sigaction_oldact_1359_1216)
(maximize sigaction_oldact_209_1216)
(maximize sigaction_oldact_321_1216)
(minimize strlen_77_64)
(maximize args_0_8)
(minimize strlen_85_64)
(minimize sigaction_oldact_754_1216)
(check-sat)
(get-objectives)
