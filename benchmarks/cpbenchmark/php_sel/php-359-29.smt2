...
(declare-fun sigaction_oldact_1016_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x29299) true))))
(assert
 (let ((?x57860 ((_ extract 127 120) sigaction_oldact_1016_1216)))
 (let ((?x13012 (bvand ?x57860 (_ bv4 8))))
 (= (_ bv0 8) ?x13012))))
