...
(declare-fun sigaction_oldact_1382_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x317))))
(assert
 (let ((?x79928 ((_ extract 127 120) sigaction_oldact_1382_1216)))
 (let ((?x79947 (bvand ?x79928 (_ bv4 8))))
 (= (_ bv0 8) ?x79947))))
