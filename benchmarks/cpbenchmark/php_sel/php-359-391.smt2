...
(declare-fun sigaction_oldact_1288_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x42342))))
(assert
 (let ((?x74654 ((_ extract 127 120) sigaction_oldact_1288_1216)))
 (let ((?x36010 (bvand ?x74654 (_ bv4 8))))
 (= (_ bv0 8) ?x36010))))
(maximize args_2_8)
(minimize args_2_8)
...
(minimize sigaction_oldact_1288_1216)
...
(maximize sigaction_oldact_1288_1216)
(check-sat)
(get-objectives)
