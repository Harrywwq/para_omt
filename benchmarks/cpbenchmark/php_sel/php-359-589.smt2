...
(declare-fun sigaction_oldact_1499_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x49763))))
(assert
 (let ((?x86166 ((_ extract 127 120) sigaction_oldact_1499_1216)))
 (let ((?x49244 (bvand ?x86166 (_ bv4 8))))
 (= (_ bv0 8) ?x49244))))
(maximize args_0_8)
...
(minimize sigaction_oldact_1499_1216)
...
(maximize args_2_8)
(maximize sigaction_oldact_1499_1216)
