...
(declare-fun sigaction_oldact_1697_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x10950))))
(assert
 (let ((?x96715 ((_ extract 127 120) sigaction_oldact_1697_1216)))
 (let ((?x96731 (bvand ?x96715 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x96731) true))))
(maximize sigaction_oldact_223_1216)
(minimize sigaction_oldact_184_1216)
(maximize sigaction_oldact_1697_1216)
