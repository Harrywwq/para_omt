...
(declare-fun sigaction_oldact_1236_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x71661 ((_ extract 127 120) sigaction_oldact_1236_1216)))
 (let ((?x71681 (bvand ?x71661 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71681) true))))
(maximize strlen_89_64)
(maximize sigaction_oldact_1236_1216)
