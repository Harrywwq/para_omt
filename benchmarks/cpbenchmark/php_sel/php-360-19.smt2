...
(declare-fun sigaction_oldact_835_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1438_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x24109) true))))
(assert
 (let ((?x48004 ((_ extract 127 120) sigaction_oldact_835_1216)))
 (let ((?x1690 (bvand ?x48004 (_ bv4 8))))
 (= (_ bv0 8) ?x1690))))
(assert
 (let ((?x82531 ((_ extract 127 120) sigaction_oldact_1438_1216)))
 (let ((?x82547 (bvand ?x82531 (_ bv4 8))))
 (= (_ bv0 8) ?x82547))))
(minimize args_9_16)
(minimize args_6_16)
(maximize args_5_16)
(maximize args_9_16)
(maximize args_0_8)
(minimize sigaction_oldact_835_1216)
(minimize strlen_84_64)
(minimize args_2_8)
(maximize sigaction_oldact_1438_1216)
(maximize args_7_16)
(maximize sigaction_oldact_490_1216)
(minimize sigaction_oldact_1438_1216)
