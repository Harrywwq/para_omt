...
(declare-fun sigaction_oldact_783_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1361_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x23058) true))))
(assert
 (let ((?x45026 ((_ extract 127 120) sigaction_oldact_783_1216)))
 (let ((?x45051 (bvand ?x45026 (_ bv4 8))))
 (= (_ bv0 8) ?x45051))))
(assert
 (let ((?x78801 ((_ extract 127 120) sigaction_oldact_1361_1216)))
 (let ((?x78821 (bvand ?x78801 (_ bv4 8))))
 (= (_ bv0 8) ?x78821))))
