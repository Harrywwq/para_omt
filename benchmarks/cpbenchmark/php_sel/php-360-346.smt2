...
(declare-fun sigaction_oldact_1375_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43792) true))))
(assert
 (let ((?x79582 ((_ extract 127 120) sigaction_oldact_1375_1216)))
 (let ((?x79606 (bvand ?x79582 (_ bv4 8))))
 (= (_ bv0 8) ?x79606))))
