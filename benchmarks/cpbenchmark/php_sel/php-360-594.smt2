...
(declare-fun sigaction_oldact_1491_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x46865) true))))
(assert
 (let ((?x85782 ((_ extract 127 120) sigaction_oldact_1491_1216)))
 (let ((?x85787 (bvand ?x85782 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x85787) true))))
(minimize args_0_8)
(minimize strlen_74_64)
(minimize sigaction_oldact_174_1216)
(minimize args_1_8)
(minimize sigaction_oldact_1491_1216)
...
(maximize sigaction_oldact_1491_1216)
