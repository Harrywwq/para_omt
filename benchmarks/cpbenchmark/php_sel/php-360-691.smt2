...
(declare-fun sigaction_oldact_1510_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x50118))))
(assert
 (let ((?x86697 ((_ extract 127 120) sigaction_oldact_1510_1216)))
 (let ((?x86712 (bvand ?x86697 (_ bv4 8))))
 (= (_ bv0 8) ?x86712))))
(minimize sigaction_oldact_536_1216)
(maximize sigaction_oldact_1510_1216)
(minimize sigaction_oldact_1510_1216)
