...
(declare-fun sigaction_oldact_973_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1844_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x28624) true))))
(assert
 (let ((?x55815 ((_ extract 127 120) sigaction_oldact_973_1216)))
 (let ((?x10950 (bvand ?x55815 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x10950) true))))
(assert
 (let ((?x105133 ((_ extract 127 120) sigaction_oldact_1844_1216)))
 (let ((?x105158 (bvand ?x105133 (_ bv4 8))))
 (= (_ bv0 8) ?x105158))))
...
(minimize sigaction_oldact_973_1216)
(minimize args_0_8)
(maximize sigaction_oldact_279_1216)
(maximize strlen_75_64)
(maximize sigaction_oldact_1844_1216)
...
(maximize sigaction_oldact_973_1216)
(minimize sigaction_oldact_1844_1216)
