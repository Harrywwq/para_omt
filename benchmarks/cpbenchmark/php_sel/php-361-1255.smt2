...
(declare-fun sigaction_oldact_1860_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x56180) true))))
(assert
 (let ((?x105966 ((_ extract 127 120) sigaction_oldact_1860_1216)))
 (let ((?x105982 (bvand ?x105966 (_ bv4 8))))
 (= (_ bv0 8) ?x105982))))
(maximize strlen_72_64)
(maximize sigaction_oldact_199_1216)
(maximize sigaction_oldact_560_1216)
(maximize sigaction_oldact_185_1216)
(minimize sigaction_oldact_175_1216)
(minimize sigaction_oldact_185_1216)
(minimize args_0_8)
(minimize sigaction_oldact_1860_1216)
...
(maximize sigaction_oldact_1860_1216)
...
(maximize sigaction_oldact_980_1216)
(check-sat)
(get-objectives)
