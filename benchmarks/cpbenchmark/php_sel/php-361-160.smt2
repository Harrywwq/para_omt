...
(declare-fun sigaction_oldact_1241_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40616))))
(assert
 (let ((?x71887 ((_ extract 127 120) sigaction_oldact_1241_1216)))
 (let ((?x71907 (bvand ?x71887 (_ bv4 8))))
 (= (_ bv0 8) ?x71907))))
(minimize args_3_8)
(minimize strlen_74_64)
(minimize sigaction_oldact_208_1216)
(maximize sigaction_oldact_717_1216)
