...
(declare-fun sigaction_oldact_1750_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x57676))))
(assert
 (let ((?x99150 ((_ extract 127 120) sigaction_oldact_1750_1216)))
 (let ((?x99165 (bvand ?x99150 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x99165) true))))
(minimize sigaction_oldact_620_1216)
(minimize sigaction_oldact_1750_1216)
