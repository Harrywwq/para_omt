...
(declare-fun sigaction_oldact_620_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1099_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x17670))))
(assert
 (let ((?x32742 ((_ extract 127 120) sigaction_oldact_620_1216)))
 (let ((?x32767 (bvand ?x32742 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x32767) true))))
(assert
 (let ((?x62904 ((_ extract 127 120) sigaction_oldact_1099_1216)))
 (let ((?x62920 (bvand ?x62904 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x62920) true))))
...
(minimize sigaction_oldact_620_1216)
(maximize sigaction_oldact_620_1216)
...
(maximize sigaction_oldact_1099_1216)
