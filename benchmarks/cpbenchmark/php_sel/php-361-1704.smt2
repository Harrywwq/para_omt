...
(declare-fun sigaction_oldact_1173_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x38281))))
(assert
 (let ((?x67560 ((_ extract 127 120) sigaction_oldact_1173_1216)))
 (let ((?x26572 (bvand ?x67560 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x26572) true))))
(minimize sigaction_oldact_187_1216)
(minimize sigaction_oldact_1173_1216)
...
(maximize sigaction_oldact_1173_1216)
