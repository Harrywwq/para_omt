...
(declare-fun sigaction_oldact_1303_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x42818))))
(assert
 (let ((?x75757 ((_ extract 127 120) sigaction_oldact_1303_1216)))
 (let ((?x75773 (bvand ?x75757 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75773) true))))
(minimize strlen_77_64)
(maximize sigaction_oldact_748_1216)
