...
(declare-fun sigaction_oldact_1329_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43839))))
(assert
 (let ((?x77015 ((_ extract 127 120) sigaction_oldact_1329_1216)))
 (let ((?x77040 (bvand ?x77015 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x77040) true))))
(minimize args_0_8)
(minimize sigaction_oldact_249_1216)
(maximize sigaction_oldact_324_1216)
(minimize sigaction_oldact_1329_1216)
(maximize strlen_77_64)
(minimize sigaction_oldact_211_1216)
(minimize strlen_81_64)
(minimize sigaction_oldact_764_1216)
(minimize args_2_8)
(minimize strlen_72_64)
(maximize sigaction_oldact_1329_1216)
