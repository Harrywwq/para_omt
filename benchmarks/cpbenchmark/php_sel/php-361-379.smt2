...
(declare-fun sigaction_oldact_839_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1580_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x24475) true))))
(assert
 (let ((?x2356 ((_ extract 127 120) sigaction_oldact_839_1216)))
 (let ((?x48441 (bvand ?x2356 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x48441) true))))
(assert
 (let ((?x90194 ((_ extract 127 120) sigaction_oldact_1580_1216)))
 (let ((?x53017 (bvand ?x90194 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x53017) true))))
(maximize sigaction_oldact_329_1216)
(minimize strlen_81_64)
(minimize strlen_74_64)
(minimize sigaction_oldact_1580_1216)
...
(maximize args_0_8)
(maximize sigaction_oldact_1580_1216)
(minimize args_3_8)
