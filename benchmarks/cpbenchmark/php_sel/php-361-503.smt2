...
(declare-fun sigaction_oldact_1592_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x49064) true))))
(assert
 (let ((?x91035 ((_ extract 127 120) sigaction_oldact_1592_1216)))
 (let ((?x91052 (bvand ?x91035 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x91052) true))))
...
(maximize sigaction_oldact_1592_1216)
(maximize args_0_8)
