...
(declare-fun sigaction_oldact_529_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_923_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1766_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x14338))))
(assert
 (let ((?x26736 ((_ extract 127 120) sigaction_oldact_529_1216)))
 (let ((?x26756 (bvand ?x26736 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x26756) true))))
(assert
 (let ((?x52928 ((_ extract 127 120) sigaction_oldact_923_1216)))
 (let ((?x7449 (bvand ?x52928 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x7449) true))))
(assert
 (let ((?x62643 ((_ extract 127 120) sigaction_oldact_1766_1216)))
 (let ((?x62682 (bvand ?x62643 (_ bv4 8))))
 (= (_ bv0 8) ?x62682))))
