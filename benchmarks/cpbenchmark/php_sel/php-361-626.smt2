...
(declare-fun sigaction_oldact_858_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1606_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x25297) true))))
(assert
 (let ((?x49595 ((_ extract 127 120) sigaction_oldact_858_1216)))
 (let ((?x49621 (bvand ?x49595 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x49621) true))))
(assert
 (let ((?x91938 ((_ extract 127 120) sigaction_oldact_1606_1216)))
 (let ((?x55028 (bvand ?x91938 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x55028) true))))
