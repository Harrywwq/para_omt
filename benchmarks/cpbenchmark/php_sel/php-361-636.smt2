...
(declare-fun sigaction_oldact_1414_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x47007))))
(assert
 (let ((?x81450 ((_ extract 127 120) sigaction_oldact_1414_1216)))
 (let ((?x81461 (bvand ?x81450 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x81461) true))))
...
(minimize sigaction_oldact_815_1216)
...
(maximize sigaction_oldact_1414_1216)
(minimize args_1_8)
(check-sat)
(get-objectives)
