...
(declare-fun sigaction_oldact_862_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1500_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x27091))))
(assert
 (let ((?x49790 ((_ extract 127 120) sigaction_oldact_862_1216)))
 (let ((?x4023 (bvand ?x49790 (_ bv4 8))))
 (= (_ bv0 8) ?x4023))))
(assert
 (let ((?x86204 ((_ extract 127 120) sigaction_oldact_1500_1216)))
 (let ((?x86229 (bvand ?x86204 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86229) true))))
(minimize sigaction_oldact_362_1216)
(minimize sigaction_oldact_193_1216)
(maximize sigaction_oldact_862_1216)
