...
(declare-fun sigaction_oldact_1505_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x49920))))
(assert
 (let ((?x86475 ((_ extract 127 120) sigaction_oldact_1505_1216)))
 (let ((?x86499 (bvand ?x86475 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86499) true))))
...
(maximize sigaction_oldact_1505_1216)
