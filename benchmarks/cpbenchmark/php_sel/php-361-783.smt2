...
(declare-fun sigaction_oldact_1027_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1789_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x33277))))
(assert
 (let ((?x58697 ((_ extract 127 120) sigaction_oldact_1027_1216)))
 (let ((?x14380 (bvand ?x58697 (_ bv4 8))))
 (= (_ bv0 8) ?x14380))))
(assert
 (let ((?x101830 ((_ extract 127 120) sigaction_oldact_1789_1216)))
 (let ((?x64414 (bvand ?x101830 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x64414) true))))
(maximize args_2_8)
...
(minimize args_0_8)
(minimize sigaction_oldact_1027_1216)
...
(maximize sigaction_oldact_1027_1216)
(check-sat)
(get-objectives)
