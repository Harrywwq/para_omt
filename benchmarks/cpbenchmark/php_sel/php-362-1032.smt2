...
(declare-fun sigaction_oldact_1821_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x55024) true))))
(assert
 (let ((?x103713 ((_ extract 127 120) sigaction_oldact_1821_1216)))
 (let ((?x103736 (bvand ?x103713 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x103736) true))))
(maximize args_0_8)
