...
(declare-fun sigaction_oldact_1554_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x51613))))
(assert
 (let ((?x88778 ((_ extract 127 120) sigaction_oldact_1554_1216)))
 (let ((?x88793 (bvand ?x88778 (_ bv4 8))))
 (= (_ bv0 8) ?x88793))))
...
(maximize sigaction_oldact_899_1216)
(minimize sigaction_oldact_271_1216)
(maximize sigaction_oldact_1554_1216)
