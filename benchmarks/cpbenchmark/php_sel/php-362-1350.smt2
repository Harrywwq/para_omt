...
(declare-fun sigaction_oldact_2015_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x17251) true))))
(assert
 (let ((?x114984 ((_ extract 127 120) sigaction_oldact_2015_1216)))
 (let ((?x77094 (bvand ?x114984 (_ bv4 8))))
 (= (_ bv0 8) ?x77094))))
(minimize args_1_8)
...
(minimize sigaction_oldact_2015_1216)
