...
(declare-fun sigaction_oldact_746_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1349_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22054) true))))
(assert
 (let ((?x42593 ((_ extract 127 120) sigaction_oldact_746_1216)))
 (let ((?x42610 (bvand ?x42593 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x42610) true))))
(assert
 (let ((?x77986 ((_ extract 127 120) sigaction_oldact_1349_1216)))
 (let ((?x78006 (bvand ?x77986 (_ bv4 8))))
 (= (_ bv0 8) ?x78006))))
(maximize sigaction_oldact_242_1216)
(minimize sigaction_oldact_1349_1216)
(minimize args_1_8)
(minimize args_0_8)
(maximize strlen_77_64)
(minimize sigaction_oldact_746_1216)
(minimize sigaction_oldact_456_1216)
(maximize args_3_8)
(minimize args_4_8)
