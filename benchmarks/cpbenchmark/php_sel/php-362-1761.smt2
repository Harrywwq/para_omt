...
(declare-fun sigaction_oldact_915_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1747_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x29219))))
(assert
 (let ((?x52288 ((_ extract 127 120) sigaction_oldact_915_1216)))
 (let ((?x52304 (bvand ?x52288 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x52304) true))))
(assert
 (let ((?x99027 ((_ extract 127 120) sigaction_oldact_1747_1216)))
 (let ((?x99052 (bvand ?x99027 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x99052) true))))
...
(maximize sigaction_oldact_915_1216)
(minimize sigaction_oldact_203_1216)
(maximize sigaction_oldact_570_1216)
(minimize sigaction_oldact_915_1216)
