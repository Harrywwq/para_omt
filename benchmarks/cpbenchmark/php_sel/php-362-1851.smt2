...
(declare-fun sigaction_oldact_2102_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x67533))))
(assert
 (let ((?x119936 ((_ extract 127 120) sigaction_oldact_2102_1216)))
 (let ((?x119945 (bvand ?x119936 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x119945) true))))
(minimize sigaction_oldact_176_1216)
(maximize sigaction_oldact_2102_1216)
...
(minimize sigaction_oldact_2102_1216)
