...
(declare-fun sigaction_oldact_1321_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43499))))
(assert
 (let ((?x76655 ((_ extract 127 120) sigaction_oldact_1321_1216)))
 (let ((?x76670 (bvand ?x76655 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x76670) true))))
...
(minimize args_0_8)
(minimize sigaction_oldact_1321_1216)
