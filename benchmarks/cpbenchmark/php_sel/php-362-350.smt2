...
(declare-fun sigaction_oldact_788_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1373_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x23311) true))))
(assert
 (let ((?x45427 ((_ extract 127 120) sigaction_oldact_788_1216)))
 (let ((?x221 (bvand ?x45427 (_ bv4 8))))
 (= (_ bv0 8) ?x221))))
(assert
 (let ((?x79474 ((_ extract 127 120) sigaction_oldact_1373_1216)))
 (let ((?x79490 (bvand ?x79474 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x79490) true))))
(minimize strlen_72_64)
(maximize sigaction_oldact_179_1216)
(minimize sigaction_oldact_475_1216)
(maximize sigaction_oldact_788_1216)
...
(minimize sigaction_oldact_788_1216)
...
(maximize sigaction_oldact_1373_1216)
(minimize args_3_8)
(minimize args_0_8)
...
(maximize args_3_8)
(minimize args_1_8)
(minimize sigaction_oldact_1373_1216)
(check-sat)
(get-objectives)
