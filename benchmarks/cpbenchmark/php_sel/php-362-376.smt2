...
(declare-fun sigaction_oldact_1451_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x529) true))))
(assert
 (let ((?x83555 ((_ extract 127 120) sigaction_oldact_1451_1216)))
 (let ((?x83571 (bvand ?x83555 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x83571) true))))
...
(minimize sigaction_oldact_1451_1216)
(minimize args_2_8)
...
(maximize sigaction_oldact_1451_1216)
