...
(declare-fun sigaction_oldact_1453_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x45700) true))))
(assert
 (let ((?x83682 ((_ extract 127 120) sigaction_oldact_1453_1216)))
 (let ((?x83692 (bvand ?x83682 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x83692) true))))
...
(maximize args_0_8)
(minimize sigaction_oldact_1453_1216)
(maximize args_2_8)
(minimize strlen_81_64)
(maximize sigaction_oldact_1453_1216)
...
(minimize sigaction_oldact_792_1216)
(minimize args_2_8)
