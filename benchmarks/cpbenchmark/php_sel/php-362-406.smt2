...
(declare-fun sigaction_oldact_1457_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x48538))))
(assert
 (let ((?x83902 ((_ extract 127 120) sigaction_oldact_1457_1216)))
 (let ((?x46758 (bvand ?x83902 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46758) true))))
...
(maximize args_3_8)
(maximize args_0_8)
(minimize sigaction_oldact_1457_1216)
(minimize strlen_72_64)
(maximize strlen_74_64)
(minimize sigaction_oldact_840_1216)
