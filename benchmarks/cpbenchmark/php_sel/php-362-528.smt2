...
(declare-fun sigaction_oldact_1594_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x54022 ((_ extract 127 120) sigaction_oldact_1594_1216)))
 (let ((?x91164 (bvand ?x54022 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x91164) true))))
...
(maximize sigaction_oldact_1594_1216)
...
(minimize args_2_8)
(minimize sigaction_oldact_1594_1216)
