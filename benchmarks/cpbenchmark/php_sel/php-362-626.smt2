...
(declare-fun sigaction_oldact_813_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1412_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x25231))))
(assert
 (let ((?x46892 ((_ extract 127 120) sigaction_oldact_813_1216)))
 (let ((?x46915 (bvand ?x46892 (_ bv4 8))))
 (= (_ bv0 8) ?x46915))))
(assert
 (let ((?x81362 ((_ extract 127 120) sigaction_oldact_1412_1216)))
 (let ((?x43527 (bvand ?x81362 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43527) true))))
(maximize sigaction_oldact_1412_1216)
(minimize sigaction_oldact_813_1216)
(minimize args_0_8)
(minimize sigaction_oldact_174_1216)
(maximize sigaction_oldact_505_1216)
(maximize sigaction_oldact_174_1216)
(minimize sigaction_oldact_1412_1216)
...
(maximize sigaction_oldact_813_1216)
