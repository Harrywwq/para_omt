...
(declare-fun sigaction_oldact_1494_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x1232) true))))
(assert
 (let ((?x85934 ((_ extract 127 120) sigaction_oldact_1494_1216)))
 (let ((?x85955 (bvand ?x85934 (_ bv4 8))))
 (= (_ bv0 8) ?x85955))))
...
(minimize sigaction_oldact_1494_1216)
(minimize sigaction_oldact_215_1216)
(maximize sigaction_oldact_256_1216)
(maximize sigaction_oldact_1494_1216)
