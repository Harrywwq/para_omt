...
(declare-fun sigaction_oldact_1609_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x3932) true))))
(assert
 (let ((?x92117 ((_ extract 127 120) sigaction_oldact_1609_1216)))
 (let ((?x92133 (bvand ?x92117 (_ bv4 8))))
 (= (_ bv0 8) ?x92133))))
...
(maximize sigaction_oldact_1609_1216)
(minimize args_0_8)
(minimize args_2_8)
(minimize sigaction_oldact_174_1216)
(maximize sigaction_oldact_193_1216)
(minimize sigaction_oldact_1609_1216)
