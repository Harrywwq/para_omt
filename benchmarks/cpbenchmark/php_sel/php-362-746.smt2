...
(declare-fun sigaction_oldact_1420_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x1817))))
(assert
 (let ((?x81714 ((_ extract 127 120) sigaction_oldact_1420_1216)))
 (let ((?x81734 (bvand ?x81714 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x81734) true))))
(maximize sigaction_oldact_219_1216)
(maximize sigaction_oldact_1420_1216)
