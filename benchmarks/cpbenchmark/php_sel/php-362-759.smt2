...
(declare-fun sigaction_oldact_934_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1780_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x27387) true))))
(assert
 (let ((?x53683 ((_ extract 127 120) sigaction_oldact_934_1216)))
 (let ((?x8538 (bvand ?x53683 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x8538) true))))
(assert
 (let ((?x101355 ((_ extract 127 120) sigaction_oldact_1780_1216)))
 (let ((?x101366 (bvand ?x101355 (_ bv4 8))))
 (= (_ bv0 8) ?x101366))))
(maximize args_0_8)
...
(minimize sigaction_oldact_934_1216)
