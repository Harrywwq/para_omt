...
(declare-fun sigaction_oldact_871_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1514_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x27434))))
(assert
 (let ((?x50244 ((_ extract 127 120) sigaction_oldact_871_1216)))
 (let ((?x50260 (bvand ?x50244 (_ bv4 8))))
 (= (_ bv0 8) ?x50260))))
(assert
 (let ((?x86881 ((_ extract 127 120) sigaction_oldact_1514_1216)))
 (let ((?x49829 (bvand ?x86881 (_ bv4 8))))
 (= (_ bv0 8) ?x49829))))
...
(minimize args_2_8)
(minimize sigaction_oldact_871_1216)
(maximize sigaction_oldact_194_1216)
(maximize args_2_8)
(maximize args_0_8)
(minimize sigaction_oldact_1514_1216)
