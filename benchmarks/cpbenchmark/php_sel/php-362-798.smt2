...
(declare-fun sigaction_oldact_388_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_578_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1026_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1788_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x8437) true))))
(assert
 (let ((?x16141 ((_ extract 127 120) sigaction_oldact_388_1216)))
 (let ((?x16166 (bvand ?x16141 (_ bv4 8))))
 (= (_ bv0 8) ?x16166))))
(assert
 (let ((?x29993 ((_ extract 127 120) sigaction_oldact_578_1216)))
 (let ((?x30003 (bvand ?x29993 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x30003) true))))
(assert
 (let ((?x58651 ((_ extract 127 120) sigaction_oldact_1026_1216)))
 (let ((?x58675 (bvand ?x58651 (_ bv4 8))))
 (= (_ bv0 8) ?x58675))))
(assert
 (let ((?x101788 ((_ extract 127 120) sigaction_oldact_1788_1216)))
 (let ((?x64369 (bvand ?x101788 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x64369) true))))
(minimize sigaction_oldact_1026_1216)
(minimize sigaction_oldact_174_1216)
(maximize sigaction_oldact_388_1216)
(maximize strlen_78_64)
(minimize sigaction_oldact_578_1216)
(minimize args_1_8)
(maximize strlen_72_64)
(maximize sigaction_oldact_219_1216)
(minimize sigaction_oldact_219_1216)
(maximize sigaction_oldact_1026_1216)
(minimize args_0_8)
(minimize sigaction_oldact_180_1216)
(maximize sigaction_oldact_578_1216)
(minimize strlen_74_64)
(minimize strlen_72_64)
(maximize sigaction_oldact_194_1216)
(maximize args_1_8)
(minimize sigaction_oldact_274_1216)
(minimize sigaction_oldact_1788_1216)
(minimize sigaction_oldact_388_1216)
(minimize args_2_8)
(maximize args_2_8)
(maximize args_0_8)
...
(maximize sigaction_oldact_1788_1216)
