...
(declare-fun sigaction_oldact_956_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1666_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x28071) true))))
(assert
 (let ((?x54886 ((_ extract 127 120) sigaction_oldact_956_1216)))
 (let ((?x54902 (bvand ?x54886 (_ bv4 8))))
 (= (_ bv0 8) ?x54902))))
(assert
 (let ((?x95126 ((_ extract 127 120) sigaction_oldact_1666_1216)))
 (let ((?x58248 (bvand ?x95126 (_ bv4 8))))
 (= (_ bv0 8) ?x58248))))
...
(minimize sigaction_oldact_1666_1216)
(maximize strlen_78_64)
(maximize sigaction_oldact_956_1216)
(minimize sigaction_oldact_183_1216)
(maximize sigaction_oldact_1666_1216)
