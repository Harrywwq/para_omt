...
(declare-fun sigaction_oldact_1040_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1987_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x30723) true))))
(assert
 (let ((?x59567 ((_ extract 127 120) sigaction_oldact_1040_1216)))
 (let ((?x59593 (bvand ?x59567 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x59593) true))))
(assert
 (let ((?x113081 ((_ extract 127 120) sigaction_oldact_1987_1216)))
 (let ((?x113095 (bvand ?x113081 (_ bv4 8))))
 (= (_ bv0 8) ?x113095))))
...
(maximize sigaction_oldact_1987_1216)
...
(maximize sigaction_oldact_1040_1216)
(maximize args_2_8)
(maximize sigaction_oldact_392_1216)
(minimize strlen_74_64)
(minimize args_0_8)
(minimize sigaction_oldact_588_1216)
(maximize sigaction_oldact_588_1216)
(minimize sigaction_oldact_1987_1216)
(minimize sigaction_oldact_226_1216)
(minimize sigaction_oldact_1040_1216)
(minimize args_1_8)
(check-sat)
(get-objectives)
