...
(declare-fun sigaction_oldact_1127_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1992_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x36801))))
(assert
 (let ((?x64537 ((_ extract 127 120) sigaction_oldact_1127_1216)))
 (let ((?x22155 (bvand ?x64537 (_ bv4 8))))
 (= (_ bv0 8) ?x22155))))
(assert
 (let ((?x113324 ((_ extract 127 120) sigaction_oldact_1992_1216)))
 (let ((?x75019 (bvand ?x113324 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75019) true))))
...
(minimize sigaction_oldact_1127_1216)
(minimize args_0_8)
(maximize sigaction_oldact_1992_1216)
