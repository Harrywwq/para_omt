...
(declare-fun sigaction_oldact_1999_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x60138) true))))
(assert
 (let ((?x75656 ((_ extract 127 120) sigaction_oldact_1999_1216)))
 (let ((?x113950 (bvand ?x75656 (_ bv4 8))))
 (= (_ bv0 8) ?x113950))))
...
(maximize sigaction_oldact_1999_1216)
(maximize sigaction_oldact_375_1216)
(minimize sigaction_oldact_1999_1216)
