...
(declare-fun sigaction_oldact_1058_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1863_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x31555) true))))
(assert
 (let ((?x60706 ((_ extract 127 120) sigaction_oldact_1058_1216)))
 (let ((?x17103 (bvand ?x60706 (_ bv4 8))))
 (= (_ bv0 8) ?x17103))))
(assert
 (let ((?x106139 ((_ extract 127 120) sigaction_oldact_1863_1216)))
 (let ((?x68623 (bvand ?x106139 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x68623) true))))
(minimize args_1_8)
...
(maximize sigaction_oldact_1863_1216)
...
(minimize sigaction_oldact_1863_1216)
(minimize sigaction_oldact_1058_1216)
(check-sat)
(get-objectives)
