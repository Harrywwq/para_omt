...
(declare-fun sigaction_oldact_1932_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x62862))))
(assert
 (let ((?x109575 ((_ extract 127 120) sigaction_oldact_1932_1216)))
 (let ((?x71130 (bvand ?x109575 (_ bv4 8))))
 (= (_ bv0 8) ?x71130))))
...
(maximize args_0_8)
(maximize sigaction_oldact_1932_1216)
