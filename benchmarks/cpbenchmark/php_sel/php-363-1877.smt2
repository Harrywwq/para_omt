...
(declare-fun sigaction_oldact_659_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1102_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1938_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x17725) true))))
(assert
 (let ((?x35846 ((_ extract 127 120) sigaction_oldact_659_1216)))
 (let ((?x35852 (bvand ?x35846 (_ bv4 8))))
 (= (_ bv0 8) ?x35852))))
(assert
 (let ((?x63034 ((_ extract 127 120) sigaction_oldact_1102_1216)))
 (let ((?x63051 (bvand ?x63034 (_ bv4 8))))
 (= (_ bv0 8) ?x63051))))
(assert
 (let ((?x109860 ((_ extract 127 120) sigaction_oldact_1938_1216)))
 (let ((?x109868 (bvand ?x109860 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x109868) true))))
(maximize sigaction_oldact_659_1216)
(minimize sigaction_oldact_1102_1216)
...
(minimize sigaction_oldact_1938_1216)
...
(maximize sigaction_oldact_1938_1216)
(maximize args_1_8)
