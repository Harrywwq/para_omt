...
(declare-fun sigaction_oldact_1169_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2098_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x36018) true))))
(assert
 (let ((?x26388 ((_ extract 127 120) sigaction_oldact_1169_1216)))
 (let ((?x67399 (bvand ?x26388 (_ bv4 8))))
 (= (_ bv0 8) ?x67399))))
(assert
 (let ((?x119755 ((_ extract 127 120) sigaction_oldact_2098_1216)))
 (let ((?x119775 (bvand ?x119755 (_ bv4 8))))
 (= (_ bv0 8) ?x119775))))
...
(minimize sigaction_oldact_1169_1216)
(minimize sigaction_oldact_176_1216)
(maximize sigaction_oldact_1169_1216)
(maximize sigaction_oldact_176_1216)
(maximize sigaction_oldact_187_1216)
(maximize args_0_8)
(minimize sigaction_oldact_662_1216)
