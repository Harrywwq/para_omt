...
(declare-fun sigaction_oldact_2203_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x67399) true))))
(assert
 (let ((?x126722 ((_ extract 127 120) sigaction_oldact_2203_1216)))
 (let ((?x90630 (bvand ?x126722 (_ bv4 8))))
 (= (_ bv0 8) ?x90630))))
(maximize args_1_8)
...
(minimize sigaction_oldact_2203_1216)
