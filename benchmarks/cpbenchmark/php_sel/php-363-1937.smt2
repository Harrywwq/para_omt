...
(declare-fun sigaction_oldact_2206_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x67496) true))))
(assert
 (let ((?x90765 ((_ extract 127 120) sigaction_oldact_2206_1216)))
 (let ((?x90808 (bvand ?x90765 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x90808) true))))
...
(maximize sigaction_oldact_2206_1216)
(minimize sigaction_oldact_303_1216)
(maximize sigaction_oldact_427_1216)
(minimize sigaction_oldact_2206_1216)
(check-sat)
(get-objectives)
