...
(declare-fun sigaction_oldact_1313_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x42035) true))))
(assert
 (let ((?x76256 ((_ extract 127 120) sigaction_oldact_1313_1216)))
 (let ((?x38000 (bvand ?x76256 (_ bv4 8))))
 (= (_ bv0 8) ?x38000))))
(maximize args_4_8)
