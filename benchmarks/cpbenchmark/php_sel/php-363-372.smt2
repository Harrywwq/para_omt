...
(declare-fun sigaction_oldact_1448_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x221) true))))
(assert
 (let ((?x83357 ((_ extract 127 120) sigaction_oldact_1448_1216)))
 (let ((?x45978 (bvand ?x83357 (_ bv4 8))))
 (= (_ bv0 8) ?x45978))))
...
(minimize args_1_8)
(maximize sigaction_oldact_1448_1216)
...
(minimize sigaction_oldact_1448_1216)
