...
(declare-fun sigaction_oldact_1477_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x46431) true))))
(assert
 (let ((?x48208 ((_ extract 127 120) sigaction_oldact_1477_1216)))
 (let ((?x85022 (bvand ?x48208 (_ bv4 8))))
 (= (_ bv0 8) ?x85022))))
(minimize args_0_8)
(minimize args_1_8)
...
(maximize sigaction_oldact_1477_1216)
(maximize args_3_8)
(minimize sigaction_oldact_1477_1216)
