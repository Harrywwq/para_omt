...
(declare-fun sigaction_oldact_1964_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x13475) true))))
(assert
 (let ((?x111219 ((_ extract 127 120) sigaction_oldact_1964_1216)))
 (let ((?x111244 (bvand ?x111219 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x111244) true))))
(maximize args_2_8)
(minimize args_0_8)
(minimize strlen_77_64)
(minimize sigaction_oldact_1964_1216)
(maximize sigaction_oldact_1021_1216)
(maximize args_1_8)
(minimize sigaction_oldact_262_1216)
(minimize args_1_8)
(minimize args_3_8)
(minimize sigaction_oldact_192_1216)
(maximize sigaction_oldact_1964_1216)
(check-sat)
(get-objectives)
