...
(declare-fun sigaction_oldact_1787_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x53952) true))))
(assert
 (let ((?x101743 ((_ extract 127 120) sigaction_oldact_1787_1216)))
 (let ((?x101766 (bvand ?x101743 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x101766) true))))
(minimize args_0_8)
...
(minimize sigaction_oldact_1787_1216)
