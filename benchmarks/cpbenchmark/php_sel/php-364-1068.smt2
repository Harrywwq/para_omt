...
(declare-fun sigaction_oldact_1816_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x103475 ((_ extract 127 120) sigaction_oldact_1816_1216)))
 (let ((?x65952 (bvand ?x103475 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x65952) true))))
