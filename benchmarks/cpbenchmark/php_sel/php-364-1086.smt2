...
(declare-fun sigaction_oldact_1124_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1986_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x33643) true))))
(assert
 (let ((?x64364 ((_ extract 127 120) sigaction_oldact_1124_1216)))
 (let ((?x64382 (bvand ?x64364 (_ bv4 8))))
 (= (_ bv0 8) ?x64382))))
(assert
 (let ((?x113015 ((_ extract 127 120) sigaction_oldact_1986_1216)))
 (let ((?x74802 (bvand ?x113015 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74802) true))))
(maximize args_1_8)
(maximize sigaction_oldact_197_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_277_1216)
(minimize sigaction_oldact_1124_1216)
...
(maximize sigaction_oldact_1124_1216)
