...
(declare-fun sigaction_oldact_673_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1197_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2267_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x19005) true))))
(assert
 (let ((?x36781 ((_ extract 127 120) sigaction_oldact_673_1216)))
 (let ((?x36801 (bvand ?x36781 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x36801) true))))
(assert
 (let ((?x68890 ((_ extract 127 120) sigaction_oldact_1197_1216)))
 (let ((?x28200 (bvand ?x68890 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x28200) true))))
(assert
 (let ((?x130190 ((_ extract 127 120) sigaction_oldact_2267_1216)))
 (let ((?x130206 (bvand ?x130190 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x130206) true))))
(minimize args_2_8)
...
(maximize sigaction_oldact_673_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_1197_1216)
(check-sat)
(get-objectives)
