...
(declare-fun sigaction_oldact_1692_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x10828))))
(assert
 (let ((?x96473 ((_ extract 127 120) sigaction_oldact_1692_1216)))
 (let ((?x96478 (bvand ?x96473 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x96478) true))))
(minimize sigaction_oldact_1692_1216)
