...
(declare-fun sigaction_oldact_972_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1695_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x31173))))
(assert
 (let ((?x55754 ((_ extract 127 120) sigaction_oldact_972_1216)))
 (let ((?x55760 (bvand ?x55754 (_ bv4 8))))
 (= (_ bv0 8) ?x55760))))
(assert
 (let ((?x96619 ((_ extract 127 120) sigaction_oldact_1695_1216)))
 (let ((?x96635 (bvand ?x96619 (_ bv4 8))))
 (= (_ bv0 8) ?x96635))))
(minimize sigaction_oldact_1695_1216)
...
(minimize sigaction_oldact_972_1216)
...
(maximize sigaction_oldact_972_1216)
(maximize strlen_72_64)
(maximize args_1_8)
(maximize sigaction_oldact_1695_1216)
