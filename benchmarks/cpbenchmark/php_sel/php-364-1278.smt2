...
(declare-fun sigaction_oldact_593_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1048_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1843_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x15361) true))))
(assert
 (let ((?x31148 ((_ extract 127 120) sigaction_oldact_593_1216)))
 (let ((?x31173 (bvand ?x31148 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x31173) true))))
(assert
 (let ((?x16350 ((_ extract 127 120) sigaction_oldact_1048_1216)))
 (let ((?x60138 (bvand ?x16350 (_ bv4 8))))
 (= (_ bv0 8) ?x60138))))
(assert
 (let ((?x105060 ((_ extract 127 120) sigaction_oldact_1843_1216)))
 (let ((?x105076 (bvand ?x105060 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x105076) true))))
(maximize sigaction_oldact_1843_1216)
(maximize args_0_8)
(minimize sigaction_oldact_375_1216)
(minimize args_1_8)
(maximize sigaction_oldact_223_1216)
(maximize sigaction_oldact_184_1216)
(minimize sigaction_oldact_593_1216)
(minimize sigaction_oldact_184_1216)
(maximize args_1_8)
(maximize sigaction_oldact_593_1216)
(minimize sigaction_oldact_1048_1216)
...
(maximize sigaction_oldact_1048_1216)
(minimize sigaction_oldact_1843_1216)
