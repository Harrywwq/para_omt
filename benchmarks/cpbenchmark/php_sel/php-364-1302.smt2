...
(declare-fun sigaction_oldact_1050_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1848_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x31292) true))))
(assert
 (let ((?x60249 ((_ extract 127 120) sigaction_oldact_1050_1216)))
 (let ((?x60259 (bvand ?x60249 (_ bv4 8))))
 (= (_ bv0 8) ?x60259))))
(assert
 (let ((?x105330 ((_ extract 127 120) sigaction_oldact_1848_1216)))
 (let ((?x105354 (bvand ?x105330 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x105354) true))))
(minimize sigaction_oldact_595_1216)
(maximize sigaction_oldact_175_1216)
(minimize strlen_72_64)
(maximize args_1_8)
(minimize sigaction_oldact_1050_1216)
(minimize sigaction_oldact_1848_1216)
