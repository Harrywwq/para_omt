...
(declare-fun sigaction_oldact_2001_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x60259) true))))
(assert
 (let ((?x114101 ((_ extract 127 120) sigaction_oldact_2001_1216)))
 (let ((?x114117 (bvand ?x114101 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x114117) true))))
...
(maximize sigaction_oldact_2001_1216)
(check-sat)
(get-objectives)
