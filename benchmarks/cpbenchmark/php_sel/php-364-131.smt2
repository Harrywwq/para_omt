...
(declare-fun sigaction_oldact_1120_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1963_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x36609))))
(assert
 (let ((?x63877 ((_ extract 127 120) sigaction_oldact_1120_1216)))
 (let ((?x21090 (bvand ?x63877 (_ bv4 8))))
 (= (_ bv0 8) ?x21090))))
(assert
 (let ((?x111065 ((_ extract 127 120) sigaction_oldact_1963_1216)))
 (let ((?x111090 (bvand ?x111065 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x111090) true))))
...
(maximize sigaction_oldact_1120_1216)
(minimize args_2_8)
(maximize args_2_8)
(maximize args_5_16)
(minimize args_5_16)
(minimize sigaction_oldact_1120_1216)
(maximize sigaction_oldact_1963_1216)
