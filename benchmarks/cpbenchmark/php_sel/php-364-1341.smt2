...
(declare-fun sigaction_oldact_1130_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2007_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x34138) true))))
(assert
 (let ((?x64867 ((_ extract 127 120) sigaction_oldact_1130_1216)))
 (let ((?x64898 (bvand ?x64867 (_ bv4 8))))
 (= (_ bv0 8) ?x64898))))
(assert
 (let ((?x114468 ((_ extract 127 120) sigaction_oldact_2007_1216)))
 (let ((?x114483 (bvand ?x114468 (_ bv4 8))))
 (= (_ bv0 8) ?x114483))))
(minimize sigaction_oldact_184_1216)
(maximize sigaction_oldact_2007_1216)
