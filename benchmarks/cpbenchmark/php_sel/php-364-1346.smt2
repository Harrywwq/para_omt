...
(declare-fun sigaction_oldact_1704_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x56093))))
(assert
 (let ((?x97017 ((_ extract 127 120) sigaction_oldact_1704_1216)))
 (let ((?x97037 (bvand ?x97017 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x97037) true))))
(minimize args_0_8)
...
(minimize sigaction_oldact_1704_1216)
...
(maximize sigaction_oldact_1704_1216)
