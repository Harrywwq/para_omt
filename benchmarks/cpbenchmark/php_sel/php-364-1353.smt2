...
(declare-fun sigaction_oldact_1858_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x60586))))
(assert
 (let ((?x105830 ((_ extract 127 120) sigaction_oldact_1858_1216)))
 (let ((?x68208 (bvand ?x105830 (_ bv4 8))))
 (= (_ bv0 8) ?x68208))))
(maximize sigaction_oldact_184_1216)
(minimize args_0_8)
(minimize sigaction_oldact_227_1216)
(minimize sigaction_oldact_1056_1216)
(minimize sigaction_oldact_1858_1216)
