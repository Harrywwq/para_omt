...
(declare-fun sigaction_oldact_2014_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x17103) true))))
(assert
 (let ((?x114897 ((_ extract 127 120) sigaction_oldact_2014_1216)))
 (let ((?x76924 (bvand ?x114897 (_ bv4 8))))
 (= (_ bv0 8) ?x76924))))
(maximize sigaction_oldact_185_1216)
(maximize sigaction_oldact_175_1216)
(maximize sigaction_oldact_224_1216)
(maximize sigaction_oldact_2014_1216)
