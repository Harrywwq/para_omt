...
(declare-fun sigaction_oldact_1192_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2245_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x38970))))
(assert
 (let ((?x68561 ((_ extract 127 120) sigaction_oldact_1192_1216)))
 (let ((?x68581 (bvand ?x68561 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x68581) true))))
(assert
 (let ((?x129077 ((_ extract 127 120) sigaction_oldact_2245_1216)))
 (let ((?x129097 (bvand ?x129077 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x129097) true))))
(maximize sigaction_oldact_241_1216)
(minimize sigaction_oldact_1192_1216)
(maximize args_1_8)
