...
(declare-fun sigaction_oldact_698_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1230_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2246_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x20432) true))))
(assert
 (let ((?x38960 ((_ extract 127 120) sigaction_oldact_698_1216)))
 (let ((?x38970 (bvand ?x38960 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x38970) true))))
(assert
 (let ((?x71361 ((_ extract 127 120) sigaction_oldact_1230_1216)))
 (let ((?x71385 (bvand ?x71361 (_ bv4 8))))
 (= (_ bv0 8) ?x71385))))
(assert
 (let ((?x129119 ((_ extract 127 120) sigaction_oldact_2246_1216)))
 (let ((?x92839 (bvand ?x129119 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x92839) true))))
(minimize strlen_77_64)
(maximize args_5_16)
(minimize args_2_8)
(minimize sigaction_oldact_1230_1216)
(minimize args_5_16)
(minimize args_1_8)
(maximize args_4_8)
(maximize sigaction_oldact_307_1216)
(maximize sigaction_oldact_2246_1216)
(minimize args_4_8)
(maximize args_0_8)
(check-sat)
(get-objectives)
