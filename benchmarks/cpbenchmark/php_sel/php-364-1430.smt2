...
(declare-fun sigaction_oldact_1060_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1868_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x31666) true))))
(assert
 (let ((?x60833 ((_ extract 127 120) sigaction_oldact_1060_1216)))
 (let ((?x17325 (bvand ?x60833 (_ bv4 8))))
 (= (_ bv0 8) ?x17325))))
(assert
 (let ((?x106418 ((_ extract 127 120) sigaction_oldact_1868_1216)))
 (let ((?x68855 (bvand ?x106418 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x68855) true))))
(maximize sigaction_oldact_397_1216)
(maximize sigaction_oldact_1868_1216)
(maximize sigaction_oldact_601_1216)
(minimize sigaction_oldact_1868_1216)
(maximize sigaction_oldact_185_1216)
(maximize sigaction_oldact_175_1216)
(maximize sigaction_oldact_1060_1216)
(minimize sigaction_oldact_1060_1216)
