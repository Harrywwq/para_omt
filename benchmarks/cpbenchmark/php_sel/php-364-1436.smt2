...
(declare-fun sigaction_oldact_638_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1061_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2017_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x16920) true))))
(assert
 (let ((?x34359 ((_ extract 127 120) sigaction_oldact_638_1216)))
 (let ((?x34384 (bvand ?x34359 (_ bv4 8))))
 (= (_ bv0 8) ?x34384))))
(assert
 (let ((?x60875 ((_ extract 127 120) sigaction_oldact_1061_1216)))
 (let ((?x60900 (bvand ?x60875 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x60900) true))))
(assert
 (let ((?x115130 ((_ extract 127 120) sigaction_oldact_2017_1216)))
 (let ((?x115142 (bvand ?x115130 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x115142) true))))
(maximize sigaction_oldact_2017_1216)
...
(maximize sigaction_oldact_1061_1216)
(minimize sigaction_oldact_397_1216)
(minimize sigaction_oldact_281_1216)
(minimize sigaction_oldact_2017_1216)
(maximize sigaction_oldact_171_1216)
(maximize sigaction_oldact_638_1216)
(minimize sigaction_oldact_185_1216)
(minimize sigaction_oldact_224_1216)
(minimize sigaction_oldact_1061_1216)
(maximize sigaction_oldact_185_1216)
(maximize sigaction_oldact_224_1216)
(minimize sigaction_oldact_638_1216)
(maximize args_1_8)
