...
(declare-fun sigaction_oldact_1193_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2136_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x39027))))
(assert
 (let ((?x68603 ((_ extract 127 120) sigaction_oldact_1193_1216)))
 (let ((?x68619 (bvand ?x68603 (_ bv4 8))))
 (= (_ bv0 8) ?x68619))))
(assert
 (let ((?x121640 ((_ extract 127 120) sigaction_oldact_2136_1216)))
 (let ((?x121651 (bvand ?x121640 (_ bv4 8))))
 (= (_ bv0 8) ?x121651))))
(minimize args_5_16)
(maximize sigaction_oldact_307_1216)
(maximize sigaction_oldact_241_1216)
(maximize sigaction_oldact_2136_1216)
...
(maximize sigaction_oldact_1193_1216)
(minimize args_2_8)
(maximize sigaction_oldact_699_1216)
(minimize sigaction_oldact_1193_1216)
...
(minimize sigaction_oldact_2136_1216)
