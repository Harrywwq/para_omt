...
(declare-fun sigaction_oldact_1875_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x61073))))
(assert
 (let ((?x106761 ((_ extract 127 120) sigaction_oldact_1875_1216)))
 (let ((?x106781 (bvand ?x106761 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x106781) true))))
(minimize sigaction_oldact_175_1216)
(minimize sigaction_oldact_1064_1216)
