...
(declare-fun sigaction_oldact_409_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_658_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1164_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2087_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x9243) true))))
(assert
 (let ((?x17653 ((_ extract 127 120) sigaction_oldact_409_1216)))
 (let ((?x17670 (bvand ?x17653 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x17670) true))))
(assert
 (let ((?x35774 ((_ extract 127 120) sigaction_oldact_658_1216)))
 (let ((?x35799 (bvand ?x35774 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x35799) true))))
(assert
 (let ((?x67073 ((_ extract 127 120) sigaction_oldact_1164_1216)))
 (let ((?x26081 (bvand ?x67073 (_ bv4 8))))
 (= (_ bv0 8) ?x26081))))
(assert
 (let ((?x119151 ((_ extract 127 120) sigaction_oldact_2087_1216)))
 (let ((?x119171 (bvand ?x119151 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x119171) true))))
