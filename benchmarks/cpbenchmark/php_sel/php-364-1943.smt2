...
(declare-fun sigaction_oldact_1167_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2093_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x38065))))
(assert
 (let ((?x67251 ((_ extract 127 120) sigaction_oldact_1167_1216)))
 (let ((?x26303 (bvand ?x67251 (_ bv4 8))))
 (= (_ bv0 8) ?x26303))))
(assert
 (let ((?x119474 ((_ extract 127 120) sigaction_oldact_2093_1216)))
 (let ((?x119499 (bvand ?x119474 (_ bv4 8))))
 (= (_ bv0 8) ?x119499))))
...
(minimize sigaction_oldact_2093_1216)
(maximize sigaction_oldact_1167_1216)
(maximize sigaction_oldact_2093_1216)
(minimize sigaction_oldact_1167_1216)
