...
(declare-fun sigaction_oldact_2263_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x71987))))
(assert
 (let ((?x129890 ((_ extract 127 120) sigaction_oldact_2263_1216)))
 (let ((?x93501 (bvand ?x129890 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x93501) true))))
(maximize sigaction_oldact_208_1216)
(maximize sigaction_oldact_313_1216)
(minimize args_4_8)
(minimize sigaction_oldact_1243_1216)
