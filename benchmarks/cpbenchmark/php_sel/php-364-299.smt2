...
(declare-fun sigaction_oldact_735_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1308_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x22342))))
(assert
 (let ((?x41924 ((_ extract 127 120) sigaction_oldact_735_1216)))
 (let ((?x41949 (bvand ?x41924 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x41949) true))))
(assert
 (let ((?x76028 ((_ extract 127 120) sigaction_oldact_1308_1216)))
 (let ((?x76044 (bvand ?x76028 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x76044) true))))
(maximize args_2_8)
...
(maximize args_1_8)
(minimize args_4_8)
(maximize sigaction_oldact_735_1216)
