...
(declare-fun sigaction_oldact_737_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1281_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x22428))))
(assert
 (let ((?x42018 ((_ extract 127 120) sigaction_oldact_737_1216)))
 (let ((?x42035 (bvand ?x42018 (_ bv4 8))))
 (= (_ bv0 8) ?x42035))))
(assert
 (let ((?x74355 ((_ extract 127 120) sigaction_oldact_1281_1216)))
 (let ((?x74371 (bvand ?x74355 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74371) true))))
(minimize sigaction_oldact_1281_1216)
(maximize args_1_8)
(maximize sigaction_oldact_462_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_737_1216)
(minimize sigaction_oldact_188_1216)
(minimize sigaction_oldact_462_1216)
(maximize args_4_8)
(minimize args_3_8)
(maximize sigaction_oldact_1281_1216)
...
(maximize args_0_8)
(minimize sigaction_oldact_737_1216)
