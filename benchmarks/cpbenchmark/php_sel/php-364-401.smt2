...
(declare-fun sigaction_oldact_1326_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43701))))
(assert
 (let ((?x76877 ((_ extract 127 120) sigaction_oldact_1326_1216)))
 (let ((?x76882 (bvand ?x76877 (_ bv4 8))))
 (= (_ bv0 8) ?x76882))))
(minimize sigaction_oldact_179_1216)
(maximize sigaction_oldact_210_1216)
(maximize sigaction_oldact_1326_1216)
...
(minimize sigaction_oldact_1326_1216)
