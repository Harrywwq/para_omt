...
(declare-fun sigaction_oldact_1454_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x48441))))
(assert
 (let ((?x83733 ((_ extract 127 120) sigaction_oldact_1454_1216)))
 (let ((?x46499 (bvand ?x83733 (_ bv4 8))))
 (= (_ bv0 8) ?x46499))))
(maximize args_2_8)
(minimize sigaction_oldact_211_1216)
(minimize strlen_74_64)
(maximize sigaction_oldact_211_1216)
(minimize sigaction_oldact_839_1216)
(maximize sigaction_oldact_1454_1216)
(minimize args_2_8)
...
(minimize sigaction_oldact_1454_1216)
