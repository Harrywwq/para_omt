...
(declare-fun sigaction_oldact_927_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1611_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x27052) true))))
(assert
 (let ((?x53252 ((_ extract 127 120) sigaction_oldact_927_1216)))
 (let ((?x53268 (bvand ?x53252 (_ bv4 8))))
 (= (_ bv0 8) ?x53268))))
(assert
 (let ((?x92213 ((_ extract 127 120) sigaction_oldact_1611_1216)))
 (let ((?x92221 (bvand ?x92213 (_ bv4 8))))
 (= (_ bv0 8) ?x92221))))
(maximize strlen_78_64)
(maximize strlen_74_64)
(minimize sigaction_oldact_927_1216)
...
(maximize sigaction_oldact_1611_1216)
(minimize sigaction_oldact_532_1216)
(maximize sigaction_oldact_927_1216)
...
(minimize sigaction_oldact_1611_1216)
