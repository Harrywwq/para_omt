...
(declare-fun sigaction_oldact_1772_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x8016) true))))
(assert
 (let ((?x100787 ((_ extract 127 120) sigaction_oldact_1772_1216)))
 (let ((?x100799 (bvand ?x100787 (_ bv4 8))))
 (= (_ bv0 8) ?x100799))))
(maximize args_1_8)
...
(minimize args_2_8)
(maximize sigaction_oldact_1772_1216)
(minimize args_1_8)
...
(minimize sigaction_oldact_1772_1216)
