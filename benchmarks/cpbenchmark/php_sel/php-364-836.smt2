...
(declare-fun sigaction_oldact_872_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1631_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x27466))))
(assert
 (let ((?x50282 ((_ extract 127 120) sigaction_oldact_872_1216)))
 (let ((?x50298 (bvand ?x50282 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x50298) true))))
(assert
 (let ((?x93312 ((_ extract 127 120) sigaction_oldact_1631_1216)))
 (let ((?x93332 (bvand ?x93312 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x93332) true))))
(maximize args_0_8)
(minimize args_2_8)
(maximize sigaction_oldact_872_1216)
...
(maximize sigaction_oldact_1631_1216)
...
(minimize sigaction_oldact_539_1216)
(minimize sigaction_oldact_872_1216)
...
(minimize sigaction_oldact_1631_1216)
(maximize args_2_8)
