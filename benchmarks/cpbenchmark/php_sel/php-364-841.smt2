...
(declare-fun sigaction_oldact_1633_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x8723))))
(assert
 (let ((?x93392 ((_ extract 127 120) sigaction_oldact_1633_1216)))
 (let ((?x56480 (bvand ?x93392 (_ bv4 8))))
 (= (_ bv0 8) ?x56480))))
(maximize strlen_74_64)
(maximize sigaction_oldact_1633_1216)
...
(maximize args_1_8)
(maximize args_2_8)
(minimize sigaction_oldact_1633_1216)
(minimize args_2_8)
(check-sat)
(get-objectives)
