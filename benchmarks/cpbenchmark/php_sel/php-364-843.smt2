...
(declare-fun sigaction_oldact_938_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1785_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x29971))))
(assert
 (let ((?x53894 ((_ extract 127 120) sigaction_oldact_938_1216)))
 (let ((?x8723 (bvand ?x53894 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x8723) true))))
(assert
 (let ((?x64269 ((_ extract 127 120) sigaction_oldact_1785_1216)))
 (let ((?x101666 (bvand ?x64269 (_ bv4 8))))
 (= (_ bv0 8) ?x101666))))
...
(minimize args_1_8)
(minimize sigaction_oldact_577_1216)
(maximize sigaction_oldact_938_1216)
...
(minimize sigaction_oldact_938_1216)
(maximize sigaction_oldact_1785_1216)
(maximize args_0_8)
(minimize sigaction_oldact_1785_1216)
(maximize args_1_8)
(minimize args_2_8)
