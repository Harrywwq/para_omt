...
(declare-fun sigaction_oldact_577_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1025_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1968_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x14686) true))))
(assert
 (let ((?x29946 ((_ extract 127 120) sigaction_oldact_577_1216)))
 (let ((?x29971 (bvand ?x29946 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x29971) true))))
(assert
 (let ((?x58594 ((_ extract 127 120) sigaction_oldact_1025_1216)))
 (let ((?x58609 (bvand ?x58594 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x58609) true))))
(assert
 (let ((?x111680 ((_ extract 127 120) sigaction_oldact_1968_1216)))
 (let ((?x111695 (bvand ?x111680 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x111695) true))))
(maximize sigaction_oldact_1968_1216)
(maximize args_2_8)
(maximize sigaction_oldact_180_1216)
(maximize sigaction_oldact_577_1216)
(maximize sigaction_oldact_219_1216)
(maximize sigaction_oldact_1025_1216)
...
(minimize sigaction_oldact_1025_1216)
