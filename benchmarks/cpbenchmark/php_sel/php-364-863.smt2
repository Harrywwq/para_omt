...
(declare-fun sigaction_oldact_627_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1121_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2140_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x16166) true))))
(assert
 (let ((?x33267 ((_ extract 127 120) sigaction_oldact_627_1216)))
 (let ((?x33277 (bvand ?x33267 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x33277) true))))
(assert
 (let ((?x64032 ((_ extract 127 120) sigaction_oldact_1121_1216)))
 (let ((?x21353 (bvand ?x64032 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21353) true))))
(assert
 (let ((?x121921 ((_ extract 127 120) sigaction_oldact_2140_1216)))
 (let ((?x84185 (bvand ?x121921 (_ bv4 8))))
 (= (_ bv0 8) ?x84185))))
(minimize sigaction_oldact_174_1216)
(maximize sigaction_oldact_627_1216)
(minimize sigaction_oldact_1121_1216)
(maximize sigaction_oldact_219_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_274_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_2140_1216)
