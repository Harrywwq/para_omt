...
(declare-fun sigaction_oldact_1983_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x112845 ((_ extract 127 120) sigaction_oldact_1983_1216)))
 (let ((?x112860 (bvand ?x112845 (_ bv4 8))))
 (= (_ bv0 8) ?x112860))))
(minimize args_2_8)
...
(maximize sigaction_oldact_1983_1216)
