...
(declare-fun sigaction_oldact_2147_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x28200))))
(assert
 (let ((?x122573 ((_ extract 127 120) sigaction_oldact_2147_1216)))
 (let ((?x122578 (bvand ?x122573 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x122578) true))))
(maximize sigaction_oldact_1197_1216)
(minimize args_0_8)
(minimize sigaction_oldact_673_1216)
(maximize args_1_8)
(maximize args_2_8)
(minimize sigaction_oldact_226_1216)
(minimize strlen_74_64)
(minimize sigaction_oldact_2147_1216)
