...
(declare-fun sigaction_oldact_1864_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x56330) true))))
(assert
 (let ((?x106221 ((_ extract 127 120) sigaction_oldact_1864_1216)))
 (let ((?x106241 (bvand ?x106221 (_ bv4 8))))
 (= (_ bv0 8) ?x106241))))
(maximize sigaction_oldact_562_1216)
(minimize sigaction_oldact_562_1216)
...
(minimize sigaction_oldact_1864_1216)
...
(maximize sigaction_oldact_1864_1216)
