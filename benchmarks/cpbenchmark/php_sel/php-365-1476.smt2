...
(declare-fun sigaction_oldact_1865_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x56372) true))))
(assert
 (let ((?x106279 ((_ extract 127 120) sigaction_oldact_1865_1216)))
 (let ((?x106295 (bvand ?x106279 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x106295) true))))
(minimize args_1_8)
(minimize args_0_8)
(minimize sigaction_oldact_1865_1216)
