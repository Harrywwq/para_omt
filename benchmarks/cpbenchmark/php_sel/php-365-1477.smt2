...
(declare-fun sigaction_oldact_1059_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1866_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x31627) true))))
(assert
 (let ((?x60779 ((_ extract 127 120) sigaction_oldact_1059_1216)))
 (let ((?x17251 (bvand ?x60779 (_ bv4 8))))
 (= (_ bv0 8) ?x17251))))
(assert
 (let ((?x106317 ((_ extract 127 120) sigaction_oldact_1866_1216)))
 (let ((?x68808 (bvand ?x106317 (_ bv4 8))))
 (= (_ bv0 8) ?x68808))))
...
(maximize sigaction_oldact_1866_1216)
(minimize sigaction_oldact_199_1216)
(maximize sigaction_oldact_175_1216)
(minimize sigaction_oldact_1059_1216)
...
(minimize sigaction_oldact_1866_1216)
(maximize sigaction_oldact_1059_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_600_1216)
