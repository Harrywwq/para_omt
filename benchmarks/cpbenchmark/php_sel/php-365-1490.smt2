...
(declare-fun sigaction_oldact_1869_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x60900))))
(assert
 (let ((?x106456 ((_ extract 127 120) sigaction_oldact_1869_1216)))
 (let ((?x106472 (bvand ?x106456 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x106472) true))))
...
(minimize sigaction_oldact_1869_1216)
...
(maximize sigaction_oldact_1869_1216)
