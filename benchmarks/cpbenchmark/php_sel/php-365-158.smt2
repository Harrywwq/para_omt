...
(declare-fun sigaction_oldact_2311_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x71439) true))))
(assert
 (let ((?x133789 ((_ extract 127 120) sigaction_oldact_2311_1216)))
 (let ((?x133804 (bvand ?x133789 (_ bv4 8))))
 (= (_ bv0 8) ?x133804))))
...
(maximize args_1_8)
(minimize args_3_8)
(minimize sigaction_oldact_2311_1216)
