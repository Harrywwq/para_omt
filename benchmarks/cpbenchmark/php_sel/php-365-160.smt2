...
(declare-fun sigaction_oldact_2249_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x71473))))
(assert
 (let ((?x129261 ((_ extract 127 120) sigaction_oldact_2249_1216)))
 (let ((?x92981 (bvand ?x129261 (_ bv4 8))))
 (= (_ bv0 8) ?x92981))))
(maximize strlen_77_64)
(maximize args_5_16)
(maximize sigaction_oldact_241_1216)
(maximize sigaction_oldact_2249_1216)
(minimize sigaction_oldact_1232_1216)
(minimize sigaction_oldact_307_1216)
(maximize sigaction_oldact_207_1216)
(minimize sigaction_oldact_2249_1216)
