...
(declare-fun sigaction_oldact_2314_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x71531) true))))
(assert
 (let ((?x133959 ((_ extract 127 120) sigaction_oldact_2314_1216)))
 (let ((?x133968 (bvand ?x133959 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x133968) true))))
(minimize sigaction_oldact_2314_1216)
(minimize args_5_16)
(minimize args_2_8)
(maximize sigaction_oldact_700_1216)
(minimize args_1_8)
(maximize args_1_8)
(maximize sigaction_oldact_2314_1216)
