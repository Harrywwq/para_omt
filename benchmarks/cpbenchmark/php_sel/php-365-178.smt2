...
(declare-fun sigaction_oldact_2315_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x71576) true))))
(assert
 (let ((?x134021 ((_ extract 127 120) sigaction_oldact_2315_1216)))
 (let ((?x134033 (bvand ?x134021 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x134033) true))))
(minimize args_4_8)
...
(maximize args_2_8)
(minimize args_0_8)
(minimize sigaction_oldact_2315_1216)
...
(maximize args_0_8)
(minimize args_2_8)
(maximize sigaction_oldact_2315_1216)
(maximize args_3_8)
