...
(declare-fun sigaction_oldact_1235_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2253_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40381))))
(assert
 (let ((?x71603 ((_ extract 127 120) sigaction_oldact_1235_1216)))
 (let ((?x71619 (bvand ?x71603 (_ bv4 8))))
 (= (_ bv0 8) ?x71619))))
(assert
 (let ((?x129438 ((_ extract 127 120) sigaction_oldact_2253_1216)))
 (let ((?x93110 (bvand ?x129438 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x93110) true))))
...
(minimize args_3_8)
(maximize sigaction_oldact_1235_1216)
(maximize sigaction_oldact_207_1216)
(maximize args_3_8)
(minimize sigaction_oldact_2253_1216)
...
(maximize args_4_8)
(minimize sigaction_oldact_1235_1216)
(check-sat)
(get-objectives)
