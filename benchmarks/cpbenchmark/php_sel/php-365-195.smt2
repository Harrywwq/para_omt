...
(declare-fun sigaction_oldact_1195_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2138_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x39126))))
(assert
 (let ((?x68683 ((_ extract 127 120) sigaction_oldact_1195_1216)))
 (let ((?x68695 (bvand ?x68683 (_ bv4 8))))
 (= (_ bv0 8) ?x68695))))
(assert
 (let ((?x121720 ((_ extract 127 120) sigaction_oldact_2138_1216)))
 (let ((?x83849 (bvand ?x121720 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x83849) true))))
...
(minimize sigaction_oldact_1195_1216)
(minimize sigaction_oldact_701_1216)
...
(maximize sigaction_oldact_2138_1216)
(maximize args_4_8)
...
(minimize sigaction_oldact_2138_1216)
(maximize strlen_89_64)
(maximize strlen_80_64)
(maximize args_2_8)
(maximize sigaction_oldact_1195_1216)
