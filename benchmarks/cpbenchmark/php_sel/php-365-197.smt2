...
(declare-fun sigaction_oldact_2254_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x68695) true))))
(assert
 (let ((?x129504 ((_ extract 127 120) sigaction_oldact_2254_1216)))
 (let ((?x93162 (bvand ?x129504 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x93162) true))))
(minimize sigaction_oldact_2254_1216)
...
(maximize sigaction_oldact_2254_1216)
