...
(declare-fun sigaction_oldact_2095_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x47984) true))))
(assert
 (let ((?x119603 ((_ extract 127 120) sigaction_oldact_2095_1216)))
 (let ((?x82272 (bvand ?x119603 (_ bv4 8))))
 (= (_ bv0 8) ?x82272))))
(minimize sigaction_oldact_237_1216)
(minimize sigaction_oldact_2095_1216)
...
(maximize sigaction_oldact_2095_1216)
