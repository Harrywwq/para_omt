...
(declare-fun sigaction_oldact_662_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1106_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1943_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x19946))))
(assert
 (let ((?x36012 ((_ extract 127 120) sigaction_oldact_662_1216)))
 (let ((?x36018 (bvand ?x36012 (_ bv4 8))))
 (= (_ bv0 8) ?x36018))))
(assert
 (let ((?x63199 ((_ extract 127 120) sigaction_oldact_1106_1216)))
 (let ((?x20684 (bvand ?x63199 (_ bv4 8))))
 (= (_ bv0 8) ?x20684))))
(assert
 (let ((?x110078 ((_ extract 127 120) sigaction_oldact_1943_1216)))
 (let ((?x110088 (bvand ?x110078 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x110088) true))))
(maximize sigaction_oldact_662_1216)
(maximize args_0_8)
(minimize sigaction_oldact_1943_1216)
(minimize args_1_8)
...
(maximize sigaction_oldact_1943_1216)
(maximize sigaction_oldact_1106_1216)
