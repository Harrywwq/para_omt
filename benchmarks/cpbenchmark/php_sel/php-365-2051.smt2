...
(declare-fun sigaction_oldact_1172_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2207_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x38224))))
(assert
 (let ((?x67518 ((_ extract 127 120) sigaction_oldact_1172_1216)))
 (let ((?x67533 (bvand ?x67518 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x67533) true))))
(assert
 (let ((?x126958 ((_ extract 127 120) sigaction_oldact_2207_1216)))
 (let ((?x126969 (bvand ?x126958 (_ bv4 8))))
 (= (_ bv0 8) ?x126969))))
...
(maximize sigaction_oldact_2207_1216)
...
(maximize sigaction_oldact_1172_1216)
