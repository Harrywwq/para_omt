...
(declare-fun sigaction_oldact_688_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1214_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2286_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x18367))))
(assert
 (let ((?x38261 ((_ extract 127 120) sigaction_oldact_688_1216)))
 (let ((?x38281 (bvand ?x38261 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x38281) true))))
(assert
 (let ((?x70355 ((_ extract 127 120) sigaction_oldact_1214_1216)))
 (let ((?x30711 (bvand ?x70355 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x30711) true))))
(assert
 (let ((?x132071 ((_ extract 127 120) sigaction_oldact_2286_1216)))
 (let ((?x132086 (bvand ?x132071 (_ bv4 8))))
 (= (_ bv0 8) ?x132086))))
(maximize strlen_75_64)
(maximize sigaction_oldact_303_1216)
(maximize sigaction_oldact_688_1216)
...
(minimize sigaction_oldact_688_1216)
(maximize sigaction_oldact_1214_1216)
(minimize args_1_8)
