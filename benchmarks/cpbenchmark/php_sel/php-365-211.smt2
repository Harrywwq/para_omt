...
(declare-fun sigaction_oldact_1238_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2323_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40505))))
(assert
 (let ((?x71745 ((_ extract 127 120) sigaction_oldact_1238_1216)))
 (let ((?x71753 (bvand ?x71745 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71753) true))))
(assert
 (let ((?x134426 ((_ extract 127 120) sigaction_oldact_2323_1216)))
 (let ((?x99833 (bvand ?x134426 (_ bv4 8))))
 (= (_ bv0 8) ?x99833))))
(maximize args_1_8)
...
(maximize args_5_16)
(maximize sigaction_oldact_2323_1216)
(minimize strlen_74_64)
(minimize args_1_8)
(minimize args_0_8)
(minimize sigaction_oldact_2323_1216)
(minimize strlen_89_64)
(maximize args_4_8)
(minimize args_3_8)
(minimize sigaction_oldact_1238_1216)
