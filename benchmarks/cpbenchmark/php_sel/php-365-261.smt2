...
(declare-fun sigaction_oldact_718_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1268_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2334_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21712))))
(assert
 (let ((?x40646 ((_ extract 127 120) sigaction_oldact_718_1216)))
 (let ((?x40671 (bvand ?x40646 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40671) true))))
(assert
 (let ((?x73766 ((_ extract 127 120) sigaction_oldact_1268_1216)))
 (let ((?x35156 (bvand ?x73766 (_ bv4 8))))
 (= (_ bv0 8) ?x35156))))
(assert
 (let ((?x134961 ((_ extract 127 120) sigaction_oldact_2334_1216)))
 (let ((?x134977 (bvand ?x134961 (_ bv4 8))))
 (= (_ bv0 8) ?x134977))))
...
(minimize sigaction_oldact_2334_1216)
(maximize args_3_8)
(minimize sigaction_oldact_243_1216)
(minimize args_2_8)
(minimize sigaction_oldact_1268_1216)
...
(minimize sigaction_oldact_718_1216)
(maximize sigaction_oldact_2334_1216)
(maximize strlen_74_64)
(minimize args_1_8)
(minimize sigaction_oldact_188_1216)
(maximize strlen_72_64)
(minimize strlen_80_64)
(maximize sigaction_oldact_718_1216)
...
(maximize sigaction_oldact_1268_1216)
(maximize args_1_8)
(maximize args_2_8)
(check-sat)
(get-objectives)
