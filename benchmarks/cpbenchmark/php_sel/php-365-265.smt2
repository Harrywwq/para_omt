...
(declare-fun sigaction_oldact_1269_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2335_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41540))))
(assert
 (let ((?x73806 ((_ extract 127 120) sigaction_oldact_1269_1216)))
 (let ((?x35205 (bvand ?x73806 (_ bv4 8))))
 (= (_ bv0 8) ?x35205))))
(assert
 (let ((?x134999 ((_ extract 127 120) sigaction_oldact_2335_1216)))
 (let ((?x100165 (bvand ?x134999 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x100165) true))))
...
(maximize args_4_8)
(minimize args_2_8)
(minimize sigaction_oldact_451_1216)
(check-sat)
(get-objectives)
