...
(declare-fun sigaction_oldact_2346_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x74207))))
(assert
 (let ((?x135499 ((_ extract 127 120) sigaction_oldact_2346_1216)))
 (let ((?x135515 (bvand ?x135499 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x135515) true))))
