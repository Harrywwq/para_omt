...
(declare-fun sigaction_oldact_1307_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x41897) true))))
(assert
 (let ((?x75964 ((_ extract 127 120) sigaction_oldact_1307_1216)))
 (let ((?x37705 (bvand ?x75964 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x37705) true))))
(minimize sigaction_oldact_245_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_315_1216)
(maximize strlen_85_64)
(maximize args_0_8)
(minimize sigaction_oldact_1307_1216)
