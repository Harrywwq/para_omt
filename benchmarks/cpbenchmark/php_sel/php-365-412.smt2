...
(declare-fun sigaction_oldact_739_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1284_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2354_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x22508))))
(assert
 (let ((?x42137 ((_ extract 127 120) sigaction_oldact_739_1216)))
 (let ((?x42157 (bvand ?x42137 (_ bv4 8))))
 (= (_ bv0 8) ?x42157))))
(assert
 (let ((?x74489 ((_ extract 127 120) sigaction_oldact_1284_1216)))
 (let ((?x35875 (bvand ?x74489 (_ bv4 8))))
 (= (_ bv0 8) ?x35875))))
(assert
 (let ((?x135836 ((_ extract 127 120) sigaction_oldact_2354_1216)))
 (let ((?x100659 (bvand ?x135836 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x100659) true))))
(minimize sigaction_oldact_739_1216)
(minimize strlen_81_64)
(maximize sigaction_oldact_179_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_463_1216)
(minimize sigaction_oldact_2354_1216)
(minimize sigaction_oldact_316_1216)
(maximize args_3_8)
(maximize args_1_8)
...
(minimize args_0_8)
(maximize sigaction_oldact_2354_1216)
...
(maximize sigaction_oldact_739_1216)
