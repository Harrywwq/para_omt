...
(declare-fun sigaction_oldact_1365_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43430) true))))
(assert
 (let ((?x79027 ((_ extract 127 120) sigaction_oldact_1365_1216)))
 (let ((?x41011 (bvand ?x79027 (_ bv4 8))))
 (= (_ bv0 8) ?x41011))))
(minimize strlen_81_64)
(maximize sigaction_oldact_1365_1216)
...
(maximize sigaction_oldact_757_1216)
(minimize sigaction_oldact_1365_1216)
(maximize args_0_8)
