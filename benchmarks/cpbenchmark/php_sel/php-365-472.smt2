...
(declare-fun sigaction_oldact_1287_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x42303))))
(assert
 (let ((?x74620 ((_ extract 127 120) sigaction_oldact_1287_1216)))
 (let ((?x35963 (bvand ?x74620 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x35963) true))))
(minimize args_1_8)
...
(minimize sigaction_oldact_1287_1216)
(maximize args_2_8)
(minimize args_0_8)
...
(minimize args_2_8)
(maximize sigaction_oldact_1287_1216)
