...
(declare-fun sigaction_oldact_1337_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x44188))))
(assert
 (let ((?x77364 ((_ extract 127 120) sigaction_oldact_1337_1216)))
 (let ((?x77369 (bvand ?x77364 (_ bv4 8))))
 (= (_ bv0 8) ?x77369))))
...
(minimize sigaction_oldact_1337_1216)
(maximize sigaction_oldact_1337_1216)
(maximize args_2_8)
(check-sat)
(get-objectives)
