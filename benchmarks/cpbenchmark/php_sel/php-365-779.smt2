...
(declare-fun sigaction_oldact_1612_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x4023) true))))
(assert
 (let ((?x92263 ((_ extract 127 120) sigaction_oldact_1612_1216)))
 (let ((?x92291 (bvand ?x92263 (_ bv4 8))))
 (= (_ bv0 8) ?x92291))))
