...
(declare-fun sigaction_oldact_1662_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x54763))))
(assert
 (let ((?x94945 ((_ extract 127 120) sigaction_oldact_1662_1216)))
 (let ((?x94961 (bvand ?x94945 (_ bv4 8))))
 (= (_ bv0 8) ?x94961))))
(minimize args_2_8)
...
(minimize sigaction_oldact_1662_1216)
(maximize sigaction_oldact_953_1216)
