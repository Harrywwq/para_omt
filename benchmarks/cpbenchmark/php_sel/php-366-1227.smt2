...
(declare-fun sigaction_oldact_1820_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x59528))))
(assert
 (let ((?x103666 ((_ extract 127 120) sigaction_oldact_1820_1216)))
 (let ((?x103677 (bvand ?x103666 (_ bv4 8))))
 (= (_ bv0 8) ?x103677))))
(minimize sigaction_oldact_197_1216)
(minimize sigaction_oldact_1039_1216)
(minimize strlen_78_64)
(minimize sigaction_oldact_630_1216)
(maximize sigaction_oldact_1820_1216)
...
(minimize args_2_8)
(maximize args_2_8)
(minimize sigaction_oldact_1820_1216)
(maximize args_0_8)
