...
(declare-fun sigaction_oldact_1988_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x74860 ((_ extract 127 120) sigaction_oldact_1988_1216)))
 (let ((?x113163 (bvand ?x74860 (_ bv4 8))))
 (= (_ bv0 8) ?x113163))))
(minimize sigaction_oldact_392_1216)
(maximize sigaction_oldact_1041_1216)
...
(minimize sigaction_oldact_1988_1216)
