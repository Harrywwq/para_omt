...
(declare-fun sigaction_oldact_1696_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x5908) true))))
(assert
 (let ((?x96667 ((_ extract 127 120) sigaction_oldact_1696_1216)))
 (let ((?x96688 (bvand ?x96667 (_ bv4 8))))
 (= (_ bv0 8) ?x96688))))
