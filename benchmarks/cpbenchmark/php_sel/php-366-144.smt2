...
(declare-fun sigaction_oldact_2134_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x68539))))
(assert
 (let ((?x121555 ((_ extract 127 120) sigaction_oldact_2134_1216)))
 (let ((?x121561 (bvand ?x121555 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x121561) true))))
(minimize args_4_8)
(minimize args_2_8)
(maximize sigaction_oldact_2134_1216)
(minimize args_5_16)
(maximize sigaction_oldact_672_1216)
(minimize strlen_84_64)
(maximize args_0_8)
(minimize args_3_8)
(minimize sigaction_oldact_2134_1216)
...
(maximize args_3_8)
(minimize sigaction_oldact_433_1216)
