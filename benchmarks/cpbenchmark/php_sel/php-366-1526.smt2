...
(declare-fun sigaction_oldact_1558_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x47905) true))))
(assert
 (let ((?x88955 ((_ extract 127 120) sigaction_oldact_1558_1216)))
 (let ((?x88967 (bvand ?x88955 (_ bv4 8))))
 (= (_ bv0 8) ?x88967))))
(minimize args_0_8)
(maximize args_0_8)
...
(maximize sigaction_oldact_1558_1216)
(minimize sigaction_oldact_833_1216)
(minimize sigaction_oldact_1558_1216)
...
(maximize args_1_8)
(maximize sigaction_oldact_833_1216)
