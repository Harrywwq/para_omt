...
(declare-fun sigaction_oldact_1710_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x11352))))
(assert
 (let ((?x97326 ((_ extract 127 120) sigaction_oldact_1710_1216)))
 (let ((?x97346 (bvand ?x97326 (_ bv4 8))))
 (= (_ bv0 8) ?x97346))))
(minimize sigaction_oldact_982_1216)
(minimize sigaction_oldact_378_1216)
(maximize sigaction_oldact_1710_1216)
...
(minimize args_0_8)
(minimize sigaction_oldact_1710_1216)
(maximize args_1_8)
