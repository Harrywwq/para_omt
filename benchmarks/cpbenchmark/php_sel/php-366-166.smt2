...
(declare-fun sigaction_oldact_443_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_711_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1232_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2312_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x10852) true))))
(assert
 (let ((?x21045 ((_ extract 127 120) sigaction_oldact_443_1216)))
 (let ((?x21070 (bvand ?x21045 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21070) true))))
(assert
 (let ((?x40242 ((_ extract 127 120) sigaction_oldact_711_1216)))
 (let ((?x40259 (bvand ?x40242 (_ bv4 8))))
 (= (_ bv0 8) ?x40259))))
(assert
 (let ((?x71461 ((_ extract 127 120) sigaction_oldact_1232_1216)))
 (let ((?x71473 (bvand ?x71461 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71473) true))))
(assert
 (let ((?x133843 ((_ extract 127 120) sigaction_oldact_2312_1216)))
 (let ((?x133871 (bvand ?x133843 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x133871) true))))
(maximize args_0_8)
(maximize strlen_72_64)
(maximize sigaction_oldact_1232_1216)
(maximize strlen_84_64)
(minimize sigaction_oldact_711_1216)
(maximize sigaction_oldact_711_1216)
