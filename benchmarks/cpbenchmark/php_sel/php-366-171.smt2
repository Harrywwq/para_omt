...
(declare-fun sigaction_oldact_1194_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2137_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x39074))))
(assert
 (let ((?x68641 ((_ extract 127 120) sigaction_oldact_1194_1216)))
 (let ((?x27745 (bvand ?x68641 (_ bv4 8))))
 (= (_ bv0 8) ?x27745))))
(assert
 (let ((?x121678 ((_ extract 127 120) sigaction_oldact_2137_1216)))
 (let ((?x121693 (bvand ?x121678 (_ bv4 8))))
 (= (_ bv0 8) ?x121693))))
...
(maximize sigaction_oldact_2137_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_1194_1216)
(minimize args_0_8)
