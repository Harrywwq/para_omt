...
(declare-fun sigaction_oldact_2251_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x71531))))
(assert
 (let ((?x129357 ((_ extract 127 120) sigaction_oldact_2251_1216)))
 (let ((?x129377 (bvand ?x129357 (_ bv4 8))))
 (= (_ bv0 8) ?x129377))))
...
(minimize sigaction_oldact_2251_1216)
(minimize sigaction_oldact_1233_1216)
...
(maximize args_1_8)
(minimize args_1_8)
(maximize sigaction_oldact_700_1216)
(minimize args_2_8)
...
(maximize args_3_8)
(maximize sigaction_oldact_2251_1216)
...
(minimize args_5_16)
(minimize sigaction_oldact_700_1216)
(check-sat)
(get-objectives)
