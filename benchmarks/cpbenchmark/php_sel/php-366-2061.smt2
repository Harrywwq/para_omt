...
(declare-fun sigaction_oldact_1935_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x62958))))
(assert
 (let ((?x109714 ((_ extract 127 120) sigaction_oldact_1935_1216)))
 (let ((?x109723 (bvand ?x109714 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x109723) true))))
...
(minimize sigaction_oldact_1935_1216)
