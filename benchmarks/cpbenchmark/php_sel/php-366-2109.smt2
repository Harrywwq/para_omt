...
(declare-fun sigaction_oldact_1942_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x47984))))
(assert
 (let ((?x110036 ((_ extract 127 120) sigaction_oldact_1942_1216)))
 (let ((?x71485 (bvand ?x110036 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71485) true))))
...
(minimize args_0_8)
(maximize sigaction_oldact_1942_1216)
...
(minimize args_1_8)
(maximize args_0_8)
(minimize sigaction_oldact_1942_1216)
