...
(declare-fun sigaction_oldact_426_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_686_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1212_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2205_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x10119) true))))
(assert
 (let ((?x19993 ((_ extract 127 120) sigaction_oldact_426_1216)))
 (let ((?x19946 (bvand ?x19993 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x19946) true))))
(assert
 (let ((?x38142 ((_ extract 127 120) sigaction_oldact_686_1216)))
 (let ((?x38159 (bvand ?x38142 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x38159) true))))
(assert
 (let ((?x70230 ((_ extract 127 120) sigaction_oldact_1212_1216)))
 (let ((?x30480 (bvand ?x70230 (_ bv4 8))))
 (= (_ bv0 8) ?x30480))))
(assert
 (let ((?x126822 ((_ extract 127 120) sigaction_oldact_2205_1216)))
 (let ((?x126838 (bvand ?x126822 (_ bv4 8))))
 (= (_ bv0 8) ?x126838))))
(maximize sigaction_oldact_2205_1216)
...
(maximize sigaction_oldact_686_1216)
(maximize sigaction_oldact_176_1216)
(maximize sigaction_oldact_237_1216)
(minimize sigaction_oldact_2205_1216)
(maximize sigaction_oldact_298_1216)
(maximize strlen_72_64)
(maximize sigaction_oldact_203_1216)
(minimize sigaction_oldact_426_1216)
(minimize sigaction_oldact_1212_1216)
(minimize strlen_75_64)
(maximize sigaction_oldact_426_1216)
(minimize strlen_72_64)
(minimize args_0_8)
(minimize sigaction_oldact_686_1216)
(maximize sigaction_oldact_1212_1216)
(check-sat)
(get-objectives)
