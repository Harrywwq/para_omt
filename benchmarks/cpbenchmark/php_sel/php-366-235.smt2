...
(declare-fun sigaction_oldact_716_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1239_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2326_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21640))))
(assert
 (let ((?x40527 ((_ extract 127 120) sigaction_oldact_716_1216)))
 (let ((?x40552 (bvand ?x40527 (_ bv4 8))))
 (= (_ bv0 8) ?x40552))))
(assert
 (let ((?x71783 ((_ extract 127 120) sigaction_oldact_1239_1216)))
 (let ((?x71803 (bvand ?x71783 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71803) true))))
(assert
 (let ((?x134576 ((_ extract 127 120) sigaction_oldact_2326_1216)))
 (let ((?x134587 (bvand ?x134576 (_ bv4 8))))
 (= (_ bv0 8) ?x134587))))
(minimize sigaction_oldact_242_1216)
(minimize sigaction_oldact_450_1216)
(minimize strlen_84_64)
(maximize args_3_8)
(minimize sigaction_oldact_716_1216)
(minimize args_4_8)
(maximize args_5_16)
(maximize sigaction_oldact_450_1216)
(minimize sigaction_oldact_1239_1216)
(minimize sigaction_oldact_312_1216)
(minimize sigaction_oldact_2326_1216)
