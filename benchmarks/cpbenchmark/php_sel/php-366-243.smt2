...
(declare-fun sigaction_oldact_2382_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x73618) true))))
(assert
 (let ((?x103108 ((_ extract 127 120) sigaction_oldact_2382_1216)))
 (let ((?x138048 (bvand ?x103108 (_ bv4 8))))
 (= (_ bv0 8) ?x138048))))
...
(maximize args_5_16)
(minimize sigaction_oldact_2382_1216)
