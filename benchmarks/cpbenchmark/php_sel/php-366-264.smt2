...
(declare-fun sigaction_oldact_2260_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x71865))))
(assert
 (let ((?x129764 ((_ extract 127 120) sigaction_oldact_2260_1216)))
 (let ((?x93432 (bvand ?x129764 (_ bv4 8))))
 (= (_ bv0 8) ?x93432))))
(minimize strlen_74_64)
(minimize args_1_8)
(maximize strlen_77_64)
(maximize sigaction_oldact_2260_1216)
(maximize args_1_8)
...
(minimize sigaction_oldact_1240_1216)
