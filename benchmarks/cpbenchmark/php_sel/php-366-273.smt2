...
(declare-fun sigaction_oldact_2332_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x73725))))
(assert
 (let ((?x134865 ((_ extract 127 120) sigaction_oldact_2332_1216)))
 (let ((?x134881 (bvand ?x134865 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x134881) true))))
...
(minimize sigaction_oldact_2332_1216)
(minimize args_2_8)
