...
(declare-fun sigaction_oldact_1271_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2338_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41612))))
(assert
 (let ((?x73906 ((_ extract 127 120) sigaction_oldact_1271_1216)))
 (let ((?x35324 (bvand ?x73906 (_ bv4 8))))
 (= (_ bv0 8) ?x35324))))
(assert
 (let ((?x135142 ((_ extract 127 120) sigaction_oldact_2338_1216)))
 (let ((?x135153 (bvand ?x135142 (_ bv4 8))))
 (= (_ bv0 8) ?x135153))))
(minimize strlen_85_64)
(maximize strlen_72_64)
(maximize args_0_8)
(minimize sigaction_oldact_1271_1216)
(maximize args_1_8)
...
(maximize sigaction_oldact_2338_1216)
(minimize args_3_8)
(minimize sigaction_oldact_2338_1216)
(maximize sigaction_oldact_1271_1216)
