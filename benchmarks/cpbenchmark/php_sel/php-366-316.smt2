...
(declare-fun sigaction_oldact_747_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1350_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22143) true))))
(assert
 (let ((?x42715 ((_ extract 127 120) sigaction_oldact_747_1216)))
 (let ((?x42735 (bvand ?x42715 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x42735) true))))
(assert
 (let ((?x78092 ((_ extract 127 120) sigaction_oldact_1350_1216)))
 (let ((?x39764 (bvand ?x78092 (_ bv4 8))))
 (= (_ bv0 8) ?x39764))))
(minimize sigaction_oldact_457_1216)
