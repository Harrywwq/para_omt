...
(declare-fun sigaction_oldact_1317_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2424_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x42115) true))))
(assert
 (let ((?x38134 ((_ extract 127 120) sigaction_oldact_1317_1216)))
 (let ((?x76474 (bvand ?x38134 (_ bv4 8))))
 (= (_ bv0 8) ?x76474))))
(assert
 (let ((?x140174 ((_ extract 127 120) sigaction_oldact_2424_1216)))
 (let ((?x140190 (bvand ?x140174 (_ bv4 8))))
 (= (_ bv0 8) ?x140190))))
...
(maximize sigaction_oldact_455_1216)
