...
(declare-fun sigaction_oldact_1325_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2435_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43665))))
(assert
 (let ((?x76835 ((_ extract 127 120) sigaction_oldact_1325_1216)))
 (let ((?x76855 (bvand ?x76835 (_ bv4 8))))
 (= (_ bv0 8) ?x76855))))
(assert
 (let ((?x140681 ((_ extract 127 120) sigaction_oldact_2435_1216)))
 (let ((?x140697 (bvand ?x140681 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x140697) true))))
...
(minimize args_2_8)
(minimize sigaction_oldact_1325_1216)
(check-sat)
(get-objectives)
