...
(declare-fun sigaction_oldact_1450_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x48343))))
(assert
 (let ((?x83457 ((_ extract 127 120) sigaction_oldact_1450_1216)))
 (let ((?x46092 (bvand ?x83457 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46092) true))))
(minimize args_0_8)
(maximize sigaction_oldact_1450_1216)
(maximize args_0_8)
...
(minimize sigaction_oldact_1450_1216)
(check-sat)
(get-objectives)
