...
(declare-fun sigaction_oldact_793_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1455_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x23477) true))))
(assert
 (let ((?x45745 ((_ extract 127 120) sigaction_oldact_793_1216)))
 (let ((?x317 (bvand ?x45745 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x317) true))))
(assert
 (let ((?x46561 ((_ extract 127 120) sigaction_oldact_1455_1216)))
 (let ((?x46644 (bvand ?x46561 (_ bv4 8))))
 (= (_ bv0 8) ?x46644))))
(maximize sigaction_oldact_793_1216)
...
(minimize sigaction_oldact_1455_1216)
(minimize sigaction_oldact_793_1216)
...
(maximize sigaction_oldact_1455_1216)
