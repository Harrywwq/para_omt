...
(declare-fun sigaction_oldact_1478_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x49133))))
(assert
 (let ((?x85059 ((_ extract 127 120) sigaction_oldact_1478_1216)))
 (let ((?x85075 (bvand ?x85059 (_ bv4 8))))
 (= (_ bv0 8) ?x85075))))
...
(minimize args_0_8)
(minimize sigaction_oldact_1478_1216)
...
(maximize sigaction_oldact_1478_1216)
