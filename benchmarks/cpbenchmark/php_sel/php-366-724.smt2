...
(declare-fun sigaction_oldact_851_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1595_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x26714))))
(assert
 (let ((?x49155 ((_ extract 127 120) sigaction_oldact_851_1216)))
 (let ((?x49175 (bvand ?x49155 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x49175) true))))
(assert
 (let ((?x91206 ((_ extract 127 120) sigaction_oldact_1595_1216)))
 (let ((?x54090 (bvand ?x91206 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x54090) true))))
(maximize sigaction_oldact_214_1216)
(minimize sigaction_oldact_851_1216)
...
(maximize sigaction_oldact_1595_1216)
(minimize args_0_8)
...
(minimize sigaction_oldact_1595_1216)
(minimize args_2_8)
(check-sat)
(get-objectives)
