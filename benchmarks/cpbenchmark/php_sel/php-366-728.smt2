...
(declare-fun sigaction_oldact_1765_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x7324) true))))
(assert
 (let ((?x100196 ((_ extract 127 120) sigaction_oldact_1765_1216)))
 (let ((?x100208 (bvand ?x100196 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x100208) true))))
...
(minimize sigaction_oldact_1765_1216)
