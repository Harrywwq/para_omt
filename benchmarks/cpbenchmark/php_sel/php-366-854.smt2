...
(declare-fun sigaction_oldact_860_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1498_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x25339) true))))
(assert
 (let ((?x49705 ((_ extract 127 120) sigaction_oldact_860_1216)))
 (let ((?x3932 (bvand ?x49705 (_ bv4 8))))
 (= (_ bv0 8) ?x3932))))
(assert
 (let ((?x86124 ((_ extract 127 120) sigaction_oldact_1498_1216)))
 (let ((?x86139 (bvand ?x86124 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86139) true))))
(maximize sigaction_oldact_860_1216)
(maximize sigaction_oldact_174_1216)
(minimize sigaction_oldact_507_1216)
(maximize args_0_8)
(maximize args_1_8)
