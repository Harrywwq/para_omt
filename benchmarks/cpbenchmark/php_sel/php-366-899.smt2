...
(declare-fun sigaction_oldact_818_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1418_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x25448))))
(assert
 (let ((?x47147 ((_ extract 127 120) sigaction_oldact_818_1216)))
 (let ((?x47151 (bvand ?x47147 (_ bv4 8))))
 (= (_ bv0 8) ?x47151))))
(assert
 (let ((?x81630 ((_ extract 127 120) sigaction_oldact_1418_1216)))
 (let ((?x81650 (bvand ?x81630 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x81650) true))))
(maximize sigaction_oldact_509_1216)
(minimize args_1_8)
(minimize strlen_74_64)
(maximize sigaction_oldact_1418_1216)
(minimize sigaction_oldact_257_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_216_1216)
(minimize args_2_8)
(maximize sigaction_oldact_818_1216)
(maximize sigaction_oldact_180_1216)
(minimize sigaction_oldact_174_1216)
(minimize sigaction_oldact_194_1216)
(minimize sigaction_oldact_818_1216)
(maximize sigaction_oldact_194_1216)
(minimize sigaction_oldact_509_1216)
