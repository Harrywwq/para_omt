...
(declare-fun sigaction_oldact_1513_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x50222))))
(assert
 (let ((?x86839 ((_ extract 127 120) sigaction_oldact_1513_1216)))
 (let ((?x86859 (bvand ?x86839 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86859) true))))
(maximize sigaction_oldact_174_1216)
(maximize args_2_8)
(minimize args_0_8)
(maximize sigaction_oldact_537_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_1513_1216)
(maximize args_1_8)
...
(minimize sigaction_oldact_1513_1216)
