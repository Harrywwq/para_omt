...
(declare-fun sigaction_oldact_1786_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x58609))))
(assert
 (let ((?x101696 ((_ extract 127 120) sigaction_oldact_1786_1216)))
 (let ((?x101712 (bvand ?x101696 (_ bv4 8))))
 (= (_ bv0 8) ?x101712))))
...
(maximize args_0_8)
(minimize sigaction_oldact_1786_1216)
(minimize args_1_8)
...
(maximize sigaction_oldact_1786_1216)
