...
(declare-fun sigaction_oldact_869_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1512_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x25549) true))))
(assert
 (let ((?x50154 ((_ extract 127 120) sigaction_oldact_869_1216)))
 (let ((?x4442 (bvand ?x50154 (_ bv4 8))))
 (= (_ bv0 8) ?x4442))))
(assert
 (let ((?x86797 ((_ extract 127 120) sigaction_oldact_1512_1216)))
 (let ((?x49744 (bvand ?x86797 (_ bv4 8))))
 (= (_ bv0 8) ?x49744))))
...
(minimize args_0_8)
(maximize args_1_8)
(maximize sigaction_oldact_869_1216)
(minimize args_1_8)
(maximize strlen_78_64)
(maximize strlen_74_64)
(maximize sigaction_oldact_1512_1216)
(minimize sigaction_oldact_1512_1216)
(maximize args_2_8)
...
(minimize sigaction_oldact_869_1216)
(check-sat)
(get-objectives)
