...
(declare-fun sigaction_oldact_1783_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x58542))))
(assert
 (let ((?x101521 ((_ extract 127 120) sigaction_oldact_1783_1216)))
 (let ((?x64207 (bvand ?x101521 (_ bv4 8))))
 (= (_ bv0 8) ?x64207))))
...
(minimize sigaction_oldact_1783_1216)
(minimize args_0_8)
(maximize args_1_8)
(maximize sigaction_oldact_1024_1216)
...
(minimize args_2_8)
(maximize sigaction_oldact_1783_1216)
(check-sat)
(get-objectives)
