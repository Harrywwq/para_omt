...
(declare-fun sigaction_oldact_1515_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x50298))))
(assert
 (let ((?x86919 ((_ extract 127 120) sigaction_oldact_1515_1216)))
 (let ((?x86944 (bvand ?x86919 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86944) true))))
...
(maximize sigaction_oldact_1515_1216)
(check-sat)
(get-objectives)
