...
(declare-fun sigaction_oldact_1664_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x54836))))
(assert
 (let ((?x95021 ((_ extract 127 120) sigaction_oldact_1664_1216)))
 (let ((?x58208 (bvand ?x95021 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x58208) true))))
