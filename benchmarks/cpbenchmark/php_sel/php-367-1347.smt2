...
(declare-fun sigaction_oldact_957_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1667_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x30644))))
(assert
 (let ((?x54924 ((_ extract 127 120) sigaction_oldact_957_1216)))
 (let ((?x54944 (bvand ?x54924 (_ bv4 8))))
 (= (_ bv0 8) ?x54944))))
(assert
 (let ((?x95164 ((_ extract 127 120) sigaction_oldact_1667_1216)))
 (let ((?x95180 (bvand ?x95164 (_ bv4 8))))
 (= (_ bv0 8) ?x95180))))
...
(minimize sigaction_oldact_586_1216)
(minimize sigaction_oldact_183_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_586_1216)
(minimize sigaction_oldact_277_1216)
(minimize sigaction_oldact_1667_1216)
(minimize sigaction_oldact_957_1216)
(maximize sigaction_oldact_183_1216)
(minimize args_1_8)
(maximize sigaction_oldact_1667_1216)
