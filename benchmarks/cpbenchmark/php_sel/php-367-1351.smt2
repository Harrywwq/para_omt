...
(declare-fun sigaction_oldact_586_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1037_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1817_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x15058) true))))
(assert
 (let ((?x30619 ((_ extract 127 120) sigaction_oldact_586_1216)))
 (let ((?x30644 (bvand ?x30619 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x30644) true))))
(assert
 (let ((?x59416 ((_ extract 127 120) sigaction_oldact_1037_1216)))
 (let ((?x59431 (bvand ?x59416 (_ bv4 8))))
 (= (_ bv0 8) ?x59431))))
(assert
 (let ((?x103519 ((_ extract 127 120) sigaction_oldact_1817_1216)))
 (let ((?x65994 (bvand ?x103519 (_ bv4 8))))
 (= (_ bv0 8) ?x65994))))
(minimize sigaction_oldact_371_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_197_1216)
(minimize sigaction_oldact_1037_1216)
(minimize sigaction_oldact_1817_1216)
(maximize sigaction_oldact_183_1216)
(maximize sigaction_oldact_226_1216)
(minimize args_0_8)
(minimize strlen_78_64)
(maximize args_0_8)
(maximize sigaction_oldact_1817_1216)
...
(maximize sigaction_oldact_1037_1216)
(check-sat)
(get-objectives)
