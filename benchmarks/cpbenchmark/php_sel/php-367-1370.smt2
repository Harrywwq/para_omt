...
(declare-fun sigaction_oldact_2143_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x64382) true))))
(assert
 (let ((?x122306 ((_ extract 127 120) sigaction_oldact_2143_1216)))
 (let ((?x84774 (bvand ?x122306 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x84774) true))))
(maximize args_0_8)
