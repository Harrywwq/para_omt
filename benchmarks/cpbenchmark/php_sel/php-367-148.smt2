...
(declare-fun sigaction_oldact_2244_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x68539) true))))
(assert
 (let ((?x129019 ((_ extract 127 120) sigaction_oldact_2244_1216)))
 (let ((?x92739 (bvand ?x129019 (_ bv4 8))))
 (= (_ bv0 8) ?x92739))))
(maximize args_3_8)
...
(minimize args_2_8)
(maximize sigaction_oldact_2244_1216)
