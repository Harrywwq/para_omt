...
(declare-fun sigaction_oldact_1690_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x5813) true))))
(assert
 (let ((?x59160 ((_ extract 127 120) sigaction_oldact_1690_1216)))
 (let ((?x96396 (bvand ?x59160 (_ bv4 8))))
 (= (_ bv0 8) ?x96396))))
(minimize args_1_8)
...
(maximize sigaction_oldact_1690_1216)
