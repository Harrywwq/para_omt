...
(declare-fun sigaction_oldact_1847_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x10998) true))))
(assert
 (let ((?x67689 ((_ extract 127 120) sigaction_oldact_1847_1216)))
 (let ((?x67732 (bvand ?x67689 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x67732) true))))
(maximize sigaction_oldact_394_1216)
(minimize sigaction_oldact_1847_1216)
