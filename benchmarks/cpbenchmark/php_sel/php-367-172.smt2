...
(declare-fun sigaction_oldact_1257_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2372_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x40259) true))))
(assert
 (let ((?x73150 ((_ extract 127 120) sigaction_oldact_1257_1216)))
 (let ((?x73158 (bvand ?x73150 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x73158) true))))
(assert
 (let ((?x102359 ((_ extract 127 120) sigaction_oldact_2372_1216)))
 (let ((?x137380 (bvand ?x102359 (_ bv4 8))))
 (= (_ bv0 8) ?x137380))))
...
(minimize args_4_8)
(minimize sigaction_oldact_1257_1216)
(minimize strlen_84_64)
(minimize strlen_89_64)
(minimize sigaction_oldact_2372_1216)
