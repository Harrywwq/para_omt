...
(declare-fun sigaction_oldact_1751_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x57723))))
(assert
 (let ((?x99192 ((_ extract 127 120) sigaction_oldact_1751_1216)))
 (let ((?x61331 (bvand ?x99192 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x61331) true))))
(minimize sigaction_oldact_410_1216)
(maximize sigaction_oldact_1751_1216)
(maximize args_1_8)
(maximize args_0_8)
...
(minimize sigaction_oldact_1751_1216)
