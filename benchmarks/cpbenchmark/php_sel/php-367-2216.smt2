...
(declare-fun sigaction_oldact_1013_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1936_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x32806))))
(assert
 (let ((?x57703 ((_ extract 127 120) sigaction_oldact_1013_1216)))
 (let ((?x57723 (bvand ?x57703 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x57723) true))))
(assert
 (let ((?x71242 ((_ extract 127 120) sigaction_oldact_1936_1216)))
 (let ((?x71281 (bvand ?x71242 (_ bv4 8))))
 (= (_ bv0 8) ?x71281))))
(minimize args_1_8)
(maximize sigaction_oldact_176_1216)
(maximize args_1_8)
(maximize sigaction_oldact_1013_1216)
...
(minimize sigaction_oldact_1013_1216)
...
(minimize sigaction_oldact_1936_1216)
(minimize sigaction_oldact_410_1216)
(maximize sigaction_oldact_171_1216)
(maximize sigaction_oldact_1936_1216)
(maximize args_0_8)
