...
(declare-fun sigaction_oldact_687_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1213_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2285_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x20098) true))))
(assert
 (let ((?x38214 ((_ extract 127 120) sigaction_oldact_687_1216)))
 (let ((?x38224 (bvand ?x38214 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x38224) true))))
(assert
 (let ((?x70308 ((_ extract 127 120) sigaction_oldact_1213_1216)))
 (let ((?x70324 (bvand ?x70308 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x70324) true))))
(assert
 (let ((?x131993 ((_ extract 127 120) sigaction_oldact_2285_1216)))
 (let ((?x132013 (bvand ?x131993 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x132013) true))))
(maximize sigaction_oldact_176_1216)
(maximize sigaction_oldact_203_1216)
(minimize args_0_8)
(maximize args_0_8)
(minimize sigaction_oldact_187_1216)
(minimize sigaction_oldact_1213_1216)
(maximize sigaction_oldact_2285_1216)
...
(minimize sigaction_oldact_2285_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_303_1216)
(maximize sigaction_oldact_237_1216)
(maximize args_1_8)
(minimize sigaction_oldact_687_1216)
(maximize sigaction_oldact_687_1216)
(maximize sigaction_oldact_303_1216)
(maximize sigaction_oldact_427_1216)
