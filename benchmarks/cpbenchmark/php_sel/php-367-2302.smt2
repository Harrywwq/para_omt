...
(declare-fun sigaction_oldact_1215_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2211_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x39695))))
(assert
 (let ((?x70404 ((_ extract 127 120) sigaction_oldact_1215_1216)))
 (let ((?x70413 (bvand ?x70404 (_ bv4 8))))
 (= (_ bv0 8) ?x70413))))
(assert
 (let ((?x127130 ((_ extract 127 120) sigaction_oldact_2211_1216)))
 (let ((?x127136 (bvand ?x127130 (_ bv4 8))))
 (= (_ bv0 8) ?x127136))))
(maximize sigaction_oldact_187_1216)
(maximize args_1_8)
(maximize sigaction_oldact_2211_1216)
...
(minimize sigaction_oldact_2211_1216)
