...
(declare-fun sigaction_oldact_725_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1293_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2465_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x21583) true))))
(assert
 (let ((?x41304 ((_ extract 127 120) sigaction_oldact_725_1216)))
 (let ((?x41321 (bvand ?x41304 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x41321) true))))
(assert
 (let ((?x75152 ((_ extract 127 120) sigaction_oldact_1293_1216)))
 (let ((?x36858 (bvand ?x75152 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x36858) true))))
(assert
 (let ((?x142322 ((_ extract 127 120) sigaction_oldact_2465_1216)))
 (let ((?x107095 (bvand ?x142322 (_ bv4 8))))
 (= (_ bv0 8) ?x107095))))
(maximize args_5_16)
...
(minimize sigaction_oldact_2465_1216)
(maximize strlen_74_64)
(maximize args_1_8)
(maximize sigaction_oldact_1293_1216)
(minimize strlen_74_64)
(maximize sigaction_oldact_2465_1216)
(maximize sigaction_oldact_725_1216)
(minimize sigaction_oldact_1293_1216)
...
(minimize args_4_8)
(minimize args_2_8)
(minimize sigaction_oldact_449_1216)
...
(maximize args_0_8)
(maximize sigaction_oldact_449_1216)
