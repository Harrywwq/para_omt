...
(declare-fun sigaction_oldact_1264_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2327_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x40552) true))))
(assert
 (let ((?x73552 ((_ extract 127 120) sigaction_oldact_1264_1216)))
 (let ((?x34955 (bvand ?x73552 (_ bv4 8))))
 (= (_ bv0 8) ?x34955))))
(assert
 (let ((?x134614 ((_ extract 127 120) sigaction_oldact_2327_1216)))
 (let ((?x134622 (bvand ?x134614 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x134622) true))))
...
(maximize sigaction_oldact_1264_1216)
(minimize args_4_8)
(minimize args_3_8)
(minimize args_1_8)
