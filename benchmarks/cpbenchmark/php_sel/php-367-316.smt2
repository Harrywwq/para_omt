...
(declare-fun sigaction_oldact_1298_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2471_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x75487 ((_ extract 127 120) sigaction_oldact_1298_1216)))
 (let ((?x75495 (bvand ?x75487 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75495) true))))
(assert
 (let ((?x142792 ((_ extract 127 120) sigaction_oldact_2471_1216)))
 (let ((?x142816 (bvand ?x142792 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x142816) true))))
(minimize sigaction_oldact_452_1216)
(minimize strlen_77_64)
(maximize sigaction_oldact_729_1216)
(minimize args_2_8)
...
(minimize sigaction_oldact_1298_1216)
(minimize strlen_74_64)
(maximize sigaction_oldact_2471_1216)
(minimize args_0_8)
(minimize sigaction_oldact_2471_1216)
...
(minimize sigaction_oldact_729_1216)
(maximize sigaction_oldact_188_1216)
(minimize sigaction_oldact_313_1216)
(minimize args_1_8)
...
(maximize sigaction_oldact_1298_1216)
(check-sat)
(get-objectives)
