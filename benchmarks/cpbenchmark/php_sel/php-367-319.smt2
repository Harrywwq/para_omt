...
(declare-fun sigaction_oldact_2394_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x73965) true))))
(assert
 (let ((?x138711 ((_ extract 127 120) sigaction_oldact_2394_1216)))
 (let ((?x138723 (bvand ?x138711 (_ bv4 8))))
 (= (_ bv0 8) ?x138723))))
(minimize strlen_74_64)
(maximize sigaction_oldact_730_1216)
(minimize sigaction_oldact_457_1216)
(minimize strlen_77_64)
(maximize args_2_8)
(maximize strlen_74_64)
(maximize strlen_80_64)
(minimize sigaction_oldact_2394_1216)
(minimize args_3_8)
(maximize args_0_8)
(maximize sigaction_oldact_2394_1216)
(minimize args_1_8)
(check-sat)
(get-objectives)
