...
(declare-fun sigaction_oldact_2483_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x78319))))
(assert
 (let ((?x143520 ((_ extract 127 120) sigaction_oldact_2483_1216)))
 (let ((?x108572 (bvand ?x143520 (_ bv4 8))))
 (= (_ bv0 8) ?x108572))))
(minimize args_4_8)
(maximize strlen_77_64)
(maximize strlen_74_64)
(minimize args_1_8)
(minimize sigaction_oldact_2483_1216)
(maximize args_0_8)
