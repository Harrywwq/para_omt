...
(declare-fun sigaction_oldact_454_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_734_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1278_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2347_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x11530))))
(assert
 (let ((?x21833 ((_ extract 127 120) sigaction_oldact_454_1216)))
 (let ((?x21858 (bvand ?x21833 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21858) true))))
(assert
 (let ((?x41877 ((_ extract 127 120) sigaction_oldact_734_1216)))
 (let ((?x41897 (bvand ?x41877 (_ bv4 8))))
 (= (_ bv0 8) ?x41897))))
(assert
 (let ((?x74229 ((_ extract 127 120) sigaction_oldact_1278_1216)))
 (let ((?x74244 (bvand ?x74229 (_ bv4 8))))
 (= (_ bv0 8) ?x74244))))
(assert
 (let ((?x135537 ((_ extract 127 120) sigaction_oldact_2347_1216)))
 (let ((?x135545 (bvand ?x135537 (_ bv4 8))))
 (= (_ bv0 8) ?x135545))))
(maximize sigaction_oldact_245_1216)
(minimize strlen_77_64)
(maximize sigaction_oldact_2347_1216)
(maximize args_3_8)
(maximize args_4_8)
(maximize strlen_85_64)
(maximize sigaction_oldact_1278_1216)
(maximize strlen_74_64)
(minimize args_4_8)
(minimize sigaction_oldact_734_1216)
(minimize sigaction_oldact_454_1216)
(check-sat)
(get-objectives)
