...
(declare-fun sigaction_oldact_2349_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x74328))))
(assert
 (let ((?x135617 ((_ extract 127 120) sigaction_oldact_2349_1216)))
 (let ((?x100546 (bvand ?x135617 (_ bv4 8))))
 (= (_ bv0 8) ?x100546))))
(minimize args_1_8)
...
(minimize sigaction_oldact_2349_1216)
