...
(declare-fun sigaction_oldact_2415_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x76182))))
(assert
 (let ((?x139735 ((_ extract 127 120) sigaction_oldact_2415_1216)))
 (let ((?x139740 (bvand ?x139735 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x139740) true))))
(minimize sigaction_oldact_209_1216)
(maximize sigaction_oldact_461_1216)
...
(maximize sigaction_oldact_2415_1216)
(minimize sigaction_oldact_188_1216)
(maximize sigaction_oldact_752_1216)
...
(maximize args_1_8)
(minimize sigaction_oldact_2415_1216)
(minimize sigaction_oldact_752_1216)
