...
(declare-fun sigaction_oldact_782_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1358_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2494_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22983) true))))
(assert
 (let ((?x44929 ((_ extract 127 120) sigaction_oldact_782_1216)))
 (let ((?x44946 (bvand ?x44929 (_ bv4 8))))
 (= (_ bv0 8) ?x44946))))
(assert
 (let ((?x78619 ((_ extract 127 120) sigaction_oldact_1358_1216)))
 (let ((?x40509 (bvand ?x78619 (_ bv4 8))))
 (= (_ bv0 8) ?x40509))))
(assert
 (let ((?x144145 ((_ extract 127 120) sigaction_oldact_2494_1216)))
 (let ((?x109323 (bvand ?x144145 (_ bv4 8))))
 (= (_ bv0 8) ?x109323))))
(minimize sigaction_oldact_470_1216)
(maximize sigaction_oldact_1358_1216)
(maximize sigaction_oldact_2494_1216)
(maximize strlen_77_64)
(maximize sigaction_oldact_245_1216)
(maximize sigaction_oldact_470_1216)
(maximize strlen_74_64)
(minimize args_1_8)
(minimize sigaction_oldact_1358_1216)
(minimize strlen_74_64)
(minimize args_2_8)
(minimize sigaction_oldact_782_1216)
...
(maximize args_0_8)
(minimize sigaction_oldact_2494_1216)
(maximize args_4_8)
...
(maximize sigaction_oldact_782_1216)
(check-sat)
(get-objectives)
