...
(declare-fun sigaction_oldact_2350_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x74371))))
(assert
 (let ((?x135655 ((_ extract 127 120) sigaction_oldact_2350_1216)))
 (let ((?x135672 (bvand ?x135655 (_ bv4 8))))
 (= (_ bv0 8) ?x135672))))
(maximize sigaction_oldact_321_1216)
(maximize sigaction_oldact_737_1216)
(maximize args_2_8)
(maximize sigaction_oldact_247_1216)
(maximize sigaction_oldact_2350_1216)
(maximize args_3_8)
(minimize sigaction_oldact_321_1216)
(maximize strlen_72_64)
(maximize args_4_8)
(minimize args_1_8)
(minimize sigaction_oldact_2350_1216)
