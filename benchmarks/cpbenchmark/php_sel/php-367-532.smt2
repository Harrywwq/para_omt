...
(declare-fun sigaction_oldact_464_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_740_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1320_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2429_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x11881))))
(assert
 (let ((?x22530 ((_ extract 127 120) sigaction_oldact_464_1216)))
 (let ((?x22540 (bvand ?x22530 (_ bv4 8))))
 (= (_ bv0 8) ?x22540))))
(assert
 (let ((?x42184 ((_ extract 127 120) sigaction_oldact_740_1216)))
 (let ((?x42194 (bvand ?x42184 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x42194) true))))
(assert
 (let ((?x76613 ((_ extract 127 120) sigaction_oldact_1320_1216)))
 (let ((?x38340 (bvand ?x76613 (_ bv4 8))))
 (= (_ bv0 8) ?x38340))))
(assert
 (let ((?x140408 ((_ extract 127 120) sigaction_oldact_2429_1216)))
 (let ((?x105216 (bvand ?x140408 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x105216) true))))
(maximize sigaction_oldact_740_1216)
(minimize sigaction_oldact_740_1216)
...
(maximize args_3_8)
(maximize sigaction_oldact_2429_1216)
(minimize args_2_8)
