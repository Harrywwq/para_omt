...
(declare-fun sigaction_oldact_759_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1322_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2431_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x23207))))
(assert
 (let ((?x43529 ((_ extract 127 120) sigaction_oldact_759_1216)))
 (let ((?x43535 (bvand ?x43529 (_ bv4 8))))
 (= (_ bv0 8) ?x43535))))
(assert
 (let ((?x76697 ((_ extract 127 120) sigaction_oldact_1322_1216)))
 (let ((?x76713 (bvand ?x76697 (_ bv4 8))))
 (= (_ bv0 8) ?x76713))))
(assert
 (let ((?x140492 ((_ extract 127 120) sigaction_oldact_2431_1216)))
 (let ((?x140517 (bvand ?x140492 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x140517) true))))
(minimize sigaction_oldact_759_1216)
(minimize args_3_8)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_322_1216)
(maximize args_2_8)
(minimize sigaction_oldact_322_1216)
(maximize sigaction_oldact_759_1216)
(maximize strlen_74_64)
(maximize strlen_81_64)
(minimize strlen_72_64)
(minimize sigaction_oldact_473_1216)
(minimize sigaction_oldact_2431_1216)
(maximize args_0_8)
...
(minimize sigaction_oldact_1322_1216)
