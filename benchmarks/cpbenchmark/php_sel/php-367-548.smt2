...
(declare-fun sigaction_oldact_1367_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43535) true))))
(assert
 (let ((?x79155 ((_ extract 127 120) sigaction_oldact_1367_1216)))
 (let ((?x79182 (bvand ?x79155 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x79182) true))))
...
(minimize sigaction_oldact_1367_1216)
(maximize args_1_8)
(maximize sigaction_oldact_1367_1216)
