...
(declare-fun sigaction_oldact_322_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_473_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_786_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1368_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2514_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x6696) true))))
(assert
 (let ((?x11864 ((_ extract 127 120) sigaction_oldact_322_1216)))
 (let ((?x11881 (bvand ?x11864 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x11881) true))))
(assert
 (let ((?x23182 ((_ extract 127 120) sigaction_oldact_473_1216)))
 (let ((?x23207 (bvand ?x23182 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x23207) true))))
(assert
 (let ((?x45267 ((_ extract 127 120) sigaction_oldact_786_1216)))
 (let ((?x45287 (bvand ?x45267 (_ bv4 8))))
 (= (_ bv0 8) ?x45287))))
(assert
 (let ((?x79204 ((_ extract 127 120) sigaction_oldact_1368_1216)))
 (let ((?x41164 (bvand ?x79204 (_ bv4 8))))
 (= (_ bv0 8) ?x41164))))
(assert
 (let ((?x145235 ((_ extract 127 120) sigaction_oldact_2514_1216)))
 (let ((?x145260 (bvand ?x145235 (_ bv4 8))))
 (= (_ bv0 8) ?x145260))))
(maximize sigaction_oldact_1368_1216)
(minimize sigaction_oldact_2514_1216)
(minimize sigaction_oldact_473_1216)
(maximize sigaction_oldact_191_1216)
(minimize sigaction_oldact_786_1216)
...
(maximize sigaction_oldact_786_1216)
(minimize sigaction_oldact_246_1216)
(minimize sigaction_oldact_1368_1216)
(maximize args_1_8)
(minimize args_2_8)
(maximize strlen_77_64)
(maximize sigaction_oldact_2514_1216)
...
(maximize args_3_8)
(maximize sigaction_oldact_473_1216)
(minimize sigaction_oldact_210_1216)
(minimize args_0_8)
(maximize args_0_8)
(maximize sigaction_oldact_322_1216)
(check-sat)
(get-objectives)
