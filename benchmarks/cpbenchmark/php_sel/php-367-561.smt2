...
(declare-fun sigaction_oldact_2515_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x76770) true))))
(assert
 (let ((?x145305 ((_ extract 127 120) sigaction_oldact_2515_1216)))
 (let ((?x110660 (bvand ?x145305 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x110660) true))))
...
(maximize args_1_8)
(minimize sigaction_oldact_2515_1216)
