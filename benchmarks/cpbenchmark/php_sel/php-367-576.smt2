...
(declare-fun sigaction_oldact_1371_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2520_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x367))))
(assert
 (let ((?x79374 ((_ extract 127 120) sigaction_oldact_1371_1216)))
 (let ((?x79390 (bvand ?x79374 (_ bv4 8))))
 (= (_ bv0 8) ?x79390))))
(assert
 (let ((?x145551 ((_ extract 127 120) sigaction_oldact_2520_1216)))
 (let ((?x110891 (bvand ?x145551 (_ bv4 8))))
 (= (_ bv0 8) ?x110891))))
...
(minimize sigaction_oldact_787_1216)
(minimize args_1_8)
(minimize strlen_74_64)
(maximize sigaction_oldact_474_1216)
(maximize sigaction_oldact_1371_1216)
(maximize args_1_8)
(maximize sigaction_oldact_2520_1216)
