...
(declare-fun sigaction_oldact_324_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_466_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_742_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1327_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2438_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x6958))))
(assert
 (let ((?x11958 ((_ extract 127 120) sigaction_oldact_324_1216)))
 (let ((?x11983 (bvand ?x11958 (_ bv4 8))))
 (= (_ bv0 8) ?x11983))))
(assert
 (let ((?x22624 ((_ extract 127 120) sigaction_oldact_466_1216)))
 (let ((?x22644 (bvand ?x22624 (_ bv4 8))))
 (= (_ bv0 8) ?x22644))))
(assert
 (let ((?x42278 ((_ extract 127 120) sigaction_oldact_742_1216)))
 (let ((?x42303 (bvand ?x42278 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x42303) true))))
(assert
 (let ((?x76939 ((_ extract 127 120) sigaction_oldact_1327_1216)))
 (let ((?x76955 (bvand ?x76939 (_ bv4 8))))
 (= (_ bv0 8) ?x76955))))
(assert
 (let ((?x140815 ((_ extract 127 120) sigaction_oldact_2438_1216)))
 (let ((?x67932 (bvand ?x140815 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x67932) true))))
(maximize sigaction_oldact_191_1216)
(minimize sigaction_oldact_742_1216)
(minimize args_3_8)
(minimize sigaction_oldact_324_1216)
(maximize sigaction_oldact_249_1216)
(minimize args_1_8)
(minimize sigaction_oldact_1327_1216)
(maximize sigaction_oldact_466_1216)
(maximize args_2_8)
(minimize args_2_8)
(maximize strlen_77_64)
(maximize sigaction_oldact_2438_1216)
(minimize sigaction_oldact_249_1216)
(maximize strlen_72_64)
(maximize sigaction_oldact_324_1216)
(minimize sigaction_oldact_211_1216)
(maximize args_0_8)
(minimize strlen_74_64)
(maximize sigaction_oldact_1327_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_742_1216)
(minimize sigaction_oldact_466_1216)
(maximize sigaction_oldact_211_1216)
(minimize sigaction_oldact_2438_1216)
(minimize args_0_8)
