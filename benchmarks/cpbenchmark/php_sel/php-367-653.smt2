...
(declare-fun sigaction_oldact_478_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_766_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1331_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2535_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x12414))))
(assert
 (let ((?x23467 ((_ extract 127 120) sigaction_oldact_478_1216)))
 (let ((?x23477 (bvand ?x23467 (_ bv4 8))))
 (= (_ bv0 8) ?x23477))))
(assert
 (let ((?x43908 ((_ extract 127 120) sigaction_oldact_766_1216)))
 (let ((?x43928 (bvand ?x43908 (_ bv4 8))))
 (= (_ bv0 8) ?x43928))))
(assert
 (let ((?x77096 ((_ extract 127 120) sigaction_oldact_1331_1216)))
 (let ((?x77120 (bvand ?x77096 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x77120) true))))
(assert
 (let ((?x146272 ((_ extract 127 120) sigaction_oldact_2535_1216)))
 (let ((?x146299 (bvand ?x146272 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x146299) true))))
...
(minimize sigaction_oldact_478_1216)
(maximize sigaction_oldact_478_1216)
...
(maximize args_3_8)
(maximize sigaction_oldact_1331_1216)
(minimize sigaction_oldact_1331_1216)
(minimize sigaction_oldact_766_1216)
