...
(declare-fun sigaction_oldact_1397_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x46340))))
(assert
 (let ((?x80651 ((_ extract 127 120) sigaction_oldact_1397_1216)))
 (let ((?x80667 (bvand ?x80651 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x80667) true))))
...
(minimize args_1_8)
(minimize args_3_8)
(minimize sigaction_oldact_1397_1216)
(maximize sigaction_oldact_1397_1216)
