...
(declare-fun sigaction_oldact_921_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1764_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26634) true))))
(assert
 (let ((?x52797 ((_ extract 127 120) sigaction_oldact_921_1216)))
 (let ((?x7189 (bvand ?x52797 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x7189) true))))
(assert
 (let ((?x100107 ((_ extract 127 120) sigaction_oldact_1764_1216)))
 (let ((?x62406 (bvand ?x100107 (_ bv4 8))))
 (= (_ bv0 8) ?x62406))))
(maximize sigaction_oldact_342_1216)
(maximize sigaction_oldact_1764_1216)
(minimize strlen_81_64)
(minimize sigaction_oldact_342_1216)
(minimize sigaction_oldact_1764_1216)
(maximize args_1_8)
(minimize args_2_8)
