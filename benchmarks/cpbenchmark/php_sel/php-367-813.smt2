...
(declare-fun sigaction_oldact_2560_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x80739))))
(assert
 (let ((?x147409 ((_ extract 127 120) sigaction_oldact_2560_1216)))
 (let ((?x147417 (bvand ?x147409 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x147417) true))))
...
(minimize sigaction_oldact_1399_1216)
...
(minimize sigaction_oldact_2560_1216)
