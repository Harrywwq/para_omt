...
(declare-fun sigaction_oldact_852_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1480_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x26756))))
(assert
 (let ((?x49197 ((_ extract 127 120) sigaction_oldact_852_1216)))
 (let ((?x49209 (bvand ?x49197 (_ bv4 8))))
 (= (_ bv0 8) ?x49209))))
(assert
 (let ((?x85135 ((_ extract 127 120) sigaction_oldact_1480_1216)))
 (let ((?x48308 (bvand ?x85135 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x48308) true))))
(minimize args_2_8)
...
(minimize sigaction_oldact_1480_1216)
(minimize sigaction_oldact_852_1216)
...
(minimize sigaction_oldact_529_1216)
(minimize args_3_8)
(maximize args_3_8)
...
(maximize args_1_8)
(maximize sigaction_oldact_852_1216)
