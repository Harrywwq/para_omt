...
(declare-fun sigaction_oldact_1492_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x85838 ((_ extract 127 120) sigaction_oldact_1492_1216)))
 (let ((?x85852 (bvand ?x85838 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x85852) true))))
(minimize sigaction_oldact_1492_1216)
