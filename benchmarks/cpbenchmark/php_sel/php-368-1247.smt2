...
(declare-fun sigaction_oldact_1629_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x8610))))
(assert
 (let ((?x93212 ((_ extract 127 120) sigaction_oldact_1629_1216)))
 (let ((?x56299 (bvand ?x93212 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x56299) true))))
(minimize args_1_8)
(maximize args_2_8)
(minimize sigaction_oldact_538_1216)
(maximize sigaction_oldact_174_1216)
(maximize sigaction_oldact_1629_1216)
(maximize args_0_8)
...
(maximize sigaction_oldact_538_1216)
(minimize sigaction_oldact_935_1216)
