...
(declare-fun sigaction_oldact_1815_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x54902) true))))
(assert
 (let ((?x65835 ((_ extract 127 120) sigaction_oldact_1815_1216)))
 (let ((?x65898 (bvand ?x65835 (_ bv4 8))))
 (= (_ bv0 8) ?x65898))))
(minimize strlen_72_64)
(minimize sigaction_oldact_1815_1216)
