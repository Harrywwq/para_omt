...
(declare-fun sigaction_oldact_1822_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x59593))))
(assert
 (let ((?x103758 ((_ extract 127 120) sigaction_oldact_1822_1216)))
 (let ((?x103778 (bvand ?x103758 (_ bv4 8))))
 (= (_ bv0 8) ?x103778))))
(maximize sigaction_oldact_1822_1216)
