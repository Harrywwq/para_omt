...
(declare-fun sigaction_oldact_1824_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x59678))))
(assert
 (let ((?x103838 ((_ extract 127 120) sigaction_oldact_1824_1216)))
 (let ((?x103863 (bvand ?x103838 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x103863) true))))
(minimize sigaction_oldact_289_1216)
(minimize args_1_8)
(minimize sigaction_oldact_1042_1216)
(maximize sigaction_oldact_1824_1216)
(maximize args_1_8)
