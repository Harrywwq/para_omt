...
(declare-fun sigaction_oldact_971_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1694_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x28577) true))))
(assert
 (let ((?x55716 ((_ extract 127 120) sigaction_oldact_971_1216)))
 (let ((?x10898 (bvand ?x55716 (_ bv4 8))))
 (= (_ bv0 8) ?x10898))))
(assert
 (let ((?x96573 ((_ extract 127 120) sigaction_oldact_1694_1216)))
 (let ((?x96597 (bvand ?x96573 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x96597) true))))
(maximize sigaction_oldact_971_1216)
...
(minimize sigaction_oldact_1694_1216)
