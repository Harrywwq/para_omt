...
(declare-fun sigaction_oldact_2002_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x16599) true))))
(assert
 (let ((?x114155 ((_ extract 127 120) sigaction_oldact_2002_1216)))
 (let ((?x114175 (bvand ?x114155 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x114175) true))))
