...
(declare-fun sigaction_oldact_599_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_982_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1862_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x15527) true))))
(assert
 (let ((?x31530 ((_ extract 127 120) sigaction_oldact_599_1216)))
 (let ((?x31555 (bvand ?x31530 (_ bv4 8))))
 (= (_ bv0 8) ?x31555))))
(assert
 (let ((?x56256 ((_ extract 127 120) sigaction_oldact_982_1216)))
 (let ((?x11352 (bvand ?x56256 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x11352) true))))
(assert
 (let ((?x68518 ((_ extract 127 120) sigaction_oldact_1862_1216)))
 (let ((?x68585 (bvand ?x68518 (_ bv4 8))))
 (= (_ bv0 8) ?x68585))))
...
(maximize sigaction_oldact_599_1216)
...
(maximize sigaction_oldact_982_1216)
(minimize args_1_8)
(minimize sigaction_oldact_982_1216)
(maximize sigaction_oldact_1862_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_1862_1216)
...
(minimize sigaction_oldact_599_1216)
