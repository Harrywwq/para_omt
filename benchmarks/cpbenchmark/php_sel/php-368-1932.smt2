...
(declare-fun sigaction_oldact_1714_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x56414))))
(assert
 (let ((?x97507 ((_ extract 127 120) sigaction_oldact_1714_1216)))
 (let ((?x97531 (bvand ?x97507 (_ bv4 8))))
 (= (_ bv0 8) ?x97531))))
(maximize sigaction_oldact_224_1216)
(maximize sigaction_oldact_1714_1216)
...
(minimize sigaction_oldact_1714_1216)
