...
(declare-fun sigaction_oldact_713_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1259_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2374_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21518))))
(assert
 (let ((?x40361 ((_ extract 127 120) sigaction_oldact_713_1216)))
 (let ((?x40381 (bvand ?x40361 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40381) true))))
(assert
 (let ((?x73272 ((_ extract 127 120) sigaction_oldact_1259_1216)))
 (let ((?x73283 (bvand ?x73272 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x73283) true))))
(assert
 (let ((?x137522 ((_ extract 127 120) sigaction_oldact_2374_1216)))
 (let ((?x137540 (bvand ?x137522 (_ bv4 8))))
 (= (_ bv0 8) ?x137540))))
(maximize sigaction_oldact_309_1216)
(maximize strlen_77_64)
(maximize args_4_8)
(minimize sigaction_oldact_713_1216)
(maximize args_0_8)
...
(maximize sigaction_oldact_2374_1216)
...
(maximize args_3_8)
(minimize args_1_8)
(maximize sigaction_oldact_1259_1216)
...
(minimize args_0_8)
(minimize sigaction_oldact_1259_1216)
(maximize strlen_89_64)
(minimize strlen_77_64)
(maximize sigaction_oldact_713_1216)
(check-sat)
(get-objectives)
