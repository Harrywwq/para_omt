...
(declare-fun sigaction_oldact_1165_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2090_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x35852) true))))
(assert
 (let ((?x67155 ((_ extract 127 120) sigaction_oldact_1165_1216)))
 (let ((?x67171 (bvand ?x67155 (_ bv4 8))))
 (= (_ bv0 8) ?x67171))))
(assert
 (let ((?x119329 ((_ extract 127 120) sigaction_oldact_2090_1216)))
 (let ((?x81896 (bvand ?x119329 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x81896) true))))
(maximize args_1_8)
(maximize sigaction_oldact_187_1216)
(minimize sigaction_oldact_171_1216)
(maximize sigaction_oldact_1165_1216)
(minimize sigaction_oldact_176_1216)
(minimize sigaction_oldact_297_1216)
(minimize sigaction_oldact_2090_1216)
(maximize args_0_8)
...
(minimize args_1_8)
(maximize sigaction_oldact_2090_1216)
