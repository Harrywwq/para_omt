...
(declare-fun sigaction_oldact_1168_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2202_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x35985) true))))
(assert
 (let ((?x67317 ((_ extract 127 120) sigaction_oldact_1168_1216)))
 (let ((?x67346 (bvand ?x67317 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x67346) true))))
(assert
 (let ((?x90559 ((_ extract 127 120) sigaction_oldact_2202_1216)))
 (let ((?x126657 (bvand ?x90559 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x126657) true))))
(minimize sigaction_oldact_187_1216)
(minimize sigaction_oldact_1168_1216)
(minimize args_1_8)
(minimize sigaction_oldact_171_1216)
(maximize args_0_8)
(minimize sigaction_oldact_237_1216)
(minimize sigaction_oldact_661_1216)
(maximize sigaction_oldact_171_1216)
(maximize sigaction_oldact_187_1216)
(minimize sigaction_oldact_2202_1216)
(maximize sigaction_oldact_661_1216)
...
(maximize sigaction_oldact_2202_1216)
(minimize sigaction_oldact_203_1216)
(maximize args_1_8)
(minimize strlen_75_64)
(minimize args_0_8)
(maximize sigaction_oldact_298_1216)
(maximize sigaction_oldact_411_1216)
(minimize sigaction_oldact_298_1216)
(minimize sigaction_oldact_411_1216)
(maximize sigaction_oldact_1168_1216)
