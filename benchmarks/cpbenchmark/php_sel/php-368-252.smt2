...
(declare-fun sigaction_oldact_450_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_726_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1265_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2328_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x11380))))
(assert
 (let ((?x21620 ((_ extract 127 120) sigaction_oldact_450_1216)))
 (let ((?x21640 (bvand ?x21620 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21640) true))))
(assert
 (let ((?x41376 ((_ extract 127 120) sigaction_oldact_726_1216)))
 (let ((?x41393 (bvand ?x41376 (_ bv4 8))))
 (= (_ bv0 8) ?x41393))))
(assert
 (let ((?x73594 ((_ extract 127 120) sigaction_oldact_1265_1216)))
 (let ((?x73618 (bvand ?x73594 (_ bv4 8))))
 (= (_ bv0 8) ?x73618))))
(assert
 (let ((?x134652 ((_ extract 127 120) sigaction_oldact_2328_1216)))
 (let ((?x99940 (bvand ?x134652 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x99940) true))))
(maximize sigaction_oldact_726_1216)
(maximize args_5_16)
(minimize args_3_8)
(maximize args_2_8)
(minimize sigaction_oldact_1265_1216)
(minimize strlen_74_64)
(minimize sigaction_oldact_726_1216)
(maximize strlen_84_64)
(maximize sigaction_oldact_207_1216)
(minimize strlen_84_64)
(maximize strlen_77_64)
(minimize sigaction_oldact_312_1216)
(maximize strlen_80_64)
(minimize strlen_77_64)
(maximize args_3_8)
(minimize strlen_72_64)
(minimize strlen_89_64)
(minimize sigaction_oldact_450_1216)
(maximize sigaction_oldact_450_1216)
(maximize sigaction_oldact_312_1216)
(maximize sigaction_oldact_1265_1216)
(maximize sigaction_oldact_2328_1216)
