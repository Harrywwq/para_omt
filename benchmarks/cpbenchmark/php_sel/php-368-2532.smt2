...
(declare-fun sigaction_oldact_436_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_705_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1249_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2288_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x10631) true))))
(assert
 (let ((?x18354 ((_ extract 127 120) sigaction_oldact_436_1216)))
 (let ((?x18367 (bvand ?x18354 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x18367) true))))
(assert
 (let ((?x39675 ((_ extract 127 120) sigaction_oldact_705_1216)))
 (let ((?x39695 (bvand ?x39675 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x39695) true))))
(assert
 (let ((?x72534 ((_ extract 127 120) sigaction_oldact_1249_1216)))
 (let ((?x33588 (bvand ?x72534 (_ bv4 8))))
 (= (_ bv0 8) ?x33588))))
(assert
 (let ((?x132171 ((_ extract 127 120) sigaction_oldact_2288_1216)))
 (let ((?x132186 (bvand ?x132171 (_ bv4 8))))
 (= (_ bv0 8) ?x132186))))
(minimize sigaction_oldact_237_1216)
(maximize sigaction_oldact_171_1216)
(maximize sigaction_oldact_187_1216)
(maximize sigaction_oldact_705_1216)
...
(maximize sigaction_oldact_2288_1216)
(maximize args_0_8)
(maximize sigaction_oldact_303_1216)
(minimize sigaction_oldact_303_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_2288_1216)
(maximize sigaction_oldact_1249_1216)
(minimize sigaction_oldact_705_1216)
(minimize args_1_8)
(minimize strlen_72_64)
(maximize sigaction_oldact_436_1216)
(maximize sigaction_oldact_237_1216)
(minimize args_0_8)
(minimize strlen_75_64)
(minimize sigaction_oldact_1249_1216)
(minimize sigaction_oldact_436_1216)
