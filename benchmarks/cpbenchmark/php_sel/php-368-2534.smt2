...
(declare-fun sigaction_oldact_2362_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x33588) true))))
(assert
 (let ((?x136526 ((_ extract 127 120) sigaction_oldact_2362_1216)))
 (let ((?x101423 (bvand ?x136526 (_ bv4 8))))
 (= (_ bv0 8) ?x101423))))
...
(maximize sigaction_oldact_2362_1216)
(maximize args_0_8)
(minimize args_1_8)
