...
(declare-fun sigaction_oldact_1294_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2466_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x41393) true))))
(assert
 (let ((?x75218 ((_ extract 127 120) sigaction_oldact_1294_1216)))
 (let ((?x75247 (bvand ?x75218 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75247) true))))
(assert
 (let ((?x142415 ((_ extract 127 120) sigaction_oldact_2466_1216)))
 (let ((?x142421 (bvand ?x142415 (_ bv4 8))))
 (= (_ bv0 8) ?x142421))))
(maximize sigaction_oldact_312_1216)
(minimize args_3_8)
(minimize sigaction_oldact_2466_1216)
(minimize sigaction_oldact_450_1216)
(maximize sigaction_oldact_2466_1216)
(minimize sigaction_oldact_1294_1216)
(maximize args_4_8)
