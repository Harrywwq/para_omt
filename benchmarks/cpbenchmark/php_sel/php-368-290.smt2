...
(declare-fun sigaction_oldact_717_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1267_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2387_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x21196) true))))
(assert
 (let ((?x40599 ((_ extract 127 120) sigaction_oldact_717_1216)))
 (let ((?x40616 (bvand ?x40599 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40616) true))))
(assert
 (let ((?x73704 ((_ extract 127 120) sigaction_oldact_1267_1216)))
 (let ((?x73725 (bvand ?x73704 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x73725) true))))
(assert
 (let ((?x138299 ((_ extract 127 120) sigaction_oldact_2387_1216)))
 (let ((?x65831 (bvand ?x138299 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x65831) true))))
...
(minimize sigaction_oldact_1267_1216)
(minimize args_3_8)
(maximize sigaction_oldact_1267_1216)
(minimize args_4_8)
(maximize sigaction_oldact_188_1216)
(minimize sigaction_oldact_2387_1216)
(check-sat)
(get-objectives)
