...
(declare-fun sigaction_oldact_1242_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2262_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40671))))
(assert
 (let ((?x71929 ((_ extract 127 120) sigaction_oldact_1242_1216)))
 (let ((?x71945 (bvand ?x71929 (_ bv4 8))))
 (= (_ bv0 8) ?x71945))))
(assert
 (let ((?x129852 ((_ extract 127 120) sigaction_oldact_2262_1216)))
 (let ((?x129868 (bvand ?x129852 (_ bv4 8))))
 (= (_ bv0 8) ?x129868))))
...
(minimize sigaction_oldact_2262_1216)
(maximize args_0_8)
...
(minimize args_1_8)
(minimize sigaction_oldact_1242_1216)
