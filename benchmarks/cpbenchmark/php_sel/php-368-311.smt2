...
(declare-fun sigaction_oldact_719_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1270_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2337_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21756))))
(assert
 (let ((?x40693 ((_ extract 127 120) sigaction_oldact_719_1216)))
 (let ((?x40718 (bvand ?x40693 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40718) true))))
(assert
 (let ((?x73858 ((_ extract 127 120) sigaction_oldact_1270_1216)))
 (let ((?x35277 (bvand ?x73858 (_ bv4 8))))
 (= (_ bv0 8) ?x35277))))
(assert
 (let ((?x135095 ((_ extract 127 120) sigaction_oldact_2337_1216)))
 (let ((?x135115 (bvand ?x135095 (_ bv4 8))))
 (= (_ bv0 8) ?x135115))))
(maximize sigaction_oldact_2337_1216)
(minimize sigaction_oldact_1270_1216)
...
(minimize args_2_8)
(minimize args_3_8)
(maximize sigaction_oldact_1270_1216)
...
(minimize sigaction_oldact_719_1216)
...
(maximize sigaction_oldact_719_1216)
(maximize args_2_8)
(minimize sigaction_oldact_188_1216)
(minimize sigaction_oldact_2337_1216)
(check-sat)
(get-objectives)
