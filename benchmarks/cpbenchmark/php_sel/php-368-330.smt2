...
(declare-fun sigaction_oldact_1299_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2472_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x41664) true))))
(assert
 (let ((?x75545 ((_ extract 127 120) sigaction_oldact_1299_1216)))
 (let ((?x75553 (bvand ?x75545 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75553) true))))
(assert
 (let ((?x142866 ((_ extract 127 120) sigaction_oldact_2472_1216)))
 (let ((?x107874 (bvand ?x142866 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x107874) true))))
...
(minimize sigaction_oldact_2472_1216)
(minimize sigaction_oldact_313_1216)
(maximize sigaction_oldact_1299_1216)
(minimize args_2_8)
(maximize sigaction_oldact_313_1216)
(minimize args_1_8)
(minimize sigaction_oldact_1299_1216)
(check-sat)
(get-objectives)
