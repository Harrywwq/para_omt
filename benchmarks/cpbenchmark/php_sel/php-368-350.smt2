...
(declare-fun sigaction_oldact_314_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_453_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_731_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1274_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2398_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x6609))))
(assert
 (let ((?x11463 ((_ extract 127 120) sigaction_oldact_314_1216)))
 (let ((?x11469 (bvand ?x11463 (_ bv4 8))))
 (= (_ bv0 8) ?x11469))))
(assert
 (let ((?x21786 ((_ extract 127 120) sigaction_oldact_453_1216)))
 (let ((?x21811 (bvand ?x21786 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21811) true))))
(assert
 (let ((?x41711 ((_ extract 127 120) sigaction_oldact_731_1216)))
 (let ((?x41736 (bvand ?x41711 (_ bv4 8))))
 (= (_ bv0 8) ?x41736))))
(assert
 (let ((?x74045 ((_ extract 127 120) sigaction_oldact_1274_1216)))
 (let ((?x74069 (bvand ?x74045 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74069) true))))
(assert
 (let ((?x138926 ((_ extract 127 120) sigaction_oldact_2398_1216)))
 (let ((?x104031 (bvand ?x138926 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x104031) true))))
(maximize sigaction_oldact_453_1216)
(maximize sigaction_oldact_314_1216)
(minimize sigaction_oldact_314_1216)
(minimize strlen_74_64)
(maximize strlen_80_64)
(minimize strlen_80_64)
(maximize sigaction_oldact_1274_1216)
(maximize strlen_77_64)
(maximize sigaction_oldact_188_1216)
(minimize sigaction_oldact_2398_1216)
(maximize args_1_8)
(check-sat)
(get-objectives)
