...
(declare-fun sigaction_oldact_2480_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x37614) true))))
(assert
 (let ((?x143378 ((_ extract 127 120) sigaction_oldact_2480_1216)))
 (let ((?x108427 (bvand ?x143378 (_ bv4 8))))
 (= (_ bv0 8) ?x108427))))
(maximize strlen_77_64)
(maximize strlen_85_64)
(minimize args_4_8)
(maximize sigaction_oldact_244_1216)
(maximize sigaction_oldact_2480_1216)
...
(minimize sigaction_oldact_2480_1216)
(minimize args_3_8)
