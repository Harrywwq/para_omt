...
(declare-fun sigaction_oldact_916_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1754_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26251) true))))
(assert
 (let ((?x52352 ((_ extract 127 120) sigaction_oldact_916_1216)))
 (let ((?x52365 (bvand ?x52352 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x52365) true))))
(assert
 (let ((?x99374 ((_ extract 127 120) sigaction_oldact_1754_1216)))
 (let ((?x99404 (bvand ?x99374 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x99404) true))))
...
(maximize args_4_8)
(minimize sigaction_oldact_916_1216)
(minimize args_7_16)
...
(maximize args_6_16)
(maximize args_7_16)
(maximize sigaction_oldact_916_1216)
...
(maximize args_3_8)
(maximize sigaction_oldact_1754_1216)
(maximize sigaction_oldact_360_1216)
(minimize strlen_74_64)
(minimize sigaction_oldact_1754_1216)
(check-sat)
(get-objectives)
