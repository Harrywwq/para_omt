...
(declare-fun sigaction_oldact_1279_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2410_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41949))))
(assert
 (let ((?x74271 ((_ extract 127 120) sigaction_oldact_1279_1216)))
 (let ((?x35631 (bvand ?x74271 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x35631) true))))
(assert
 (let ((?x139509 ((_ extract 127 120) sigaction_oldact_2410_1216)))
 (let ((?x139518 (bvand ?x139509 (_ bv4 8))))
 (= (_ bv0 8) ?x139518))))
(maximize args_0_8)
...
(minimize args_3_8)
(minimize sigaction_oldact_2410_1216)
(maximize sigaction_oldact_209_1216)
(maximize sigaction_oldact_460_1216)
(minimize args_1_8)
(maximize args_2_8)
...
(minimize sigaction_oldact_460_1216)
(minimize args_0_8)
(minimize sigaction_oldact_188_1216)
(minimize sigaction_oldact_1279_1216)
(minimize strlen_77_64)
(minimize args_2_8)
(maximize strlen_72_64)
(minimize args_4_8)
(minimize sigaction_oldact_735_1216)
(maximize args_1_8)
