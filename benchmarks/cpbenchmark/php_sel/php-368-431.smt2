...
(declare-fun sigaction_oldact_1355_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2488_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43053) true))))
(assert
 (let ((?x78444 ((_ extract 127 120) sigaction_oldact_1355_1216)))
 (let ((?x40240 (bvand ?x78444 (_ bv4 8))))
 (= (_ bv0 8) ?x40240))))
(assert
 (let ((?x143825 ((_ extract 127 120) sigaction_oldact_2488_1216)))
 (let ((?x143837 (bvand ?x143825 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x143837) true))))
(maximize strlen_85_64)
(minimize sigaction_oldact_751_1216)
(minimize sigaction_oldact_2488_1216)
(minimize strlen_77_64)
(maximize sigaction_oldact_209_1216)
(maximize args_2_8)
(maximize args_4_8)
(maximize sigaction_oldact_245_1216)
(maximize sigaction_oldact_751_1216)
(minimize args_4_8)
(maximize args_0_8)
(check-sat)
(get-objectives)
