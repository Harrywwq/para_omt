...
(declare-fun sigaction_oldact_1356_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2491_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43110) true))))
(assert
 (let ((?x40304 ((_ extract 127 120) sigaction_oldact_1356_1216)))
 (let ((?x40390 (bvand ?x40304 (_ bv4 8))))
 (= (_ bv0 8) ?x40390))))
(assert
 (let ((?x144003 ((_ extract 127 120) sigaction_oldact_2491_1216)))
 (let ((?x109181 (bvand ?x144003 (_ bv4 8))))
 (= (_ bv0 8) ?x109181))))
(minimize args_2_8)
...
(minimize sigaction_oldact_2491_1216)
...
(minimize args_4_8)
(maximize sigaction_oldact_2491_1216)
(maximize sigaction_oldact_1356_1216)
