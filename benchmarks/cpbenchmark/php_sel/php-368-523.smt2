...
(declare-fun sigaction_oldact_722_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1246_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2266_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21905))))
(assert
 (let ((?x40834 ((_ extract 127 120) sigaction_oldact_722_1216)))
 (let ((?x40859 (bvand ?x40834 (_ bv4 8))))
 (= (_ bv0 8) ?x40859))))
(assert
 (let ((?x72093 ((_ extract 127 120) sigaction_oldact_1246_1216)))
 (let ((?x72113 (bvand ?x72093 (_ bv4 8))))
 (= (_ bv0 8) ?x72113))))
(assert
 (let ((?x130009 ((_ extract 127 120) sigaction_oldact_2266_1216)))
 (let ((?x130025 (bvand ?x130009 (_ bv4 8))))
 (= (_ bv0 8) ?x130025))))
...
(minimize sigaction_oldact_455_1216)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_1246_1216)
(minimize sigaction_oldact_2266_1216)
(minimize args_3_8)
(maximize strlen_72_64)
(minimize strlen_72_64)
(minimize strlen_77_64)
(maximize strlen_81_64)
(minimize sigaction_oldact_722_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_722_1216)
(minimize args_0_8)
(check-sat)
(get-objectives)
