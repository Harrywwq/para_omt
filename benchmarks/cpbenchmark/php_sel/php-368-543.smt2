...
(declare-fun sigaction_oldact_2426_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x38259))))
(assert
 (let ((?x140274 ((_ extract 127 120) sigaction_oldact_2426_1216)))
 (let ((?x140290 (bvand ?x140274 (_ bv4 8))))
 (= (_ bv0 8) ?x140290))))
...
(minimize args_2_8)
(maximize sigaction_oldact_2426_1216)
