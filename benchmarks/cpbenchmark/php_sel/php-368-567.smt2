...
(declare-fun sigaction_oldact_758_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1366_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2511_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22540) true))))
(assert
 (let ((?x43482 ((_ extract 127 120) sigaction_oldact_758_1216)))
 (let ((?x43499 (bvand ?x43482 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43499) true))))
(assert
 (let ((?x79103 ((_ extract 127 120) sigaction_oldact_1366_1216)))
 (let ((?x41112 (bvand ?x79103 (_ bv4 8))))
 (= (_ bv0 8) ?x41112))))
(assert
 (let ((?x145101 ((_ extract 127 120) sigaction_oldact_2511_1216)))
 (let ((?x110482 (bvand ?x145101 (_ bv4 8))))
 (= (_ bv0 8) ?x110482))))
(minimize args_2_8)
...
(maximize sigaction_oldact_758_1216)
(maximize args_1_8)
...
(minimize args_1_8)
(minimize sigaction_oldact_2511_1216)
(minimize args_3_8)
...
(maximize sigaction_oldact_1366_1216)
(check-sat)
(get-objectives)
