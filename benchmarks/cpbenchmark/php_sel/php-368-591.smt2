...
(declare-fun sigaction_oldact_1323_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2433_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x42241) true))))
(assert
 (let ((?x76755 ((_ extract 127 120) sigaction_oldact_1323_1216)))
 (let ((?x76770 (bvand ?x76755 (_ bv4 8))))
 (= (_ bv0 8) ?x76770))))
(assert
 (let ((?x140592 ((_ extract 127 120) sigaction_oldact_2433_1216)))
 (let ((?x105396 (bvand ?x140592 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x105396) true))))
(maximize strlen_77_64)
(minimize args_1_8)
(minimize sigaction_oldact_465_1216)
(minimize strlen_77_64)
(minimize sigaction_oldact_1323_1216)
(maximize args_1_8)
