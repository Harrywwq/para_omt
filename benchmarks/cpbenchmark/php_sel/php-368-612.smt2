...
(declare-fun sigaction_oldact_2641_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x79390) true))))
(assert
 (let ((?x151896 ((_ extract 127 120) sigaction_oldact_2641_1216)))
 (let ((?x115948 (bvand ?x151896 (_ bv4 8))))
 (= (_ bv0 8) ?x115948))))
(maximize strlen_72_64)
(minimize sigaction_oldact_787_1216)
(maximize strlen_74_64)
(minimize args_3_8)
(maximize sigaction_oldact_2641_1216)
...
(minimize sigaction_oldact_2641_1216)
