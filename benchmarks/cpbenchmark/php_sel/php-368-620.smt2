...
(declare-fun sigaction_oldact_2521_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x76882) true))))
(assert
 (let ((?x145613 ((_ extract 127 120) sigaction_oldact_2521_1216)))
 (let ((?x145628 (bvand ?x145613 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x145628) true))))
(minimize strlen_72_64)
(maximize args_0_8)
(maximize sigaction_oldact_179_1216)
(minimize strlen_77_64)
(minimize sigaction_oldact_210_1216)
(maximize sigaction_oldact_2521_1216)
(maximize args_2_8)
