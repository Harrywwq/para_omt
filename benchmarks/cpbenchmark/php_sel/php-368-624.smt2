...
(declare-fun sigaction_oldact_475_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_762_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1372_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2643_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x12281))))
(assert
 (let ((?x23301 ((_ extract 127 120) sigaction_oldact_475_1216)))
 (let ((?x23311 (bvand ?x23301 (_ bv4 8))))
 (= (_ bv0 8) ?x23311))))
(assert
 (let ((?x43695 ((_ extract 127 120) sigaction_oldact_762_1216)))
 (let ((?x43701 (bvand ?x43695 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43701) true))))
(assert
 (let ((?x79426 ((_ extract 127 120) sigaction_oldact_1372_1216)))
 (let ((?x79437 (bvand ?x79426 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x79437) true))))
(assert
 (let ((?x152018 ((_ extract 127 120) sigaction_oldact_2643_1216)))
 (let ((?x116067 (bvand ?x152018 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x116067) true))))
(minimize strlen_77_64)
(maximize args_0_8)
(minimize args_3_8)
(minimize strlen_74_64)
(minimize sigaction_oldact_2643_1216)
(maximize sigaction_oldact_475_1216)
...
(minimize sigaction_oldact_475_1216)
(maximize args_2_8)
(check-sat)
(get-objectives)
