...
(declare-fun sigaction_oldact_1954_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x63570))))
(assert
 (let ((?x110678 ((_ extract 127 120) sigaction_oldact_1954_1216)))
 (let ((?x72162 (bvand ?x110678 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x72162) true))))
(minimize args_7_16)
...
(maximize sigaction_oldact_1954_1216)
