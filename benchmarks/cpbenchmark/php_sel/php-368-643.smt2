...
(declare-fun sigaction_oldact_838_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1579_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x24370) true))))
(assert
 (let ((?x48338 ((_ extract 127 120) sigaction_oldact_838_1216)))
 (let ((?x48343 (bvand ?x48338 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x48343) true))))
(assert
 (let ((?x90089 ((_ extract 127 120) sigaction_oldact_1579_1216)))
 (let ((?x90105 (bvand ?x90089 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x90105) true))))
(minimize strlen_81_64)
(maximize sigaction_oldact_328_1216)
(maximize sigaction_oldact_210_1216)
(minimize sigaction_oldact_1579_1216)
...
(minimize sigaction_oldact_838_1216)
(maximize sigaction_oldact_1579_1216)
(minimize args_1_8)
(minimize sigaction_oldact_248_1216)
(maximize sigaction_oldact_838_1216)
(check-sat)
(get-objectives)
