...
(declare-fun sigaction_oldact_476_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_790_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1377_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2530_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x11983) true))))
(assert
 (let ((?x23373 ((_ extract 127 120) sigaction_oldact_476_1216)))
 (let ((?x23398 (bvand ?x23373 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x23398) true))))
(assert
 (let ((?x45564 ((_ extract 127 120) sigaction_oldact_790_1216)))
 (let ((?x529 (bvand ?x45564 (_ bv4 8))))
 (= (_ bv0 8) ?x529))))
(assert
 (let ((?x79686 ((_ extract 127 120) sigaction_oldact_1377_1216)))
 (let ((?x79691 (bvand ?x79686 (_ bv4 8))))
 (= (_ bv0 8) ?x79691))))
(assert
 (let ((?x146048 ((_ extract 127 120) sigaction_oldact_2530_1216)))
 (let ((?x111271 (bvand ?x146048 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x111271) true))))
...
(maximize sigaction_oldact_1377_1216)
(minimize sigaction_oldact_790_1216)
(minimize sigaction_oldact_211_1216)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_191_1216)
(maximize sigaction_oldact_790_1216)
(minimize sigaction_oldact_1377_1216)
(minimize args_2_8)
(maximize sigaction_oldact_476_1216)
(minimize args_3_8)
(minimize strlen_77_64)
(minimize strlen_74_64)
(minimize sigaction_oldact_191_1216)
(minimize sigaction_oldact_2530_1216)
(maximize args_1_8)
(maximize sigaction_oldact_2530_1216)
(maximize sigaction_oldact_211_1216)
(minimize args_0_8)
(minimize sigaction_oldact_476_1216)
