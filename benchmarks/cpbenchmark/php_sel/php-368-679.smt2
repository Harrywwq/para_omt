...
(declare-fun sigaction_oldact_1378_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2532_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43886) true))))
(assert
 (let ((?x79738 ((_ extract 127 120) sigaction_oldact_1378_1216)))
 (let ((?x79768 (bvand ?x79738 (_ bv4 8))))
 (= (_ bv0 8) ?x79768))))
(assert
 (let ((?x146149 ((_ extract 127 120) sigaction_oldact_2532_1216)))
 (let ((?x146165 (bvand ?x146149 (_ bv4 8))))
 (= (_ bv0 8) ?x146165))))
(minimize sigaction_oldact_329_1216)
(minimize sigaction_oldact_765_1216)
(maximize sigaction_oldact_329_1216)
(maximize strlen_74_64)
(minimize strlen_72_64)
(maximize sigaction_oldact_249_1216)
(maximize sigaction_oldact_1378_1216)
(maximize strlen_77_64)
(maximize strlen_72_64)
(maximize args_1_8)
(maximize sigaction_oldact_2532_1216)
(minimize strlen_74_64)
(minimize sigaction_oldact_2532_1216)
(maximize args_0_8)
