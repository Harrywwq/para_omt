...
(declare-fun sigaction_oldact_1381_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2536_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x43928) true))))
(assert
 (let ((?x79884 ((_ extract 127 120) sigaction_oldact_1381_1216)))
 (let ((?x42016 (bvand ?x79884 (_ bv4 8))))
 (= (_ bv0 8) ?x42016))))
(assert
 (let ((?x146321 ((_ extract 127 120) sigaction_oldact_2536_1216)))
 (let ((?x111404 (bvand ?x146321 (_ bv4 8))))
 (= (_ bv0 8) ?x111404))))
...
(minimize sigaction_oldact_2536_1216)
(maximize args_3_8)
(maximize args_1_8)
(minimize args_3_8)
...
(maximize sigaction_oldact_2536_1216)
(maximize sigaction_oldact_330_1216)
(maximize sigaction_oldact_211_1216)
(minimize args_2_8)
(maximize sigaction_oldact_252_1216)
(maximize sigaction_oldact_1381_1216)
(maximize sigaction_oldact_766_1216)
