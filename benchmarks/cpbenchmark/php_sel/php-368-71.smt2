...
(declare-fun sigaction_oldact_1956_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x63631))))
(assert
 (let ((?x110770 ((_ extract 127 120) sigaction_oldact_1956_1216)))
 (let ((?x72208 (bvand ?x110770 (_ bv4 8))))
 (= (_ bv0 8) ?x72208))))
(minimize args_4_8)
(maximize strlen_97_64)
(maximize sigaction_oldact_288_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_413_1216)
