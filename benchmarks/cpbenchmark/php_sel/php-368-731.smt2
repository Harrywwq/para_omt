...
(declare-fun sigaction_oldact_1384_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2665_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x504))))
(assert
 (let ((?x80012 ((_ extract 127 120) sigaction_oldact_1384_1216)))
 (let ((?x80032 (bvand ?x80012 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x80032) true))))
(assert
 (let ((?x117157 ((_ extract 127 120) sigaction_oldact_2665_1216)))
 (let ((?x117196 (bvand ?x117157 (_ bv4 8))))
 (= (_ bv0 8) ?x117196))))
(maximize strlen_72_64)
(minimize sigaction_oldact_2665_1216)
(maximize args_0_8)
(maximize args_2_8)
