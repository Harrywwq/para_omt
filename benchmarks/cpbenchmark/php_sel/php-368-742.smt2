...
(declare-fun sigaction_oldact_1460_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2668_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x2601))))
(assert
 (let ((?x84044 ((_ extract 127 120) sigaction_oldact_1460_1216)))
 (let ((?x46919 (bvand ?x84044 (_ bv4 8))))
 (= (_ bv0 8) ?x46919))))
(assert
 (let ((?x153333 ((_ extract 127 120) sigaction_oldact_2668_1216)))
 (let ((?x153349 (bvand ?x153333 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x153349) true))))
(minimize args_3_8)
(minimize args_1_8)
...
(maximize sigaction_oldact_2668_1216)
...
(minimize sigaction_oldact_525_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_2668_1216)
(minimize sigaction_oldact_1460_1216)
...
(minimize sigaction_oldact_842_1216)
