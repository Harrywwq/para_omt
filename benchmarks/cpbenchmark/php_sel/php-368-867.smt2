...
(declare-fun sigaction_oldact_802_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1396_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2690_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x23700) true))))
(assert
 (let ((?x46270 ((_ extract 127 120) sigaction_oldact_802_1216)))
 (let ((?x46287 (bvand ?x46270 (_ bv4 8))))
 (= (_ bv0 8) ?x46287))))
(assert
 (let ((?x80605 ((_ extract 127 120) sigaction_oldact_1396_1216)))
 (let ((?x80629 (bvand ?x80605 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x80629) true))))
(assert
 (let ((?x154531 ((_ extract 127 120) sigaction_oldact_2690_1216)))
 (let ((?x154557 (bvand ?x154531 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x154557) true))))
(minimize args_0_8)
(maximize strlen_81_64)
(maximize args_0_8)
(maximize sigaction_oldact_482_1216)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_1396_1216)
(maximize args_3_8)
(maximize sigaction_oldact_254_1216)
(minimize sigaction_oldact_1396_1216)
(minimize args_1_8)
(minimize sigaction_oldact_333_1216)
(maximize sigaction_oldact_802_1216)
...
(maximize sigaction_oldact_2690_1216)
