...
(declare-fun sigaction_oldact_1471_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x46287) true))))
(assert
 (let ((?x84724 ((_ extract 127 120) sigaction_oldact_1471_1216)))
 (let ((?x84740 (bvand ?x84724 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x84740) true))))
(minimize sigaction_oldact_333_1216)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_1471_1216)
(maximize args_3_8)
