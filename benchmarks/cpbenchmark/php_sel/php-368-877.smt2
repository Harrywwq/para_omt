...
(declare-fun sigaction_oldact_499_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_803_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1472_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x12566) true))))
(assert
 (let ((?x24843 ((_ extract 127 120) sigaction_oldact_499_1216)))
 (let ((?x24868 (bvand ?x24843 (_ bv4 8))))
 (= (_ bv0 8) ?x24868))))
(assert
 (let ((?x46317 ((_ extract 127 120) sigaction_oldact_803_1216)))
 (let ((?x46340 (bvand ?x46317 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46340) true))))
(assert
 (let ((?x84776 ((_ extract 127 120) sigaction_oldact_1472_1216)))
 (let ((?x84802 (bvand ?x84776 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x84802) true))))
(minimize args_1_8)
...
(minimize sigaction_oldact_1472_1216)
(maximize sigaction_oldact_192_1216)
(minimize sigaction_oldact_803_1216)
(maximize strlen_77_64)
(maximize args_1_8)
(minimize sigaction_oldact_499_1216)
