...
(declare-fun sigaction_oldact_804_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1398_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2695_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x24915))))
(assert
 (let ((?x46362 ((_ extract 127 120) sigaction_oldact_804_1216)))
 (let ((?x836 (bvand ?x46362 (_ bv4 8))))
 (= (_ bv0 8) ?x836))))
(assert
 (let ((?x80689 ((_ extract 127 120) sigaction_oldact_1398_1216)))
 (let ((?x80705 (bvand ?x80689 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x80705) true))))
(assert
 (let ((?x118609 ((_ extract 127 120) sigaction_oldact_2695_1216)))
 (let ((?x118648 (bvand ?x118609 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x118648) true))))
...
(maximize args_2_8)
(minimize sigaction_oldact_1398_1216)
(minimize sigaction_oldact_500_1216)
(maximize args_3_8)
(minimize args_3_8)
(maximize sigaction_oldact_2695_1216)
(check-sat)
(get-objectives)
