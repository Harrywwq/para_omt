...
(declare-fun sigaction_oldact_1768_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13475))))
(assert
 (let ((?x100373 ((_ extract 127 120) sigaction_oldact_1768_1216)))
 (let ((?x100393 (bvand ?x100373 (_ bv4 8))))
 (= (_ bv0 8) ?x100393))))
(maximize sigaction_oldact_1768_1216)
