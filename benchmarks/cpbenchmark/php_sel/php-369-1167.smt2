...
(declare-fun sigaction_oldact_2730_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x156575 ((_ extract 127 120) sigaction_oldact_2730_1216)))
 (let ((?x120466 (bvand ?x156575 (_ bv4 8))))
 (= (_ bv0 8) ?x120466))))
(maximize args_0_8)
(maximize args_1_8)
...
(minimize sigaction_oldact_2730_1216)
