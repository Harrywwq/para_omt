...
(declare-fun sigaction_oldact_532_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_861_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1610_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2933_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x13471) true))))
(assert
 (let ((?x27027 ((_ extract 127 120) sigaction_oldact_532_1216)))
 (let ((?x27052 (bvand ?x27027 (_ bv4 8))))
 (= (_ bv0 8) ?x27052))))
(assert
 (let ((?x49743 ((_ extract 127 120) sigaction_oldact_861_1216)))
 (let ((?x49763 (bvand ?x49743 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x49763) true))))
(assert
 (let ((?x55181 ((_ extract 127 120) sigaction_oldact_1610_1216)))
 (let ((?x92176 (bvand ?x55181 (_ bv4 8))))
 (= (_ bv0 8) ?x92176))))
(assert
 (let ((?x167531 ((_ extract 127 120) sigaction_oldact_2933_1216)))
 (let ((?x130135 (bvand ?x167531 (_ bv4 8))))
 (= (_ bv0 8) ?x130135))))
(maximize args_1_8)
(minimize strlen_72_64)
(minimize sigaction_oldact_2933_1216)
(minimize sigaction_oldact_193_1216)
(maximize sigaction_oldact_346_1216)
(minimize args_1_8)
