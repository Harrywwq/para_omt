...
(declare-fun sigaction_oldact_1782_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x8657) true))))
(assert
 (let ((?x101473 ((_ extract 127 120) sigaction_oldact_1782_1216)))
 (let ((?x101494 (bvand ?x101473 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x101494) true))))
(minimize args_2_8)
(maximize sigaction_oldact_265_1216)
(minimize sigaction_oldact_1782_1216)
...
(minimize args_1_8)
(minimize args_0_8)
(maximize sigaction_oldact_1782_1216)
