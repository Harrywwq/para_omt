...
(declare-fun sigaction_oldact_1632_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x53872))))
(assert
 (let ((?x93354 ((_ extract 127 120) sigaction_oldact_1632_1216)))
 (let ((?x56441 (bvand ?x93354 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x56441) true))))
(minimize args_2_8)
...
(maximize sigaction_oldact_1632_1216)
(check-sat)
(get-objectives)
