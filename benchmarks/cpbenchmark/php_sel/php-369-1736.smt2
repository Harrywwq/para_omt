...
(declare-fun sigaction_oldact_587_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1038_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1819_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x16449))))
(assert
 (let ((?x30666 ((_ extract 127 120) sigaction_oldact_587_1216)))
 (let ((?x30691 (bvand ?x30666 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x30691) true))))
(assert
 (let ((?x59467 ((_ extract 127 120) sigaction_oldact_1038_1216)))
 (let ((?x59489 (bvand ?x59467 (_ bv4 8))))
 (= (_ bv0 8) ?x59489))))
(assert
 (let ((?x103619 ((_ extract 127 120) sigaction_oldact_1819_1216)))
 (let ((?x103625 (bvand ?x103619 (_ bv4 8))))
 (= (_ bv0 8) ?x103625))))
(maximize sigaction_oldact_391_1216)
(minimize args_2_8)
(maximize sigaction_oldact_1038_1216)
(maximize args_0_8)
(maximize args_2_8)
(minimize sigaction_oldact_1038_1216)
(maximize sigaction_oldact_183_1216)
(maximize sigaction_oldact_197_1216)
(minimize sigaction_oldact_391_1216)
(maximize sigaction_oldact_1819_1216)
