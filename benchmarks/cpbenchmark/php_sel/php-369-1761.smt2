...
(declare-fun sigaction_oldact_1989_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x22030))))
(assert
 (let ((?x113190 ((_ extract 127 120) sigaction_oldact_1989_1216)))
 (let ((?x74927 (bvand ?x113190 (_ bv4 8))))
 (= (_ bv0 8) ?x74927))))
(maximize args_2_8)
...
(minimize args_1_8)
(maximize args_0_8)
(minimize sigaction_oldact_1989_1216)
