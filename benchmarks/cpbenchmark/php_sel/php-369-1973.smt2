...
(declare-fun sigaction_oldact_832_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1434_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2604_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x26077))))
(assert
 (let ((?x47840 ((_ extract 127 120) sigaction_oldact_832_1216)))
 (let ((?x47865 (bvand ?x47840 (_ bv4 8))))
 (= (_ bv0 8) ?x47865))))
(assert
 (let ((?x82316 ((_ extract 127 120) sigaction_oldact_1434_1216)))
 (let ((?x82336 (bvand ?x82316 (_ bv4 8))))
 (= (_ bv0 8) ?x82336))))
(assert
 (let ((?x149363 ((_ extract 127 120) sigaction_oldact_2604_1216)))
 (let ((?x113322 (bvand ?x149363 (_ bv4 8))))
 (= (_ bv0 8) ?x113322))))
...
(maximize args_1_8)
(maximize sigaction_oldact_1434_1216)
(maximize sigaction_oldact_357_1216)
(minimize sigaction_oldact_1434_1216)
(check-sat)
(get-objectives)
