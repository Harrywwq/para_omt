...
(declare-fun sigaction_oldact_970_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1840_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x28525) true))))
(assert
 (let ((?x55650 ((_ extract 127 120) sigaction_oldact_970_1216)))
 (let ((?x10828 (bvand ?x55650 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x10828) true))))
(assert
 (let ((?x104886 ((_ extract 127 120) sigaction_oldact_1840_1216)))
 (let ((?x104902 (bvand ?x104886 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x104902) true))))
...
(minimize sigaction_oldact_556_1216)
...
(maximize sigaction_oldact_970_1216)
