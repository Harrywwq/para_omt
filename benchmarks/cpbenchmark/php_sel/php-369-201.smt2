...
(declare-fun sigaction_oldact_1258_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2373_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x40339) true))))
(assert
 (let ((?x73224 ((_ extract 127 120) sigaction_oldact_1258_1216)))
 (let ((?x73235 (bvand ?x73224 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x73235) true))))
(assert
 (let ((?x137452 ((_ extract 127 120) sigaction_oldact_2373_1216)))
 (let ((?x102523 (bvand ?x137452 (_ bv4 8))))
 (= (_ bv0 8) ?x102523))))
(maximize strlen_89_64)
(maximize args_0_8)
(maximize sigaction_oldact_241_1216)
(minimize sigaction_oldact_2373_1216)
...
(maximize args_5_16)
(maximize sigaction_oldact_1258_1216)
(minimize sigaction_oldact_207_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_712_1216)
(minimize strlen_74_64)
(minimize sigaction_oldact_1258_1216)
(minimize args_4_8)
(maximize sigaction_oldact_2373_1216)
