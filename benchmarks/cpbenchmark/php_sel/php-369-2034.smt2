...
(declare-fun sigaction_oldact_594_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_974_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1698_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3078_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x15408) true))))
(assert
 (let ((?x31220 ((_ extract 127 120) sigaction_oldact_594_1216)))
 (let ((?x31240 (bvand ?x31220 (_ bv4 8))))
 (= (_ bv0 8) ?x31240))))
(assert
 (let ((?x55855 ((_ extract 127 120) sigaction_oldact_974_1216)))
 (let ((?x55871 (bvand ?x55855 (_ bv4 8))))
 (= (_ bv0 8) ?x55871))))
(assert
 (let ((?x96753 ((_ extract 127 120) sigaction_oldact_1698_1216)))
 (let ((?x96758 (bvand ?x96753 (_ bv4 8))))
 (= (_ bv0 8) ?x96758))))
(assert
 (let ((?x174729 ((_ extract 127 120) sigaction_oldact_3078_1216)))
 (let ((?x135865 (bvand ?x174729 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x135865) true))))
(maximize sigaction_oldact_594_1216)
(maximize args_0_8)
...
(maximize sigaction_oldact_3078_1216)
(minimize sigaction_oldact_594_1216)
(maximize sigaction_oldact_376_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_974_1216)
(minimize args_0_8)
(maximize sigaction_oldact_1698_1216)
