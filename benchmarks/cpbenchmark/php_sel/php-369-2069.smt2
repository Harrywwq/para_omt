...
(declare-fun sigaction_oldact_976_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1850_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x28671) true))))
(assert
 (let ((?x55951 ((_ extract 127 120) sigaction_oldact_976_1216)))
 (let ((?x11058 (bvand ?x55951 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x11058) true))))
(assert
 (let ((?x105449 ((_ extract 127 120) sigaction_oldact_1850_1216)))
 (let ((?x105474 (bvand ?x105449 (_ bv4 8))))
 (= (_ bv0 8) ?x105474))))
(minimize sigaction_oldact_559_1216)
(maximize sigaction_oldact_377_1216)
(maximize sigaction_oldact_1850_1216)
(minimize sigaction_oldact_976_1216)
(maximize args_0_8)
(maximize sigaction_oldact_198_1216)
(minimize sigaction_oldact_280_1216)
(maximize sigaction_oldact_976_1216)
...
(minimize sigaction_oldact_1850_1216)
(minimize args_0_8)
