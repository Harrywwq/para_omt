...
(declare-fun sigaction_oldact_448_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_724_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1260_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2319_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x11264) true))))
(assert
 (let ((?x21501 ((_ extract 127 120) sigaction_oldact_448_1216)))
 (let ((?x21518 (bvand ?x21501 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21518) true))))
(assert
 (let ((?x41207 ((_ extract 127 120) sigaction_oldact_724_1216)))
 (let ((?x41227 (bvand ?x41207 (_ bv4 8))))
 (= (_ bv0 8) ?x41227))))
(assert
 (let ((?x73324 ((_ extract 127 120) sigaction_oldact_1260_1216)))
 (let ((?x73335 (bvand ?x73324 (_ bv4 8))))
 (= (_ bv0 8) ?x73335))))
(assert
 (let ((?x134205 ((_ extract 127 120) sigaction_oldact_2319_1216)))
 (let ((?x134225 (bvand ?x134205 (_ bv4 8))))
 (= (_ bv0 8) ?x134225))))
(minimize strlen_89_64)
(minimize strlen_72_64)
(maximize sigaction_oldact_1260_1216)
(minimize strlen_84_64)
(maximize strlen_80_64)
(maximize sigaction_oldact_2319_1216)
(maximize strlen_84_64)
(maximize sigaction_oldact_448_1216)
(minimize sigaction_oldact_309_1216)
(minimize args_0_8)
(maximize args_3_8)
(check-sat)
(get-objectives)
