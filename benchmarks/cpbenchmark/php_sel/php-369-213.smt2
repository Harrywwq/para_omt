...
(declare-fun sigaction_oldact_2375_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x137590 ((_ extract 127 120) sigaction_oldact_2375_1216)))
 (let ((?x102680 (bvand ?x137590 (_ bv4 8))))
 (= (_ bv0 8) ?x102680))))
(minimize args_3_8)
...
(maximize sigaction_oldact_2375_1216)
(minimize args_2_8)
(check-sat)
(get-objectives)
