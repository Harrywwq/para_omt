...
(declare-fun sigaction_oldact_2605_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x44615))))
(assert
 (let ((?x149405 ((_ extract 127 120) sigaction_oldact_2605_1216)))
 (let ((?x149414 (bvand ?x149405 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x149414) true))))
