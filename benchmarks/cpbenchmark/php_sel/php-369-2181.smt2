...
(declare-fun sigaction_oldact_906_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1562_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3096_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x28818))))
(assert
 (let ((?x51901 ((_ extract 127 120) sigaction_oldact_906_1216)))
 (let ((?x6118 (bvand ?x51901 (_ bv4 8))))
 (= (_ bv0 8) ?x6118))))
(assert
 (let ((?x89130 ((_ extract 127 120) sigaction_oldact_1562_1216)))
 (let ((?x89150 (bvand ?x89130 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x89150) true))))
(assert
 (let ((?x175578 ((_ extract 127 120) sigaction_oldact_3096_1216)))
 (let ((?x175588 (bvand ?x175578 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x175588) true))))
(minimize sigaction_oldact_171_1216)
(maximize sigaction_oldact_171_1216)
(minimize args_1_8)
(maximize sigaction_oldact_1562_1216)
(minimize sigaction_oldact_1562_1216)
(minimize sigaction_oldact_281_1216)
(maximize sigaction_oldact_199_1216)
(maximize sigaction_oldact_3096_1216)
