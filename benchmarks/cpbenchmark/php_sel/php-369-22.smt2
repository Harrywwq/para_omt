...
(declare-fun sigaction_oldact_2463_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x77879))))
(assert
 (let ((?x142068 ((_ extract 127 120) sigaction_oldact_2463_1216)))
 (let ((?x106681 (bvand ?x142068 (_ bv4 8))))
 (= (_ bv0 8) ?x106681))))
(minimize args_4_8)
...
(minimize sigaction_oldact_780_1216)
(maximize args_4_8)
(minimize sigaction_oldact_490_1216)
...
(minimize args_0_8)
(minimize args_5_16)
(minimize sigaction_oldact_2463_1216)
...
(maximize sigaction_oldact_2463_1216)
