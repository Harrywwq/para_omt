...
(declare-fun sigaction_oldact_714_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1261_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2377_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x21164) true))))
(assert
 (let ((?x40433 ((_ extract 127 120) sigaction_oldact_714_1216)))
 (let ((?x40450 (bvand ?x40433 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40450) true))))
(assert
 (let ((?x73398 ((_ extract 127 120) sigaction_oldact_1261_1216)))
 (let ((?x34736 (bvand ?x73398 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x34736) true))))
(assert
 (let ((?x137719 ((_ extract 127 120) sigaction_oldact_2377_1216)))
 (let ((?x102834 (bvand ?x137719 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x102834) true))))
...
(minimize sigaction_oldact_1261_1216)
(maximize args_1_8)
(minimize args_3_8)
...
(minimize sigaction_oldact_2377_1216)
(minimize args_0_8)
(minimize strlen_89_64)
(maximize sigaction_oldact_1261_1216)
(maximize sigaction_oldact_445_1216)
(minimize strlen_84_64)
(maximize args_4_8)
(maximize sigaction_oldact_714_1216)
(maximize sigaction_oldact_2377_1216)
(minimize strlen_74_64)
(maximize args_2_8)
(minimize sigaction_oldact_242_1216)
(minimize args_5_16)
(minimize sigaction_oldact_714_1216)
