...
(declare-fun sigaction_oldact_2257_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x71753))))
(assert
 (let ((?x129622 ((_ extract 127 120) sigaction_oldact_2257_1216)))
 (let ((?x129646 (bvand ?x129622 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x129646) true))))
...
(maximize args_1_8)
(maximize sigaction_oldact_2257_1216)
(maximize sigaction_oldact_207_1216)
(maximize sigaction_oldact_715_1216)
(minimize args_3_8)
(minimize args_5_16)
(minimize sigaction_oldact_2257_1216)
