...
(declare-fun sigaction_oldact_449_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_715_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1262_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2378_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x11245) true))))
(assert
 (let ((?x21573 ((_ extract 127 120) sigaction_oldact_449_1216)))
 (let ((?x21583 (bvand ?x21573 (_ bv4 8))))
 (= (_ bv0 8) ?x21583))))
(assert
 (let ((?x40480 ((_ extract 127 120) sigaction_oldact_715_1216)))
 (let ((?x40505 (bvand ?x40480 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40505) true))))
(assert
 (let ((?x73446 ((_ extract 127 120) sigaction_oldact_1262_1216)))
 (let ((?x73476 (bvand ?x73446 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x73476) true))))
(assert
 (let ((?x137800 ((_ extract 127 120) sigaction_oldact_2378_1216)))
 (let ((?x137811 (bvand ?x137800 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x137811) true))))
(minimize strlen_89_64)
(minimize sigaction_oldact_1262_1216)
(maximize args_3_8)
(maximize sigaction_oldact_310_1216)
(minimize sigaction_oldact_715_1216)
(minimize args_4_8)
