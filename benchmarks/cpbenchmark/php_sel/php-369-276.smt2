...
(declare-fun sigaction_oldact_1296_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2386_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x42610))))
(assert
 (let ((?x75327 ((_ extract 127 120) sigaction_oldact_1296_1216)))
 (let ((?x37017 (bvand ?x75327 (_ bv4 8))))
 (= (_ bv0 8) ?x37017))))
(assert
 (let ((?x138208 ((_ extract 127 120) sigaction_oldact_2386_1216)))
 (let ((?x138228 (bvand ?x138208 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x138228) true))))
(maximize sigaction_oldact_312_1216)
(minimize sigaction_oldact_2386_1216)
(maximize sigaction_oldact_207_1216)
(maximize args_0_8)
(minimize sigaction_oldact_1296_1216)
(minimize args_3_8)
(minimize args_5_16)
(maximize sigaction_oldact_2386_1216)
