...
(declare-fun sigaction_oldact_1014_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1752_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x32846))))
(assert
 (let ((?x57745 ((_ extract 127 120) sigaction_oldact_1014_1216)))
 (let ((?x12919 (bvand ?x57745 (_ bv4 8))))
 (= (_ bv0 8) ?x12919))))
(assert
 (let ((?x99230 ((_ extract 127 120) sigaction_oldact_1752_1216)))
 (let ((?x61366 (bvand ?x99230 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x61366) true))))
(maximize sigaction_oldact_622_1216)
(maximize sigaction_oldact_187_1216)
(maximize args_0_8)
(minimize sigaction_oldact_298_1216)
(minimize sigaction_oldact_1014_1216)
(minimize sigaction_oldact_411_1216)
(minimize sigaction_oldact_622_1216)
...
(maximize sigaction_oldact_1014_1216)
