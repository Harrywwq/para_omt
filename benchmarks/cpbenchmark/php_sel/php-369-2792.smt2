...
(declare-fun sigaction_oldact_622_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1104_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1941_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x17764))))
(assert
 (let ((?x32836 ((_ extract 127 120) sigaction_oldact_622_1216)))
 (let ((?x32846 (bvand ?x32836 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x32846) true))))
(assert
 (let ((?x20524 ((_ extract 127 120) sigaction_oldact_1104_1216)))
 (let ((?x63155 (bvand ?x20524 (_ bv4 8))))
 (= (_ bv0 8) ?x63155))))
(assert
 (let ((?x109994 ((_ extract 127 120) sigaction_oldact_1941_1216)))
 (let ((?x71443 (bvand ?x109994 (_ bv4 8))))
 (= (_ bv0 8) ?x71443))))
(maximize sigaction_oldact_411_1216)
(maximize sigaction_oldact_171_1216)
(minimize sigaction_oldact_1941_1216)
(maximize sigaction_oldact_1104_1216)
(minimize sigaction_oldact_203_1216)
(maximize sigaction_oldact_622_1216)
(maximize strlen_75_64)
(minimize strlen_75_64)
(maximize sigaction_oldact_237_1216)
(minimize sigaction_oldact_1104_1216)
(minimize sigaction_oldact_176_1216)
(maximize args_1_8)
(maximize sigaction_oldact_1941_1216)
(minimize args_0_8)
