...
(declare-fun sigaction_oldact_2096_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x67346))))
(assert
 (let ((?x119652 ((_ extract 127 120) sigaction_oldact_2096_1216)))
 (let ((?x82314 (bvand ?x119652 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x82314) true))))
