...
(declare-fun sigaction_oldact_1196_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2139_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x39168))))
(assert
 (let ((?x68725 ((_ extract 127 120) sigaction_oldact_1196_1216)))
 (let ((?x68745 (bvand ?x68725 (_ bv4 8))))
 (= (_ bv0 8) ?x68745))))
(assert
 (let ((?x121758 ((_ extract 127 120) sigaction_oldact_2139_1216)))
 (let ((?x83885 (bvand ?x121758 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x83885) true))))
(minimize sigaction_oldact_702_1216)
(maximize strlen_77_64)
(maximize sigaction_oldact_2139_1216)
