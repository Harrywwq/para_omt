...
(declare-fun sigaction_oldact_1300_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2396_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x42735))))
(assert
 (let ((?x75583 ((_ extract 127 120) sigaction_oldact_1300_1216)))
 (let ((?x75594 (bvand ?x75583 (_ bv4 8))))
 (= (_ bv0 8) ?x75594))))
(assert
 (let ((?x138791 ((_ extract 127 120) sigaction_oldact_2396_1216)))
 (let ((?x138816 (bvand ?x138791 (_ bv4 8))))
 (= (_ bv0 8) ?x138816))))
...
(minimize sigaction_oldact_2396_1216)
(maximize args_0_8)
(minimize sigaction_oldact_243_1216)
(minimize sigaction_oldact_457_1216)
(maximize sigaction_oldact_747_1216)
...
(maximize sigaction_oldact_1300_1216)
(maximize sigaction_oldact_188_1216)
(minimize args_0_8)
(maximize sigaction_oldact_2396_1216)
(maximize args_1_8)
