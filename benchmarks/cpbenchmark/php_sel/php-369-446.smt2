...
(declare-fun sigaction_oldact_1280_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2413_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41996))))
(assert
 (let ((?x74313 ((_ extract 127 120) sigaction_oldact_1280_1216)))
 (let ((?x74328 (bvand ?x74313 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74328) true))))
(assert
 (let ((?x139655 ((_ extract 127 120) sigaction_oldact_2413_1216)))
 (let ((?x139671 (bvand ?x139655 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x139671) true))))
(maximize sigaction_oldact_320_1216)
(maximize sigaction_oldact_245_1216)
(minimize strlen_77_64)
(maximize args_4_8)
(minimize sigaction_oldact_1280_1216)
(maximize sigaction_oldact_209_1216)
(minimize sigaction_oldact_2413_1216)
(maximize sigaction_oldact_1280_1216)
...
(maximize sigaction_oldact_736_1216)
(minimize args_0_8)
(minimize args_2_8)
(minimize args_3_8)
