...
(declare-fun sigaction_oldact_1310_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2489_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x76124 ((_ extract 127 120) sigaction_oldact_1310_1216)))
 (let ((?x76132 (bvand ?x76124 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x76132) true))))
(assert
 (let ((?x143907 ((_ extract 127 120) sigaction_oldact_2489_1216)))
 (let ((?x109048 (bvand ?x143907 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x109048) true))))
...
(maximize args_4_8)
(minimize sigaction_oldact_1310_1216)
(maximize sigaction_oldact_2489_1216)
...
(maximize args_1_8)
(maximize sigaction_oldact_1310_1216)
