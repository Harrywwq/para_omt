...
(declare-fun sigaction_oldact_1312_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2416_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43153))))
(assert
 (let ((?x76204 ((_ extract 127 120) sigaction_oldact_1312_1216)))
 (let ((?x76219 (bvand ?x76204 (_ bv4 8))))
 (= (_ bv0 8) ?x76219))))
(assert
 (let ((?x139777 ((_ extract 127 120) sigaction_oldact_2416_1216)))
 (let ((?x104697 (bvand ?x139777 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x104697) true))))
(maximize strlen_74_64)
(minimize args_3_8)
(minimize args_1_8)
(minimize sigaction_oldact_1312_1216)
(minimize sigaction_oldact_209_1216)
(maximize sigaction_oldact_470_1216)
(maximize sigaction_oldact_1312_1216)
(minimize args_2_8)
...
(minimize sigaction_oldact_753_1216)
(maximize args_2_8)
(minimize strlen_85_64)
(minimize sigaction_oldact_188_1216)
(minimize sigaction_oldact_2416_1216)
(maximize args_1_8)
(check-sat)
(get-objectives)
