...
(declare-fun sigaction_oldact_1756_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13012))))
(assert
 (let ((?x99480 ((_ extract 127 120) sigaction_oldact_1756_1216)))
 (let ((?x61659 (bvand ?x99480 (_ bv4 8))))
 (= (_ bv0 8) ?x61659))))
(maximize strlen_72_64)
(minimize args_1_8)
(maximize sigaction_oldact_1756_1216)
(maximize args_4_8)
(maximize args_7_16)
(maximize args_2_8)
(minimize args_5_16)
...
(minimize sigaction_oldact_1756_1216)
(maximize args_3_8)
