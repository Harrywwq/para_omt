...
(declare-fun sigaction_oldact_1951_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x13012) true))))
(assert
 (let ((?x110496 ((_ extract 127 120) sigaction_oldact_1951_1216)))
 (let ((?x110516 (bvand ?x110496 (_ bv4 8))))
 (= (_ bv0 8) ?x110516))))
(minimize args_4_8)
...
(maximize args_6_16)
(maximize sigaction_oldact_1016_1216)
(minimize sigaction_oldact_1951_1216)
(minimize args_2_8)
(minimize args_7_16)
...
(minimize sigaction_oldact_1016_1216)
(maximize sigaction_oldact_360_1216)
(minimize args_5_16)
(maximize args_7_16)
(maximize strlen_80_64)
(minimize args_3_8)
(minimize sigaction_oldact_571_1216)
...
(maximize sigaction_oldact_1951_1216)
(maximize args_0_8)
(check-sat)
(get-objectives)
