...
(declare-fun sigaction_oldact_1319_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2427_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43430))))
(assert
 (let ((?x76555 ((_ extract 127 120) sigaction_oldact_1319_1216)))
 (let ((?x76571 (bvand ?x76555 (_ bv4 8))))
 (= (_ bv0 8) ?x76571))))
(assert
 (let ((?x140312 ((_ extract 127 120) sigaction_oldact_2427_1216)))
 (let ((?x105119 (bvand ?x140312 (_ bv4 8))))
 (= (_ bv0 8) ?x105119))))
...
(maximize args_0_8)
(maximize sigaction_oldact_2427_1216)
(minimize args_3_8)
(maximize strlen_72_64)
(maximize sigaction_oldact_1319_1216)
(minimize sigaction_oldact_2427_1216)
