...
(declare-fun sigaction_oldact_387_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_572_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_918_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1757_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x9299))))
(assert
 (let ((?x15969 ((_ extract 127 120) sigaction_oldact_387_1216)))
 (let ((?x15989 (bvand ?x15969 (_ bv4 8))))
 (= (_ bv0 8) ?x15989))))
(assert
 (let ((?x29336 ((_ extract 127 120) sigaction_oldact_572_1216)))
 (let ((?x29361 (bvand ?x29336 (_ bv4 8))))
 (= (_ bv0 8) ?x29361))))
(assert
 (let ((?x52440 ((_ extract 127 120) sigaction_oldact_918_1216)))
 (let ((?x6572 (bvand ?x52440 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x6572) true))))
(assert
 (let ((?x99541 ((_ extract 127 120) sigaction_oldact_1757_1216)))
 (let ((?x99551 (bvand ?x99541 (_ bv4 8))))
 (= (_ bv0 8) ?x99551))))
(maximize strlen_92_64)
(maximize args_5_16)
(minimize sigaction_oldact_1757_1216)
(minimize args_1_8)
(minimize args_6_16)
(minimize args_7_16)
...
(maximize sigaction_oldact_572_1216)
(check-sat)
(get-objectives)
