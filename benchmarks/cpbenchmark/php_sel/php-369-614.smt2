...
(declare-fun sigaction_oldact_760_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1369_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2517_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22587) true))))
(assert
 (let ((?x43601 ((_ extract 127 120) sigaction_oldact_760_1216)))
 (let ((?x43626 (bvand ?x43601 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43626) true))))
(assert
 (let ((?x79278 ((_ extract 127 120) sigaction_oldact_1369_1216)))
 (let ((?x79289 (bvand ?x79278 (_ bv4 8))))
 (= (_ bv0 8) ?x79289))))
(assert
 (let ((?x145409 ((_ extract 127 120) sigaction_oldact_2517_1216)))
 (let ((?x110752 (bvand ?x145409 (_ bv4 8))))
 (= (_ bv0 8) ?x110752))))
(maximize strlen_81_64)
(minimize sigaction_oldact_179_1216)
(maximize args_1_8)
(minimize sigaction_oldact_1369_1216)
(minimize sigaction_oldact_323_1216)
(minimize strlen_81_64)
(minimize args_0_8)
(maximize sigaction_oldact_760_1216)
...
(minimize args_1_8)
(minimize sigaction_oldact_465_1216)
(minimize strlen_72_64)
(minimize args_2_8)
(maximize strlen_72_64)
(minimize args_3_8)
(maximize strlen_77_64)
(maximize sigaction_oldact_2517_1216)
(minimize sigaction_oldact_2517_1216)
(check-sat)
(get-objectives)
