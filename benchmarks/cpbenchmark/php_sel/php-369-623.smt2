...
(declare-fun sigaction_oldact_761_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1370_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2519_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x23260))))
(assert
 (let ((?x43648 ((_ extract 127 120) sigaction_oldact_761_1216)))
 (let ((?x43665 (bvand ?x43648 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43665) true))))
(assert
 (let ((?x41296 ((_ extract 127 120) sigaction_oldact_1370_1216)))
 (let ((?x79352 (bvand ?x41296 (_ bv4 8))))
 (= (_ bv0 8) ?x79352))))
(assert
 (let ((?x145513 ((_ extract 127 120) sigaction_oldact_2519_1216)))
 (let ((?x110860 (bvand ?x145513 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x110860) true))))
...
(minimize args_1_8)
(minimize sigaction_oldact_2519_1216)
(minimize sigaction_oldact_761_1216)
...
(maximize sigaction_oldact_761_1216)
(maximize args_0_8)
(minimize args_3_8)
(check-sat)
(get-objectives)
