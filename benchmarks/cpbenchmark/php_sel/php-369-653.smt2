...
(declare-fun sigaction_oldact_2646_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x41500) true))))
(assert
 (let ((?x116151 ((_ extract 127 120) sigaction_oldact_2646_1216)))
 (let ((?x116218 (bvand ?x116151 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x116218) true))))
...
(minimize sigaction_oldact_2646_1216)
