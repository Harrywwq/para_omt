...
(declare-fun sigaction_oldact_2851_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x83420) true))))
(assert
 (let ((?x162626 ((_ extract 127 120) sigaction_oldact_2851_1216)))
 (let ((?x125034 (bvand ?x162626 (_ bv4 8))))
 (= (_ bv0 8) ?x125034))))
...
(minimize sigaction_oldact_2851_1216)
(maximize strlen_81_64)
(minimize args_3_8)
(maximize args_0_8)
(minimize sigaction_oldact_179_1216)
(minimize strlen_74_64)
(maximize sigaction_oldact_328_1216)
(maximize sigaction_oldact_2851_1216)
(maximize args_3_8)
