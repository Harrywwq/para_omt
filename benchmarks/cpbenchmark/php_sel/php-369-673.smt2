...
(declare-fun sigaction_oldact_763_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1328_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2439_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x22644) true))))
(assert
 (let ((?x43767 ((_ extract 127 120) sigaction_oldact_763_1216)))
 (let ((?x43792 (bvand ?x43767 (_ bv4 8))))
 (= (_ bv0 8) ?x43792))))
(assert
 (let ((?x76977 ((_ extract 127 120) sigaction_oldact_1328_1216)))
 (let ((?x38724 (bvand ?x76977 (_ bv4 8))))
 (= (_ bv0 8) ?x38724))))
(assert
 (let ((?x140857 ((_ extract 127 120) sigaction_oldact_2439_1216)))
 (let ((?x140877 (bvand ?x140857 (_ bv4 8))))
 (= (_ bv0 8) ?x140877))))
...
(minimize sigaction_oldact_763_1216)
