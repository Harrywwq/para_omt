...
(declare-fun sigaction_oldact_477_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_765_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1330_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2531_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x12372))))
(assert
 (let ((?x23420 ((_ extract 127 120) sigaction_oldact_477_1216)))
 (let ((?x23445 (bvand ?x23420 (_ bv4 8))))
 (= (_ bv0 8) ?x23445))))
(assert
 (let ((?x43861 ((_ extract 127 120) sigaction_oldact_765_1216)))
 (let ((?x43886 (bvand ?x43861 (_ bv4 8))))
 (= (_ bv0 8) ?x43886))))
(assert
 (let ((?x77062 ((_ extract 127 120) sigaction_oldact_1330_1216)))
 (let ((?x38767 (bvand ?x77062 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x38767) true))))
(assert
 (let ((?x146102 ((_ extract 127 120) sigaction_oldact_2531_1216)))
 (let ((?x146127 (bvand ?x146102 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x146127) true))))
...
(maximize sigaction_oldact_2531_1216)
(minimize sigaction_oldact_477_1216)
...
(maximize sigaction_oldact_477_1216)
(minimize strlen_72_64)
(maximize args_1_8)
(minimize sigaction_oldact_1330_1216)
(minimize sigaction_oldact_191_1216)
(maximize args_3_8)
(minimize sigaction_oldact_2531_1216)
(maximize strlen_77_64)
(maximize sigaction_oldact_179_1216)
(maximize sigaction_oldact_1330_1216)
(check-sat)
(get-objectives)
