...
(declare-fun sigaction_oldact_791_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1452_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2855_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x23445) true))))
(assert
 (let ((?x45631 ((_ extract 127 120) sigaction_oldact_791_1216)))
 (let ((?x291 (bvand ?x45631 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x291) true))))
(assert
 (let ((?x83628 ((_ extract 127 120) sigaction_oldact_1452_1216)))
 (let ((?x46435 (bvand ?x83628 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46435) true))))
(assert
 (let ((?x162917 ((_ extract 127 120) sigaction_oldact_2855_1216)))
 (let ((?x162944 (bvand ?x162917 (_ bv4 8))))
 (= (_ bv0 8) ?x162944))))
(maximize sigaction_oldact_191_1216)
(maximize strlen_81_64)
(minimize strlen_81_64)
(minimize sigaction_oldact_2855_1216)
(minimize sigaction_oldact_477_1216)
(minimize args_1_8)
(maximize sigaction_oldact_211_1216)
(minimize sigaction_oldact_179_1216)
(maximize sigaction_oldact_791_1216)
(maximize args_1_8)
...
(maximize sigaction_oldact_1452_1216)
(minimize args_0_8)
(minimize args_2_8)
