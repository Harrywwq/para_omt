...
(declare-fun sigaction_oldact_1383_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2662_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x45814))))
(assert
 (let ((?x79974 ((_ extract 127 120) sigaction_oldact_1383_1216)))
 (let ((?x79985 (bvand ?x79974 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x79985) true))))
(assert
 (let ((?x153061 ((_ extract 127 120) sigaction_oldact_2662_1216)))
 (let ((?x153093 (bvand ?x153061 (_ bv4 8))))
 (= (_ bv0 8) ?x153093))))
(minimize strlen_81_64)
(minimize sigaction_oldact_1383_1216)
(maximize args_2_8)
...
(minimize args_1_8)
(minimize sigaction_oldact_2662_1216)
...
(maximize sigaction_oldact_2662_1216)
(minimize args_3_8)
(maximize sigaction_oldact_1383_1216)
