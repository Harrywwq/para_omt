...
(declare-fun sigaction_oldact_1019_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1760_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x33029))))
(assert
 (let ((?x58000 ((_ extract 127 120) sigaction_oldact_1019_1216)))
 (let ((?x58005 (bvand ?x58000 (_ bv4 8))))
 (= (_ bv0 8) ?x58005))))
(assert
 (let ((?x99664 ((_ extract 127 120) sigaction_oldact_1760_1216)))
 (let ((?x61774 (bvand ?x99664 (_ bv4 8))))
 (= (_ bv0 8) ?x61774))))
...
(minimize sigaction_oldact_1019_1216)
(maximize strlen_88_64)
(minimize args_2_8)
(maximize sigaction_oldact_1760_1216)
(minimize sigaction_oldact_1760_1216)
