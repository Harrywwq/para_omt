...
(declare-fun sigaction_oldact_495_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_841_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1459_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2667_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13024))))
(assert
 (let ((?x24569 ((_ extract 127 120) sigaction_oldact_495_1216)))
 (let ((?x24594 (bvand ?x24569 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x24594) true))))
(assert
 (let ((?x2528 ((_ extract 127 120) sigaction_oldact_841_1216)))
 (let ((?x48596 (bvand ?x2528 (_ bv4 8))))
 (= (_ bv0 8) ?x48596))))
(assert
 (let ((?x84002 ((_ extract 127 120) sigaction_oldact_1459_1216)))
 (let ((?x46874 (bvand ?x84002 (_ bv4 8))))
 (= (_ bv0 8) ?x46874))))
(assert
 (let ((?x153295 ((_ extract 127 120) sigaction_oldact_2667_1216)))
 (let ((?x153311 (bvand ?x153295 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x153311) true))))
(maximize strlen_81_64)
(minimize args_3_8)
(maximize sigaction_oldact_841_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_191_1216)
(maximize args_3_8)
(minimize sigaction_oldact_841_1216)
(maximize sigaction_oldact_340_1216)
(minimize args_2_8)
(maximize sigaction_oldact_211_1216)
(minimize sigaction_oldact_1459_1216)
(minimize strlen_74_64)
(maximize args_2_8)
(minimize sigaction_oldact_340_1216)
(maximize sigaction_oldact_252_1216)
(maximize strlen_72_64)
(maximize sigaction_oldact_2667_1216)
(maximize args_0_8)
(minimize args_0_8)
(maximize args_1_8)
(minimize args_1_8)
(maximize sigaction_oldact_1459_1216)
(minimize sigaction_oldact_179_1216)
(minimize sigaction_oldact_495_1216)
(minimize sigaction_oldact_252_1216)
(minimize strlen_77_64)
(maximize sigaction_oldact_495_1216)
...
(minimize sigaction_oldact_2667_1216)
