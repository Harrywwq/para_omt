...
(declare-fun sigaction_oldact_919_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1584_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2868_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x26404) true))))
(assert
 (let ((?x6788 ((_ extract 127 120) sigaction_oldact_919_1216)))
 (let ((?x52599 (bvand ?x6788 (_ bv4 8))))
 (= (_ bv0 8) ?x52599))))
(assert
 (let ((?x90459 ((_ extract 127 120) sigaction_oldact_1584_1216)))
 (let ((?x90475 (bvand ?x90459 (_ bv4 8))))
 (= (_ bv0 8) ?x90475))))
(assert
 (let ((?x163671 ((_ extract 127 120) sigaction_oldact_2868_1216)))
 (let ((?x126051 (bvand ?x163671 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x126051) true))))
(maximize sigaction_oldact_1584_1216)
(minimize args_1_8)
...
(maximize sigaction_oldact_919_1216)
...
(maximize args_1_8)
(minimize sigaction_oldact_1584_1216)
(maximize sigaction_oldact_191_1216)
(minimize sigaction_oldact_2868_1216)
(check-sat)
(get-objectives)
