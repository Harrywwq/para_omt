...
(declare-fun sigaction_oldact_1184_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2233_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x36381) true))))
(assert
 (let ((?x68138 ((_ extract 127 120) sigaction_oldact_1184_1216)))
 (let ((?x68165 (bvand ?x68138 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x68165) true))))
(assert
 (let ((?x128365 ((_ extract 127 120) sigaction_oldact_2233_1216)))
 (let ((?x92086 (bvand ?x128365 (_ bv4 8))))
 (= (_ bv0 8) ?x92086))))
(maximize args_5_16)
(maximize strlen_88_64)
(minimize args_4_8)
(maximize args_7_16)
(minimize sigaction_oldact_2233_1216)
(minimize strlen_80_64)
(maximize strlen_84_64)
(maximize args_4_8)
(maximize sigaction_oldact_1184_1216)
(maximize args_0_8)
(check-sat)
(get-objectives)
