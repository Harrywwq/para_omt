...
(declare-fun sigaction_oldact_1474_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2696_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x836) true))))
(assert
 (let ((?x84872 ((_ extract 127 120) sigaction_oldact_1474_1216)))
 (let ((?x48151 (bvand ?x84872 (_ bv4 8))))
 (= (_ bv0 8) ?x48151))))
(assert
 (let ((?x154818 ((_ extract 127 120) sigaction_oldact_2696_1216)))
 (let ((?x118690 (bvand ?x154818 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x118690) true))))
(maximize sigaction_oldact_214_1216)
(minimize args_3_8)
(minimize sigaction_oldact_214_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_2696_1216)
(minimize sigaction_oldact_804_1216)
(maximize args_3_8)
(minimize args_1_8)
