...
(declare-fun sigaction_oldact_500_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_848_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1475_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2889_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13203))))
(assert
 (let ((?x24890 ((_ extract 127 120) sigaction_oldact_500_1216)))
 (let ((?x24915 (bvand ?x24890 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x24915) true))))
(assert
 (let ((?x49013 ((_ extract 127 120) sigaction_oldact_848_1216)))
 (let ((?x49037 (bvand ?x49013 (_ bv4 8))))
 (= (_ bv0 8) ?x49037))))
(assert
 (let ((?x84916 ((_ extract 127 120) sigaction_oldact_1475_1216)))
 (let ((?x84936 (bvand ?x84916 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x84936) true))))
(assert
 (let ((?x165024 ((_ extract 127 120) sigaction_oldact_2889_1216)))
 (let ((?x127445 (bvand ?x165024 (_ bv4 8))))
 (= (_ bv0 8) ?x127445))))
(maximize sigaction_oldact_2889_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_179_1216)
(maximize sigaction_oldact_500_1216)
(maximize sigaction_oldact_342_1216)
(maximize sigaction_oldact_1475_1216)
...
(minimize args_0_8)
(maximize sigaction_oldact_848_1216)
(maximize sigaction_oldact_214_1216)
(minimize sigaction_oldact_848_1216)
(minimize sigaction_oldact_2889_1216)
...
(maximize args_0_8)
(minimize args_3_8)
(minimize sigaction_oldact_500_1216)
(check-sat)
(get-objectives)
