...
(declare-fun sigaction_oldact_528_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_922_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1596_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2899_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x13255) true))))
(assert
 (let ((?x26689 ((_ extract 127 120) sigaction_oldact_528_1216)))
 (let ((?x26714 (bvand ?x26689 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x26714) true))))
(assert
 (let ((?x52875 ((_ extract 127 120) sigaction_oldact_922_1216)))
 (let ((?x7324 (bvand ?x52875 (_ bv4 8))))
 (= (_ bv0 8) ?x7324))))
(assert
 (let ((?x91248 ((_ extract 127 120) sigaction_oldact_1596_1216)))
 (let ((?x91268 (bvand ?x91248 (_ bv4 8))))
 (= (_ bv0 8) ?x91268))))
(assert
 (let ((?x165517 ((_ extract 127 120) sigaction_oldact_2899_1216)))
 (let ((?x127883 (bvand ?x165517 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x127883) true))))
(maximize args_0_8)
(minimize sigaction_oldact_214_1216)
(maximize sigaction_oldact_343_1216)
...
(maximize sigaction_oldact_2899_1216)
(minimize sigaction_oldact_262_1216)
(minimize sigaction_oldact_528_1216)
(maximize sigaction_oldact_192_1216)
(minimize args_1_8)
(minimize args_3_8)
(minimize strlen_81_64)
(maximize sigaction_oldact_214_1216)
(maximize sigaction_oldact_922_1216)
(maximize strlen_81_64)
(maximize sigaction_oldact_528_1216)
(maximize args_2_8)
(minimize sigaction_oldact_2899_1216)
(maximize sigaction_oldact_1596_1216)
(minimize sigaction_oldact_922_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_343_1216)
(check-sat)
(get-objectives)
