...
(declare-fun sigaction_oldact_924_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1599_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2903_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x29514))))
(assert
 (let ((?x52970 ((_ extract 127 120) sigaction_oldact_924_1216)))
 (let ((?x7496 (bvand ?x52970 (_ bv4 8))))
 (= (_ bv0 8) ?x7496))))
(assert
 (let ((?x91390 ((_ extract 127 120) sigaction_oldact_1599_1216)))
 (let ((?x54246 (bvand ?x91390 (_ bv4 8))))
 (= (_ bv0 8) ?x54246))))
(assert
 (let ((?x165701 ((_ extract 127 120) sigaction_oldact_2903_1216)))
 (let ((?x165720 (bvand ?x165701 (_ bv4 8))))
 (= (_ bv0 8) ?x165720))))
...
(minimize args_2_8)
(maximize args_0_8)
(maximize sigaction_oldact_1599_1216)
(maximize sigaction_oldact_192_1216)
(maximize sigaction_oldact_2903_1216)
(minimize args_3_8)
(minimize sigaction_oldact_924_1216)
(maximize sigaction_oldact_262_1216)
(maximize sigaction_oldact_361_1216)
(minimize sigaction_oldact_2903_1216)
