...
(declare-fun sigaction_oldact_2578_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43480))))
(assert
 (let ((?x148256 ((_ extract 127 120) sigaction_oldact_2578_1216)))
 (let ((?x74182 (bvand ?x148256 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74182) true))))
