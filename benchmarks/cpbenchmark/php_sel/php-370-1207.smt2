...
(declare-fun sigaction_oldact_1493_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2729_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x49559))))
(assert
 (let ((?x85882 ((_ extract 127 120) sigaction_oldact_1493_1216)))
 (let ((?x85902 (bvand ?x85882 (_ bv4 8))))
 (= (_ bv0 8) ?x85902))))
(assert
 (let ((?x156524 ((_ extract 127 120) sigaction_oldact_2729_1216)))
 (let ((?x156544 (bvand ?x156524 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x156544) true))))
(minimize strlen_78_64)
(minimize sigaction_oldact_256_1216)
(maximize sigaction_oldact_1493_1216)
(maximize args_2_8)
(maximize sigaction_oldact_505_1216)
(maximize sigaction_oldact_174_1216)
(maximize sigaction_oldact_2729_1216)
(maximize args_1_8)
(minimize sigaction_oldact_505_1216)
(maximize sigaction_oldact_857_1216)
