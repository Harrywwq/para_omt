...
(declare-fun sigaction_oldact_857_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1605_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2922_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x25231) true))))
(assert
 (let ((?x49543 ((_ extract 127 120) sigaction_oldact_857_1216)))
 (let ((?x49559 (bvand ?x49543 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x49559) true))))
(assert
 (let ((?x91865 ((_ extract 127 120) sigaction_oldact_1605_1216)))
 (let ((?x91873 (bvand ?x91865 (_ bv4 8))))
 (= (_ bv0 8) ?x91873))))
(assert
 (let ((?x166933 ((_ extract 127 120) sigaction_oldact_2922_1216)))
 (let ((?x166944 (bvand ?x166933 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x166944) true))))
...
(minimize sigaction_oldact_857_1216)
(maximize args_0_8)
...
(minimize sigaction_oldact_1605_1216)
