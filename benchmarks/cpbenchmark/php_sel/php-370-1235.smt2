...
(declare-fun sigaction_oldact_531_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_859_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1607_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2927_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x13424) true))))
(assert
 (let ((?x26955 ((_ extract 127 120) sigaction_oldact_531_1216)))
 (let ((?x26965 (bvand ?x26955 (_ bv4 8))))
 (= (_ bv0 8) ?x26965))))
(assert
 (let ((?x49643 ((_ extract 127 120) sigaction_oldact_859_1216)))
 (let ((?x49662 (bvand ?x49643 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x49662) true))))
(assert
 (let ((?x91996 ((_ extract 127 120) sigaction_oldact_1607_1216)))
 (let ((?x92021 (bvand ?x91996 (_ bv4 8))))
 (= (_ bv0 8) ?x92021))))
(assert
 (let ((?x167210 ((_ extract 127 120) sigaction_oldact_2927_1216)))
 (let ((?x129872 (bvand ?x167210 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x129872) true))))
...
(minimize sigaction_oldact_2927_1216)
(maximize sigaction_oldact_256_1216)
(minimize args_0_8)
(maximize sigaction_oldact_174_1216)
(maximize strlen_74_64)
(maximize sigaction_oldact_531_1216)
(maximize sigaction_oldact_859_1216)
...
(maximize sigaction_oldact_2927_1216)
