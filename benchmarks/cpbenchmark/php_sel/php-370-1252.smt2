...
(declare-fun sigaction_oldact_815_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1497_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2929_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x25339))))
(assert
 (let ((?x46983 ((_ extract 127 120) sigaction_oldact_815_1216)))
 (let ((?x47007 (bvand ?x46983 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x47007) true))))
(assert
 (let ((?x86082 ((_ extract 127 120) sigaction_oldact_1497_1216)))
 (let ((?x86097 (bvand ?x86082 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86097) true))))
(assert
 (let ((?x167330 ((_ extract 127 120) sigaction_oldact_2929_1216)))
 (let ((?x167335 (bvand ?x167330 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x167335) true))))
(maximize sigaction_oldact_815_1216)
...
(maximize sigaction_oldact_1497_1216)
(maximize strlen_78_64)
(maximize strlen_74_64)
(minimize strlen_72_64)
(minimize args_2_8)
(maximize sigaction_oldact_2929_1216)
