...
(declare-fun sigaction_oldact_3204_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x92176) true))))
(assert
 (let ((?x181889 ((_ extract 127 120) sigaction_oldact_3204_1216)))
 (let ((?x181914 (bvand ?x181889 (_ bv4 8))))
 (= (_ bv0 8) ?x181914))))
(maximize sigaction_oldact_346_1216)
(minimize args_2_8)
(minimize sigaction_oldact_215_1216)
(minimize sigaction_oldact_3204_1216)
