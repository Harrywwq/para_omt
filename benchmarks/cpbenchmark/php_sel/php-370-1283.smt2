...
(declare-fun sigaction_oldact_3207_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x182068 ((_ extract 127 120) sigaction_oldact_3207_1216)))
 (let ((?x142924 (bvand ?x182068 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x142924) true))))
(maximize sigaction_oldact_263_1216)
(maximize sigaction_oldact_3207_1216)
