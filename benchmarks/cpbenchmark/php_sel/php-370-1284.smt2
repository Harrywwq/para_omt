...
(declare-fun sigaction_oldact_533_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_928_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1613_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2937_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x14460))))
(assert
 (let ((?x27074 ((_ extract 127 120) sigaction_oldact_533_1216)))
 (let ((?x27091 (bvand ?x27074 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x27091) true))))
(assert
 (let ((?x53304 ((_ extract 127 120) sigaction_oldact_928_1216)))
 (let ((?x8016 (bvand ?x53304 (_ bv4 8))))
 (= (_ bv0 8) ?x8016))))
(assert
 (let ((?x92313 ((_ extract 127 120) sigaction_oldact_1613_1216)))
 (let ((?x55317 (bvand ?x92313 (_ bv4 8))))
 (= (_ bv0 8) ?x55317))))
(assert
 (let ((?x167703 ((_ extract 127 120) sigaction_oldact_2937_1216)))
 (let ((?x130233 (bvand ?x167703 (_ bv4 8))))
 (= (_ bv0 8) ?x130233))))
(minimize sigaction_oldact_180_1216)
(minimize sigaction_oldact_533_1216)
(minimize strlen_78_64)
(maximize args_2_8)
(maximize sigaction_oldact_928_1216)
(maximize strlen_78_64)
(minimize strlen_74_64)
(maximize sigaction_oldact_362_1216)
(minimize args_2_8)
(minimize sigaction_oldact_362_1216)
...
(maximize sigaction_oldact_2937_1216)
(minimize sigaction_oldact_193_1216)
(minimize sigaction_oldact_928_1216)
(maximize sigaction_oldact_180_1216)
(minimize sigaction_oldact_1613_1216)
(minimize sigaction_oldact_2937_1216)
(minimize args_1_8)
(maximize sigaction_oldact_263_1216)
(maximize sigaction_oldact_533_1216)
