...
(declare-fun sigaction_oldact_929_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1614_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2938_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x29665))))
(assert
 (let ((?x53348 ((_ extract 127 120) sigaction_oldact_929_1216)))
 (let ((?x53372 (bvand ?x53348 (_ bv4 8))))
 (= (_ bv0 8) ?x53372))))
(assert
 (let ((?x92351 ((_ extract 127 120) sigaction_oldact_1614_1216)))
 (let ((?x92367 (bvand ?x92351 (_ bv4 8))))
 (= (_ bv0 8) ?x92367))))
(assert
 (let ((?x167741 ((_ extract 127 120) sigaction_oldact_2938_1216)))
 (let ((?x167751 (bvand ?x167741 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x167751) true))))
