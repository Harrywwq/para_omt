...
(declare-fun sigaction_oldact_511_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_820_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1511_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2959_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13618))))
(assert
 (let ((?x25532 ((_ extract 127 120) sigaction_oldact_511_1216)))
 (let ((?x25549 (bvand ?x25532 (_ bv4 8))))
 (= (_ bv0 8) ?x25549))))
(assert
 (let ((?x47237 ((_ extract 127 120) sigaction_oldact_820_1216)))
 (let ((?x1817 (bvand ?x47237 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x1817) true))))
(assert
 (let ((?x86751 ((_ extract 127 120) sigaction_oldact_1511_1216)))
 (let ((?x86775 (bvand ?x86751 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x86775) true))))
(assert
 (let ((?x168870 ((_ extract 127 120) sigaction_oldact_2959_1216)))
 (let ((?x168880 (bvand ?x168870 (_ bv4 8))))
 (= (_ bv0 8) ?x168880))))
(maximize sigaction_oldact_2959_1216)
(minimize sigaction_oldact_349_1216)
(minimize sigaction_oldact_174_1216)
(minimize sigaction_oldact_511_1216)
(maximize sigaction_oldact_194_1216)
(maximize sigaction_oldact_820_1216)
(maximize sigaction_oldact_1511_1216)
(maximize sigaction_oldact_180_1216)
(maximize strlen_72_64)
(minimize args_0_8)
(maximize args_0_8)
(minimize sigaction_oldact_219_1216)
(minimize sigaction_oldact_1511_1216)
(maximize sigaction_oldact_174_1216)
(maximize args_1_8)
(maximize sigaction_oldact_511_1216)
