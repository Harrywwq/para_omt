...
(declare-fun sigaction_oldact_538_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_935_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1781_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3234_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x14644))))
(assert
 (let ((?x27409 ((_ extract 127 120) sigaction_oldact_538_1216)))
 (let ((?x27434 (bvand ?x27409 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x27434) true))))
(assert
 (let ((?x53745 ((_ extract 127 120) sigaction_oldact_935_1216)))
 (let ((?x8610 (bvand ?x53745 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x8610) true))))
(assert
 (let ((?x101419 ((_ extract 127 120) sigaction_oldact_1781_1216)))
 (let ((?x101433 (bvand ?x101419 (_ bv4 8))))
 (= (_ bv0 8) ?x101433))))
(assert
 (let ((?x183709 ((_ extract 127 120) sigaction_oldact_3234_1216)))
 (let ((?x144723 (bvand ?x183709 (_ bv4 8))))
 (= (_ bv0 8) ?x144723))))
(maximize sigaction_oldact_3234_1216)
...
(minimize args_2_8)
(minimize sigaction_oldact_3234_1216)
(maximize args_2_8)
(maximize sigaction_oldact_1781_1216)
(check-sat)
(get-objectives)
