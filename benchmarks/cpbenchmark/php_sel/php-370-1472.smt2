...
(declare-fun sigaction_oldact_936_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1630_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3235_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x29894))))
(assert
 (let ((?x53789 ((_ extract 127 120) sigaction_oldact_936_1216)))
 (let ((?x8657 (bvand ?x53789 (_ bv4 8))))
 (= (_ bv0 8) ?x8657))))
(assert
 (let ((?x93250 ((_ extract 127 120) sigaction_oldact_1630_1216)))
 (let ((?x56334 (bvand ?x93250 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x56334) true))))
(assert
 (let ((?x144743 ((_ extract 127 120) sigaction_oldact_3235_1216)))
 (let ((?x183783 (bvand ?x144743 (_ bv4 8))))
 (= (_ bv0 8) ?x183783))))
...
(maximize sigaction_oldact_1630_1216)
(maximize sigaction_oldact_174_1216)
(minimize args_0_8)
(minimize strlen_72_64)
(minimize sigaction_oldact_936_1216)
(maximize sigaction_oldact_576_1216)
(minimize sigaction_oldact_3235_1216)
(maximize sigaction_oldact_936_1216)
(minimize sigaction_oldact_194_1216)
(maximize sigaction_oldact_219_1216)
(maximize args_1_8)
(maximize sigaction_oldact_3235_1216)
(minimize strlen_78_64)
(minimize sigaction_oldact_1630_1216)
