...
(declare-fun sigaction_oldact_365_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_539_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_937_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1784_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3240_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x8437))))
(assert
 (let ((?x14666 ((_ extract 127 120) sigaction_oldact_365_1216)))
 (let ((?x14686 (bvand ?x14666 (_ bv4 8))))
 (= (_ bv0 8) ?x14686))))
(assert
 (let ((?x27456 ((_ extract 127 120) sigaction_oldact_539_1216)))
 (let ((?x27466 (bvand ?x27456 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x27466) true))))
(assert
 (let ((?x53843 ((_ extract 127 120) sigaction_oldact_937_1216)))
 (let ((?x53872 (bvand ?x53843 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x53872) true))))
(assert
 (let ((?x101584 ((_ extract 127 120) sigaction_oldact_1784_1216)))
 (let ((?x101616 (bvand ?x101584 (_ bv4 8))))
 (= (_ bv0 8) ?x101616))))
(assert
 (let ((?x184017 ((_ extract 127 120) sigaction_oldact_3240_1216)))
 (let ((?x184033 (bvand ?x184017 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x184033) true))))
(minimize args_2_8)
(minimize args_0_8)
(minimize args_1_8)
(maximize args_1_8)
(minimize sigaction_oldact_937_1216)
...
(maximize sigaction_oldact_539_1216)
(maximize sigaction_oldact_365_1216)
(minimize sigaction_oldact_365_1216)
(maximize sigaction_oldact_1784_1216)
(minimize sigaction_oldact_274_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_174_1216)
(maximize sigaction_oldact_3240_1216)
(check-sat)
(get-objectives)
