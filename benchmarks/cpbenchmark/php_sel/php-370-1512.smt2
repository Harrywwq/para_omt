...
(declare-fun sigaction_oldact_939_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1634_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3244_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x30003))))
(assert
 (let ((?x53928 ((_ extract 127 120) sigaction_oldact_939_1216)))
 (let ((?x53952 (bvand ?x53928 (_ bv4 8))))
 (= (_ bv0 8) ?x53952))))
(assert
 (let ((?x93434 ((_ extract 127 120) sigaction_oldact_1634_1216)))
 (let ((?x56518 (bvand ?x93434 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x56518) true))))
(assert
 (let ((?x184211 ((_ extract 127 120) sigaction_oldact_3244_1216)))
 (let ((?x184225 (bvand ?x184211 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x184225) true))))
