...
(declare-fun sigaction_oldact_1969_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x58675) true))))
(assert
 (let ((?x111757 ((_ extract 127 120) sigaction_oldact_1969_1216)))
 (let ((?x111777 (bvand ?x111757 (_ bv4 8))))
 (= (_ bv0 8) ?x111777))))
(minimize args_0_8)
...
(minimize sigaction_oldact_1969_1216)
