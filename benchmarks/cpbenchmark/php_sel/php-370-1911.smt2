...
(declare-fun sigaction_oldact_588_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_959_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1669_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3029_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x16504))))
(assert
 (let ((?x30713 ((_ extract 127 120) sigaction_oldact_588_1216)))
 (let ((?x30723 (bvand ?x30713 (_ bv4 8))))
 (= (_ bv0 8) ?x30723))))
(assert
 (let ((?x55008 ((_ extract 127 120) sigaction_oldact_959_1216)))
 (let ((?x55024 (bvand ?x55008 (_ bv4 8))))
 (= (_ bv0 8) ?x55024))))
(assert
 (let ((?x95240 ((_ extract 127 120) sigaction_oldact_1669_1216)))
 (let ((?x95250 (bvand ?x95240 (_ bv4 8))))
 (= (_ bv0 8) ?x95250))))
(assert
 (let ((?x172243 ((_ extract 127 120) sigaction_oldact_3029_1216)))
 (let ((?x133402 (bvand ?x172243 (_ bv4 8))))
 (= (_ bv0 8) ?x133402))))
(minimize args_2_8)
(minimize args_0_8)
(maximize args_2_8)
...
(maximize sigaction_oldact_3029_1216)
(maximize args_1_8)
(maximize strlen_74_64)
(maximize sigaction_oldact_174_1216)
(minimize sigaction_oldact_959_1216)
(minimize strlen_78_64)
(maximize sigaction_oldact_289_1216)
(minimize args_1_8)
(maximize strlen_78_64)
(minimize sigaction_oldact_588_1216)
(maximize sigaction_oldact_959_1216)
(maximize sigaction_oldact_1669_1216)
(maximize sigaction_oldact_197_1216)
(minimize sigaction_oldact_3029_1216)
(maximize sigaction_oldact_588_1216)
(check-sat)
(get-objectives)
