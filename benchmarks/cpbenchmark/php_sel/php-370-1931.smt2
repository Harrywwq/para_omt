...
(declare-fun sigaction_oldact_1125_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2144_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x33711) true))))
(assert
 (let ((?x64441 ((_ extract 127 120) sigaction_oldact_1125_1216)))
 (let ((?x22030 (bvand ?x64441 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x22030) true))))
(assert
 (let ((?x122395 ((_ extract 127 120) sigaction_oldact_2144_1216)))
 (let ((?x122415 (bvand ?x122395 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x122415) true))))
(maximize args_0_8)
(minimize sigaction_oldact_631_1216)
(maximize sigaction_oldact_631_1216)
(maximize sigaction_oldact_1125_1216)
(minimize args_2_8)
(maximize sigaction_oldact_2144_1216)
(minimize sigaction_oldact_226_1216)
(minimize args_1_8)
(maximize sigaction_oldact_183_1216)
(minimize sigaction_oldact_1125_1216)
...
(minimize sigaction_oldact_2144_1216)
(minimize args_0_8)
