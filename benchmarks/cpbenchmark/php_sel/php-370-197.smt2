...
(declare-fun sigaction_oldact_2313_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x73158))))
(assert
 (let ((?x133893 ((_ extract 127 120) sigaction_oldact_2313_1216)))
 (let ((?x133909 (bvand ?x133893 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x133909) true))))
