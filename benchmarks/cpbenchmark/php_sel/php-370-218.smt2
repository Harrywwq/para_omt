...
(declare-fun sigaction_oldact_2317_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x71619) true))))
(assert
 (let ((?x134121 ((_ extract 127 120) sigaction_oldact_2317_1216)))
 (let ((?x134126 (bvand ?x134121 (_ bv4 8))))
 (= (_ bv0 8) ?x134126))))
