...
(declare-fun sigaction_oldact_1553_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3066_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x5813))))
(assert
 (let ((?x88736 ((_ extract 127 120) sigaction_oldact_1553_1216)))
 (let ((?x88756 (bvand ?x88736 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x88756) true))))
(assert
 (let ((?x135235 ((_ extract 127 120) sigaction_oldact_3066_1216)))
 (let ((?x135274 (bvand ?x135235 (_ bv4 8))))
 (= (_ bv0 8) ?x135274))))
...
(minimize sigaction_oldact_521_1216)
(minimize args_0_8)
(maximize args_1_8)
(minimize sigaction_oldact_3066_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_1553_1216)
(maximize sigaction_oldact_175_1216)
(maximize sigaction_oldact_898_1216)
(minimize strlen_75_64)
(maximize sigaction_oldact_521_1216)
(maximize sigaction_oldact_3066_1216)
...
(maximize sigaction_oldact_1553_1216)
(check-sat)
(get-objectives)
