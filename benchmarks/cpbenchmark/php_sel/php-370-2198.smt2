...
(declare-fun sigaction_oldact_556_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_899_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1691_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3354_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x14063) true))))
(assert
 (let ((?x28505 ((_ extract 127 120) sigaction_oldact_556_1216)))
 (let ((?x28525 (bvand ?x28505 (_ bv4 8))))
 (= (_ bv0 8) ?x28525))))
(assert
 (let ((?x51602 ((_ extract 127 120) sigaction_oldact_899_1216)))
 (let ((?x51613 (bvand ?x51602 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x51613) true))))
(assert
 (let ((?x96439 ((_ extract 127 120) sigaction_oldact_1691_1216)))
 (let ((?x15131 (bvand ?x96439 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x15131) true))))
(assert
 (let ((?x190401 ((_ extract 127 120) sigaction_oldact_3354_1216)))
 (let ((?x190426 (bvand ?x190401 (_ bv4 8))))
 (= (_ bv0 8) ?x190426))))
(minimize sigaction_oldact_175_1216)
(maximize sigaction_oldact_3354_1216)
(minimize sigaction_oldact_899_1216)
(maximize args_0_8)
(minimize sigaction_oldact_223_1216)
(minimize sigaction_oldact_3354_1216)
(maximize sigaction_oldact_223_1216)
(maximize sigaction_oldact_556_1216)
(minimize sigaction_oldact_198_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_357_1216)
(minimize args_1_8)
(minimize sigaction_oldact_1691_1216)
(minimize args_0_8)
(check-sat)
(get-objectives)
