...
(declare-fun sigaction_oldact_375_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_557_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_900_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1693_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3072_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x8190) true))))
(assert
 (let ((?x15336 ((_ extract 127 120) sigaction_oldact_375_1216)))
 (let ((?x15361 (bvand ?x15336 (_ bv4 8))))
 (= (_ bv0 8) ?x15361))))
(assert
 (let ((?x28552 ((_ extract 127 120) sigaction_oldact_557_1216)))
 (let ((?x28577 (bvand ?x28552 (_ bv4 8))))
 (= (_ bv0 8) ?x28577))))
(assert
 (let ((?x51640 ((_ extract 127 120) sigaction_oldact_900_1216)))
 (let ((?x51652 (bvand ?x51640 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x51652) true))))
(assert
 (let ((?x59302 ((_ extract 127 120) sigaction_oldact_1693_1216)))
 (let ((?x59336 (bvand ?x59302 (_ bv4 8))))
 (= (_ bv0 8) ?x59336))))
(assert
 (let ((?x174461 ((_ extract 127 120) sigaction_oldact_3072_1216)))
 (let ((?x135599 (bvand ?x174461 (_ bv4 8))))
 (= (_ bv0 8) ?x135599))))
(maximize strlen_72_64)
(minimize sigaction_oldact_198_1216)
(minimize sigaction_oldact_900_1216)
(minimize sigaction_oldact_171_1216)
(maximize sigaction_oldact_3072_1216)
(minimize args_1_8)
(maximize sigaction_oldact_271_1216)
(maximize sigaction_oldact_184_1216)
(maximize sigaction_oldact_900_1216)
(maximize sigaction_oldact_198_1216)
(maximize sigaction_oldact_375_1216)
(minimize sigaction_oldact_271_1216)
(minimize strlen_75_64)
(maximize args_0_8)
(minimize sigaction_oldact_175_1216)
(maximize strlen_75_64)
(maximize sigaction_oldact_557_1216)
(minimize sigaction_oldact_1693_1216)
(minimize sigaction_oldact_375_1216)
(minimize sigaction_oldact_3072_1216)
(maximize args_1_8)
...
(maximize sigaction_oldact_1693_1216)
(check-sat)
(get-objectives)
