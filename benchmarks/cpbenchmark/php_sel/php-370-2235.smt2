...
(declare-fun sigaction_oldact_376_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_558_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_901_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1556_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2814_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x8807))))
(assert
 (let ((?x15383 ((_ extract 127 120) sigaction_oldact_376_1216)))
 (let ((?x15408 (bvand ?x15383 (_ bv4 8))))
 (= (_ bv0 8) ?x15408))))
(assert
 (let ((?x28599 ((_ extract 127 120) sigaction_oldact_558_1216)))
 (let ((?x28624 (bvand ?x28599 (_ bv4 8))))
 (= (_ bv0 8) ?x28624))))
(assert
 (let ((?x51682 ((_ extract 127 120) sigaction_oldact_901_1216)))
 (let ((?x5908 (bvand ?x51682 (_ bv4 8))))
 (= (_ bv0 8) ?x5908))))
(assert
 (let ((?x88862 ((_ extract 127 120) sigaction_oldact_1556_1216)))
 (let ((?x88877 (bvand ?x88862 (_ bv4 8))))
 (= (_ bv0 8) ?x88877))))
(assert
 (let ((?x160390 ((_ extract 127 120) sigaction_oldact_2814_1216)))
 (let ((?x123028 (bvand ?x160390 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x123028) true))))
(maximize sigaction_oldact_175_1216)
(maximize args_0_8)
(minimize sigaction_oldact_279_1216)
(maximize sigaction_oldact_901_1216)
(minimize sigaction_oldact_2814_1216)
(minimize sigaction_oldact_376_1216)
(maximize sigaction_oldact_558_1216)
(maximize args_1_8)
(minimize sigaction_oldact_184_1216)
(maximize sigaction_oldact_223_1216)
(maximize sigaction_oldact_184_1216)
(maximize sigaction_oldact_1556_1216)
