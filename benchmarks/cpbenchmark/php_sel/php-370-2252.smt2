...
(declare-fun sigaction_oldact_3366_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x96758) true))))
(assert
 (let ((?x191050 ((_ extract 127 120) sigaction_oldact_3366_1216)))
 (let ((?x191058 (bvand ?x191050 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x191058) true))))
...
(minimize sigaction_oldact_1698_1216)
(minimize sigaction_oldact_3366_1216)
(maximize args_0_8)
