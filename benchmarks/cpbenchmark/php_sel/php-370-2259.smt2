...
(declare-fun sigaction_oldact_2000_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x16531) true))))
(assert
 (let ((?x114013 ((_ extract 127 120) sigaction_oldact_2000_1216)))
 (let ((?x114039 (bvand ?x114013 (_ bv4 8))))
 (= (_ bv0 8) ?x114039))))
