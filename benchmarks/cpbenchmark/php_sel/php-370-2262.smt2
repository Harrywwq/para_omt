...
(declare-fun sigaction_oldact_3079_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x96810))))
(assert
 (let ((?x174771 ((_ extract 127 120) sigaction_oldact_3079_1216)))
 (let ((?x135903 (bvand ?x174771 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x135903) true))))
(maximize sigaction_oldact_394_1216)
