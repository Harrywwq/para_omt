...
(declare-fun sigaction_oldact_595_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_975_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1699_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3369_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x16723))))
(assert
 (let ((?x31267 ((_ extract 127 120) sigaction_oldact_595_1216)))
 (let ((?x31292 (bvand ?x31267 (_ bv4 8))))
 (= (_ bv0 8) ?x31292))))
(assert
 (let ((?x55893 ((_ extract 127 120) sigaction_oldact_975_1216)))
 (let ((?x10998 (bvand ?x55893 (_ bv4 8))))
 (= (_ bv0 8) ?x10998))))
(assert
 (let ((?x96795 ((_ extract 127 120) sigaction_oldact_1699_1216)))
 (let ((?x96810 (bvand ?x96795 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x96810) true))))
(assert
 (let ((?x152349 ((_ extract 127 120) sigaction_oldact_3369_1216)))
 (let ((?x191209 (bvand ?x152349 (_ bv4 8))))
 (= (_ bv0 8) ?x191209))))
...
(minimize sigaction_oldact_3369_1216)
(maximize sigaction_oldact_1699_1216)
(maximize sigaction_oldact_595_1216)
(minimize sigaction_oldact_279_1216)
(maximize sigaction_oldact_175_1216)
(minimize sigaction_oldact_595_1216)
(minimize sigaction_oldact_975_1216)
...
(minimize sigaction_oldact_394_1216)
(maximize sigaction_oldact_3369_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_1699_1216)
(check-sat)
(get-objectives)
