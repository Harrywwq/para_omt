...
(declare-fun sigaction_oldact_3372_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x105384))))
(assert
 (let ((?x191307 ((_ extract 127 120) sigaction_oldact_3372_1216)))
 (let ((?x191322 (bvand ?x191307 (_ bv4 8))))
 (= (_ bv0 8) ?x191322))))
(minimize sigaction_oldact_3372_1216)
(maximize sigaction_oldact_1051_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_279_1216)
(maximize sigaction_oldact_3372_1216)
