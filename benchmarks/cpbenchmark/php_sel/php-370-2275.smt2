...
(declare-fun sigaction_oldact_1051_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1849_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x34046))))
(assert
 (let ((?x60300 ((_ extract 127 120) sigaction_oldact_1051_1216)))
 (let ((?x16599 (bvand ?x60300 (_ bv4 8))))
 (= (_ bv0 8) ?x16599))))
(assert
 (let ((?x105376 ((_ extract 127 120) sigaction_oldact_1849_1216)))
 (let ((?x105384 (bvand ?x105376 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x105384) true))))
...
(maximize sigaction_oldact_1051_1216)
(maximize sigaction_oldact_279_1216)
(minimize sigaction_oldact_634_1216)
(minimize args_0_8)
...
(maximize args_0_8)
(minimize sigaction_oldact_1051_1216)
(minimize sigaction_oldact_1849_1216)
(minimize sigaction_oldact_184_1216)
(minimize sigaction_oldact_394_1216)
(maximize sigaction_oldact_634_1216)
(maximize sigaction_oldact_1849_1216)
(maximize args_1_8)
(check-sat)
(get-objectives)
