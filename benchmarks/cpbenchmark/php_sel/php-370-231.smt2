...
(declare-fun sigaction_oldact_1292_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2464_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x41227) true))))
(assert
 (let ((?x75060 ((_ extract 127 120) sigaction_oldact_1292_1216)))
 (let ((?x36736 (bvand ?x75060 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x36736) true))))
(assert
 (let ((?x142212 ((_ extract 127 120) sigaction_oldact_2464_1216)))
 (let ((?x142229 (bvand ?x142212 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x142229) true))))
(maximize strlen_77_64)
(minimize args_2_8)
(maximize sigaction_oldact_724_1216)
(maximize args_3_8)
(maximize args_0_8)
(minimize sigaction_oldact_2464_1216)
(minimize sigaction_oldact_309_1216)
(maximize sigaction_oldact_2464_1216)
...
(maximize args_2_8)
(maximize args_1_8)
(maximize sigaction_oldact_309_1216)
(check-sat)
(get-objectives)
