...
(declare-fun sigaction_oldact_522_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_833_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1435_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2816_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x14095))))
(assert
 (let ((?x26099 ((_ extract 127 120) sigaction_oldact_522_1216)))
 (let ((?x26116 (bvand ?x26099 (_ bv4 8))))
 (= (_ bv0 8) ?x26116))))
(assert
 (let ((?x47887 ((_ extract 127 120) sigaction_oldact_833_1216)))
 (let ((?x47905 (bvand ?x47887 (_ bv4 8))))
 (= (_ bv0 8) ?x47905))))
(assert
 (let ((?x82358 ((_ extract 127 120) sigaction_oldact_1435_1216)))
 (let ((?x44615 (bvand ?x82358 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x44615) true))))
(assert
 (let ((?x160486 ((_ extract 127 120) sigaction_oldact_2816_1216)))
 (let ((?x123090 (bvand ?x160486 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x123090) true))))
(maximize args_1_8)
(maximize args_0_8)
(maximize strlen_75_64)
(maximize sigaction_oldact_199_1216)
(maximize strlen_72_64)
(maximize sigaction_oldact_2816_1216)
(minimize sigaction_oldact_175_1216)
(minimize strlen_75_64)
(minimize sigaction_oldact_833_1216)
...
(maximize sigaction_oldact_522_1216)
...
(minimize args_1_8)
(maximize sigaction_oldact_1435_1216)
(minimize sigaction_oldact_1435_1216)
(minimize sigaction_oldact_522_1216)
