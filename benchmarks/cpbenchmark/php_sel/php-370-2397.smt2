...
(declare-fun sigaction_oldact_3391_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x105982))))
(assert
 (let ((?x192297 ((_ extract 127 120) sigaction_oldact_3391_1216)))
 (let ((?x192313 (bvand ?x192297 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x192313) true))))
(maximize args_0_8)
