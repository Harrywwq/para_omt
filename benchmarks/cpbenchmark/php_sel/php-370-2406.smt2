...
(declare-fun sigaction_oldact_3392_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x97258) true))))
(assert
 (let ((?x192369 ((_ extract 127 120) sigaction_oldact_3392_1216)))
 (let ((?x192387 (bvand ?x192369 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x192387) true))))
...
(minimize sigaction_oldact_3392_1216)
