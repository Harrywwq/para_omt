...
(declare-fun sigaction_oldact_1237_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2256_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40450))))
(assert
 (let ((?x71703 ((_ extract 127 120) sigaction_oldact_1237_1216)))
 (let ((?x71723 (bvand ?x71703 (_ bv4 8))))
 (= (_ bv0 8) ?x71723))))
(assert
 (let ((?x129580 ((_ extract 127 120) sigaction_oldact_2256_1216)))
 (let ((?x93248 (bvand ?x129580 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x93248) true))))
...
(minimize sigaction_oldact_1237_1216)
...
(maximize args_0_8)
(minimize args_4_8)
(minimize sigaction_oldact_2256_1216)
(minimize strlen_77_64)
(maximize sigaction_oldact_2256_1216)
...
(maximize sigaction_oldact_1237_1216)
(maximize args_4_8)
(check-sat)
(get-objectives)
