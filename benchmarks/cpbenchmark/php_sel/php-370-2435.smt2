...
(declare-fun sigaction_oldact_562_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_983_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1712_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_3098_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x15559))))
(assert
 (let ((?x28812 ((_ extract 127 120) sigaction_oldact_562_1216)))
 (let ((?x28818 (bvand ?x28812 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x28818) true))))
(assert
 (let ((?x56314 ((_ extract 127 120) sigaction_oldact_983_1216)))
 (let ((?x56330 (bvand ?x56314 (_ bv4 8))))
 (= (_ bv0 8) ?x56330))))
(assert
 (let ((?x97431 ((_ extract 127 120) sigaction_oldact_1712_1216)))
 (let ((?x59985 (bvand ?x97431 (_ bv4 8))))
 (= (_ bv0 8) ?x59985))))
(assert
 (let ((?x175660 ((_ extract 127 120) sigaction_oldact_3098_1216)))
 (let ((?x136433 (bvand ?x175660 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x136433) true))))
