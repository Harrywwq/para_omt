...
(declare-fun sigaction_oldact_2325_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x34855))))
(assert
 (let ((?x134518 ((_ extract 127 120) sigaction_oldact_2325_1216)))
 (let ((?x99862 (bvand ?x134518 (_ bv4 8))))
 (= (_ bv0 8) ?x99862))))
(minimize args_1_8)
(minimize args_4_8)
...
(minimize sigaction_oldact_2325_1216)
