...
(declare-fun sigaction_oldact_1263_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2379_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x41321))))
(assert
 (let ((?x73498 ((_ extract 127 120) sigaction_oldact_1263_1216)))
 (let ((?x34855 (bvand ?x73498 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x34855) true))))
(assert
 (let ((?x102934 ((_ extract 127 120) sigaction_oldact_2379_1216)))
 (let ((?x137874 (bvand ?x102934 (_ bv4 8))))
 (= (_ bv0 8) ?x137874))))
(maximize sigaction_oldact_207_1216)
(minimize strlen_80_64)
(minimize args_4_8)
(maximize sigaction_oldact_1263_1216)
...
(maximize args_4_8)
(minimize sigaction_oldact_1263_1216)
(minimize args_5_16)
(minimize sigaction_oldact_449_1216)
(minimize sigaction_oldact_2379_1216)
(minimize args_1_8)
