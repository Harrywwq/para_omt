...
(declare-fun sigaction_oldact_2609_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x82509))))
(assert
 (let ((?x149635 ((_ extract 127 120) sigaction_oldact_2609_1216)))
 (let ((?x113509 (bvand ?x149635 (_ bv4 8))))
 (= (_ bv0 8) ?x113509))))
...
(maximize sigaction_oldact_2609_1216)
(minimize args_2_8)
(minimize args_4_8)
...
(minimize sigaction_oldact_2609_1216)
(minimize args_3_8)
(check-sat)
(get-objectives)
