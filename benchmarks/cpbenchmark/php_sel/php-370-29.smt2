...
(declare-fun sigaction_oldact_1437_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2833_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x44660) true))))
(assert
 (let ((?x82480 ((_ extract 127 120) sigaction_oldact_1437_1216)))
 (let ((?x82509 (bvand ?x82480 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x82509) true))))
(assert
 (let ((?x161254 ((_ extract 127 120) sigaction_oldact_2833_1216)))
 (let ((?x123528 (bvand ?x161254 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x123528) true))))
(maximize strlen_74_64)
(maximize sigaction_oldact_490_1216)
(minimize args_6_16)
(minimize strlen_80_64)
(minimize sigaction_oldact_1437_1216)
(maximize strlen_96_64)
(maximize strlen_77_64)
(minimize sigaction_oldact_2833_1216)
(minimize args_3_8)
...
(maximize args_4_8)
(maximize args_5_16)
(maximize sigaction_oldact_1437_1216)
(maximize args_2_8)
(minimize args_7_16)
(check-sat)
(get-objectives)
