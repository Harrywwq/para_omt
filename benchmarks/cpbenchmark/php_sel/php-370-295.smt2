...
(declare-fun sigaction_oldact_2612_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x78006) true))))
(assert
 (let ((?x149851 ((_ extract 127 120) sigaction_oldact_2612_1216)))
 (let ((?x149878 (bvand ?x149851 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x149878) true))))
(minimize strlen_84_64)
(minimize args_4_8)
(maximize args_5_16)
(minimize sigaction_oldact_2612_1216)
...
(minimize args_2_8)
(maximize sigaction_oldact_2612_1216)
(minimize args_0_8)
(maximize sigaction_oldact_1349_1216)
...
(maximize args_2_8)
(maximize sigaction_oldact_746_1216)
