...
(declare-fun sigaction_oldact_311_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_451_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_728_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1297_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2470_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x6516))))
(assert
 (let ((?x11155 ((_ extract 127 120) sigaction_oldact_311_1216)))
 (let ((?x11214 (bvand ?x11155 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x11214) true))))
(assert
 (let ((?x21692 ((_ extract 127 120) sigaction_oldact_451_1216)))
 (let ((?x21712 (bvand ?x21692 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x21712) true))))
(assert
 (let ((?x41520 ((_ extract 127 120) sigaction_oldact_728_1216)))
 (let ((?x41540 (bvand ?x41520 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x41540) true))))
(assert
 (let ((?x37092 ((_ extract 127 120) sigaction_oldact_1297_1216)))
 (let ((?x75433 (bvand ?x37092 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x75433) true))))
(assert
 (let ((?x142702 ((_ extract 127 120) sigaction_oldact_2470_1216)))
 (let ((?x142731 (bvand ?x142702 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x142731) true))))
(minimize sigaction_oldact_1297_1216)
(minimize args_3_8)
(maximize sigaction_oldact_728_1216)
(minimize strlen_77_64)
(minimize args_0_8)
(minimize sigaction_oldact_311_1216)
(maximize sigaction_oldact_208_1216)
(maximize sigaction_oldact_451_1216)
(maximize args_2_8)
(minimize strlen_72_64)
(minimize sigaction_oldact_728_1216)
