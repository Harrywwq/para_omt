...
(declare-fun sigaction_oldact_1243_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2336_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40718))))
(assert
 (let ((?x71967 ((_ extract 127 120) sigaction_oldact_1243_1216)))
 (let ((?x71987 (bvand ?x71967 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x71987) true))))
(assert
 (let ((?x135053 ((_ extract 127 120) sigaction_oldact_2336_1216)))
 (let ((?x100220 (bvand ?x135053 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x100220) true))))
(minimize args_4_8)
