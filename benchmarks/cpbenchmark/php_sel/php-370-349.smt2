...
(declare-fun sigaction_oldact_2395_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x75553))))
(assert
 (let ((?x138753 ((_ extract 127 120) sigaction_oldact_2395_1216)))
 (let ((?x103913 (bvand ?x138753 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x103913) true))))
