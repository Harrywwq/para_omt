...
(declare-fun sigaction_oldact_1245_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2345_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x40812))))
(assert
 (let ((?x72051 ((_ extract 127 120) sigaction_oldact_1245_1216)))
 (let ((?x72066 (bvand ?x72051 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x72066) true))))
(assert
 (let ((?x135455 ((_ extract 127 120) sigaction_oldact_2345_1216)))
 (let ((?x135477 (bvand ?x135455 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x135477) true))))
(minimize sigaction_oldact_245_1216)
(maximize strlen_72_64)
(minimize sigaction_oldact_721_1216)
(minimize sigaction_oldact_2345_1216)
(minimize sigaction_oldact_209_1216)
(minimize args_2_8)
(maximize sigaction_oldact_454_1216)
(maximize args_2_8)
(minimize args_0_8)
(maximize sigaction_oldact_1245_1216)
...
(minimize sigaction_oldact_1245_1216)
(maximize strlen_77_64)
(maximize args_1_8)
(minimize args_3_8)
(minimize strlen_85_64)
(minimize strlen_74_64)
(maximize sigaction_oldact_2345_1216)
