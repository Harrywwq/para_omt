...
(declare-fun sigaction_oldact_721_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1277_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2407_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x21858))))
(assert
 (let ((?x40787 ((_ extract 127 120) sigaction_oldact_721_1216)))
 (let ((?x40812 (bvand ?x40787 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x40812) true))))
(assert
 (let ((?x74191 ((_ extract 127 120) sigaction_oldact_1277_1216)))
 (let ((?x74207 (bvand ?x74191 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x74207) true))))
(assert
 (let ((?x139363 ((_ extract 127 120) sigaction_oldact_2407_1216)))
 (let ((?x139379 (bvand ?x139363 (_ bv4 8))))
 (= (_ bv0 8) ?x139379))))
(minimize args_3_8)
(minimize args_1_8)
(minimize strlen_74_64)
(minimize args_0_8)
(maximize sigaction_oldact_454_1216)
(maximize strlen_80_64)
(maximize sigaction_oldact_721_1216)
(minimize strlen_77_64)
(maximize args_4_8)
(minimize args_4_8)
(maximize strlen_85_64)
(minimize sigaction_oldact_1277_1216)
(maximize args_0_8)
...
(maximize sigaction_oldact_1277_1216)
(maximize sigaction_oldact_209_1216)
(minimize strlen_72_64)
(minimize sigaction_oldact_315_1216)
(maximize sigaction_oldact_315_1216)
(minimize sigaction_oldact_245_1216)
(minimize sigaction_oldact_209_1216)
(maximize args_3_8)
(maximize sigaction_oldact_2407_1216)
(minimize sigaction_oldact_721_1216)
(minimize sigaction_oldact_454_1216)
(maximize strlen_74_64)
(minimize sigaction_oldact_2407_1216)
(check-sat)
(get-objectives)
