...
(declare-fun sigaction_oldact_2348_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x35631))))
(assert
 (let ((?x135575 ((_ extract 127 120) sigaction_oldact_2348_1216)))
 (let ((?x135590 (bvand ?x135575 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x135590) true))))
(minimize args_3_8)
...
(minimize sigaction_oldact_2348_1216)
(minimize args_0_8)
(maximize args_3_8)
(maximize sigaction_oldact_2348_1216)
(minimize sigaction_oldact_209_1216)
(minimize sigaction_oldact_315_1216)
(minimize args_2_8)
(minimize sigaction_oldact_735_1216)
(maximize sigaction_oldact_1279_1216)
