...
(declare-fun sigaction_oldact_1309_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2412_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x43053))))
(assert
 (let ((?x76066 ((_ extract 127 120) sigaction_oldact_1309_1216)))
 (let ((?x76082 (bvand ?x76066 (_ bv4 8))))
 (= (_ bv0 8) ?x76082))))
(assert
 (let ((?x139597 ((_ extract 127 120) sigaction_oldact_2412_1216)))
 (let ((?x139613 (bvand ?x139597 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x139613) true))))
(maximize args_1_8)
...
(minimize sigaction_oldact_2412_1216)
(minimize strlen_85_64)
(maximize sigaction_oldact_2412_1216)
