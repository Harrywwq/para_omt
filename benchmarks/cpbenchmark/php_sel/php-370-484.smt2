...
(declare-fun sigaction_oldact_1441_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2623_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x44946) true))))
(assert
 (let ((?x82816 ((_ extract 127 120) sigaction_oldact_1441_1216)))
 (let ((?x45197 (bvand ?x82816 (_ bv4 8))))
 (= (_ bv0 8) ?x45197))))
(assert
 (let ((?x150731 ((_ extract 127 120) sigaction_oldact_2623_1216)))
 (let ((?x114694 (bvand ?x150731 (_ bv4 8))))
 (= (_ bv0 8) ?x114694))))
...
(maximize sigaction_oldact_2623_1216)
...
(minimize sigaction_oldact_2623_1216)
(maximize args_0_8)
(maximize args_3_8)
(minimize args_4_8)
(minimize sigaction_oldact_1441_1216)
(check-sat)
(get-objectives)
