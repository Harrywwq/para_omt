...
(declare-fun sigaction_oldact_2842_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x45197) true))))
(assert
 (let ((?x161859 ((_ extract 127 120) sigaction_oldact_2842_1216)))
 (let ((?x161879 (bvand ?x161859 (_ bv4 8))))
 (= (_ bv0 8) ?x161879))))
...
(maximize sigaction_oldact_2842_1216)
...
(maximize sigaction_oldact_1441_1216)
(maximize args_2_8)
