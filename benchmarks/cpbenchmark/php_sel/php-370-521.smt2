...
(declare-fun sigaction_oldact_327_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_472_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_756_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1316_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2421_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x6944) true))))
(assert
 (let ((?x12178 ((_ extract 127 120) sigaction_oldact_327_1216)))
 (let ((?x12203 (bvand ?x12178 (_ bv4 8))))
 (= (_ bv0 8) ?x12203))))
(assert
 (let ((?x23085 ((_ extract 127 120) sigaction_oldact_472_1216)))
 (let ((?x23110 (bvand ?x23085 (_ bv4 8))))
 (= (_ bv0 8) ?x23110))))
(assert
 (let ((?x43313 ((_ extract 127 120) sigaction_oldact_756_1216)))
 (let ((?x43338 (bvand ?x43313 (_ bv4 8))))
 (= (_ bv0 8) ?x43338))))
(assert
 (let ((?x76381 ((_ extract 127 120) sigaction_oldact_1316_1216)))
 (let ((?x76397 (bvand ?x76381 (_ bv4 8))))
 (= (_ bv0 8) ?x76397))))
(assert
 (let ((?x140004 ((_ extract 127 120) sigaction_oldact_2421_1216)))
 (let ((?x104853 (bvand ?x140004 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x104853) true))))
(minimize strlen_85_64)
(maximize strlen_85_64)
(minimize sigaction_oldact_247_1216)
(minimize strlen_72_64)
(maximize sigaction_oldact_247_1216)
(minimize sigaction_oldact_327_1216)
(minimize args_0_8)
