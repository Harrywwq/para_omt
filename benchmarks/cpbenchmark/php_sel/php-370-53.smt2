...
(declare-fun sigaction_oldact_1576_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2839_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x6559))))
(assert
 (let ((?x89787 ((_ extract 127 120) sigaction_oldact_1576_1216)))
 (let ((?x89798 (bvand ?x89787 (_ bv4 8))))
 (= (_ bv0 8) ?x89798))))
(assert
 (let ((?x161533 ((_ extract 127 120) sigaction_oldact_2839_1216)))
 (let ((?x123759 (bvand ?x161533 (_ bv4 8))))
 (= (_ bv0 8) ?x123759))))
(minimize sigaction_oldact_571_1216)
(maximize strlen_101_64)
(minimize args_2_8)
(maximize strlen_84_64)
(maximize sigaction_oldact_2839_1216)
