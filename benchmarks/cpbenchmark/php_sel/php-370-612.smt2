...
(declare-fun sigaction_oldact_1446_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2638_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (and (distinct (_ bv0 8) ?x45287) true))))
(assert
 (let ((?x83179 ((_ extract 127 120) sigaction_oldact_1446_1216)))
 (let ((?x83205 (bvand ?x83179 (_ bv4 8))))
 (= (_ bv0 8) ?x83205))))
(assert
 (let ((?x151681 ((_ extract 127 120) sigaction_oldact_2638_1216)))
 (let ((?x115673 (bvand ?x151681 (_ bv4 8))))
 (= (_ bv0 8) ?x115673))))
(maximize args_1_8)
(maximize strlen_81_64)
(maximize sigaction_oldact_191_1216)
(minimize sigaction_oldact_322_1216)
(maximize sigaction_oldact_786_1216)
(minimize sigaction_oldact_179_1216)
(minimize sigaction_oldact_1446_1216)
