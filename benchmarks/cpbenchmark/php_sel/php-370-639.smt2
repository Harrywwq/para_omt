...
(declare-fun sigaction_oldact_2640_1216 () (_ BitVec 1216))
(assert
...
(assert
 (let ((?x151844 ((_ extract 127 120) sigaction_oldact_2640_1216)))
 (let ((?x115897 (bvand ?x151844 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x115897) true))))
(maximize args_2_8)
