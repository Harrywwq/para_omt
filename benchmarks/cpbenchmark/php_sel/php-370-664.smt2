...
(declare-fun sigaction_oldact_1374_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2524_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x45478))))
(assert
 (let ((?x79512 ((_ extract 127 120) sigaction_oldact_1374_1216)))
 (let ((?x41500 (bvand ?x79512 (_ bv4 8))))
 (= (_ bv0 8) ?x41500))))
(assert
 (let ((?x145739 ((_ extract 127 120) sigaction_oldact_2524_1216)))
 (let ((?x145759 (bvand ?x145739 (_ bv4 8))))
 (= (_ bv0 8) ?x145759))))
...
(minimize sigaction_oldact_2524_1216)
