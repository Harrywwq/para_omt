...
(declare-fun sigaction_oldact_764_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1376_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2529_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x23398))))
(assert
 (let ((?x43814 ((_ extract 127 120) sigaction_oldact_764_1216)))
 (let ((?x43839 (bvand ?x43814 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x43839) true))))
(assert
 (let ((?x79648 ((_ extract 127 120) sigaction_oldact_1376_1216)))
 (let ((?x79656 (bvand ?x79648 (_ bv4 8))))
 (= (_ bv0 8) ?x79656))))
(assert
 (let ((?x146006 ((_ extract 127 120) sigaction_oldact_2529_1216)))
 (let ((?x111217 (bvand ?x146006 (_ bv4 8))))
 (= (_ bv0 8) ?x111217))))
(minimize strlen_81_64)
(minimize strlen_74_64)
(minimize sigaction_oldact_1376_1216)
