...
(declare-fun sigaction_oldact_2538_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x79985))))
(assert
 (let ((?x146406 ((_ extract 127 120) sigaction_oldact_2538_1216)))
 (let ((?x146414 (bvand ?x146406 (_ bv4 8))))
 (= (_ bv0 8) ?x146414))))
(maximize sigaction_oldact_2538_1216)
...
(minimize args_0_8)
(minimize sigaction_oldact_2538_1216)
