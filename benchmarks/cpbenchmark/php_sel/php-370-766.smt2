...
(declare-fun sigaction_oldact_794_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1456_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2860_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x24547))))
(assert
 (let ((?x45791 ((_ extract 127 120) sigaction_oldact_794_1216)))
 (let ((?x45814 (bvand ?x45791 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x45814) true))))
(assert
 (let ((?x83854 ((_ extract 127 120) sigaction_oldact_1456_1216)))
 (let ((?x46713 (bvand ?x83854 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46713) true))))
(assert
 (let ((?x163262 ((_ extract 127 120) sigaction_oldact_2860_1216)))
 (let ((?x125697 (bvand ?x163262 (_ bv4 8))))
 (= (_ bv0 8) ?x125697))))
(minimize sigaction_oldact_330_1216)
(maximize strlen_77_64)
(minimize sigaction_oldact_2860_1216)
(minimize sigaction_oldact_1456_1216)
(maximize args_1_8)
...
(maximize args_3_8)
(minimize args_0_8)
(maximize sigaction_oldact_1456_1216)
(minimize sigaction_oldact_794_1216)
