...
(declare-fun sigaction_oldact_2666_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x46828))))
(assert
 (let ((?x153249 ((_ extract 127 120) sigaction_oldact_2666_1216)))
 (let ((?x153273 (bvand ?x153249 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x153273) true))))
(minimize sigaction_oldact_191_1216)
(minimize sigaction_oldact_795_1216)
(minimize sigaction_oldact_2666_1216)
(maximize args_1_8)
(maximize strlen_74_64)
(maximize sigaction_oldact_2666_1216)
