...
(declare-fun sigaction_oldact_795_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1458_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2863_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x24594))))
(assert
 (let ((?x45836 ((_ extract 127 120) sigaction_oldact_795_1216)))
 (let ((?x504 (bvand ?x45836 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x504) true))))
(assert
 (let ((?x83964 ((_ extract 127 120) sigaction_oldact_1458_1216)))
 (let ((?x46828 (bvand ?x83964 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x46828) true))))
(assert
 (let ((?x163425 ((_ extract 127 120) sigaction_oldact_2863_1216)))
 (let ((?x125869 (bvand ?x163425 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x125869) true))))
(minimize sigaction_oldact_340_1216)
(minimize sigaction_oldact_795_1216)
(maximize sigaction_oldact_1458_1216)
...
(maximize sigaction_oldact_2863_1216)
