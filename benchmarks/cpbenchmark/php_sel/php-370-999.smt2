...
(declare-fun sigaction_oldact_805_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_1399_1216 () (_ BitVec 1216))
(declare-fun sigaction_oldact_2699_1216 () (_ BitVec 1216))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x24954))))
(assert
 (let ((?x46407 ((_ extract 127 120) sigaction_oldact_805_1216)))
 (let ((?x46431 (bvand ?x46407 (_ bv4 8))))
 (= (_ bv0 8) ?x46431))))
(assert
 (let ((?x80727 ((_ extract 127 120) sigaction_oldact_1399_1216)))
 (let ((?x80739 (bvand ?x80727 (_ bv4 8))))
 (and (distinct (_ bv0 8) ?x80739) true))))
(assert
 (let ((?x154956 ((_ extract 127 120) sigaction_oldact_2699_1216)))
 (let ((?x118832 (bvand ?x154956 (_ bv4 8))))
 (= (_ bv0 8) ?x118832))))
(minimize sigaction_oldact_179_1216)
(minimize sigaction_oldact_2699_1216)
(maximize sigaction_oldact_179_1216)
(minimize sigaction_oldact_192_1216)
(minimize sigaction_oldact_262_1216)
(minimize args_0_8)
(maximize sigaction_oldact_1399_1216)
(minimize strlen_72_64)
(maximize strlen_81_64)
(maximize sigaction_oldact_214_1216)
(maximize args_2_8)
(minimize sigaction_oldact_501_1216)
(maximize sigaction_oldact_805_1216)
...
(minimize args_2_8)
(maximize sigaction_oldact_2699_1216)
(maximize sigaction_oldact_501_1216)
(maximize strlen_77_64)
(minimize sigaction_oldact_214_1216)
(minimize sigaction_oldact_805_1216)
