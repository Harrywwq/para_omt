...
(assert
 ...
 (and (distinct (_ bv0 16) ?x11989) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x6435 ((_ extract 839 836) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 ...
 (let ((?x15581 ((_ extract 127 120) mem_0_114_128)))
 (let (($x15838 (= (_ bv10 8) ?x15581)))
 (let ((?x35598 (ite $x15838 (_ bv15 32) (_ bv64 32))))
 (let ((?x24696 ((_ extract 119 112) mem_0_114_128)))
 (let (($x24693 (= (_ bv10 8) ?x24696)))
 (let ((?x35062 (ite $x24693 (_ bv14 32) ?x35598)))
 (let ((?x24690 ((_ extract 111 104) mem_0_114_128)))
 (let (($x24686 (= (_ bv10 8) ?x24690)))
 (let ((?x35123 (ite $x24686 (_ bv13 32) ?x35062)))
 (let ((?x15918 ((_ extract 103 96) mem_0_114_128)))
 (let (($x15552 (= (_ bv10 8) ?x15918)))
 (let ((?x35948 (ite $x15552 (_ bv12 32) ?x35123)))
 (let ((?x15418 ((_ extract 95 88) mem_0_114_128)))
 (let (($x13488 (= (_ bv10 8) ?x15418)))
 (let ((?x35270 (ite $x13488 (_ bv11 32) ?x35948)))
 (let ((?x13956 ((_ extract 87 80) mem_0_114_128)))
 (let (($x12952 (= (_ bv10 8) ?x13956)))
 (let ((?x35130 (ite $x12952 (_ bv10 32) ?x35270)))
 (let ((?x13249 ((_ extract 79 72) mem_0_114_128)))
 (let (($x15259 (= (_ bv10 8) ?x13249)))
 (let ((?x35075 (ite $x15259 (_ bv9 32) ?x35130)))
 (let ((?x13504 ((_ extract 71 64) mem_0_114_128)))
 (let (($x12999 (= (_ bv10 8) ?x13504)))
 (let ((?x35568 (ite $x12999 (_ bv8 32) ?x35075)))
 (let ((?x15293 ((_ extract 63 56) mem_0_114_128)))
 (let (($x15165 (= (_ bv10 8) ?x15293)))
 (let ((?x36522 (ite $x15165 (_ bv7 32) ?x35568)))
 (let ((?x15711 ((_ extract 55 48) mem_0_114_128)))
 (let (($x15716 (= (_ bv10 8) ?x15711)))
 (let ((?x35267 (ite $x15716 (_ bv6 32) ?x36522)))
 (let ((?x15971 ((_ extract 47 40) mem_0_114_128)))
 (let (($x16179 (= (_ bv10 8) ?x15971)))
 (let ((?x34991 (ite $x16179 (_ bv5 32) ?x35267)))
 (let ((?x15579 ((_ extract 39 32) mem_0_114_128)))
 (let (($x16176 (= (_ bv10 8) ?x15579)))
 (let ((?x36327 (ite $x16176 (_ bv4 32) ?x34991)))
 (let ((?x16165 ((_ extract 31 24) mem_0_114_128)))
 (let (($x16157 (= (_ bv10 8) ?x16165)))
 (let ((?x36316 (ite $x16157 (_ bv3 32) ?x36327)))
 (let ((?x15176 ((_ extract 23 16) mem_0_114_128)))
 (let (($x15261 (= (_ bv10 8) ?x15176)))
 (let ((?x34992 (ite $x15261 (_ bv2 32) ?x36316)))
 (let ((?x15218 ((_ extract 15 8) mem_0_114_128)))
 (let (($x23022 (= (_ bv10 8) ?x15218)))
 (let ((?x36317 (ite $x23022 (_ bv1 32) ?x34992)))
 (let ((?x23178 ((_ extract 7 0) mem_0_114_128)))
 (let (($x23187 (= (_ bv10 8) ?x23178)))
 (let ((?x36326 (ite $x23187 (_ bv0 32) ?x36317)))
 (let ((?x16030 (ite $x23187 (_ bv1 1) (_ bv0 1))))
 (let ((?x16041 (ite $x23022 (_ bv1 1) (_ bv0 1))))
 (let ((?x15296 (ite $x15261 (_ bv1 1) (_ bv0 1))))
 (let ((?x15974 (ite $x16157 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x15848 (ite $x15552 (_ bv1 1) (_ bv0 1))))
 (let ((?x15778 (ite $x24686 (_ bv1 1) (_ bv0 1))))
 (let ((?x24889 (concat (concat (concat (_ bv0 16) (ite $x15838 (_ bv1 1) (_ bv0 1))) (ite $x24693 (_ bv1 1) (_ bv0 1))) ?x15778)))
 (let ((?x25728 (concat (concat (concat (concat (concat ?x24889 ?x15848) ?x23006) ?x23218) ?x15266) ?x15894)))
 (let ((?x25454 (concat (concat (concat (concat (concat ?x25728 ?x15453) ?x23053) ?x23102) ?x15206) ?x15974)))
 (let ((?x24955 (concat (concat (concat ?x25454 ?x15296) ?x16041) ?x16030)))
 (let (($x35932 (not $x15838)))
 (let (($x35939 (not $x24693)))
 (let (($x34297 (not $x24686)))
 (let (($x35103 (not $x15552)))
 (let (($x35927 (not $x13488)))
 (let (($x35268 (not $x12952)))
 (let (($x35550 (not $x15259)))
 (let (($x34278 (not $x12999)))
 (let (($x35544 (not $x15165)))
 (let (($x35069 (not $x15716)))
 (let (($x35973 (not $x16179)))
 (let (($x34771 (not $x16176)))
 (let (($x36029 (not $x16157)))
 (let (($x35989 (not $x15261)))
 (let (($x36018 (not $x23022)))
 (let (($x36007 (not $x23187)))
 (let (($x36321 (and $x36007 $x36018 $x35989 $x36029 $x34771 $x35973 $x35069 $x35544 $x34278 $x35550 $x35268 $x35927 $x35103 $x34297 $x35939 $x35932)))
 (let ((?x34990 (ite $x36321 ?x24955 ?x36326)))
 (let ((?x36323 (concat (_ bv0 32) ?x34990)))
 (let ((?x35906 (bvadd (bvadd (_ bv16 64) ?x36323) ?x14202)))
 (and (distinct (_ bv0 64) ?x35906) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
