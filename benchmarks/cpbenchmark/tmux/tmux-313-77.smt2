...
(assert
 ...
 (let (($x15714 (= (_ bv10 8) ?x15698)))
 (let ((?x24144 (ite $x15714 (_ bv1 1) (_ bv0 1))))
 (let ((?x24978 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 127 120) mem_0_113_128)) (_ bv1 1) (_ bv0 1))) ?x24144)))
 (let ((?x15745 (concat (concat (concat (concat (concat ?x24978 ?x24122) ?x24065) ?x15623) ?x24107) ?x15896)))
 (let ((?x26154 (concat (concat (concat (concat (concat ?x15745 ?x15535) ?x24077) ?x24150) ?x24119) ?x24139)))
 (let ((?x25327 (concat (concat (concat (concat ?x26154 ?x24092) ?x24047) ?x24041) ?x24038)))
 (let ((?x23457 ((_ zero_extend 32) ?x25327)))
 (let ((?x24051 ((_ extract 127 120) mem_0_113_128)))
 (let (($x24052 (= (_ bv10 8) ?x24051)))
 (let ((?x25263 (ite $x24052 (_ bv15 64) (_ bv64 64))))
 (let ((?x23383 (ite $x15714 (_ bv14 64) ?x25263)))
 (let ((?x15343 (ite $x15873 (_ bv13 64) ?x23383)))
 (let ((?x26157 (ite $x16342 (_ bv12 64) ?x15343)))
 (let ((?x25135 (ite $x15952 (_ bv11 64) ?x26157)))
 (let ((?x23951 (ite $x15541 (_ bv10 64) ?x25135)))
 (let ((?x15691 (ite $x23833 (_ bv9 64) ?x23951)))
 (let ((?x25102 (ite $x24036 (_ bv8 64) ?x15691)))
 (let ((?x23868 (ite $x24040 (_ bv7 64) ?x25102)))
 (let ((?x25224 (ite $x24046 (_ bv6 64) ?x23868)))
 (let ((?x25270 (ite $x15798 (_ bv5 64) ?x25224)))
 (let ((?x24513 (ite $x24058 (_ bv4 64) ?x25270)))
 (let ((?x23521 (ite $x24064 (_ bv3 64) ?x24513)))
 (let ((?x25549 (ite $x24072 (_ bv2 64) ?x23521)))
 (let ((?x24348 (ite $x24078 (_ bv1 64) ?x25549)))
 (let ((?x24584 (ite $x24085 (_ bv0 64) ?x24348)))
 (let (($x26422 (and (distinct (_ bv0 32) ?x25327) true)))
 (let ((?x26211 (ite $x26422 ?x24584 ?x23457)))
 (let ((?x26235 ((_ extract 31 0) ?x26211)))
 (let ((?x15503 ((_ zero_extend 32) ?x26235)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
...
(assert
 ...
 (let ((?x24051 ((_ extract 127 120) mem_0_113_128)))
 (let (($x24052 (= (_ bv10 8) ?x24051)))
 (let ((?x34078 (ite $x24052 (_ bv15 32) (_ bv64 32))))
 (let ((?x15698 ((_ extract 119 112) mem_0_113_128)))
 (let (($x15714 (= (_ bv10 8) ?x15698)))
 (let ((?x34074 (ite $x15714 (_ bv14 32) ?x34078)))
 (let ((?x15665 ((_ extract 111 104) mem_0_113_128)))
 (let (($x15873 (= (_ bv10 8) ?x15665)))
 (let ((?x34081 (ite $x15873 (_ bv13 32) ?x34074)))
 (let ((?x24049 ((_ extract 103 96) mem_0_113_128)))
 (let (($x16342 (= (_ bv10 8) ?x24049)))
 (let ((?x34082 (ite $x16342 (_ bv12 32) ?x34081)))
 (let ((?x16461 ((_ extract 95 88) mem_0_113_128)))
 (let (($x15952 (= (_ bv10 8) ?x16461)))
 (let ((?x34083 (ite $x15952 (_ bv11 32) ?x34082)))
 (let ((?x15973 ((_ extract 87 80) mem_0_113_128)))
 (let (($x15541 (= (_ bv10 8) ?x15973)))
 (let ((?x33368 (ite $x15541 (_ bv10 32) ?x34083)))
 (let ((?x15582 ((_ extract 79 72) mem_0_113_128)))
 (let (($x23833 (= (_ bv10 8) ?x15582)))
 (let ((?x34071 (ite $x23833 (_ bv9 32) ?x33368)))
 (let ((?x24033 ((_ extract 71 64) mem_0_113_128)))
 (let (($x24036 (= (_ bv10 8) ?x24033)))
 (let ((?x34092 (ite $x24036 (_ bv8 32) ?x34071)))
 (let ((?x24034 ((_ extract 63 56) mem_0_113_128)))
 (let (($x24040 (= (_ bv10 8) ?x24034)))
 (let ((?x34073 (ite $x24040 (_ bv7 32) ?x34092)))
 (let ((?x24043 ((_ extract 55 48) mem_0_113_128)))
 (let (($x24046 (= (_ bv10 8) ?x24043)))
 (let ((?x33441 (ite $x24046 (_ bv6 32) ?x34073)))
 (let ((?x15994 ((_ extract 47 40) mem_0_113_128)))
 (let (($x15798 (= (_ bv10 8) ?x15994)))
 (let ((?x34089 (ite $x15798 (_ bv5 32) ?x33441)))
 (let ((?x24055 ((_ extract 39 32) mem_0_113_128)))
 (let (($x24058 (= (_ bv10 8) ?x24055)))
 (let ((?x34090 (ite $x24058 (_ bv4 32) ?x34089)))
 (let ((?x24063 ((_ extract 31 24) mem_0_113_128)))
 (let (($x24064 (= (_ bv10 8) ?x24063)))
 (let ((?x34091 (ite $x24064 (_ bv3 32) ?x34090)))
 (let ((?x24069 ((_ extract 23 16) mem_0_113_128)))
 (let (($x24072 (= (_ bv10 8) ?x24069)))
 (let ((?x34072 (ite $x24072 (_ bv2 32) ?x34091)))
 (let ((?x24076 ((_ extract 15 8) mem_0_113_128)))
 (let (($x24078 (= (_ bv10 8) ?x24076)))
 (let ((?x34088 (ite $x24078 (_ bv1 32) ?x34072)))
 (let ((?x24082 ((_ extract 7 0) mem_0_113_128)))
 (let (($x24085 (= (_ bv10 8) ?x24082)))
 (let ((?x34778 (ite $x24085 (_ bv0 32) ?x34088)))
 (let ((?x24038 (ite $x24085 (_ bv1 1) (_ bv0 1))))
 (let ((?x24041 (ite $x24078 (_ bv1 1) (_ bv0 1))))
 (let ((?x24047 (ite $x24072 (_ bv1 1) (_ bv0 1))))
 (let ((?x24092 (ite $x24064 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x24065 (ite $x16342 (_ bv1 1) (_ bv0 1))))
 (let ((?x24122 (ite $x15873 (_ bv1 1) (_ bv0 1))))
 (let ((?x25783 (concat (concat (concat (_ bv0 16) (ite $x24052 (_ bv1 1) (_ bv0 1))) (ite $x15714 (_ bv1 1) (_ bv0 1))) ?x24122)))
 (let ((?x24898 (concat (concat (concat (concat (concat ?x25783 ?x24065) ?x15623) ?x24107) ?x15896) ?x15535)))
 (let ((?x23681 (concat (concat (concat (concat (concat ?x24898 ?x24077) ?x24150) ?x24119) ?x24139) ?x24092)))
 (let ((?x25327 (concat (concat (concat ?x23681 ?x24047) ?x24041) ?x24038)))
 (let (($x34079 (not $x24052)))
 (let (($x34075 (not $x15714)))
 (let (($x34087 (not $x15873)))
 (let (($x34077 (not $x16342)))
 (let (($x34860 (not $x15952)))
 (let (($x34859 (not $x15541)))
 (let (($x34854 (not $x23833)))
 (let (($x33288 (not $x24036)))
 (let (($x34069 (not $x24040)))
 (let (($x34076 (not $x24046)))
 (let (($x33367 (not $x15798)))
 (let (($x34070 (not $x24058)))
 (let (($x33365 (not $x24064)))
 (let (($x33370 (not $x24072)))
 (let (($x34667 (not $x24078)))
 (let (($x34562 (not $x24085)))
 (let (($x34080 (and $x34562 $x34667 $x33370 $x33365 $x34070 $x33367 $x34076 $x34069 $x33288 $x34854 $x34859 $x34860 $x34077 $x34087 $x34075 $x34079)))
 (let ((?x34782 (ite $x34080 ?x25327 ?x34778)))
 (let ((?x34784 (concat (_ bv0 32) ?x34782)))
 (let ((?x42653 (bvadd (bvadd (_ bv16 64) ?x34784) ?x14202)))
 (and (distinct (_ bv0 64) ?x42653) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
