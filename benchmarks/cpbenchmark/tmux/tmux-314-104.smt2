...
(assert
 ...
 (let ((?x27564 ((_ extract 127 120) mem_20_123_128)))
 (let (($x29776 (= (_ bv10 8) ?x27564)))
 (let ((?x45777 (ite $x29776 (_ bv15 32) (_ bv64 32))))
 (let ((?x28916 ((_ extract 119 112) mem_20_123_128)))
 (let (($x28548 (= (_ bv10 8) ?x28916)))
 (let ((?x44765 (ite $x28548 (_ bv14 32) ?x45777)))
 (let ((?x28328 ((_ extract 111 104) mem_20_123_128)))
 (let (($x29997 (= (_ bv10 8) ?x28328)))
 (let ((?x45814 (ite $x29997 (_ bv13 32) ?x44765)))
 (let ((?x29150 ((_ extract 103 96) mem_20_123_128)))
 (let (($x29126 (= (_ bv10 8) ?x29150)))
 (let ((?x45819 (ite $x29126 (_ bv12 32) ?x45814)))
 (let ((?x28802 ((_ extract 95 88) mem_20_123_128)))
 (let (($x29162 (= (_ bv10 8) ?x28802)))
 (let ((?x45818 (ite $x29162 (_ bv11 32) ?x45819)))
 (let ((?x30008 ((_ extract 87 80) mem_20_123_128)))
 (let (($x29156 (= (_ bv10 8) ?x30008)))
 (let ((?x45815 (ite $x29156 (_ bv10 32) ?x45818)))
 (let ((?x28875 ((_ extract 79 72) mem_20_123_128)))
 (let (($x27570 (= (_ bv10 8) ?x28875)))
 (let ((?x43415 (ite $x27570 (_ bv9 32) ?x45815)))
 (let ((?x27600 ((_ extract 71 64) mem_20_123_128)))
 (let (($x29163 (= (_ bv10 8) ?x27600)))
 (let ((?x43698 (ite $x29163 (_ bv8 32) ?x43415)))
 (let ((?x28526 ((_ extract 63 56) mem_20_123_128)))
 (let (($x27705 (= (_ bv10 8) ?x28526)))
 (let ((?x45745 (ite $x27705 (_ bv7 32) ?x43698)))
 (let ((?x29896 ((_ extract 55 48) mem_20_123_128)))
 (let (($x28664 (= (_ bv10 8) ?x29896)))
 (let ((?x43193 (ite $x28664 (_ bv6 32) ?x45745)))
 (let ((?x28755 ((_ extract 47 40) mem_20_123_128)))
 (let (($x28233 (= (_ bv10 8) ?x28755)))
 (let ((?x45757 (ite $x28233 (_ bv5 32) ?x43193)))
 (let ((?x27423 ((_ extract 39 32) mem_20_123_128)))
 (let (($x27636 (= (_ bv10 8) ?x27423)))
 (let ((?x45794 (ite $x27636 (_ bv4 32) ?x45757)))
 (let ((?x29115 ((_ extract 31 24) mem_20_123_128)))
 (let (($x29431 (= (_ bv10 8) ?x29115)))
 (let ((?x43673 (ite $x29431 (_ bv3 32) ?x45794)))
 (let ((?x29879 ((_ extract 23 16) mem_20_123_128)))
 (let (($x28208 (= (_ bv10 8) ?x29879)))
 (let ((?x45824 (ite $x28208 (_ bv2 32) ?x43673)))
 (let ((?x28217 ((_ extract 15 8) mem_20_123_128)))
 (let (($x28212 (= (_ bv10 8) ?x28217)))
 (let ((?x45874 (ite $x28212 (_ bv1 32) ?x45824)))
 (let ((?x28285 ((_ extract 7 0) mem_20_123_128)))
 (let (($x28142 (= (_ bv10 8) ?x28285)))
 (let ((?x43388 (ite $x28142 (_ bv0 32) ?x45874)))
 (let ((?x28209 (ite $x28142 (_ bv1 1) (_ bv0 1))))
 (let ((?x28094 (ite $x28212 (_ bv1 1) (_ bv0 1))))
 (let ((?x28143 (ite $x28208 (_ bv1 1) (_ bv0 1))))
 (let ((?x28352 (ite $x29431 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x28072 (ite $x29126 (_ bv1 1) (_ bv0 1))))
 (let ((?x29084 (ite $x29997 (_ bv1 1) (_ bv0 1))))
 (let ((?x36571 (concat (concat (concat (_ bv0 16) (ite $x29776 (_ bv1 1) (_ bv0 1))) (ite $x28548 (_ bv1 1) (_ bv0 1))) ?x29084)))
 (let ((?x35895 (concat (concat (concat (concat (concat ?x36571 ?x28072) ?x28028) ?x28042) ?x28982) ?x29917)))
 (let ((?x35958 (concat (concat (concat (concat (concat ?x35895 ?x28096) ?x29187) ?x29619) ?x28058) ?x28352)))
 (let ((?x36019 (concat (concat (concat ?x35958 ?x28143) ?x28094) ?x28209)))
 (let (($x45837 (not $x29776)))
 (let (($x43389 (not $x28548)))
 (let (($x45828 (not $x29997)))
 (let (($x45810 (not $x29126)))
 (let (($x45836 (not $x29162)))
 (let (($x45856 (not $x29156)))
 (let (($x45855 (not $x27570)))
 (let (($x45813 (not $x29163)))
 (let (($x45879 (not $x27705)))
 (let (($x45809 (not $x28664)))
 (let (($x45812 (not $x28233)))
 (let (($x45807 (not $x27636)))
 (let (($x45808 (not $x29431)))
 (let (($x45880 (not $x28208)))
 (let (($x45806 (not $x28212)))
 (let (($x45383 (not $x28142)))
 (let (($x45773 (and $x45383 $x45806 $x45880 $x45808 $x45807 $x45812 $x45809 $x45879 $x45813 $x45855 $x45856 $x45836 $x45810 $x45828 $x43389 $x45837)))
 (let ((?x43392 (ite $x45773 ?x36019 ?x43388)))
 (let ((?x44926 (concat (_ bv0 32) ?x43392)))
 (let ((?x45787 (bvadd (bvadd (_ bv48 64) ?x44926) ?x14202)))
 (and (distinct (_ bv0 64) ?x45787) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
