...
(assert
 ...
 (and (distinct (_ bv0 16) ?x36621) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x6435 ((_ extract 839 836) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 ...
 (let ((?x36741 ((_ extract 127 120) mem_30_134_128)))
 (let (($x36644 (= (_ bv10 8) ?x36741)))
 (let ((?x49886 (ite $x36644 (_ bv15 32) (_ bv64 32))))
 (let ((?x36188 ((_ extract 119 112) mem_30_134_128)))
 (let (($x36771 (= (_ bv10 8) ?x36188)))
 (let ((?x50427 (ite $x36771 (_ bv14 32) ?x49886)))
 (let ((?x36549 ((_ extract 111 104) mem_30_134_128)))
 (let (($x36500 (= (_ bv10 8) ?x36549)))
 (let ((?x48961 (ite $x36500 (_ bv13 32) ?x50427)))
 (let ((?x36591 ((_ extract 103 96) mem_30_134_128)))
 (let (($x36668 (= (_ bv10 8) ?x36591)))
 (let ((?x50174 (ite $x36668 (_ bv12 32) ?x48961)))
 (let ((?x36949 ((_ extract 95 88) mem_30_134_128)))
 (let (($x36566 (= (_ bv10 8) ?x36949)))
 (let ((?x50407 (ite $x36566 (_ bv11 32) ?x50174)))
 (let ((?x36488 ((_ extract 87 80) mem_30_134_128)))
 (let (($x36826 (= (_ bv10 8) ?x36488)))
 (let ((?x49674 (ite $x36826 (_ bv10 32) ?x50407)))
 (let ((?x36603 ((_ extract 79 72) mem_30_134_128)))
 (let (($x35664 (= (_ bv10 8) ?x36603)))
 (let ((?x50606 (ite $x35664 (_ bv9 32) ?x49674)))
 (let ((?x36663 ((_ extract 71 64) mem_30_134_128)))
 (let (($x34781 (= (_ bv10 8) ?x36663)))
 (let ((?x53130 (ite $x34781 (_ bv8 32) ?x50606)))
 (let ((?x35308 ((_ extract 63 56) mem_30_134_128)))
 (let (($x34288 (= (_ bv10 8) ?x35308)))
 (let ((?x47944 (ite $x34288 (_ bv7 32) ?x53130)))
 (let ((?x34201 ((_ extract 55 48) mem_30_134_128)))
 (let (($x34199 (= (_ bv10 8) ?x34201)))
 (let ((?x53265 (ite $x34199 (_ bv6 32) ?x47944)))
 (let ((?x34197 ((_ extract 47 40) mem_30_134_128)))
 (let (($x34196 (= (_ bv10 8) ?x34197)))
 (let ((?x47699 (ite $x34196 (_ bv5 32) ?x53265)))
 (let ((?x34188 ((_ extract 39 32) mem_30_134_128)))
 (let (($x34067 (= (_ bv10 8) ?x34188)))
 (let ((?x53129 (ite $x34067 (_ bv4 32) ?x47699)))
 (let ((?x34379 ((_ extract 31 24) mem_30_134_128)))
 (let (($x34265 (= (_ bv10 8) ?x34379)))
 (let ((?x48332 (ite $x34265 (_ bv3 32) ?x53129)))
 (let ((?x34693 ((_ extract 23 16) mem_30_134_128)))
 (let (($x34236 (= (_ bv10 8) ?x34693)))
 (let ((?x50046 (ite $x34236 (_ bv2 32) ?x48332)))
 (let ((?x34389 ((_ extract 15 8) mem_30_134_128)))
 (let (($x34392 (= (_ bv10 8) ?x34389)))
 (let ((?x48129 (ite $x34392 (_ bv1 32) ?x50046)))
 (let ((?x34256 ((_ extract 7 0) mem_30_134_128)))
 (let (($x34246 (= (_ bv10 8) ?x34256)))
 (let ((?x50534 (ite $x34246 (_ bv0 32) ?x48129)))
 (let ((?x34612 (ite $x34246 (_ bv1 1) (_ bv0 1))))
 (let ((?x35394 (ite $x34392 (_ bv1 1) (_ bv0 1))))
 (let ((?x36270 (ite $x34236 (_ bv1 1) (_ bv0 1))))
 (let ((?x36426 (ite $x34265 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x36960 (ite $x36668 (_ bv1 1) (_ bv0 1))))
 (let ((?x36734 (ite $x36500 (_ bv1 1) (_ bv0 1))))
 (let ((?x40958 (concat (concat (concat (_ bv0 16) (ite $x36644 (_ bv1 1) (_ bv0 1))) (ite $x36771 (_ bv1 1) (_ bv0 1))) ?x36734)))
 (let ((?x45358 (concat (concat (concat (concat (concat ?x40958 ?x36960) ?x36280) ?x35325) ?x36964) ?x34627)))
 (let ((?x43632 (concat (concat (concat (concat (concat ?x45358 ?x36977) ?x36953) ?x36946) ?x34466) ?x36426)))
 (let ((?x44386 (concat (concat (concat ?x43632 ?x36270) ?x35394) ?x34612)))
 (let (($x52513 (not $x36644)))
 (let (($x47728 (not $x36771)))
 (let (($x47975 (not $x36500)))
 (let (($x49944 (not $x36668)))
 (let (($x49537 (not $x36566)))
 (let (($x54237 (not $x36826)))
 (let (($x52136 (not $x35664)))
 (let (($x47629 (not $x34781)))
 (let (($x50891 (not $x34288)))
 (let (($x48273 (not $x34199)))
 (let (($x53217 (not $x34196)))
 (let (($x49977 (not $x34067)))
 (let (($x48859 (not $x34265)))
 (let (($x53289 (not $x34236)))
 (let (($x52561 (not $x34392)))
 (let (($x49635 (not $x34246)))
 (let (($x49983 (and $x49635 $x52561 $x53289 $x48859 $x49977 $x53217 $x48273 $x50891 $x47629 $x52136 $x54237 $x49537 $x49944 $x47975 $x47728 $x52513)))
 (let ((?x50700 (ite $x49983 ?x44386 ?x50534)))
 (let ((?x48861 (concat (_ bv0 32) ?x50700)))
 (let ((?x52522 (bvadd (bvadd (_ bv64 64) ?x48861) ?x14202)))
 (and (distinct (_ bv0 64) ?x52522) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
