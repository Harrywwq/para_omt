...
(assert
 ...
 (let ((?x122852 (concat (concat (_ bv0 26) mem_c0080024_86_32) (_ bv0 1))))
 (let ((?x201 (concat (_ bv0 27) mem_c0080024_86_32)))
 (let ((?x125103 (bvadd ?x201 ?x122852)))
 (let ((?x124441 (concat ?x125103 (_ bv0 3))))
 (let ((?x128 (concat (_ bv0 29) mem_c0080024_86_32)))
 (let ((?x133983 (concat ?x128 (_ bv0 1))))
 (let ((?x190 (concat (_ bv0 30) mem_c0080024_86_32)))
 (let ((?x127184 (bvadd (bvadd ?x190 ?x133983) ?x124441)))
 (let ((?x126636 (concat ?x127184 (_ bv0 2))))
 (let ((?x168 (concat (_ bv0 32) mem_c0080020_87_32)))
 (let ((?x124372 (bvadd ?x168 ?x126636)))
 (let ((?x124374 (concat (concat (_ bv0 29) mem_c0080010_84_32) (_ bv0 1))))
 (let ((?x161 (concat (_ bv0 30) mem_c0080010_84_32)))
 (let ((?x127993 (bvadd ?x161 ?x124374)))
 (let ((?x132150 (concat ?x127993 (_ bv0 2))))
 (let ((?x143 (concat (_ bv0 32) mem_c0080008_85_32)))
 (let ((?x120025 (bvadd ?x143 ?x132150)))
 (let (($x133683 (bvsle ?x124372 ?x120025)))
 (let ((?x127732 (ite $x133683 ?x120025 ?x124372)))
 (let (($x127978 (bvsle ?x129 ?x127732)))
 (let ((?x126895 (ite $x127978 ?x127732 ?x129)))
 (let (($x126712 (= (_ bv0 64) ?x126895)))
 (not $x126712))))))))))))))))))))))))))
(assert
