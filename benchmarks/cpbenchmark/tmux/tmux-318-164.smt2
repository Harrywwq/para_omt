...
(assert
 ...
 (bvugt ?x50547 (_ bv16 64)))))))))))))))))))))))))))))))))))
(assert
 (let ((?x4996 ((_ extract 837 832) mem_c0000f45_79_992)))
 (let ((?x58073 (bvadd (_ bv1 6) ?x4996)))
 (let ((?x196410 (concat (_ bv0 26) ?x58073)))
 (let ((?x196749 (bvand ?x196410 (_ bv15 32))))
 (let ((?x194985 ((_ zero_extend 32) ?x196749)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 (let ((?x2357 ((_ extract 815 808) mem_c0000f45_79_992)))
 ...
 (let (($x50372 (and $x51616 $x51938)))
 (let ((?x50547 (ite $x50372 ?x30195 (_ bv398 64))))
 (let ((?x196392 (bvadd (bvadd (_ bv18446744073709551600 64) ?x50547) ?x194985)))
 (bvugt ?x196392 (_ bv64 64)))))))))))))))))))))))))))))))))))))))))
