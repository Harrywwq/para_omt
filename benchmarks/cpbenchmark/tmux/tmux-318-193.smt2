...
(assert
 ...
 (and (distinct (_ bv0 16) ?x33819) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x33457 ((_ extract 7 0) mem_10_132_128)))
 (let (($x33455 (= (_ bv10 8) ?x33457)))
 (let ((?x33804 (ite $x33455 (_ bv1 1) (_ bv0 1))))
 ...
 (let (($x33285 (= (_ bv10 8) ?x33766)))
 (let ((?x33789 (ite $x33285 (_ bv1 1) (_ bv0 1))))
 (let ((?x42681 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 127 120) mem_10_132_128)) (_ bv1 1) (_ bv0 1))) ?x33789)))
 (let ((?x41488 (concat (concat (concat (concat (concat ?x42681 ?x33783) ?x33780) ?x33798) ?x33525) ?x33795)))
 (let ((?x40620 (concat (concat (concat (concat (concat ?x41488 ?x33786) ?x33462) ?x33777) ?x33531) ?x33567)))
 (let ((?x41290 (concat (concat (concat (concat ?x40620 ?x33792) ?x33802) ?x33803) ?x33804)))
 (let ((?x41255 ((_ zero_extend 32) ?x41290)))
 (let ((?x33577 ((_ extract 127 120) mem_10_132_128)))
 (let (($x33527 (= (_ bv10 8) ?x33577)))
 (let ((?x41363 (ite $x33527 (_ bv15 64) (_ bv64 64))))
 (let ((?x42077 (ite $x33285 (_ bv14 64) ?x41363)))
 (let ((?x41664 (ite $x33579 (_ bv13 64) ?x42077)))
 (let ((?x42478 (ite $x33316 (_ bv12 64) ?x41664)))
 (let ((?x40849 (ite $x33449 (_ bv11 64) ?x42478)))
 (let ((?x41243 (ite $x33458 (_ bv10 64) ?x40849)))
 (let ((?x41302 (ite $x33451 (_ bv9 64) ?x41243)))
 (let ((?x39401 (ite $x33453 (_ bv8 64) ?x41302)))
 (let ((?x39840 (ite $x33282 (_ bv7 64) ?x39401)))
 (let ((?x40920 (ite $x33461 (_ bv6 64) ?x39840)))
 (let ((?x41873 (ite $x33450 (_ bv5 64) ?x40920)))
 (let ((?x40381 (ite $x34512 (_ bv4 64) ?x41873)))
 (let ((?x40336 (ite $x33323 (_ bv3 64) ?x40381)))
 (let ((?x42166 (ite $x33354 (_ bv2 64) ?x40336)))
 (let ((?x42713 (ite $x33446 (_ bv1 64) ?x42166)))
 (let ((?x42624 (ite $x33455 (_ bv0 64) ?x42713)))
 (let (($x40455 (and (distinct (_ bv0 32) ?x41290) true)))
 (let ((?x42668 (ite $x40455 ?x42624 ?x41255)))
 (let ((?x41372 ((_ extract 31 0) ?x42668)))
 (let ((?x41216 ((_ zero_extend 32) ?x41372)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
...
(assert
 (let ((?x33577 ((_ extract 127 120) mem_10_132_128)))
 (let (($x33527 (= (_ bv10 8) ?x33577)))
 (let ((?x50761 (ite $x33527 (_ bv15 32) (_ bv64 32))))
 (let ((?x33766 ((_ extract 119 112) mem_10_132_128)))
 (let (($x33285 (= (_ bv10 8) ?x33766)))
 (let ((?x50681 (ite $x33285 (_ bv14 32) ?x50761)))
 (let ((?x33580 ((_ extract 111 104) mem_10_132_128)))
 (let (($x33579 (= (_ bv10 8) ?x33580)))
 (let ((?x50695 (ite $x33579 (_ bv13 32) ?x50681)))
 (let ((?x33460 ((_ extract 103 96) mem_10_132_128)))
 (let (($x33316 (= (_ bv10 8) ?x33460)))
 (let ((?x47721 (ite $x33316 (_ bv12 32) ?x50695)))
 (let ((?x33448 ((_ extract 95 88) mem_10_132_128)))
 (let (($x33449 (= (_ bv10 8) ?x33448)))
 (let ((?x50732 (ite $x33449 (_ bv11 32) ?x47721)))
 (let ((?x33528 ((_ extract 87 80) mem_10_132_128)))
 (let (($x33458 (= (_ bv10 8) ?x33528)))
 (let ((?x49217 (ite $x33458 (_ bv10 32) ?x50732)))
 (let ((?x33454 ((_ extract 79 72) mem_10_132_128)))
 (let (($x33451 (= (_ bv10 8) ?x33454)))
 (let ((?x50365 (ite $x33451 (_ bv9 32) ?x49217)))
 (let ((?x33522 ((_ extract 71 64) mem_10_132_128)))
 (let (($x33453 (= (_ bv10 8) ?x33522)))
 (let ((?x48677 (ite $x33453 (_ bv8 32) ?x50365)))
 (let ((?x33573 ((_ extract 63 56) mem_10_132_128)))
 (let (($x33282 (= (_ bv10 8) ?x33573)))
 (let ((?x48441 (ite $x33282 (_ bv7 32) ?x48677)))
 (let ((?x33435 ((_ extract 55 48) mem_10_132_128)))
 (let (($x33461 (= (_ bv10 8) ?x33435)))
 (let ((?x50652 (ite $x33461 (_ bv6 32) ?x48441)))
 (let ((?x33203 ((_ extract 47 40) mem_10_132_128)))
 (let (($x33450 (= (_ bv10 8) ?x33203)))
 (let ((?x50042 (ite $x33450 (_ bv5 32) ?x50652)))
 (let ((?x33204 ((_ extract 39 32) mem_10_132_128)))
 (let (($x34512 (= (_ bv10 8) ?x33204)))
 (let ((?x48233 (ite $x34512 (_ bv4 32) ?x50042)))
 (let ((?x33216 ((_ extract 31 24) mem_10_132_128)))
 (let (($x33323 (= (_ bv10 8) ?x33216)))
 (let ((?x50643 (ite $x33323 (_ bv3 32) ?x48233)))
 (let ((?x33164 ((_ extract 23 16) mem_10_132_128)))
 (let (($x33354 (= (_ bv10 8) ?x33164)))
 (let ((?x49958 (ite $x33354 (_ bv2 32) ?x50643)))
 (let ((?x33518 ((_ extract 15 8) mem_10_132_128)))
 (let (($x33446 (= (_ bv10 8) ?x33518)))
 (let ((?x50642 (ite $x33446 (_ bv1 32) ?x49958)))
 (let ((?x33457 ((_ extract 7 0) mem_10_132_128)))
 (let (($x33455 (= (_ bv10 8) ?x33457)))
 (let ((?x50386 (ite $x33455 (_ bv0 32) ?x50642)))
 (let ((?x33804 (ite $x33455 (_ bv1 1) (_ bv0 1))))
 (let ((?x33803 (ite $x33446 (_ bv1 1) (_ bv0 1))))
 (let ((?x33802 (ite $x33354 (_ bv1 1) (_ bv0 1))))
 (let ((?x33792 (ite $x33323 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x33780 (ite $x33316 (_ bv1 1) (_ bv0 1))))
 (let ((?x33783 (ite $x33579 (_ bv1 1) (_ bv0 1))))
 (let ((?x41005 (concat (concat (concat (_ bv0 16) (ite $x33527 (_ bv1 1) (_ bv0 1))) (ite $x33285 (_ bv1 1) (_ bv0 1))) ?x33783)))
 (let ((?x41958 (concat (concat (concat (concat (concat ?x41005 ?x33780) ?x33798) ?x33525) ?x33795) ?x33786)))
 (let ((?x42975 (concat (concat (concat (concat (concat ?x41958 ?x33462) ?x33777) ?x33531) ?x33567) ?x33792)))
 (let ((?x41290 (concat (concat (concat ?x42975 ?x33802) ?x33803) ?x33804)))
 (let (($x50667 (not $x33527)))
 (let (($x50791 (not $x33285)))
 (let (($x50665 (not $x33579)))
 (let (($x50853 (not $x33316)))
 (let (($x50911 (not $x33449)))
 (let (($x50720 (not $x33458)))
 (let (($x50701 (not $x33451)))
 (let (($x50466 (not $x33453)))
 (let (($x50885 (not $x33282)))
 (let (($x50812 (not $x33461)))
 (let (($x49671 (not $x33450)))
 (let (($x50934 (not $x34512)))
 (let (($x48730 (not $x33323)))
 (let (($x49479 (not $x33354)))
 (let (($x47643 (not $x33446)))
 (let (($x48382 (not $x33455)))
 (let (($x50724 (and $x48382 $x47643 $x49479 $x48730 $x50934 $x49671 $x50812 $x50885 $x50466 $x50701 $x50720 $x50911 $x50853 $x50665 $x50791 $x50667)))
 (let ((?x49984 (ite $x50724 ?x41290 ?x50386)))
 (let ((?x49988 (concat (_ bv0 32) ?x49984)))
 (let ((?x6435 ((_ extract 839 836) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 (let ((?x2357 ((_ extract 815 808) mem_c0000f45_79_992)))
 ...
 (let ((?x62502 (bvadd ?x59154 ?x49988)))
 (and (distinct (_ bv0 64) ?x62502) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
