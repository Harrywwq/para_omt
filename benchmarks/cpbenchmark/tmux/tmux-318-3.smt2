...
(assert
 ...
 (let ((?x204733 (concat (concat (_ bv0 26) mem_c0080024_86_32) (_ bv0 1))))
 (let ((?x201 (concat (_ bv0 27) mem_c0080024_86_32)))
 (let ((?x207322 (bvadd ?x201 ?x204733)))
 (let ((?x197195 (concat ?x207322 (_ bv0 3))))
 (let ((?x206305 (concat (concat (_ bv0 29) mem_c0080024_86_32) (_ bv0 1))))
 (let ((?x190 (concat (_ bv0 30) mem_c0080024_86_32)))
 (let ((?x206559 (bvadd (bvadd ?x190 ?x206305) ?x197195)))
 (let ((?x206139 (concat ?x206559 (_ bv0 2))))
 (let ((?x168 (concat (_ bv0 32) mem_c0080020_87_32)))
 (let ((?x204228 (bvadd ?x168 ?x206139)))
 (let ((?x205398 (concat (concat (_ bv0 29) mem_c0080010_84_32) (_ bv0 1))))
 (let ((?x161 (concat (_ bv0 30) mem_c0080010_84_32)))
 (let ((?x205346 (bvadd ?x161 ?x205398)))
 (let ((?x203660 (concat ?x205346 (_ bv0 2))))
 (let ((?x143 (concat (_ bv0 32) mem_c0080008_85_32)))
 (let ((?x82 (bvadd ?x143 ?x203660)))
 (let (($x205861 (bvsle ?x204228 ?x82)))
 (let ((?x205785 (ite $x205861 ?x82 ?x204228)))
 (let (($x205463 (bvsle ?x129 ?x205785)))
 (let ((?x203714 (ite $x205463 ?x205785 ?x129)))
 (let (($x205388 (= (_ bv0 64) ?x203714)))
 (not $x205388)))))))))))))))))))))))))
(assert
