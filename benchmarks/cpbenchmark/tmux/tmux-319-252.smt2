...
(assert
 ...
 (let (($x61636 (= (_ bv10 8) ?x59062)))
 (let ((?x81342 (ite $x61636 (_ bv1 1) (_ bv0 1))))
 (let ((?x124412 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 2439 2432) mem_40_155_2560)) (_ bv1 1) (_ bv0 1))) ?x81342)))
 (let ((?x123829 (concat (concat (concat (concat (concat ?x124412 ?x80946) ?x87823) ?x86778) ?x86976) ?x85306)))
 (let ((?x123540 (concat (concat (concat (concat (concat ?x123829 ?x87720) ?x84516) ?x85353) ?x83977) ?x87464)))
 (let ((?x122335 (concat (concat (concat (concat ?x123540 ?x85137) ?x85770) ?x87148) ?x85964)))
 (let ((?x124669 ((_ zero_extend 32) ?x122335)))
 (let ((?x59686 ((_ extract 2439 2432) mem_40_155_2560)))
 (let (($x57872 (= (_ bv10 8) ?x59686)))
 (let ((?x123057 (ite $x57872 (_ bv15 64) (_ bv64 64))))
 (let ((?x122538 (ite $x61636 (_ bv14 64) ?x123057)))
 (let ((?x123528 (ite $x61502 (_ bv13 64) ?x122538)))
 (let ((?x123956 (ite $x59235 (_ bv12 64) ?x123528)))
 (let ((?x123133 (ite $x59759 (_ bv11 64) ?x123956)))
 (let ((?x123621 (ite $x63277 (_ bv10 64) ?x123133)))
 (let ((?x123721 (ite $x55919 (_ bv9 64) ?x123621)))
 (let ((?x123593 (ite $x60858 (_ bv8 64) ?x123721)))
 (let ((?x123754 (ite $x57860 (_ bv7 64) ?x123593)))
 (let ((?x121478 (ite $x58805 (_ bv6 64) ?x123754)))
 (let ((?x124361 (ite $x60391 (_ bv5 64) ?x121478)))
 (let ((?x123508 (ite $x55144 (_ bv4 64) ?x124361)))
 (let ((?x122742 (ite $x61093 (_ bv3 64) ?x123508)))
 (let ((?x123087 (ite $x63108 (_ bv2 64) ?x122742)))
 (let ((?x123874 (ite $x64353 (_ bv1 64) ?x123087)))
 (let ((?x123786 (ite $x60238 (_ bv0 64) ?x123874)))
 (let (($x122886 (and (distinct (_ bv0 32) ?x122335) true)))
 (let ((?x124383 (ite $x122886 ?x123786 ?x124669)))
 (let ((?x123149 ((_ extract 31 0) ?x124383)))
 (let ((?x122928 ((_ zero_extend 32) ?x123149)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
