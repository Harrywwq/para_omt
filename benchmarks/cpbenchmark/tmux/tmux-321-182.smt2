...
(assert
 ...
 (let ((?x292696 (bvadd ?x292589 ?x292542)))
 (let (($x290225 (bvule ?x292696 ?x286410)))
 (not $x290225)))))))))))))))))))))
(assert
...
(assert
 (let ((?x292395 (bvadd mem_c0000ff0_235_64 (_ bv8 64))))
 (= (_ bv9223372036854775816 64) ?x292395)))
(assert
 (let ((?x3977 ((_ extract 583 576) mem_c0000f45_79_992)))
 (let ((?x935 ((_ extract 575 568) mem_c0000f45_79_992)))
 ...
 (= (_ bv4294967295 32) ?x102547))))))
(assert
 (bvule mem_8000000000000020_271_64 mem_8000000000000008_316_64))
