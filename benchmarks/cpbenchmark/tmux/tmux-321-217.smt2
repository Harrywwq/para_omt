...
(assert
 (let ((?x42721 ((_ extract 127 120) mem_30_167_128)))
 (let (($x52300 (= (_ bv10 8) ?x42721)))
 (let ((?x101134 (ite $x52300 (_ bv15 32) (_ bv64 32))))
 (let ((?x48767 ((_ extract 119 112) mem_30_167_128)))
 (let (($x51073 (= (_ bv10 8) ?x48767)))
 (let ((?x100801 (ite $x51073 (_ bv14 32) ?x101134)))
 (let ((?x58063 ((_ extract 111 104) mem_30_167_128)))
 (let (($x47600 (= (_ bv10 8) ?x58063)))
 (let ((?x103458 (ite $x47600 (_ bv13 32) ?x100801)))
 (let ((?x47597 ((_ extract 103 96) mem_30_167_128)))
 (let (($x48135 (= (_ bv10 8) ?x47597)))
 (let ((?x100517 (ite $x48135 (_ bv12 32) ?x103458)))
 (let ((?x42333 ((_ extract 95 88) mem_30_167_128)))
 (let (($x48749 (= (_ bv10 8) ?x42333)))
 (let ((?x101320 (ite $x48749 (_ bv11 32) ?x100517)))
 (let ((?x53137 ((_ extract 87 80) mem_30_167_128)))
 (let (($x53541 (= (_ bv10 8) ?x53137)))
 (let ((?x101257 (ite $x53541 (_ bv10 32) ?x101320)))
 (let ((?x54950 ((_ extract 79 72) mem_30_167_128)))
 (let (($x51354 (= (_ bv10 8) ?x54950)))
 (let ((?x101447 (ite $x51354 (_ bv9 32) ?x101257)))
 (let ((?x54983 ((_ extract 71 64) mem_30_167_128)))
 (let (($x52069 (= (_ bv10 8) ?x54983)))
 (let ((?x100761 (ite $x52069 (_ bv8 32) ?x101447)))
 (let ((?x40838 ((_ extract 63 56) mem_30_167_128)))
 (let (($x53602 (= (_ bv10 8) ?x40838)))
 (let ((?x101506 (ite $x53602 (_ bv7 32) ?x100761)))
 (let ((?x42264 ((_ extract 55 48) mem_30_167_128)))
 (let (($x53637 (= (_ bv10 8) ?x42264)))
 (let ((?x100392 (ite $x53637 (_ bv6 32) ?x101506)))
 (let ((?x48952 ((_ extract 47 40) mem_30_167_128)))
 (let (($x54959 (= (_ bv10 8) ?x48952)))
 (let ((?x100391 (ite $x54959 (_ bv5 32) ?x100392)))
 (let ((?x52408 ((_ extract 39 32) mem_30_167_128)))
 (let (($x51269 (= (_ bv10 8) ?x52408)))
 (let ((?x103270 (ite $x51269 (_ bv4 32) ?x100391)))
 (let ((?x50548 ((_ extract 31 24) mem_30_167_128)))
 (let (($x49831 (= (_ bv10 8) ?x50548)))
 (let ((?x103342 (ite $x49831 (_ bv3 32) ?x103270)))
 (let ((?x48635 ((_ extract 23 16) mem_30_167_128)))
 (let (($x50668 (= (_ bv10 8) ?x48635)))
 (let ((?x105942 (ite $x50668 (_ bv2 32) ?x103342)))
 (let ((?x49966 ((_ extract 15 8) mem_30_167_128)))
 (let (($x51781 (= (_ bv10 8) ?x49966)))
 (let ((?x105385 (ite $x51781 (_ bv1 32) ?x105942)))
 (let ((?x51043 ((_ extract 7 0) mem_30_167_128)))
 (let (($x54960 (= (_ bv10 8) ?x51043)))
 (let ((?x104849 (ite $x54960 (_ bv0 32) ?x105385)))
 (let ((?x53572 (ite $x54960 (_ bv1 1) (_ bv0 1))))
 (let ((?x53891 (ite $x51781 (_ bv1 1) (_ bv0 1))))
 (let ((?x53762 (ite $x50668 (_ bv1 1) (_ bv0 1))))
 (let ((?x53976 (ite $x49831 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x53987 (ite $x48135 (_ bv1 1) (_ bv0 1))))
 (let ((?x51250 (ite $x47600 (_ bv1 1) (_ bv0 1))))
 (let ((?x45835 (concat (concat (concat (_ bv0 16) (ite $x52300 (_ bv1 1) (_ bv0 1))) (ite $x51073 (_ bv1 1) (_ bv0 1))) ?x51250)))
 (let ((?x45061 (concat (concat (concat (concat (concat ?x45835 ?x53987) ?x52020) ?x54832) ?x51996) ?x46852)))
 (let ((?x45693 (concat (concat (concat (concat (concat ?x45061 ?x50822) ?x41476) ?x58091) ?x51467) ?x53976)))
 (let ((?x45069 (concat (concat (concat ?x45693 ?x53762) ?x53891) ?x53572)))
 (let (($x105545 (not $x52300)))
 (let (($x105614 (not $x51073)))
 (let (($x100203 (not $x47600)))
 (let (($x101461 (not $x48135)))
 (let (($x101752 (not $x48749)))
 (let (($x100210 (not $x53541)))
 (let (($x100873 (not $x51354)))
 (let (($x106542 (not $x52069)))
 (let (($x101810 (not $x53602)))
 (let (($x103200 (not $x53637)))
 (let (($x103160 (not $x54959)))
 (let (($x102155 (not $x51269)))
 (let (($x102011 (not $x49831)))
 (let (($x102250 (not $x50668)))
 (let (($x102669 (not $x51781)))
 (let (($x102339 (not $x54960)))
 (let (($x105566 (and $x102339 $x102669 $x102250 $x102011 $x102155 $x103160 $x103200 $x101810 $x106542 $x100873 $x100210 $x101752 $x101461 $x100203 $x105614 $x105545)))
 (let ((?x105376 (ite $x105566 ?x45069 ?x104849)))
 (let ((?x101309 (concat (_ bv0 32) ?x105376)))
 (let ((?x6435 ((_ extract 839 836) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 (let ((?x2357 ((_ extract 815 808) mem_c0000f45_79_992)))
 ...
 (let ((?x145375 (bvadd ?x124753 ?x101309)))
 (and (distinct (_ bv0 64) ?x145375) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(maximize mem_fffffffffffffff0_103_128)
(minimize mem_30_167_128)
