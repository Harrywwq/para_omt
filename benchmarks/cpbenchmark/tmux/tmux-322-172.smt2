...
(assert
 ...
 (let ((?x288571 (bvadd ?x287635 ?x463189)))
 (let (($x462711 (bvule ?x288571 ?x463214)))
 (not $x462711)))))))))))))))))))))
(assert
...
(assert
 (bvule mem_c000000000000000_261_64 mem_c000000000000008_262_64))
(minimize mem_c000000000000030_305_64)
(minimize mem_c000000000000008_262_64)
...
(maximize mem_c000000000000008_262_64)
