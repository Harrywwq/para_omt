...
(declare-fun mem_c000000000000018_266_64 () (_ BitVec 64))
(declare-fun mem_c000000000000020_263_64 () (_ BitVec 64))
(declare-fun mem_c000000000000030_264_64 () (_ BitVec 64))
(declare-fun mem_c000000000000038_265_64 () (_ BitVec 64))
(declare-fun mem_c000000000000008_309_64 () (_ BitVec 64))
(declare-fun mem_c0001010_98_32 () (_ BitVec 32))
(declare-fun mem_c0001028_107_64 () (_ BitVec 64))
(declare-fun mem_c0000ff0_231_64 () (_ BitVec 64))
(assert
...
(assert
 ...
 (let ((?x1833785 (concat ?x4642 (_ bv4294967295 32))))
 (let ((?x3977 ((_ extract 583 576) mem_c0000f45_79_992)))
 (let ((?x935 ((_ extract 575 568) mem_c0000f45_79_992)))
 (let ((?x4611 ((_ extract 567 560) mem_c0000f45_79_992)))
 (let ((?x3400 ((_ extract 559 552) mem_c0000f45_79_992)))
...
(assert
 ...
 (not $x139075))))
(assert
 (let ((?x289264 (bvmul (_ bv18446744073709551615 64) mem_c000000000000018_266_64)))
 (let ((?x283663 (bvadd mem_c000000000000020_263_64 ?x289264)))
 (let ((?x287824 (bvashr ?x283663 (_ bv2 64))))
 (let ((?x285261 (bvmul (_ bv18446744073709551615 64) mem_c000000000000030_264_64)))
 (let ((?x285970 (bvadd mem_c000000000000038_265_64 ?x285261)))
 (let ((?x285276 (bvashr ?x285970 (_ bv2 64))))
 (let ((?x787256 (bvadd (_ bv1 64) ?x285276)))
 (let (($x786051 (bvule ?x787256 ?x287824)))
 (not $x786051))))))))))
(assert
 (let ((?x2427 ((_ extract 775 768) mem_c0000f45_79_992)))
 (= (_ bv255 8) ?x2427)))
(assert
 (let (($x787806 (bvule mem_c000000000000020_263_64 mem_c000000000000008_309_64)))
 (not $x787806)))
(assert
...
(assert
 ...
 (let (($x32835 (= (_ bv255 8) ?x2374)))
 (let (($x1833863 (not $x32835)))
 (let ((?x2357 ((_ extract 815 808) mem_c0000f45_79_992)))
 (let (($x17659 (= (_ bv255 8) ?x2357)))
 (let (($x1828574 (not $x17659)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 (let (($x17600 (= (_ bv255 8) ?x2349)))
 (let (($x928621 (not $x17600)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let (($x17605 (= (_ bv255 8) ?x2364)))
 (let (($x928264 (not $x17605)))
 (let (($x1820034 (or $x928264 $x928621 $x1828574 $x1833863 $x4136 $x3672 $x3664 $x3671)))
 (let (($x933398 (not $x1820034)))
 ...
 (let ((?x4642 (concat (concat (concat ?x2400 ?x2401) ?x2411) ?x2410)))
 (let ((?x1833785 (concat ?x4642 (_ bv4294967295 32))))
 (let ((?x951637 (bvadd ?x1833785 ?x3646)))
 (let ((?x944384 ((_ extract 63 63) ?x951637)))
 (let (($x949430 (= (_ bv1 1) ?x944384)))
 (or $x949430 $x933398)))))))))))))))))))))))))))))))))))))))))
(assert
...
(assert
 (= (_ bv13835058055282163712 64) mem_c0000ff0_231_64))
(minimize mem_c000000000000038_265_64)
(maximize mem_c0001028_107_64)
(maximize mem_c0001010_98_32)
(minimize syscall_stub_newfstatat_83_64)
(minimize mem_c000000000000030_264_64)
(maximize mem_c000000000000030_264_64)
(maximize mem_c0000ff0_231_64)
(minimize mem_c0001028_107_64)
(minimize mem_c0000ff0_231_64)
(minimize mem_c0001010_98_32)
(minimize mem_c000000000000020_263_64)
(maximize mem_c000000000000018_266_64)
(maximize mem_c0000f45_79_992)
(maximize mem_c000000000000008_309_64)
(minimize mem_c000000000000018_266_64)
(minimize mem_c0000f45_79_992)
(maximize mem_c000000000000038_265_64)
(maximize syscall_stub_newfstatat_83_64)
(maximize mem_c000000000000020_263_64)
(minimize mem_c000000000000008_309_64)
(check-sat)
(get-objectives)
