...
(declare-fun mem_8000000000000008_270_64 () (_ BitVec 64))
(assert
...
(assert
 ...
 (= (_ bv1 1) ?x139080)))
(assert
 (let ((?x470001 (bvmul (_ bv18446744073709551615 64) mem_8000000000000018_314_64)))
 (let ((?x469071 (bvadd mem_8000000000000000_269_64 ?x470001)))
 (let ((?x794543 (bvashr ?x469071 (_ bv2 64))))
 ...
 (let ((?x283258 (bvadd ?x292589 ?x464643)))
 (let (($x468350 (bvule ?x283258 ?x794543)))
 (not $x468350)))))))))))))))))))))
(assert
...
(assert
 (bvule mem_8000000000000000_269_64 mem_8000000000000008_270_64))
...
(minimize mem_8000000000000008_270_64)
...
(maximize mem_8000000000000008_270_64)
