...
(assert
 ...
 (let ((?x434707 ((_ extract 127 120) mem_0_291_128)))
 (let (($x436012 (= (_ bv10 8) ?x434707)))
 (let ((?x1162562 (ite $x436012 (_ bv15 32) (_ bv64 32))))
 (let ((?x435175 ((_ extract 119 112) mem_0_291_128)))
 (let (($x435181 (= (_ bv10 8) ?x435175)))
 (let ((?x1166490 (ite $x435181 (_ bv14 32) ?x1162562)))
 (let ((?x435197 ((_ extract 111 104) mem_0_291_128)))
 (let (($x435224 (= (_ bv10 8) ?x435197)))
 (let ((?x1164557 (ite $x435224 (_ bv13 32) ?x1166490)))
 (let ((?x434723 ((_ extract 103 96) mem_0_291_128)))
 (let (($x435204 (= (_ bv10 8) ?x434723)))
 (let ((?x1166477 (ite $x435204 (_ bv12 32) ?x1164557)))
 (let ((?x386961 ((_ extract 95 88) mem_0_291_128)))
 (let (($x434742 (= (_ bv10 8) ?x386961)))
 (let ((?x1165090 (ite $x434742 (_ bv11 32) ?x1166477)))
 (let ((?x434722 ((_ extract 87 80) mem_0_291_128)))
 (let (($x435807 (= (_ bv10 8) ?x434722)))
 (let ((?x1168860 (ite $x435807 (_ bv10 32) ?x1165090)))
 (let ((?x435236 ((_ extract 79 72) mem_0_291_128)))
 (let (($x435262 (= (_ bv10 8) ?x435236)))
 (let ((?x1178528 (ite $x435262 (_ bv9 32) ?x1168860)))
 (let ((?x435161 ((_ extract 71 64) mem_0_291_128)))
 (let (($x436156 (= (_ bv10 8) ?x435161)))
 (let ((?x1178225 (ite $x436156 (_ bv8 32) ?x1178528)))
 (let ((?x435157 ((_ extract 63 56) mem_0_291_128)))
 (let (($x438205 (= (_ bv10 8) ?x435157)))
 (let ((?x1178209 (ite $x438205 (_ bv7 32) ?x1178225)))
 (let ((?x435265 ((_ extract 55 48) mem_0_291_128)))
 (let (($x204816 (= (_ bv10 8) ?x435265)))
 (let ((?x1177855 (ite $x204816 (_ bv6 32) ?x1178209)))
 (let ((?x202594 ((_ extract 47 40) mem_0_291_128)))
 (let (($x198464 (= (_ bv10 8) ?x202594)))
 (let ((?x1178544 (ite $x198464 (_ bv5 32) ?x1177855)))
 (let ((?x205504 ((_ extract 39 32) mem_0_291_128)))
 (let (($x436235 (= (_ bv10 8) ?x205504)))
 (let ((?x1165828 (ite $x436235 (_ bv4 32) ?x1178544)))
 (let ((?x436237 ((_ extract 31 24) mem_0_291_128)))
 (let (($x435209 (= (_ bv10 8) ?x436237)))
 (let ((?x1166765 (ite $x435209 (_ bv3 32) ?x1165828)))
 (let ((?x435722 ((_ extract 23 16) mem_0_291_128)))
 (let (($x201206 (= (_ bv10 8) ?x435722)))
 (let ((?x1166598 (ite $x201206 (_ bv2 32) ?x1166765)))
 (let ((?x435465 ((_ extract 15 8) mem_0_291_128)))
 (let (($x435245 (= (_ bv10 8) ?x435465)))
 (let ((?x1175667 (ite $x435245 (_ bv1 32) ?x1166598)))
 (let ((?x435131 ((_ extract 7 0) mem_0_291_128)))
 (let (($x435138 (= (_ bv10 8) ?x435131)))
 (let ((?x1177867 (ite $x435138 (_ bv0 32) ?x1175667)))
 (let ((?x436208 (ite $x435138 (_ bv1 1) (_ bv0 1))))
 (let ((?x436062 (ite $x435245 (_ bv1 1) (_ bv0 1))))
 (let ((?x436046 (ite $x201206 (_ bv1 1) (_ bv0 1))))
 (let ((?x437152 (ite $x435209 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x436181 (ite $x435204 (_ bv1 1) (_ bv0 1))))
 (let ((?x435953 (ite $x435224 (_ bv1 1) (_ bv0 1))))
 (let ((?x656422 (concat (concat (concat (_ bv0 16) (ite $x436012 (_ bv1 1) (_ bv0 1))) (ite $x435181 (_ bv1 1) (_ bv0 1))) ?x435953)))
 (let ((?x656331 (concat (concat (concat (concat (concat ?x656422 ?x436181) ?x435962) ?x435792) ?x434713) ?x435182)))
 (let ((?x657604 (concat (concat (concat (concat (concat ?x656331 ?x434752) ?x435243) ?x436079) ?x435935) ?x437152)))
 (let ((?x661490 (concat (concat (concat ?x657604 ?x436046) ?x436062) ?x436208)))
 (let (($x1175689 (not $x436012)))
 (let (($x1175688 (not $x435181)))
 (let (($x1175687 (not $x435224)))
 (let (($x1175686 (not $x435204)))
 (let (($x1175677 (not $x434742)))
 (let (($x1162212 (not $x435807)))
 (let (($x1165781 (not $x435262)))
 (let (($x1162310 (not $x436156)))
 (let (($x1163929 (not $x438205)))
 (let (($x1178538 (not $x204816)))
 (let (($x1166261 (not $x198464)))
 (let (($x1165947 (not $x436235)))
 (let (($x1162341 (not $x435209)))
 (let (($x1164324 (not $x201206)))
 (let (($x1165080 (not $x435245)))
 (let (($x1164479 (not $x435138)))
 (let (($x1175690 (and $x1164479 $x1165080 $x1164324 $x1162341 $x1165947 $x1166261 $x1178538 $x1163929 $x1162310 $x1165781 $x1162212 $x1175677 $x1175686 $x1175687 $x1175688 $x1175689)))
 (let ((?x1165461 (ite $x1175690 ?x661490 ?x1177867)))
 (let ((?x1165774 (concat (_ bv0 32) ?x1165461)))
 (let ((?x1178221 (bvadd (bvadd (_ bv16 64) ?x1165774) ?x14202)))
 (and (distinct (_ bv0 64) ?x1178221) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
