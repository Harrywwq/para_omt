...
(assert
 ...
 (let (($x1395117 (bvule ?x463189 ?x463214)))
 (not $x1395117)))))))))
(assert
...
(assert
 (bvule mem_c000000000000000_261_64 (_ bv18446744073709551615 64)))
(assert
 (= (_ bv18446744073709551615 64) mem_c000000000000000_261_64))
(assert
 (let ((?x1393183 (bvadd mem_c000000000000000_261_64 (_ bv4 64))))
 (bvule ?x1393183 mem_c000000000000008_262_64)))
