...
(assert
 ...
 (let ((?x2058980 (bvadd (_ bv18446744073709551615 64) ?x463192)))
 (let ((?x2059319 (bvashr ?x2058980 (_ bv2 64))))
 ...
 (let (($x2060326 (bvule ?x463189 ?x2059319)))
 (not $x2060326)))))))))
(assert
 (let (($x1387090 (bvule (_ bv3 64) mem_c000000000000008_262_64)))
 (not $x1387090)))
