...
(declare-fun mem_c0000fc4_308_8 () (_ BitVec 8))
(assert
...
(assert
 (let ((?x288193 (bvadd mem_c0000ff0_231_64 (_ bv24 64))))
 (= (_ bv13835058055282163736 64) ?x288193)))
(assert
 (let ((?x288175 (bvsub mem_c000000000000020_263_64 mem_c000000000000018_266_64)))
 (let ((?x288322 (bvashr ?x288175 (_ bv2 64))))
 (let ((?x286470 (bvsub mem_c000000000000038_265_64 mem_c000000000000030_264_64)))
 (let ((?x285087 (bvashr ?x286470 (_ bv2 64))))
 (let ((?x2417 ((_ extract 751 744) mem_c0000f45_79_992)))
 ...
 (let (($x139082 (and $x52309 $x17574 $x17591 $x17650)))
 (let ((?x289163 (ite $x139082 (_ bv1 1) (_ bv0 1))))
 (let ((?x287635 (concat (_ bv0 63) ?x289163)))
 (let ((?x285772 (bvadd ?x287635 ?x285087)))
 (bvule ?x285772 ?x288322))))))))))))))))))
(assert
 (let ((?x462700 (bvand mem_c0000fc4_308_8 (_ bv8 8))))
 (= (_ bv0 8) ?x462700)))
(assert
 ...
 (let ((?x458826 (bvadd ?x285276 (_ bv50 64))))
 (let ((?x784498 (bvshl ?x458826 (_ bv1 64))))
 (let ((?x785739 (bvlshr ?x784498 (_ bv62 64))))
 (= (_ bv0 64) ?x785739))))))))
(assert
 (let ((?x285261 (bvmul (_ bv18446744073709551615 64) mem_c000000000000030_264_64)))
 (let ((?x285970 (bvadd mem_c000000000000038_265_64 ?x285261)))
 (let ((?x285276 (bvashr ?x285970 (_ bv2 64))))
 (let ((?x288965 ((_ extract 62 0) ?x285276)))
 (let ((?x786928 (bvadd (_ bv50 63) ?x288965)))
 (let ((?x1392281 (concat ?x786928 (_ bv0 1))))
 (bvugt ?x285276 ?x1392281))))))))
(maximize mem_c000000000000018_266_64)
(minimize mem_c0000fc4_308_8)
(minimize mem_c000000000000020_263_64)
(maximize mem_c000000000000030_264_64)
(maximize mem_c0000fc4_308_8)
