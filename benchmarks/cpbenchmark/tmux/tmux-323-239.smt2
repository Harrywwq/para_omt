...
(declare-fun mem_8000000000000018_314_64 () (_ BitVec 64))
(declare-fun mem_8000000000000000_269_64 () (_ BitVec 64))
(declare-fun mem_8000000000000030_312_64 () (_ BitVec 64))
(declare-fun mem_8000000000000038_313_64 () (_ BitVec 64))
(declare-fun mem_c0000fc4_371_8 () (_ BitVec 8))
(assert
...
(assert
 (let ((?x464620 (bvsub mem_8000000000000000_269_64 mem_8000000000000018_314_64)))
 (let ((?x457270 (bvashr ?x464620 (_ bv2 64))))
 (let ((?x469074 (bvsub mem_8000000000000038_313_64 mem_8000000000000030_312_64)))
 (let ((?x468213 (bvashr ?x469074 (_ bv2 64))))
 (let ((?x3400 ((_ extract 559 552) mem_c0000f45_79_992)))
 ...
 (let ((?x470158 (bvadd ?x292589 ?x468213)))
 (bvule ?x470158 ?x457270))))))))))))))))))
(assert
 (let ((?x794165 (bvand mem_c0000fc4_371_8 (_ bv8 8))))
 (= (_ bv0 8) ?x794165)))
(assert
 (let ((?x470276 (bvmul (_ bv18446744073709551615 64) mem_8000000000000030_312_64)))
 (let ((?x465216 (bvadd mem_8000000000000038_313_64 ?x470276)))
 (let ((?x464643 (bvashr ?x465216 (_ bv2 64))))
 (let ((?x1414181 (bvadd ?x464643 (_ bv50 64))))
 (let ((?x1413493 (bvshl ?x1414181 (_ bv1 64))))
 (let ((?x1414842 (bvlshr ?x1413493 (_ bv62 64))))
 (= (_ bv0 64) ?x1414842))))))))
(assert
 (let ((?x470276 (bvmul (_ bv18446744073709551615 64) mem_8000000000000030_312_64)))
 (let ((?x465216 (bvadd mem_8000000000000038_313_64 ?x470276)))
 (let ((?x464643 (bvashr ?x465216 (_ bv2 64))))
 (let ((?x548892 ((_ extract 62 0) ?x464643)))
 (let ((?x1414273 (bvadd (_ bv50 63) ?x548892)))
 (let ((?x2071431 (concat ?x1414273 (_ bv0 1))))
 (bvule ?x464643 ?x2071431))))))))
(minimize mem_8000000000000038_313_64)
(maximize syscall_stub_newfstatat_83_64)
(maximize mem_8000000000000018_314_64)
(minimize mem_c0001010_98_32)
(minimize mem_8000000000000018_314_64)
(minimize mem_c0001028_107_64)
(maximize mem_8000000000000038_313_64)
(maximize mem_c0000fc4_371_8)
(maximize mem_8000000000000030_312_64)
(minimize mem_c0000fc4_371_8)
(minimize mem_c0000ff0_235_64)
(maximize mem_c0001028_107_64)
(minimize syscall_stub_newfstatat_83_64)
(maximize mem_8000000000000000_269_64)
(maximize mem_c0001010_98_32)
(minimize mem_8000000000000030_312_64)
(maximize mem_c0000f45_79_992)
(minimize mem_8000000000000000_269_64)
