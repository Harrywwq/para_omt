...
(assert
 ...
 (let (($x1414326 (bvule ?x464643 ?x794543)))
 (not $x1414326)))))))))
(assert
...
(assert
 (bvule mem_8000000000000000_269_64 (_ bv18446744073709551615 64)))
(assert
 (= (_ bv18446744073709551615 64) mem_8000000000000000_269_64))
(assert
 (let ((?x1414275 (bvadd mem_8000000000000000_269_64 (_ bv4 64))))
 (bvule ?x1414275 mem_8000000000000008_270_64)))
