...
(assert
 ...
 (let ((?x2077004 (bvadd (_ bv18446744073709551615 64) ?x470001)))
 (let ((?x2078057 (bvashr ?x2077004 (_ bv2 64))))
 ...
 (let (($x2075026 (bvule ?x464643 ?x2078057)))
 (not $x2075026)))))))))
(assert
 (let (($x1409652 (bvule (_ bv3 64) mem_8000000000000008_270_64)))
 (not $x1409652)))
