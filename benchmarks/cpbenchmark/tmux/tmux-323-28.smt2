...
(declare-fun mem_10_406_128 () (_ BitVec 128))
(assert
...
(assert
 ...
 (= (_ bv16 64) ?x13437))))))))))))
(assert
 (let ((?x1166677 ((_ extract 7 0) mem_10_406_128)))
 (let (($x1175322 (= (_ bv10 8) ?x1166677)))
 (let ((?x358342 (ite $x1175322 (_ bv1 1) (_ bv0 1))))
 (let ((?x1173013 ((_ extract 15 8) mem_10_406_128)))
 (let (($x1175340 (= (_ bv10 8) ?x1173013)))
 (let ((?x358057 (ite $x1175340 (_ bv1 1) (_ bv0 1))))
 (let ((?x1164126 ((_ extract 23 16) mem_10_406_128)))
 (let (($x1175337 (= (_ bv10 8) ?x1164126)))
 (let ((?x356993 (ite $x1175337 (_ bv1 1) (_ bv0 1))))
 (let ((?x1175317 ((_ extract 31 24) mem_10_406_128)))
 (let (($x1172367 (= (_ bv10 8) ?x1175317)))
 (let ((?x359231 (ite $x1172367 (_ bv1 1) (_ bv0 1))))
 (let ((?x1175639 ((_ extract 39 32) mem_10_406_128)))
 (let (($x1175636 (= (_ bv10 8) ?x1175639)))
 (let ((?x358932 (ite $x1175636 (_ bv1 1) (_ bv0 1))))
 (let ((?x360953 ((_ extract 47 40) mem_10_406_128)))
 (let (($x1171894 (= (_ bv10 8) ?x360953)))
 (let ((?x360664 (ite $x1171894 (_ bv1 1) (_ bv0 1))))
 (let ((?x361177 ((_ extract 55 48) mem_10_406_128)))
 (let (($x360952 (= (_ bv10 8) ?x361177)))
 (let ((?x360666 (ite $x360952 (_ bv1 1) (_ bv0 1))))
 (let ((?x360066 ((_ extract 63 56) mem_10_406_128)))
 (let (($x1164469 (= (_ bv10 8) ?x360066)))
 (let ((?x359207 (ite $x1164469 (_ bv1 1) (_ bv0 1))))
 (let ((?x360074 ((_ extract 71 64) mem_10_406_128)))
 (let (($x1175701 (= (_ bv10 8) ?x360074)))
 (let ((?x357531 (ite $x1175701 (_ bv1 1) (_ bv0 1))))
 (let ((?x361175 ((_ extract 79 72) mem_10_406_128)))
 (let (($x1175478 (= (_ bv10 8) ?x361175)))
 (let ((?x359757 (ite $x1175478 (_ bv1 1) (_ bv0 1))))
 (let ((?x1171666 ((_ extract 87 80) mem_10_406_128)))
 (let (($x1175321 (= (_ bv10 8) ?x1171666)))
 (let ((?x358996 (ite $x1175321 (_ bv1 1) (_ bv0 1))))
 (let ((?x359226 ((_ extract 95 88) mem_10_406_128)))
 (let (($x361817 (= (_ bv10 8) ?x359226)))
 (let ((?x358936 (ite $x361817 (_ bv1 1) (_ bv0 1))))
 (let ((?x360942 ((_ extract 103 96) mem_10_406_128)))
 (let (($x360895 (= (_ bv10 8) ?x360942)))
 (let ((?x361160 (ite $x360895 (_ bv1 1) (_ bv0 1))))
 (let ((?x360894 ((_ extract 111 104) mem_10_406_128)))
 (let (($x360892 (= (_ bv10 8) ?x360894)))
 (let ((?x359504 (ite $x360892 (_ bv1 1) (_ bv0 1))))
 (let ((?x361522 ((_ extract 119 112) mem_10_406_128)))
 (let (($x360663 (= (_ bv10 8) ?x361522)))
 (let ((?x353464 (ite $x360663 (_ bv1 1) (_ bv0 1))))
 (let ((?x1176871 ((_ extract 127 120) mem_10_406_128)))
 (let (($x358350 (= (_ bv10 8) ?x1176871)))
 (let ((?x359763 (ite $x358350 (_ bv1 1) (_ bv0 1))))
 (let ((?x358657 (concat (concat (concat (concat (concat ?x359763 ?x353464) ?x359504) ?x361160) ?x358936) ?x358996)))
 (let ((?x358374 (concat (concat (concat (concat (concat ?x358657 ?x359757) ?x357531) ?x359207) ?x360666) ?x360664)))
 (let ((?x357826 (concat (concat (concat (concat (concat ?x358374 ?x358932) ?x359231) ?x356993) ?x358057) ?x358342)))
 (and (distinct (_ bv0 16) ?x357826) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1166677 ((_ extract 7 0) mem_10_406_128)))
 (let (($x1175322 (= (_ bv10 8) ?x1166677)))
 (let ((?x358342 (ite $x1175322 (_ bv1 1) (_ bv0 1))))
 ...
 (let (($x360663 (= (_ bv10 8) ?x361522)))
 (let ((?x353464 (ite $x360663 (_ bv1 1) (_ bv0 1))))
 (let ((?x1831200 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 127 120) mem_10_406_128)) (_ bv1 1) (_ bv0 1))) ?x353464)))
 (let ((?x1603924 (concat (concat (concat (concat (concat ?x1831200 ?x359504) ?x361160) ?x358936) ?x358996) ?x359757)))
 (let ((?x1832876 (concat (concat (concat (concat (concat ?x1603924 ?x357531) ?x359207) ?x360666) ?x360664) ?x358932)))
 (let ((?x1833545 (concat (concat (concat (concat ?x1832876 ?x359231) ?x356993) ?x358057) ?x358342)))
 (let ((?x985827 ((_ zero_extend 32) ?x1833545)))
 (let ((?x1176871 ((_ extract 127 120) mem_10_406_128)))
 (let (($x358350 (= (_ bv10 8) ?x1176871)))
 (let ((?x1832253 (ite $x358350 (_ bv15 64) (_ bv64 64))))
 (let ((?x1832537 (ite $x360663 (_ bv14 64) ?x1832253)))
 (let ((?x1831486 (ite $x360892 (_ bv13 64) ?x1832537)))
 (let ((?x1582631 (ite $x360895 (_ bv12 64) ?x1831486)))
 (let ((?x962400 (ite $x361817 (_ bv11 64) ?x1582631)))
 (let ((?x952292 (ite $x1175321 (_ bv10 64) ?x962400)))
 (let ((?x966070 (ite $x1175478 (_ bv9 64) ?x952292)))
 (let ((?x1603406 (ite $x1175701 (_ bv8 64) ?x966070)))
 (let ((?x1575839 (ite $x1164469 (_ bv7 64) ?x1603406)))
 (let ((?x963675 (ite $x360952 (_ bv6 64) ?x1575839)))
 (let ((?x959478 (ite $x1171894 (_ bv5 64) ?x963675)))
 (let ((?x1585069 (ite $x1175636 (_ bv4 64) ?x959478)))
 (let ((?x1821698 (ite $x1172367 (_ bv3 64) ?x1585069)))
 (let ((?x1583172 (ite $x1175337 (_ bv2 64) ?x1821698)))
 (let ((?x959222 (ite $x1175340 (_ bv1 64) ?x1583172)))
 (let ((?x1832375 (ite $x1175322 (_ bv0 64) ?x959222)))
 (let (($x1832396 (and (distinct (_ bv0 32) ?x1833545) true)))
 (let ((?x1582554 (ite $x1832396 ?x1832375 ?x985827)))
 (let ((?x1832490 ((_ extract 31 0) ?x1582554)))
 (let ((?x1832667 ((_ zero_extend 32) ?x1832490)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 ...
 (bvule ?x40370 ?x1832667))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(minimize mem_c0080024_86_32)
(maximize mem_10_406_128)
