...
(assert
 ...
 (and (distinct (_ bv0 16) ?x435403) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x435668 ((_ extract 7 0) mem_0_290_128)))
 (let (($x435640 (= (_ bv10 8) ?x435668)))
 (let ((?x435364 (ite $x435640 (_ bv1 1) (_ bv0 1))))
 ...
 (let (($x435661 (= (_ bv10 8) ?x435657)))
 (let ((?x119363 (ite $x435661 (_ bv1 1) (_ bv0 1))))
 (let ((?x657307 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 127 120) mem_0_290_128)) (_ bv1 1) (_ bv0 1))) ?x119363)))
 (let ((?x655932 (concat (concat (concat (concat (concat ?x657307 ?x128124) ?x126578) ?x123377) ?x62240) ?x124264)))
 (let ((?x657355 (concat (concat (concat (concat (concat ?x655932 ?x435361) ?x435394) ?x435322) ?x203877) ?x435358)))
 (let ((?x656429 (concat (concat (concat (concat ?x657355 ?x435359) ?x435373) ?x435387) ?x435364)))
 (let ((?x656500 ((_ zero_extend 32) ?x656429)))
 (let ((?x435350 ((_ extract 127 120) mem_0_290_128)))
 (let (($x197611 (= (_ bv10 8) ?x435350)))
 (let ((?x657636 (ite $x197611 (_ bv15 64) (_ bv64 64))))
 (let ((?x657029 (ite $x435661 (_ bv14 64) ?x657636)))
 (let ((?x650589 (ite $x435662 (_ bv13 64) ?x657029)))
 (let ((?x655634 (ite $x435652 (_ bv12 64) ?x650589)))
 (let ((?x618450 (ite $x398564 (_ bv11 64) ?x655634)))
 (let ((?x656487 (ite $x435672 (_ bv10 64) ?x618450)))
 (let ((?x659523 (ite $x435320 (_ bv9 64) ?x656487)))
 (let ((?x661509 (ite $x435351 (_ bv8 64) ?x659523)))
 (let ((?x649882 (ite $x204294 (_ bv7 64) ?x661509)))
 (let ((?x656017 (ite $x193962 (_ bv6 64) ?x649882)))
 (let ((?x656989 (ite $x204132 (_ bv5 64) ?x656017)))
 (let ((?x655681 (ite $x204885 (_ bv4 64) ?x656989)))
 (let ((?x657300 (ite $x204717 (_ bv3 64) ?x655681)))
 (let ((?x657718 (ite $x435636 (_ bv2 64) ?x657300)))
 (let ((?x655702 (ite $x435666 (_ bv1 64) ?x657718)))
 (let ((?x657264 (ite $x435640 (_ bv0 64) ?x655702)))
 (let (($x656393 (and (distinct (_ bv0 32) ?x656429) true)))
 (let ((?x657342 (ite $x656393 ?x657264 ?x656500)))
 (let ((?x657695 ((_ extract 31 0) ?x657342)))
 (let ((?x657191 ((_ zero_extend 32) ?x657695)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
...
(assert
 ...
 (let ((?x435350 ((_ extract 127 120) mem_0_290_128)))
 (let (($x197611 (= (_ bv10 8) ?x435350)))
 (let ((?x1179018 (ite $x197611 (_ bv15 32) (_ bv64 32))))
 (let ((?x435657 ((_ extract 119 112) mem_0_290_128)))
 (let (($x435661 (= (_ bv10 8) ?x435657)))
 (let ((?x1179019 (ite $x435661 (_ bv14 32) ?x1179018)))
 (let ((?x435663 ((_ extract 111 104) mem_0_290_128)))
 (let (($x435662 (= (_ bv10 8) ?x435663)))
 (let ((?x1168906 (ite $x435662 (_ bv13 32) ?x1179019)))
 (let ((?x435352 ((_ extract 103 96) mem_0_290_128)))
 (let (($x435652 (= (_ bv10 8) ?x435352)))
 (let ((?x1173683 (ite $x435652 (_ bv12 32) ?x1168906)))
 (let ((?x435639 ((_ extract 95 88) mem_0_290_128)))
 (let (($x398564 (= (_ bv10 8) ?x435639)))
 (let ((?x1175435 (ite $x398564 (_ bv11 32) ?x1173683)))
 (let ((?x435665 ((_ extract 87 80) mem_0_290_128)))
 (let (($x435672 (= (_ bv10 8) ?x435665)))
 (let ((?x1179013 (ite $x435672 (_ bv10 32) ?x1175435)))
 (let ((?x435670 ((_ extract 79 72) mem_0_290_128)))
 (let (($x435320 (= (_ bv10 8) ?x435670)))
 (let ((?x1178997 (ite $x435320 (_ bv9 32) ?x1179013)))
 (let ((?x435353 ((_ extract 71 64) mem_0_290_128)))
 (let (($x435351 (= (_ bv10 8) ?x435353)))
 (let ((?x1178996 (ite $x435351 (_ bv8 32) ?x1178997)))
 (let ((?x435356 ((_ extract 63 56) mem_0_290_128)))
 (let (($x204294 (= (_ bv10 8) ?x435356)))
 (let ((?x1178679 (ite $x204294 (_ bv7 32) ?x1178996)))
 (let ((?x194899 ((_ extract 55 48) mem_0_290_128)))
 (let (($x193962 (= (_ bv10 8) ?x194899)))
 (let ((?x1178995 (ite $x193962 (_ bv6 32) ?x1178679)))
 (let ((?x205448 ((_ extract 47 40) mem_0_290_128)))
 (let (($x204132 (= (_ bv10 8) ?x205448)))
 (let ((?x1168174 (ite $x204132 (_ bv5 32) ?x1178995)))
 (let ((?x205218 ((_ extract 39 32) mem_0_290_128)))
 (let (($x204885 (= (_ bv10 8) ?x205218)))
 (let ((?x1177627 (ite $x204885 (_ bv4 32) ?x1168174)))
 (let ((?x205665 ((_ extract 31 24) mem_0_290_128)))
 (let (($x204717 (= (_ bv10 8) ?x205665)))
 (let ((?x1177634 (ite $x204717 (_ bv3 32) ?x1177627)))
 (let ((?x435650 ((_ extract 23 16) mem_0_290_128)))
 (let (($x435636 (= (_ bv10 8) ?x435650)))
 (let ((?x1170305 (ite $x435636 (_ bv2 32) ?x1177634)))
 (let ((?x435637 ((_ extract 15 8) mem_0_290_128)))
 (let (($x435666 (= (_ bv10 8) ?x435637)))
 (let ((?x1177623 (ite $x435666 (_ bv1 32) ?x1170305)))
 (let ((?x435668 ((_ extract 7 0) mem_0_290_128)))
 (let (($x435640 (= (_ bv10 8) ?x435668)))
 (let ((?x1167698 (ite $x435640 (_ bv0 32) ?x1177623)))
 (let ((?x435364 (ite $x435640 (_ bv1 1) (_ bv0 1))))
 (let ((?x435387 (ite $x435666 (_ bv1 1) (_ bv0 1))))
 (let ((?x435373 (ite $x435636 (_ bv1 1) (_ bv0 1))))
 (let ((?x435359 (ite $x204717 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x126578 (ite $x435652 (_ bv1 1) (_ bv0 1))))
 (let ((?x128124 (ite $x435662 (_ bv1 1) (_ bv0 1))))
 (let ((?x656356 (concat (concat (concat (_ bv0 16) (ite $x197611 (_ bv1 1) (_ bv0 1))) (ite $x435661 (_ bv1 1) (_ bv0 1))) ?x128124)))
 (let ((?x655572 (concat (concat (concat (concat (concat ?x656356 ?x126578) ?x123377) ?x62240) ?x124264) ?x435361)))
 (let ((?x661489 (concat (concat (concat (concat (concat ?x655572 ?x435394) ?x435322) ?x203877) ?x435358) ?x435359)))
 (let ((?x656429 (concat (concat (concat ?x661489 ?x435373) ?x435387) ?x435364)))
 (let (($x1179014 (not $x197611)))
 (let (($x1178688 (not $x435661)))
 (let (($x1178686 (not $x435662)))
 (let (($x1178685 (not $x435652)))
 (let (($x1179016 (not $x398564)))
 (let (($x1179015 (not $x435672)))
 (let (($x1178687 (not $x435320)))
 (let (($x1179012 (not $x435351)))
 (let (($x1178684 (not $x204294)))
 (let (($x1179021 (not $x193962)))
 (let (($x1178693 (not $x204132)))
 (let (($x1178692 (not $x204885)))
 (let (($x1178691 (not $x204717)))
 (let (($x1178690 (not $x435636)))
 (let (($x1178678 (not $x435666)))
 (let (($x1178689 (not $x435640)))
 (let (($x1179017 (and $x1178689 $x1178678 $x1178690 $x1178691 $x1178692 $x1178693 $x1179021 $x1178684 $x1179012 $x1178687 $x1179015 $x1179016 $x1178685 $x1178686 $x1178688 $x1179014)))
 (let ((?x1177635 (ite $x1179017 ?x656429 ?x1167698)))
 (let ((?x1177640 (concat (_ bv0 32) ?x1177635)))
 (let ((?x960893 (bvadd (bvadd (_ bv16 64) ?x1177640) ?x14202)))
 (and (distinct (_ bv0 64) ?x960893) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
