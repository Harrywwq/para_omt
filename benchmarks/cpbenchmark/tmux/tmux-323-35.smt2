...
(declare-fun mem_20_407_128 () (_ BitVec 128))
(assert
...
(assert
 ...
 (= (_ bv32 64) ?x28164))))))))))))
(assert
 (let ((?x1166529 ((_ extract 7 0) mem_20_407_128)))
 (let (($x1170040 (= (_ bv10 8) ?x1166529)))
 (let ((?x1164400 (ite $x1170040 (_ bv1 1) (_ bv0 1))))
 (let ((?x1179149 ((_ extract 15 8) mem_20_407_128)))
 (let (($x1179152 (= (_ bv10 8) ?x1179149)))
 (let ((?x1173147 (ite $x1179152 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178881 ((_ extract 23 16) mem_20_407_128)))
 (let (($x1178829 (= (_ bv10 8) ?x1178881)))
 (let ((?x1165971 (ite $x1178829 (_ bv1 1) (_ bv0 1))))
 (let ((?x1164654 ((_ extract 31 24) mem_20_407_128)))
 (let (($x1179151 (= (_ bv10 8) ?x1164654)))
 (let ((?x1177657 (ite $x1179151 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178875 ((_ extract 39 32) mem_20_407_128)))
 (let (($x1178874 (= (_ bv10 8) ?x1178875)))
 (let ((?x1177629 (ite $x1178874 (_ bv1 1) (_ bv0 1))))
 (let ((?x1163215 ((_ extract 47 40) mem_20_407_128)))
 (let (($x1165207 (= (_ bv10 8) ?x1163215)))
 (let ((?x1164386 (ite $x1165207 (_ bv1 1) (_ bv0 1))))
 (let ((?x1173379 ((_ extract 55 48) mem_20_407_128)))
 (let (($x1168355 (= (_ bv10 8) ?x1173379)))
 (let ((?x1165964 (ite $x1168355 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178882 ((_ extract 63 56) mem_20_407_128)))
 (let (($x1166008 (= (_ bv10 8) ?x1178882)))
 (let ((?x1173366 (ite $x1166008 (_ bv1 1) (_ bv0 1))))
 (let ((?x1166089 ((_ extract 71 64) mem_20_407_128)))
 (let (($x1166651 (= (_ bv10 8) ?x1166089)))
 (let ((?x1172469 (ite $x1166651 (_ bv1 1) (_ bv0 1))))
 (let ((?x1164811 ((_ extract 79 72) mem_20_407_128)))
 (let (($x1179045 (= (_ bv10 8) ?x1164811)))
 (let ((?x1170241 (ite $x1179045 (_ bv1 1) (_ bv0 1))))
 (let ((?x1168963 ((_ extract 87 80) mem_20_407_128)))
 (let (($x1163617 (= (_ bv10 8) ?x1168963)))
 (let ((?x1166179 (ite $x1163617 (_ bv1 1) (_ bv0 1))))
 (let ((?x1164475 ((_ extract 95 88) mem_20_407_128)))
 (let (($x1177517 (= (_ bv10 8) ?x1164475)))
 (let ((?x1170904 (ite $x1177517 (_ bv1 1) (_ bv0 1))))
 (let ((?x1173415 ((_ extract 103 96) mem_20_407_128)))
 (let (($x1173119 (= (_ bv10 8) ?x1173415)))
 (let ((?x1168930 (ite $x1173119 (_ bv1 1) (_ bv0 1))))
 (let ((?x1169909 ((_ extract 111 104) mem_20_407_128)))
 (let (($x1169892 (= (_ bv10 8) ?x1169909)))
 (let ((?x1165228 (ite $x1169892 (_ bv1 1) (_ bv0 1))))
 (let ((?x1165754 ((_ extract 119 112) mem_20_407_128)))
 (let (($x1164639 (= (_ bv10 8) ?x1165754)))
 (let ((?x1164244 (ite $x1164639 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178863 ((_ extract 127 120) mem_20_407_128)))
 (let (($x1168362 (= (_ bv10 8) ?x1178863)))
 (let ((?x1175310 (ite $x1168362 (_ bv1 1) (_ bv0 1))))
 (let ((?x1166623 (concat (concat (concat (concat (concat ?x1175310 ?x1164244) ?x1165228) ?x1168930) ?x1170904) ?x1166179)))
 (let ((?x1164344 (concat (concat (concat (concat (concat ?x1166623 ?x1170241) ?x1172469) ?x1173366) ?x1165964) ?x1164386)))
 (let ((?x1167580 (concat (concat (concat (concat (concat ?x1164344 ?x1177629) ?x1177657) ?x1165971) ?x1173147) ?x1164400)))
 (and (distinct (_ bv0 16) ?x1167580) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1166529 ((_ extract 7 0) mem_20_407_128)))
 (let (($x1170040 (= (_ bv10 8) ?x1166529)))
 (let ((?x1164400 (ite $x1170040 (_ bv1 1) (_ bv0 1))))
 ...
 (let (($x1164639 (= (_ bv10 8) ?x1165754)))
 (let ((?x1164244 (ite $x1164639 (_ bv1 1) (_ bv0 1))))
 (let ((?x1823144 (concat (concat (_ bv0 16) (ite (= (_ bv10 8) ((_ extract 127 120) mem_20_407_128)) (_ bv1 1) (_ bv0 1))) ?x1164244)))
 (let ((?x934717 (concat (concat (concat (concat (concat ?x1823144 ?x1165228) ?x1168930) ?x1170904) ?x1166179) ?x1170241)))
 (let ((?x1829532 (concat (concat (concat (concat (concat ?x934717 ?x1172469) ?x1173366) ?x1165964) ?x1164386) ?x1177629)))
 (let ((?x1827656 (concat (concat (concat (concat ?x1829532 ?x1177657) ?x1165971) ?x1173147) ?x1164400)))
 (let ((?x1831117 ((_ zero_extend 32) ?x1827656)))
 (let ((?x1178863 ((_ extract 127 120) mem_20_407_128)))
 (let (($x1168362 (= (_ bv10 8) ?x1178863)))
 (let ((?x1824655 (ite $x1168362 (_ bv15 64) (_ bv64 64))))
 (let ((?x1825065 (ite $x1164639 (_ bv14 64) ?x1824655)))
 (let ((?x1823264 (ite $x1169892 (_ bv13 64) ?x1825065)))
 (let ((?x1825110 (ite $x1173119 (_ bv12 64) ?x1823264)))
 (let ((?x1824129 (ite $x1177517 (_ bv11 64) ?x1825110)))
 (let ((?x1830121 (ite $x1163617 (_ bv10 64) ?x1824129)))
 (let ((?x1825708 (ite $x1179045 (_ bv9 64) ?x1830121)))
 (let ((?x1827478 (ite $x1166651 (_ bv8 64) ?x1825708)))
 (let ((?x1827030 (ite $x1166008 (_ bv7 64) ?x1827478)))
 (let ((?x1832265 (ite $x1168355 (_ bv6 64) ?x1827030)))
 (let ((?x1832275 (ite $x1165207 (_ bv5 64) ?x1832265)))
 (let ((?x1826306 (ite $x1178874 (_ bv4 64) ?x1832275)))
 (let ((?x1825031 (ite $x1179151 (_ bv3 64) ?x1826306)))
 (let ((?x1830908 (ite $x1178829 (_ bv2 64) ?x1825031)))
 (let ((?x1824833 (ite $x1179152 (_ bv1 64) ?x1830908)))
 (let ((?x1829585 (ite $x1170040 (_ bv0 64) ?x1824833)))
 (let (($x1831556 (and (distinct (_ bv0 32) ?x1827656) true)))
 (let ((?x1824512 (ite $x1831556 ?x1829585 ?x1831117)))
 (let ((?x1824273 ((_ extract 31 0) ?x1824512)))
 (let ((?x1829854 ((_ zero_extend 32) ?x1824273)))
 (let ((?x6423 ((_ extract 835 832) mem_c0000f45_79_992)))
 (let ((?x16888 (concat (_ bv268435455 28) ?x6423)))
 (let ((?x2374 ((_ extract 839 832) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
