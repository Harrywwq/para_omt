...
(declare-fun mem_8000000000000000_471_64 () (_ BitVec 64))
(assert
...
(assert
 ...
 (let ((?x939970 (concat (concat (_ bv0 26) mem_c0080024_86_32) (_ bv0 1))))
 (let ((?x201 (concat (_ bv0 27) mem_c0080024_86_32)))
 (let ((?x1811633 (bvadd ?x201 ?x939970)))
 (let ((?x2550023 (concat ?x1811633 (_ bv0 3))))
 (let ((?x2549169 (concat (concat (_ bv0 29) mem_c0080024_86_32) (_ bv0 1))))
 (let ((?x190 (concat (_ bv0 30) mem_c0080024_86_32)))
 (let ((?x1812261 (bvadd (bvadd ?x190 ?x2549169) ?x2550023)))
 (let ((?x2556051 (concat ?x1812261 (_ bv0 2))))
 (let ((?x168 (concat (_ bv0 32) mem_c0080020_87_32)))
 (let ((?x2545934 (bvadd ?x168 ?x2556051)))
 (let ((?x943974 (concat (concat (_ bv0 29) mem_c0080010_84_32) (_ bv0 1))))
 (let ((?x161 (concat (_ bv0 30) mem_c0080010_84_32)))
 (let ((?x2550494 (bvadd ?x161 ?x943974)))
 (let ((?x2545062 (concat ?x2550494 (_ bv0 2))))
 (let ((?x143 (concat (_ bv0 32) mem_c0080008_85_32)))
 (let ((?x2553917 (bvadd ?x143 ?x2545062)))
 (let (($x2544933 (bvsle ?x2545934 ?x2553917)))
 (let ((?x1811734 (ite $x2544933 ?x2553917 ?x2545934)))
 (let (($x2556714 (bvsle ?x129 ?x1811734)))
 (let ((?x2553515 (ite $x2556714 ?x1811734 ?x129)))
 (let (($x2547641 (= (_ bv0 64) ?x2553515)))
 (not $x2547641)))))))))))))))))))))))))
(assert
...
(assert
 (= (_ bv9223372036854775808 64) mem_ffffffffffffffee_404_64))
(assert
 (and (distinct (_ bv0 64) mem_8000000000000000_471_64) true))
(minimize mem_8000000000000000_471_64)
