...
(assert
 ...
 (let ((?x657242 ((_ extract 127 120) mem_20_347_128)))
 (let (($x658154 (= (_ bv10 8) ?x657242)))
 (let ((?x1824431 (ite $x658154 (_ bv15 32) (_ bv64 32))))
 (let ((?x662527 ((_ extract 119 112) mem_20_347_128)))
 (let (($x657516 (= (_ bv10 8) ?x662527)))
 (let ((?x1872491 (ite $x657516 (_ bv14 32) ?x1824431)))
 (let ((?x650381 ((_ extract 111 104) mem_20_347_128)))
 (let (($x662327 (= (_ bv10 8) ?x650381)))
 (let ((?x1821639 (ite $x662327 (_ bv13 32) ?x1872491)))
 (let ((?x656785 ((_ extract 103 96) mem_20_347_128)))
 (let (($x657114 (= (_ bv10 8) ?x656785)))
 (let ((?x1872760 (ite $x657114 (_ bv12 32) ?x1821639)))
 (let ((?x660345 ((_ extract 95 88) mem_20_347_128)))
 (let (($x662701 (= (_ bv10 8) ?x660345)))
 (let ((?x1827557 (ite $x662701 (_ bv11 32) ?x1872760)))
 (let ((?x661560 ((_ extract 87 80) mem_20_347_128)))
 (let (($x661729 (= (_ bv10 8) ?x661560)))
 (let ((?x1830893 (ite $x661729 (_ bv10 32) ?x1827557)))
 (let ((?x662147 ((_ extract 79 72) mem_20_347_128)))
 (let (($x660238 (= (_ bv10 8) ?x662147)))
 (let ((?x1590873 (ite $x660238 (_ bv9 32) ?x1830893)))
 (let ((?x660834 ((_ extract 71 64) mem_20_347_128)))
 (let (($x655940 (= (_ bv10 8) ?x660834)))
 (let ((?x1823119 (ite $x655940 (_ bv8 32) ?x1590873)))
 (let ((?x656896 ((_ extract 63 56) mem_20_347_128)))
 (let (($x664597 (= (_ bv10 8) ?x656896)))
 (let ((?x1829863 (ite $x664597 (_ bv7 32) ?x1823119)))
 (let ((?x664620 ((_ extract 55 48) mem_20_347_128)))
 (let (($x657106 (= (_ bv10 8) ?x664620)))
 (let ((?x1553374 (ite $x657106 (_ bv6 32) ?x1829863)))
 (let ((?x657865 ((_ extract 47 40) mem_20_347_128)))
 (let (($x660601 (= (_ bv10 8) ?x657865)))
 (let ((?x1824694 (ite $x660601 (_ bv5 32) ?x1553374)))
 (let ((?x657237 ((_ extract 39 32) mem_20_347_128)))
 (let (($x658123 (= (_ bv10 8) ?x657237)))
 (let ((?x1872761 (ite $x658123 (_ bv4 32) ?x1824694)))
 (let ((?x658170 ((_ extract 31 24) mem_20_347_128)))
 (let (($x658166 (= (_ bv10 8) ?x658170)))
 (let ((?x1565904 (ite $x658166 (_ bv3 32) ?x1872761)))
 (let ((?x660906 ((_ extract 23 16) mem_20_347_128)))
 (let (($x660833 (= (_ bv10 8) ?x660906)))
 (let ((?x1600787 (ite $x660833 (_ bv2 32) ?x1565904)))
 (let ((?x661464 ((_ extract 15 8) mem_20_347_128)))
 (let (($x661552 (= (_ bv10 8) ?x661464)))
 (let ((?x1583270 (ite $x661552 (_ bv1 32) ?x1600787)))
 (let ((?x662491 ((_ extract 7 0) mem_20_347_128)))
 (let (($x661730 (= (_ bv10 8) ?x662491)))
 (let ((?x1873441 (ite $x661730 (_ bv0 32) ?x1583270)))
 (let ((?x656754 (ite $x661730 (_ bv1 1) (_ bv0 1))))
 (let ((?x656382 (ite $x661552 (_ bv1 1) (_ bv0 1))))
 (let ((?x661555 (ite $x660833 (_ bv1 1) (_ bv0 1))))
 (let ((?x661659 (ite $x658166 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x392919 (ite $x657114 (_ bv1 1) (_ bv0 1))))
 (let ((?x395073 (ite $x662327 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178977 (concat (concat (concat (_ bv0 16) (ite $x658154 (_ bv1 1) (_ bv0 1))) (ite $x657516 (_ bv1 1) (_ bv0 1))) ?x395073)))
 (let ((?x1166642 (concat (concat (concat (concat (concat ?x1178977 ?x392919) ?x394485) ?x395268) ?x393923) ?x393163)))
 (let ((?x1166109 (concat (concat (concat (concat (concat ?x1166642 ?x394015) ?x393877) ?x393491) ?x661628) ?x661659)))
 (let ((?x1177585 (concat (concat (concat ?x1166109 ?x661555) ?x656382) ?x656754)))
 (let (($x1872768 (not $x658154)))
 (let (($x1872492 (not $x657516)))
 (let (($x1871293 (not $x662327)))
 (let (($x1827601 (not $x657114)))
 (let (($x1826314 (not $x662701)))
 (let (($x1822689 (not $x661729)))
 (let (($x1833479 (not $x660238)))
 (let (($x1561165 (not $x655940)))
 (let (($x1562751 (not $x664597)))
 (let (($x1562629 (not $x657106)))
 (let (($x1562350 (not $x660601)))
 (let (($x1555486 (not $x658123)))
 (let (($x1561385 (not $x658166)))
 (let (($x1560895 (not $x660833)))
 (let (($x1565783 (not $x661552)))
 (let (($x1565677 (not $x661730)))
 (let (($x1833055 (and $x1565677 $x1565783 $x1560895 $x1561385 $x1555486 $x1562350 $x1562629 $x1562751 $x1561165 $x1833479 $x1822689 $x1826314 $x1827601 $x1871293 $x1872492 $x1872768)))
 (let ((?x1871304 (ite $x1833055 ?x1177585 ?x1873441)))
 (let ((?x1872498 (concat (_ bv0 32) ?x1871304)))
 (let ((?x1873353 (bvadd (bvadd (_ bv48 64) ?x1872498) ?x14202)))
 (and (distinct (_ bv0 64) ?x1873353) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
