...
(declare-fun mem_ffffffc07f800000_294_8 () (_ BitVec 8))
(assert
...
(assert
 (and (distinct (_ bv10 8) mem_ffffffc07f800000_294_8) true))
(maximize mem_c0080024_86_32)
(maximize mem_ffffffc07f800000_294_8)
...
(minimize mem_ffffffc07f800000_294_8)
