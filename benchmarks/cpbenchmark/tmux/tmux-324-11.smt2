...
(assert
 ...
 (and (distinct (_ bv0 64) ?x31872) true))))))))))
(assert
 (let ((?x2290 ((_ extract 900 896) mem_c0000f45_79_992)))
 (let ((?x2283 ((_ extract 903 902) mem_c0000f45_79_992)))
 (let ((?x40313 (concat (concat (_ bv1 1) ((_ extract 894 889) mem_c0000f45_79_992)) (_ bv0 1))))
 (let ((?x42548 (concat (concat (concat ?x40313 ?x2283) (_ bv0 1)) ?x2290)))
 (let ((?x42560 (bvand ?x42548 (_ bv256 16))))
 (= (_ bv0 16) ?x42560)))))))
