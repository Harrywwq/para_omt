...
(declare-fun mem_fffffffff8000000_493_64 () (_ BitVec 64))
(declare-fun mem_ffffffffffe00000_820_64 () (_ BitVec 64))
(assert
...
(assert
 (= (_ bv18446744073575333888 64) mem_ffffffffffff0000_420_64))
(assert
 (= (_ bv18446744073707454464 64) mem_fffffffff8000000_493_64))
(assert
 (and (distinct (_ bv0 64) mem_ffffffffffe00000_820_64) true))
(minimize mem_fe00000000000000_302_64)
(minimize mem_ffffffffffe00000_820_64)
...
(maximize mem_ffffffffffe00000_820_64)
(check-sat)
(get-objectives)
