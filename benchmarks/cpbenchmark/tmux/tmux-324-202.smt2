...
(declare-fun mem_fffffffffffffff3_304_64 () (_ BitVec 64))
(declare-fun mem_ffe0000000000000_363_64 () (_ BitVec 64))
(declare-fun mem_ffe0000000000010_362_32 () (_ BitVec 32))
(declare-fun mem_3_303_32 () (_ BitVec 32))
...
(assert
 (= (_ bv18446744073709551603 64) mem_fffffffffe000000_260_64))
(assert
 (= (_ bv18437736874454810624 64) mem_fffffffffffffff3_304_64))
(assert
 (= (_ bv0 64) mem_ffe0000000000000_363_64))
(assert
 ...
 (let ((?x1386256 ((_ extract 31 31) mem_ffe0000000000010_362_32)))
 (let ((?x1381953 (concat (concat (concat (concat (concat ?x1386256 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1386209 (concat (concat (concat (concat (concat ?x1381953 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1386711 (concat (concat (concat (concat (concat ?x1386209 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1384630 (concat (concat (concat (concat (concat ?x1386711 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1387027 (concat (concat (concat (concat (concat ?x1384630 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1386509 (concat (concat (concat (concat (concat ?x1387027 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1383978 (concat (concat ?x1386509 ?x1386256) mem_ffe0000000000010_362_32)))
 (let ((?x777694 ((_ extract 31 31) mem_3_303_32)))
 (let ((?x776868 (concat (concat (concat (concat (concat ?x777694 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x780988 (concat (concat (concat (concat (concat ?x776868 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x772400 (concat (concat (concat (concat (concat ?x780988 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x278246 (concat (concat (concat (concat (concat ?x772400 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x779936 (concat (concat (concat (concat (concat ?x278246 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x460876 (concat (concat (concat (concat (concat ?x779936 ?x777694) ?x777694) ?x777694) ?x777694) ?x777694)))
 (let ((?x772703 (concat (concat ?x460876 ?x777694) mem_3_303_32)))
 ...
 (let (($x769758 (bvsle ?x457468 ?x772703)))
 (let ((?x773147 (ite $x769758 ?x457468 ?x772703)))
 (let (($x460826 (bvsle ?x773147 ?x1383978)))
 (let ((?x1382130 (ite $x460826 ?x773147 ?x1383978)))
 (let ((?x47620 (bvsub ?x20542 ?x15071)))
 (let ((?x779087 (bvsub ?x47620 ?x1382130)))
 (bvule ?x779087 ?x114530))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1386256 ((_ extract 31 31) mem_ffe0000000000010_362_32)))
 (let ((?x1381953 (concat (concat (concat (concat (concat ?x1386256 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 (let ((?x1386209 (concat (concat (concat (concat (concat ?x1381953 ?x1386256) ?x1386256) ?x1386256) ?x1386256) ?x1386256)))
 ...
 (let (($x460826 (bvsle ?x773147 ?x1383978)))
 (let ((?x1382130 (ite $x460826 ?x773147 ?x1383978)))
 (let ((?x2802753 ((_ extract 63 63) ?x1382130)))
 (= (_ bv0 1) ?x2802753)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(maximize mem_ffe0000000000010_362_32)
(maximize mem_c0000f45_79_992)
(minimize mem_fffffffffe000000_260_64)
(minimize mem_ffe0000000000010_362_32)
(maximize mem_fffff80000000010_205_32)
(minimize mem_ffffffffffffff6f_187_64)
(maximize mem_ffffffffffc00000_230_64)
(maximize mem_ffffffffffffff7f_186_32)
(minimize mem_ffe0000000000000_363_64)
(minimize mem_3_303_32)
(maximize mem_c0001010_98_32)
(minimize syscall_stub_newfstatat_83_64)
(maximize mem_ffffffffffc00010_229_32)
(minimize mem_fffff80000000000_206_64)
(maximize mem_ffe0000000000000_363_64)
(minimize mem_fffffffffffffff3_304_64)
(maximize mem_3_303_32)
(maximize mem_fffff80000000000_206_64)
(minimize mem_ffffffffffc00010_229_32)
(maximize mem_ffffffffffffff6f_187_64)
(minimize mem_ffffffffffc00000_230_64)
...
(maximize mem_fffffffffffffff3_304_64)
