...
(declare-fun mem_c0000fc4_367_8 () (_ BitVec 8))
(assert
...
(assert
 (let ((?x463191 (bvsub mem_c000000000000000_261_64 mem_c000000000000018_307_64)))
 (let ((?x463212 (bvashr ?x463191 (_ bv2 64))))
 (let ((?x460418 (bvsub mem_c000000000000038_306_64 mem_c000000000000030_305_64)))
 (let ((?x463203 (bvashr ?x460418 (_ bv2 64))))
 (let ((?x2417 ((_ extract 751 744) mem_c0000f45_79_992)))
 ...
 (let ((?x149620 (bvadd ?x287635 ?x463203)))
 (bvule ?x149620 ?x463212))))))))))))))))))
(assert
 (let ((?x289042 (bvand mem_c0000fc4_367_8 (_ bv8 8))))
 (= (_ bv0 8) ?x289042)))
(assert
 ...
 (let ((?x1391145 (bvadd ?x463189 (_ bv50 64))))
 (let ((?x1392814 (bvshl ?x1391145 (_ bv1 64))))
 (let ((?x1393041 (bvlshr ?x1392814 (_ bv62 64))))
 (= (_ bv0 64) ?x1393041))))))))
(assert
 (let ((?x462751 (bvmul (_ bv18446744073709551615 64) mem_c000000000000030_305_64)))
 (let ((?x460664 (bvadd mem_c000000000000038_306_64 ?x462751)))
 (let ((?x463189 (bvashr ?x460664 (_ bv2 64))))
 (let ((?x1392887 ((_ extract 62 0) ?x463189)))
 (let ((?x1392866 (bvadd (_ bv50 63) ?x1392887)))
 (let ((?x2059805 (concat ?x1392866 (_ bv0 1))))
 (bvule ?x463189 ?x2059805))))))))
