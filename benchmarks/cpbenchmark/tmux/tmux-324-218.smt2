...
(declare-fun mem_c000000000000018_307_64 () (_ BitVec 64))
(declare-fun mem_c000000000000000_261_64 () (_ BitVec 64))
(declare-fun mem_c000000000000030_305_64 () (_ BitVec 64))
(declare-fun mem_c000000000000038_306_64 () (_ BitVec 64))
(declare-fun mem_c000000000000008_262_64 () (_ BitVec 64))
...
(assert
 ...
 (let ((?x2062216 (concat ?x4642 (_ bv4294967295 32))))
 (let ((?x3977 ((_ extract 583 576) mem_c0000f45_79_992)))
 (let ((?x935 ((_ extract 575 568) mem_c0000f45_79_992)))
 (let ((?x4611 ((_ extract 567 560) mem_c0000f45_79_992)))
 (let ((?x3400 ((_ extract 559 552) mem_c0000f45_79_992)))
...
(assert
 ...
 (= (_ bv1 1) ?x139080)))
(assert
 (let ((?x463192 (bvmul (_ bv18446744073709551615 64) mem_c000000000000018_307_64)))
 (let ((?x463213 (bvadd mem_c000000000000000_261_64 ?x463192)))
 (let ((?x463214 (bvashr ?x463213 (_ bv2 64))))
 (let ((?x462751 (bvmul (_ bv18446744073709551615 64) mem_c000000000000030_305_64)))
 (let ((?x460664 (bvadd mem_c000000000000038_306_64 ?x462751)))
 (let ((?x463189 (bvashr ?x460664 (_ bv2 64))))
 (let ((?x1393578 (bvadd (_ bv1 64) ?x463189)))
 (let (($x1394801 (bvule ?x1393578 ?x463214)))
 (not $x1394801))))))))))
(assert
 (let ((?x2427 ((_ extract 775 768) mem_c0000f45_79_992)))
 (= (_ bv255 8) ?x2427)))
(assert
 (let (($x1394154 (bvule mem_c000000000000000_261_64 mem_c000000000000008_262_64)))
 (not $x1394154)))
(assert
...
(assert
 ...
 (let ((?x2062216 (concat ?x4642 (_ bv4294967295 32))))
 (let ((?x2060228 (bvadd ?x2062216 ?x3646)))
 (let ((?x2062107 ((_ extract 63 63) ?x2060228)))
 (let (($x2061641 (= (_ bv1 1) ?x2062107)))
 (or $x2061641 $x2062245)))))))))))))))))))))))))))))))))))))))))
(assert
...
(minimize mem_c000000000000018_307_64)
...
(minimize mem_c000000000000000_261_64)
(maximize mem_c0000ff0_231_64)
(maximize mem_c000000000000038_306_64)
(minimize mem_c0001028_107_64)
(minimize mem_c0000ff0_231_64)
(maximize mem_c000000000000030_305_64)
(minimize mem_c000000000000030_305_64)
(maximize mem_c000000000000000_261_64)
(maximize mem_c000000000000018_307_64)
(minimize mem_c000000000000038_306_64)
(check-sat)
(get-objectives)
