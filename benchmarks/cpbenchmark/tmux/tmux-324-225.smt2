...
(assert
 ...
 (let ((?x286240 (bvadd ?x287635 ?x285276)))
 (let (($x285273 (bvule ?x286240 ?x287824)))
 (not $x285273)))))))))))))))))))))
(assert
...
(assert
 (let ((?x289201 (bvadd mem_c0000ff0_231_64 (_ bv8 64))))
 (= (_ bv13835058055282163720 64) ?x289201)))
(assert
 (let ((?x2427 ((_ extract 775 768) mem_c0000f45_79_992)))
 (let ((?x2419 ((_ extract 767 760) mem_c0000f45_79_992)))
 ...
 (= (_ bv4294967295 32) ?x22501))))))
(assert
 (bvule mem_c000000000000020_263_64 mem_c000000000000008_309_64))
