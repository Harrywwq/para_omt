...
(assert
 ...
 (let ((?x2817245 (bvadd (_ bv18446744073709551615 64) ?x289264)))
 (let ((?x2816964 (bvashr ?x2817245 (_ bv2 64))))
 ...
 (let (($x2816735 (bvule ?x285276 ?x2816964)))
 (not $x2816735)))))))))
(assert
 (let (($x788081 (bvule (_ bv3 64) mem_c000000000000008_309_64)))
 (not $x788081)))
(assert
 (let ((?x2427 ((_ extract 775 768) mem_c0000f45_79_992)))
 (let ((?x2419 ((_ extract 767 760) mem_c0000f45_79_992)))
