...
(declare-fun mem_c0000fc4_315_8 () (_ BitVec 8))
(assert
...
(assert
 (let ((?x292615 (bvadd mem_c0000ff0_235_64 (_ bv24 64))))
 (= (_ bv9223372036854775832 64) ?x292615)))
(assert
 (let ((?x290589 (bvsub mem_8000000000000020_271_64 mem_8000000000000018_274_64)))
 (let ((?x291343 (bvashr ?x290589 (_ bv2 64))))
 (let ((?x289594 (bvsub mem_8000000000000038_273_64 mem_8000000000000030_272_64)))
 (let ((?x292422 (bvashr ?x289594 (_ bv2 64))))
 (let ((?x3400 ((_ extract 559 552) mem_c0000f45_79_992)))
 ...
 (let (($x139860 (and $x140991 $x140958 $x146242 $x140995)))
 (let ((?x285889 (ite $x139860 (_ bv1 1) (_ bv0 1))))
 (let ((?x292589 (concat (_ bv0 63) ?x285889)))
 (let ((?x291328 (bvadd ?x292589 ?x292422)))
 (bvule ?x291328 ?x291343))))))))))))))))))
(assert
 (let ((?x466818 (bvand mem_c0000fc4_315_8 (_ bv8 8))))
 (= (_ bv0 8) ?x466818)))
(assert
 ...
 (let ((?x470170 (bvadd ?x292542 (_ bv50 64))))
 (let ((?x801610 (bvshl ?x470170 (_ bv1 64))))
 (let ((?x799084 (bvlshr ?x801610 (_ bv62 64))))
 (= (_ bv0 64) ?x799084))))))))
(assert
 (let ((?x291078 (bvmul (_ bv18446744073709551615 64) mem_8000000000000030_272_64)))
 (let ((?x292764 (bvadd mem_8000000000000038_273_64 ?x291078)))
 (let ((?x292542 (bvashr ?x292764 (_ bv2 64))))
 (let ((?x1410351 ((_ extract 62 0) ?x292542)))
 (let ((?x1409270 (bvadd (_ bv50 63) ?x1410351)))
 (let ((?x1409310 (concat ?x1409270 (_ bv0 1))))
 (bvule ?x292542 ?x1409310))))))))
(minimize mem_8000000000000030_272_64)
(minimize mem_c0001010_98_32)
(minimize mem_c0000fc4_315_8)
...
(minimize mem_8000000000000018_274_64)
