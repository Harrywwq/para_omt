...
(assert
 ...
 (let ((?x796392 (bvadd (_ bv18446744073709551615 64) ?x291428)))
 (let ((?x1407783 (bvashr ?x796392 (_ bv2 64))))
 ...
 (let (($x2078173 (bvule ?x292542 ?x1407783)))
 (not $x2078173)))))))))
(assert
 (let (($x796688 (bvule (_ bv3 64) mem_8000000000000008_316_64)))
 (not $x796688)))
(assert
 (let ((?x3977 ((_ extract 583 576) mem_c0000f45_79_992)))
 (let ((?x935 ((_ extract 575 568) mem_c0000f45_79_992)))
