...
(declare-fun mem_8000000000000018_1082_64 () (_ BitVec 64))
(declare-fun mem_8000000000000020_1079_64 () (_ BitVec 64))
(declare-fun mem_8000000000000030_1080_64 () (_ BitVec 64))
(declare-fun mem_8000000000000038_1081_64 () (_ BitVec 64))
(assert
...
(assert
 ...
 (let (($x14981 (= (_ bv0 8) ?x14868)))
 (let (($x799177 (not $x14981)))
 (let ((?x14869 ((_ extract 319 312) mem_c0000f45_79_992)))
 (let (($x14910 (= (_ bv0 8) ?x14869)))
 (let (($x799657 (not $x14910)))
 (let ((?x14857 ((_ extract 287 280) mem_c0000f45_79_992)))
 (let (($x14987 (= (_ bv0 8) ?x14857)))
 (let (($x798641 (not $x14987)))
 (let ((?x14951 ((_ extract 271 264) mem_c0000f45_79_992)))
 (let (($x14890 (= (_ bv0 8) ?x14951)))
 (let (($x800094 (not $x14890)))
 (let ((?x14875 ((_ extract 303 296) mem_c0000f45_79_992)))
 (let (($x14879 (= (_ bv0 8) ?x14875)))
 (let (($x800152 (not $x14879)))
 (let ((?x14872 ((_ extract 295 288) mem_c0000f45_79_992)))
 (let (($x14915 (= (_ bv0 8) ?x14872)))
 (let (($x798812 (not $x14915)))
 (let ((?x14893 ((_ extract 311 304) mem_c0000f45_79_992)))
 (let (($x15018 (= (_ bv0 8) ?x14893)))
 (let (($x799827 (not $x15018)))
 (let ((?x14887 ((_ extract 327 320) mem_c0000f45_79_992)))
 (let (($x14901 (= (_ bv0 8) ?x14887)))
 (let (($x800150 (not $x14901)))
 (or $x800150 $x799827 $x798812 $x800152 $x800094 $x798641 $x799657 $x799177))))))))))))))))))))))))))
(assert
...
(assert
 (let ((?x2874371 (bvsub mem_8000000000000020_1079_64 mem_8000000000000018_1082_64)))
 (let ((?x2871786 (bvashr ?x2874371 (_ bv2 64))))
 (let ((?x2874548 (bvsub mem_8000000000000038_1081_64 mem_8000000000000030_1080_64)))
 (let ((?x2872240 (bvashr ?x2874548 (_ bv2 64))))
 (let ((?x3400 ((_ extract 559 552) mem_c0000f45_79_992)))
 ...
 (let ((?x2874306 (bvadd ?x292589 ?x2872240)))
 (bvule ?x2874306 ?x2871786))))))))))))))))))
...
(minimize mem_8000000000000030_1080_64)
(maximize mem_c0001028_107_64)
(maximize mem_8000000000000018_1082_64)
(maximize mem_8000000000000020_1079_64)
(minimize mem_8000000000000018_1082_64)
