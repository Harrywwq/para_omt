...
(declare-fun mem_ffffffffffffffee_404_64 () (_ BitVec 64))
(declare-fun mem_fffffffffffffffe_402_16 () (_ BitVec 16))
(declare-fun mem_0_403_16 () (_ BitVec 16))
(assert
...
(assert
 ...
 (= (_ bv18446744073709551598 64) ?x30409))))))))))
(assert
 (= (_ bv0 64) mem_ffffffffffffffee_404_64))
(assert
 ...
 (let ((?x1833862 ((_ extract 15 15) mem_0_403_16)))
 (let ((?x921018 (concat (concat (concat (concat (concat ?x1833862 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x1831473 (concat (concat (concat (concat (concat ?x921018 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x945589 (concat (concat (concat (concat (concat ?x1831473 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x939433 (concat (concat (concat (concat (concat ?x945589 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x1832930 (concat (concat (concat (concat (concat ?x939433 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x1831326 (concat (concat (concat (concat (concat ?x1832930 ?x1833862) ?x1833862) ?x1833862) ?x1833862) ?x1833862)))
 (let ((?x1832392 (concat (concat (concat ?x1831326 ?x1833862) mem_0_403_16) mem_fffffffffffffffe_402_16)))
 ...
 (let (($x1830108 (bvsle ?x32022 ?x1832392)))
 (let ((?x1833305 (ite $x1830108 ?x32022 ?x1832392)))
 ...
 (let ((?x2282008 (bvsub ?x25492 ?x1833305)))
 (bvugt ?x2282008 ?x47949))))))))))))))))))))))))))))))))))))))))))))))
(maximize mem_c0080014_89_32)
(minimize mem_c0080018_88_32)
(maximize mem_ffffffffffffffee_404_64)
(minimize mem_c0000f45_79_992)
(minimize mem_c0080008_85_32)
(maximize mem_0_403_16)
...
(maximize mem_fffffffffffffffe_402_16)
