...
(declare-fun mem_c0000fc4_1085_8 () (_ BitVec 8))
(assert
...
(assert
 (let ((?x2145883 (bvsub mem_fffffffffc000000_428_64 mem_fffffffffc000018_504_64)))
 (let ((?x2148070 (bvashr ?x2145883 (_ bv2 64))))
 (let ((?x2146502 (bvsub mem_fffffffffc000038_503_64 mem_fffffffffc000030_502_64)))
 (let ((?x2147587 (bvashr ?x2146502 (_ bv2 64))))
 (let ((?x15053 ((_ extract 175 168) mem_c0000f45_79_992)))
 ...
 (let ((?x2147302 (bvadd ?x794592 ?x2147587)))
 (bvule ?x2147302 ?x2148070))))))))))))))))))
(assert
 (let ((?x1451597 (bvand mem_c0000fc4_1085_8 (_ bv8 8))))
 (= (_ bv0 8) ?x1451597)))
