...
(declare-fun mem_fffffffffc000018_504_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000000_428_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000030_502_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000038_503_64 () (_ BitVec 64))
...
(assert
 ...
 (= (_ bv1 1) ?x139080)))
(assert
 (let ((?x837073 (bvmul (_ bv18446744073709551615 64) mem_fffffffffc000018_504_64)))
 (let ((?x2146019 (bvadd mem_fffffffffc000000_428_64 ?x837073)))
 (let ((?x1868985 (bvashr ?x2146019 (_ bv2 64))))
 (let ((?x2146838 (bvmul (_ bv18446744073709551615 64) mem_fffffffffc000030_502_64)))
 (let ((?x2145169 (bvadd mem_fffffffffc000038_503_64 ?x2146838)))
 (let ((?x2146102 (bvashr ?x2145169 (_ bv2 64))))
 (let ((?x15053 ((_ extract 175 168) mem_c0000f45_79_992)))
 ...
 (let ((?x1458127 (bvadd ?x794592 ?x2146102)))
 (let (($x2149109 (bvule ?x1458127 ?x1868985)))
 (not $x2149109)))))))))))))))))))))
(assert
...
(maximize mem_fffffffffc000018_504_64)
(minimize mem_c0001028_107_64)
(maximize mem_fffffffffc000030_502_64)
(minimize mem_fffffffffc000018_504_64)
(minimize mem_fffffffffc000038_503_64)
(minimize mem_c0000ff0_372_64)
(maximize mem_fffffffffc000038_503_64)
(maximize mem_c0001010_98_32)
(minimize syscall_stub_newfstatat_83_64)
(minimize mem_c0001010_98_32)
(minimize mem_fffffffffc000000_428_64)
(maximize mem_fffffffffc000000_428_64)
