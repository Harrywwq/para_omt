...
(declare-fun mem_c0000ff0_372_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000018_433_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000020_430_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000030_431_64 () (_ BitVec 64))
(declare-fun mem_fffffffffc000038_432_64 () (_ BitVec 64))
(declare-fun mem_c0000fc4_505_8 () (_ BitVec 8))
(assert
...
(assert
 ...
 (= (_ bv0 8) ?x13650)))
(assert
 (let ((?x12871 ((_ extract 215 208) mem_c0000f45_79_992)))
 (= (_ bv0 8) ?x12871)))
(assert
 (let ((?x11917 ((_ extract 207 200) mem_c0000f45_79_992)))
 (= (_ bv0 8) ?x11917)))
(assert
...
(assert
 (= (_ bv18446744073642442752 64) mem_c0000ff0_372_64))
(assert
 (let ((?x1451817 (bvadd mem_c0000ff0_372_64 (_ bv24 64))))
 (= (_ bv18446744073642442776 64) ?x1451817)))
(assert
 (let ((?x1417629 (bvsub mem_fffffffffc000020_430_64 mem_fffffffffc000018_433_64)))
 (let ((?x1453057 (bvashr ?x1417629 (_ bv2 64))))
 (let ((?x1458137 (bvsub mem_fffffffffc000038_432_64 mem_fffffffffc000030_431_64)))
 (let ((?x1418466 (bvashr ?x1458137 (_ bv2 64))))
 (let ((?x15053 ((_ extract 175 168) mem_c0000f45_79_992)))
 (let (($x56273 (= (_ bv255 8) ?x15053)))
 (let ((?x15055 ((_ extract 183 176) mem_c0000f45_79_992)))
 (let (($x834649 (= (_ bv255 8) ?x15055)))
 (let ((?x15057 ((_ extract 191 184) mem_c0000f45_79_992)))
 (let (($x794425 (= (_ bv255 8) ?x15057)))
 (let ((?x15059 ((_ extract 199 192) mem_c0000f45_79_992)))
 (let (($x839101 (= (_ bv255 8) ?x15059)))
 (let (($x835305 (and $x839101 $x794425 $x834649 $x56273)))
 (let ((?x1450975 (ite $x835305 (_ bv1 1) (_ bv0 1))))
 (let ((?x794592 (concat (_ bv0 63) ?x1450975)))
 (let ((?x1459430 (bvadd ?x794592 ?x1418466)))
 (bvule ?x1459430 ?x1453057))))))))))))))))))
(assert
 (let ((?x2146295 (bvand mem_c0000fc4_505_8 (_ bv8 8))))
 (= (_ bv0 8) ?x2146295)))
(assert
 (let ((?x797022 (bvmul (_ bv18446744073709551615 64) mem_fffffffffc000030_431_64)))
 (let ((?x1451715 (bvadd mem_fffffffffc000038_432_64 ?x797022)))
 (let ((?x1415544 (bvashr ?x1451715 (_ bv2 64))))
 (let ((?x2154081 (bvadd ?x1415544 (_ bv50 64))))
 (let ((?x2909556 (bvshl ?x2154081 (_ bv1 64))))
 (let ((?x2908389 (bvlshr ?x2909556 (_ bv62 64))))
 (= (_ bv0 64) ?x2908389))))))))
(minimize mem_fffffffffc000018_433_64)
(minimize mem_fffffffffc000020_430_64)
(minimize mem_c0001010_98_32)
(minimize mem_fffffffffc000030_431_64)
(maximize mem_fffffffffc000018_433_64)
(maximize mem_c0000fc4_505_8)
(minimize mem_fffffffffc000038_432_64)
(minimize syscall_stub_newfstatat_83_64)
(maximize mem_fffffffffc000038_432_64)
(minimize mem_c0000ff0_372_64)
(maximize mem_fffffffffc000030_431_64)
(minimize mem_c0001028_107_64)
(minimize mem_c0000fc4_505_8)
(maximize mem_c0000f45_79_992)
(maximize mem_c0001028_107_64)
(maximize mem_fffffffffc000020_430_64)
(maximize mem_c0000ff0_372_64)
