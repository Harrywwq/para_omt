...
(assert
 ...
 (let ((?x1461770 (bvadd ?x794592 ?x1415544)))
 (let (($x1460902 (bvule ?x1461770 ?x1458140)))
 (not $x1460902)))))))))))))))))))))
(assert
...
(assert
 (let ((?x480165 (bvadd mem_c0000ff0_372_64 (_ bv8 64))))
 (= (_ bv18446744073642442760 64) ?x480165)))
(assert
 (let ((?x15059 ((_ extract 199 192) mem_c0000f45_79_992)))
 (let ((?x15057 ((_ extract 191 184) mem_c0000f45_79_992)))
 ...
 (= (_ bv4294967295 32) ?x465344))))))
(assert
 (bvule mem_fffffffffc000020_430_64 mem_fffffffffc000008_506_64))
