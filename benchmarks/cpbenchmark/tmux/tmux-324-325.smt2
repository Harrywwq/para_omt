...
(declare-fun mem_fffffffffc000008_506_64 () (_ BitVec 64))
(assert
...
(assert
 ...
 (let (($x2910588 (not $x794425)))
 (let ((?x15059 ((_ extract 199 192) mem_c0000f45_79_992)))
 (let (($x839101 (= (_ bv255 8) ?x15059)))
 (let (($x2910144 (not $x839101)))
 (let ((?x15055 ((_ extract 183 176) mem_c0000f45_79_992)))
 (let (($x834649 (= (_ bv255 8) ?x15055)))
 (let (($x2909862 (not $x834649)))
 (let ((?x15053 ((_ extract 175 168) mem_c0000f45_79_992)))
 (let (($x56273 (= (_ bv255 8) ?x15053)))
 (let (($x584848 (not $x56273)))
 (or $x584848 $x2909862 $x2910144 $x2910588))))))))))))))
(assert
...
(assert
 (let ((?x1458897 (bvmul (_ bv18446744073709551615 64) mem_fffffffffc000018_433_64)))
 (let ((?x1460296 (bvadd mem_fffffffffc000020_430_64 ?x1458897)))
 (let ((?x1458140 (bvashr ?x1460296 (_ bv2 64))))
 ...
 (let (($x2909336 (bvule ?x1415544 ?x1458140)))
 (not $x2909336)))))))))
(assert
 (bvule mem_fffffffffc000020_430_64 (_ bv18446744073709551615 64)))
(assert
 (= (_ bv18446744073709551615 64) mem_fffffffffc000020_430_64))
(assert
 (let ((?x2909770 (bvadd mem_fffffffffc000020_430_64 (_ bv4 64))))
 (bvugt ?x2909770 mem_fffffffffc000008_506_64)))
...
(minimize mem_fffffffffc000008_506_64)
