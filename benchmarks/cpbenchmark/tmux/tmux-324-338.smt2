...
(declare-fun mem_f000000001040101_319_64 () (_ BitVec 64))
(declare-fun mem_ffffffffffffffef_376_64 () (_ BitVec 64))
(declare-fun mem_fe07ffffe0000000_435_64 () (_ BitVec 64))
(declare-fun mem_fe07ffffe0000010_434_32 () (_ BitVec 32))
(declare-fun mem_ffffffffffffffff_374_8 () (_ BitVec 8))
(declare-fun mem_0_375_24 () (_ BitVec 24))
(declare-fun mem_f000000001040111_318_32 () (_ BitVec 32))
(assert
...
(assert
 (= (_ bv18446744073709551599 64) mem_f000000001040101_319_64))
(assert
 (= (_ bv18304880684910510080 64) mem_ffffffffffffffef_376_64))
(assert
 (= (_ bv0 64) mem_fe07ffffe0000000_435_64))
(assert
 ...
 (let ((?x2150270 ((_ extract 31 31) mem_fe07ffffe0000010_434_32)))
 (let ((?x2151613 (concat (concat (concat (concat (concat ?x2150270 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2149869 (concat (concat (concat (concat (concat ?x2151613 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2150198 (concat (concat (concat (concat (concat ?x2149869 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2150513 (concat (concat (concat (concat (concat ?x2150198 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2151081 (concat (concat (concat (concat (concat ?x2150513 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2151628 (concat (concat (concat (concat (concat ?x2151081 ?x2150270) ?x2150270) ?x2150270) ?x2150270) ?x2150270)))
 (let ((?x2150713 (concat (concat ?x2151628 ?x2150270) mem_fe07ffffe0000010_434_32)))
 (let ((?x472906 ((_ extract 23 23) mem_0_375_24)))
 (let ((?x1458144 (concat (concat (concat (concat (concat ?x472906 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1458133 (concat (concat (concat (concat (concat ?x1458144 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1451729 (concat (concat (concat (concat (concat ?x1458133 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1452739 (concat (concat (concat (concat (concat ?x1451729 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1452127 (concat (concat (concat (concat (concat ?x1452739 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1452973 (concat (concat (concat (concat (concat ?x1452127 ?x472906) ?x472906) ?x472906) ?x472906) ?x472906)))
 (let ((?x1450981 (concat (concat (concat ?x1452973 ?x472906) mem_0_375_24) mem_ffffffffffffffff_374_8)))
 (let ((?x844651 ((_ extract 31 31) mem_f000000001040111_318_32)))
 (let ((?x837385 (concat (concat (concat (concat (concat ?x844651 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839632 (concat (concat (concat (concat (concat ?x837385 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839637 (concat (concat (concat (concat (concat ?x839632 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839642 (concat (concat (concat (concat (concat ?x839637 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839647 (concat (concat (concat (concat (concat ?x839642 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839750 (concat (concat (concat (concat (concat ?x839647 ?x844651) ?x844651) ?x844651) ?x844651) ?x844651)))
 (let ((?x839814 (concat (concat ?x839750 ?x844651) mem_f000000001040111_318_32)))
 (let ((?x14887 ((_ extract 327 320) mem_c0000f45_79_992)))
 (let ((?x14869 ((_ extract 319 312) mem_c0000f45_79_992)))
 (let ((?x14893 ((_ extract 311 304) mem_c0000f45_79_992)))
 (let ((?x14875 ((_ extract 303 296) mem_c0000f45_79_992)))
 ...
 (let (($x839815 (bvsle ?x97029 ?x839814)))
 (let ((?x839816 (ite $x839815 ?x97029 ?x839814)))
 (let (($x1450982 (bvsle ?x839816 ?x1450981)))
 (let ((?x1450983 (ite $x1450982 ?x839816 ?x1450981)))
 (let (($x2151328 (bvsle ?x1450983 ?x2150713)))
 (let ((?x2151096 (ite $x2151328 ?x1450983 ?x2150713)))
 (let ((?x47620 (bvsub ?x20542 ?x15071)))
 (let ((?x2920153 (bvsub ?x47620 ?x2151096)))
 (bvugt ?x2920153 ?x1161266))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(maximize mem_0_375_24)
(maximize syscall_stub_newfstatat_83_64)
(maximize mem_ffffffffffffffff_374_8)
(minimize mem_f000000001040111_318_32)
(minimize mem_fe07ffffe0000010_434_32)
(minimize mem_c0000f45_79_992)
(maximize mem_f000000001040101_319_64)
(maximize mem_c0000f45_79_992)
(minimize mem_ffffffffffffffff_374_8)
(maximize mem_ffffffffffffffef_376_64)
(minimize syscall_stub_newfstatat_83_64)
(maximize mem_fe07ffffe0000000_435_64)
(maximize mem_fe07ffffe0000010_434_32)
(check-sat)
(get-objectives)
