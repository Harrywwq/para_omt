...
(declare-fun mem_ffffffc000000000_508_64 () (_ BitVec 64))
(declare-fun mem_ffffffffffffffee_1087_8 () (_ BitVec 8))
(assert
...
(assert
 (= (_ bv18446743798831644672 64) mem_fe07ffffe0000000_435_64))
(assert
 (= (_ bv18446744073709551598 64) mem_ffffffc000000000_508_64))
(assert
 (let ((?x2926472 ((_ extract 55 0) mem_ffffffffffffffef_376_64)))
 (let ((?x2917052 (concat ?x2926472 mem_ffffffffffffffee_1087_8)))
 (and (distinct (_ bv0 64) ?x2917052) true))))
...
(minimize mem_ffffffffffffffee_1087_8)
(maximize mem_fe07ffffe0000000_435_64)
(minimize mem_ffffffffffffffef_376_64)
(minimize mem_ffffffc000000000_508_64)
