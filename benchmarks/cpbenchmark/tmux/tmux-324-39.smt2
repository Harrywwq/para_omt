...
(declare-fun mem_30_798_128 () (_ BitVec 128))
(assert
...
(assert
 ...
 (= (_ bv48 64) ?x36827))))))))))))
(assert
 (let ((?x2562740 ((_ extract 7 0) mem_30_798_128)))
 (let (($x2550632 (= (_ bv10 8) ?x2562740)))
 (let ((?x948628 (ite $x2550632 (_ bv1 1) (_ bv0 1))))
 (let ((?x2562058 ((_ extract 15 8) mem_30_798_128)))
 (let (($x2545593 (= (_ bv10 8) ?x2562058)))
 (let ((?x2295969 (ite $x2545593 (_ bv1 1) (_ bv0 1))))
 (let ((?x2421680 ((_ extract 23 16) mem_30_798_128)))
 (let (($x2546018 (= (_ bv10 8) ?x2421680)))
 (let ((?x1811981 (ite $x2546018 (_ bv1 1) (_ bv0 1))))
 (let ((?x2422103 ((_ extract 31 24) mem_30_798_128)))
 (let (($x2422285 (= (_ bv10 8) ?x2422103)))
 (let ((?x1810242 (ite $x2422285 (_ bv1 1) (_ bv0 1))))
 (let ((?x2422943 ((_ extract 39 32) mem_30_798_128)))
 (let (($x2421074 (= (_ bv10 8) ?x2422943)))
 (let ((?x944487 (ite $x2421074 (_ bv1 1) (_ bv0 1))))
 (let ((?x1811887 ((_ extract 47 40) mem_30_798_128)))
 (let (($x2421840 (= (_ bv10 8) ?x1811887)))
 (let ((?x1812413 (ite $x2421840 (_ bv1 1) (_ bv0 1))))
 (let ((?x1812236 ((_ extract 55 48) mem_30_798_128)))
 (let (($x2292984 (= (_ bv10 8) ?x1812236)))
 (let ((?x948770 (ite $x2292984 (_ bv1 1) (_ bv0 1))))
 (let ((?x2312717 ((_ extract 63 56) mem_30_798_128)))
 (let (($x2299113 (= (_ bv10 8) ?x2312717)))
 (let ((?x2423942 (ite $x2299113 (_ bv1 1) (_ bv0 1))))
 (let ((?x946344 ((_ extract 71 64) mem_30_798_128)))
 (let (($x2305379 (= (_ bv10 8) ?x946344)))
 (let ((?x2424681 (ite $x2305379 (_ bv1 1) (_ bv0 1))))
 (let ((?x948093 ((_ extract 79 72) mem_30_798_128)))
 (let (($x1812109 (= (_ bv10 8) ?x948093)))
 (let ((?x2425037 (ite $x1812109 (_ bv1 1) (_ bv0 1))))
 (let ((?x2307097 ((_ extract 87 80) mem_30_798_128)))
 (let (($x948523 (= (_ bv10 8) ?x2307097)))
 (let ((?x2425249 (ite $x948523 (_ bv1 1) (_ bv0 1))))
 (let ((?x2305156 ((_ extract 95 88) mem_30_798_128)))
 (let (($x947005 (= (_ bv10 8) ?x2305156)))
 (let ((?x2425570 (ite $x947005 (_ bv1 1) (_ bv0 1))))
 (let ((?x1812736 ((_ extract 103 96) mem_30_798_128)))
 (let (($x1812831 (= (_ bv10 8) ?x1812736)))
 (let ((?x2425643 (ite $x1812831 (_ bv1 1) (_ bv0 1))))
 (let ((?x1812419 ((_ extract 111 104) mem_30_798_128)))
 (let (($x1812042 (= (_ bv10 8) ?x1812419)))
 (let ((?x2426173 (ite $x1812042 (_ bv1 1) (_ bv0 1))))
 (let ((?x2420655 ((_ extract 119 112) mem_30_798_128)))
 (let (($x1811130 (= (_ bv10 8) ?x2420655)))
 (let ((?x2426212 (ite $x1811130 (_ bv1 1) (_ bv0 1))))
 (let ((?x2303775 ((_ extract 127 120) mem_30_798_128)))
 (let (($x948713 (= (_ bv10 8) ?x2303775)))
 (let ((?x2426696 (ite $x948713 (_ bv1 1) (_ bv0 1))))
 (let ((?x946675 (concat (concat (concat (concat (concat ?x2426696 ?x2426212) ?x2426173) ?x2425643) ?x2425570) ?x2425249)))
 (let ((?x1812049 (concat (concat (concat (concat (concat ?x946675 ?x2425037) ?x2424681) ?x2423942) ?x948770) ?x1812413)))
 (let ((?x944552 (concat (concat (concat (concat (concat ?x1812049 ?x944487) ?x1810242) ?x1811981) ?x2295969) ?x948628)))
 (and (distinct (_ bv0 16) ?x944552) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
