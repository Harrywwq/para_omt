...
(assert
 (and (distinct (_ bv10 8) mem_fffffff9feffffff_119_8) true))
(assert
 (let ((?x14887 ((_ extract 327 320) mem_c0000f45_79_992)))
 (let ((?x14869 ((_ extract 319 312) mem_c0000f45_79_992)))
 (let ((?x14893 ((_ extract 311 304) mem_c0000f45_79_992)))
 ...
 (let ((?x21207 (concat (concat ((_ extract 143 136) mem_c0000f45_79_992) ((_ extract 151 144) mem_c0000f45_79_992)) ?x15050)))
 (let ((?x20542 (concat (concat (concat (concat (concat ?x21207 ?x15049) ?x15053) ?x15055) ?x15057) ?x15059)))
 (let ((?x51353 (bvsub ?x20542 ?x55842)))
 (let (($x48454 (= (_ bv0 64) ?x51353)))
 (let ((?x58347 (ite $x48454 (_ bv1 1) (_ bv0 1))))
 (let ((?x56201 ((_ extract 63 63) ?x51353)))
 (let ((?x54863 (bvor ?x56201 ?x58347)))
 (and (distinct (_ bv0 1) ?x54863) true))))))))))))))))))))))))
(assert
 (let ((?x40313 (concat (concat (_ bv1 1) ((_ extract 894 889) mem_c0000f45_79_992)) (_ bv0 1))))
 (let ((?x375674 (bvand ?x40313 (_ bv8 8))))
 (= (_ bv0 8) ?x375674))))
(assert
 (let ((?x14887 ((_ extract 327 320) mem_c0000f45_79_992)))
 (let ((?x14869 ((_ extract 319 312) mem_c0000f45_79_992)))
...
(assert
 (let ((?x40313 (concat (concat (_ bv1 1) ((_ extract 894 889) mem_c0000f45_79_992)) (_ bv0 1))))
 (let ((?x1102234 (bvand ?x40313 (_ bv1 8))))
 (= (_ bv0 8) ?x1102234))))
(assert
