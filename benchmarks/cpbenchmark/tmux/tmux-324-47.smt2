...
(assert
 ...
 (and (distinct (_ bv0 16) ?x1167468) true)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x6435 ((_ extract 839 836) mem_c0000f45_79_992)))
 (let ((?x2364 ((_ extract 831 824) mem_c0000f45_79_992)))
 (let ((?x2349 ((_ extract 823 816) mem_c0000f45_79_992)))
 ...
 (let ((?x1172908 ((_ extract 127 120) mem_30_408_128)))
 (let (($x1176896 (= (_ bv10 8) ?x1172908)))
 (let ((?x2561961 (ite $x1176896 (_ bv15 32) (_ bv64 32))))
 (let ((?x1179393 ((_ extract 119 112) mem_30_408_128)))
 (let (($x1166083 (= (_ bv10 8) ?x1179393)))
 (let ((?x2550994 (ite $x1166083 (_ bv14 32) ?x2561961)))
 (let ((?x1167423 ((_ extract 111 104) mem_30_408_128)))
 (let (($x1169240 (= (_ bv10 8) ?x1167423)))
 (let ((?x2431122 (ite $x1169240 (_ bv13 32) ?x2550994)))
 (let ((?x1166621 ((_ extract 103 96) mem_30_408_128)))
 (let (($x1169141 (= (_ bv10 8) ?x1166621)))
 (let ((?x2285287 (ite $x1169141 (_ bv12 32) ?x2431122)))
 (let ((?x1166366 ((_ extract 95 88) mem_30_408_128)))
 (let (($x1167372 (= (_ bv10 8) ?x1166366)))
 (let ((?x2560968 (ite $x1167372 (_ bv11 32) ?x2285287)))
 (let ((?x1175697 ((_ extract 87 80) mem_30_408_128)))
 (let (($x1176902 (= (_ bv10 8) ?x1175697)))
 (let ((?x2534071 (ite $x1176902 (_ bv10 32) ?x2560968)))
 (let ((?x1175704 ((_ extract 79 72) mem_30_408_128)))
 (let (($x1167373 (= (_ bv10 8) ?x1175704)))
 (let ((?x2431204 (ite $x1167373 (_ bv9 32) ?x2534071)))
 (let ((?x1177145 ((_ extract 71 64) mem_30_408_128)))
 (let (($x1162559 (= (_ bv10 8) ?x1177145)))
 (let ((?x2561042 (ite $x1162559 (_ bv8 32) ?x2431204)))
 (let ((?x1175618 ((_ extract 63 56) mem_30_408_128)))
 (let (($x1165451 (= (_ bv10 8) ?x1175618)))
 (let ((?x2428307 (ite $x1165451 (_ bv7 32) ?x2561042)))
 (let ((?x1176721 ((_ extract 55 48) mem_30_408_128)))
 (let (($x1172344 (= (_ bv10 8) ?x1176721)))
 (let ((?x2561434 (ite $x1172344 (_ bv6 32) ?x2428307)))
 (let ((?x1167615 ((_ extract 47 40) mem_30_408_128)))
 (let (($x1171343 (= (_ bv10 8) ?x1167615)))
 (let ((?x2562501 (ite $x1171343 (_ bv5 32) ?x2561434)))
 (let ((?x1171329 ((_ extract 39 32) mem_30_408_128)))
 (let (($x1171930 (= (_ bv10 8) ?x1171329)))
 (let ((?x2562534 (ite $x1171930 (_ bv4 32) ?x2562501)))
 (let ((?x1174833 ((_ extract 31 24) mem_30_408_128)))
 (let (($x1171845 (= (_ bv10 8) ?x1174833)))
 (let ((?x2547961 (ite $x1171845 (_ bv3 32) ?x2562534)))
 (let ((?x1179556 ((_ extract 23 16) mem_30_408_128)))
 (let (($x1178811 (= (_ bv10 8) ?x1179556)))
 (let ((?x2430460 (ite $x1178811 (_ bv2 32) ?x2547961)))
 (let ((?x1178905 ((_ extract 15 8) mem_30_408_128)))
 (let (($x1179284 (= (_ bv10 8) ?x1178905)))
 (let ((?x2561720 (ite $x1179284 (_ bv1 32) ?x2430460)))
 (let ((?x1162287 ((_ extract 7 0) mem_30_408_128)))
 (let (($x1163273 (= (_ bv10 8) ?x1162287)))
 (let ((?x2561736 (ite $x1163273 (_ bv0 32) ?x2561720)))
 (let ((?x1164158 (ite $x1163273 (_ bv1 1) (_ bv0 1))))
 (let ((?x1164348 (ite $x1179284 (_ bv1 1) (_ bv0 1))))
 (let ((?x1166114 (ite $x1178811 (_ bv1 1) (_ bv0 1))))
 (let ((?x1179267 (ite $x1171845 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x1166502 (ite $x1169141 (_ bv1 1) (_ bv0 1))))
 (let ((?x1178847 (ite $x1169240 (_ bv1 1) (_ bv0 1))))
 (let ((?x1823868 (concat (concat (concat (_ bv0 16) (ite $x1176896 (_ bv1 1) (_ bv0 1))) (ite $x1166083 (_ bv1 1) (_ bv0 1))) ?x1178847)))
 (let ((?x1832308 (concat (concat (concat (concat (concat ?x1823868 ?x1166502) ?x1165939) ?x1176842) ?x1165926) ?x1170626)))
 (let ((?x1555666 (concat (concat (concat (concat (concat ?x1832308 ?x1167480) ?x1174669) ?x1177129) ?x1175719) ?x1179267)))
 (let ((?x1552538 (concat (concat (concat ?x1555666 ?x1166114) ?x1164348) ?x1164158)))
 (let (($x2544213 (not $x1176896)))
 (let (($x2562600 (not $x1166083)))
 (let (($x2561986 (not $x1169240)))
 (let (($x2431333 (not $x1169141)))
 (let (($x2561435 (not $x1167372)))
 (let (($x2560927 (not $x1176902)))
 (let (($x2560934 (not $x1167373)))
 (let (($x2555854 (not $x1162559)))
 (let (($x2431609 (not $x1165451)))
 (let (($x1599744 (not $x1172344)))
 (let (($x1809991 (not $x1171343)))
 (let (($x2561030 (not $x1171930)))
 (let (($x2561989 (not $x1171845)))
 (let (($x2560075 (not $x1178811)))
 (let (($x1781975 (not $x1179284)))
 (let (($x2560910 (not $x1163273)))
 (let (($x2560928 (and $x2560910 $x1781975 $x2560075 $x2561989 $x2561030 $x1809991 $x1599744 $x2431609 $x2555854 $x2560934 $x2560927 $x2561435 $x2431333 $x2561986 $x2562600 $x2544213)))
 (let ((?x2562107 (ite $x2560928 ?x1552538 ?x2561736)))
 (let ((?x2558404 (concat (_ bv0 32) ?x2562107)))
 (let ((?x2543888 (bvadd (bvadd (_ bv64 64) ?x2558404) ?x14202)))
 (and (distinct (_ bv0 64) ?x2543888) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
