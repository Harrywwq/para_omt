...
(assert
 ...
 (let (($x190882 (bvule ?x385788 ?x32022)))
 (not $x190882))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x2357 ((_ extract 815 808) mem_c0000f45_79_992)))
 (let ((?x2417 ((_ extract 751 744) mem_c0000f45_79_992)))
...
(assert
 ...
 (let ((?x1103659 (bvadd ?x298255 ?x387080)))
 (bvule ?x1103659 (_ bv9223372039002259555 64))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x80359 ((_ extract 31 31) mem_fffffffff0000010_193_32)))
 (let ((?x117212 (concat (concat (concat (concat (concat ?x80359 ?x80359) ?x80359) ?x80359) ?x80359) ?x80359)))
 (let ((?x115888 (concat (concat (concat (concat (concat ?x117212 ?x80359) ?x80359) ?x80359) ?x80359) ?x80359)))
 ...
 (let (($x118656 (bvsle ?x80055 ?x118593)))
 (let ((?x118657 (ite $x118656 ?x80055 ?x118593)))
 (let ((?x376848 ((_ extract 63 63) ?x118657)))
 (and (distinct (_ bv0 1) ?x376848) true)))))))))))))))))))))))))))))))))))))))))
