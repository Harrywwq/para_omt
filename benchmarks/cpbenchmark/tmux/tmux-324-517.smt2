...
(assert
 ...
 (let ((?x1733802 ((_ extract 127 120) mem_8000000000000030_454_128)))
 (let (($x1732655 (= (_ bv10 8) ?x1733802)))
 (let ((?x3241709 (ite $x1732655 (_ bv15 32) (_ bv64 32))))
 (let ((?x1721479 ((_ extract 119 112) mem_8000000000000030_454_128)))
 (let (($x1727295 (= (_ bv10 8) ?x1721479)))
 (let ((?x3241773 (ite $x1727295 (_ bv14 32) ?x3241709)))
 (let ((?x916670 ((_ extract 111 104) mem_8000000000000030_454_128)))
 (let (($x1722901 (= (_ bv10 8) ?x916670)))
 (let ((?x3242367 (ite $x1722901 (_ bv13 32) ?x3241773)))
 (let ((?x1721868 ((_ extract 103 96) mem_8000000000000030_454_128)))
 (let (($x1726468 (= (_ bv10 8) ?x1721868)))
 (let ((?x3242373 (ite $x1726468 (_ bv12 32) ?x3242367)))
 (let ((?x1734659 ((_ extract 95 88) mem_8000000000000030_454_128)))
 (let (($x597150 (= (_ bv10 8) ?x1734659)))
 (let ((?x3242132 (ite $x597150 (_ bv11 32) ?x3242373)))
 (let ((?x1720784 ((_ extract 87 80) mem_8000000000000030_454_128)))
 (let (($x1733023 (= (_ bv10 8) ?x1720784)))
 (let ((?x3242238 (ite $x1733023 (_ bv10 32) ?x3242132)))
 (let ((?x1728207 ((_ extract 79 72) mem_8000000000000030_454_128)))
 (let (($x1728079 (= (_ bv10 8) ?x1728207)))
 (let ((?x3242597 (ite $x1728079 (_ bv9 32) ?x3242238)))
 (let ((?x915999 ((_ extract 71 64) mem_8000000000000030_454_128)))
 (let (($x915998 (= (_ bv10 8) ?x915999)))
 (let ((?x3242601 (ite $x915998 (_ bv8 32) ?x3242597)))
 (let ((?x915034 ((_ extract 63 56) mem_8000000000000030_454_128)))
 (let (($x915515 (= (_ bv10 8) ?x915034)))
 (let ((?x3241823 (ite $x915515 (_ bv7 32) ?x3242601)))
 (let ((?x916223 ((_ extract 55 48) mem_8000000000000030_454_128)))
 (let (($x916221 (= (_ bv10 8) ?x916223)))
 (let ((?x3242053 (ite $x916221 (_ bv6 32) ?x3241823)))
 (let ((?x916015 ((_ extract 47 40) mem_8000000000000030_454_128)))
 (let (($x915997 (= (_ bv10 8) ?x916015)))
 (let ((?x3242061 (ite $x915997 (_ bv5 32) ?x3242053)))
 (let ((?x1721772 ((_ extract 39 32) mem_8000000000000030_454_128)))
 (let (($x915933 (= (_ bv10 8) ?x1721772)))
 (let ((?x3242726 (ite $x915933 (_ bv4 32) ?x3242061)))
 (let ((?x915939 ((_ extract 31 24) mem_8000000000000030_454_128)))
 (let (($x600145 (= (_ bv10 8) ?x915939)))
 (let ((?x3241657 (ite $x600145 (_ bv3 32) ?x3242726)))
 (let ((?x1728376 ((_ extract 23 16) mem_8000000000000030_454_128)))
 (let (($x917022 (= (_ bv10 8) ?x1728376)))
 (let ((?x3242283 (ite $x917022 (_ bv2 32) ?x3241657)))
 (let ((?x1727041 ((_ extract 15 8) mem_8000000000000030_454_128)))
 (let (($x1734524 (= (_ bv10 8) ?x1727041)))
 (let ((?x3242286 (ite $x1734524 (_ bv1 32) ?x3242283)))
 (let ((?x1721353 ((_ extract 7 0) mem_8000000000000030_454_128)))
 (let (($x917342 (= (_ bv10 8) ?x1721353)))
 (let ((?x3242414 (ite $x917342 (_ bv0 32) ?x3242286)))
 (let ((?x912757 (ite $x917342 (_ bv1 1) (_ bv0 1))))
 (let ((?x915330 (ite $x1734524 (_ bv1 1) (_ bv0 1))))
 (let ((?x915329 (ite $x917022 (_ bv1 1) (_ bv0 1))))
 (let ((?x915326 (ite $x600145 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x915139 (ite $x1726468 (_ bv1 1) (_ bv0 1))))
 (let ((?x914807 (ite $x1722901 (_ bv1 1) (_ bv0 1))))
 (let ((?x2465682 (concat (concat (concat (_ bv0 16) (ite $x1732655 (_ bv1 1) (_ bv0 1))) (ite $x1727295 (_ bv1 1) (_ bv0 1))) ?x914807)))
 (let ((?x2466276 (concat (concat (concat (concat (concat ?x2465682 ?x915139) ?x915767) ?x915577) ?x916225) ?x916343)))
 (let ((?x2463581 (concat (concat (concat (concat (concat ?x2466276 ?x916896) ?x916483) ?x916671) ?x915771) ?x915326)))
 (let ((?x2463504 (concat (concat (concat ?x2463581 ?x915329) ?x915330) ?x912757)))
 (let (($x3241592 (not $x1732655)))
 (let (($x3241588 (not $x1727295)))
 (let (($x3241568 (not $x1722901)))
 (let (($x3241430 (not $x1726468)))
 (let (($x3241416 (not $x597150)))
 (let (($x3241174 (not $x1733023)))
 (let (($x3241159 (not $x1728079)))
 (let (($x3243619 (not $x915998)))
 (let (($x3241925 (not $x915515)))
 (let (($x3241942 (not $x916221)))
 (let (($x3242426 (not $x915997)))
 (let (($x3242423 (not $x915933)))
 (let (($x3240957 (not $x600145)))
 (let (($x3240872 (not $x917022)))
 (let (($x3240848 (not $x1734524)))
 (let (($x3240702 (not $x917342)))
 (let (($x3241608 (and $x3240702 $x3240848 $x3240872 $x3240957 $x3242423 $x3242426 $x3241942 $x3241925 $x3243619 $x3241159 $x3241174 $x3241416 $x3241430 $x3241568 $x3241588 $x3241592)))
 (let ((?x3242421 (ite $x3241608 ?x2463504 ?x3242414)))
 (let ((?x3242744 (concat (_ bv0 32) ?x3242421)))
 (let ((?x3242349 (bvadd (bvadd (_ bv32 64) ?x3242744) ?x195888)))
 (and (distinct (_ bv0 64) ?x3242349) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
