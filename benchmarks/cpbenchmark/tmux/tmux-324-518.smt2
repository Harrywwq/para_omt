...
(assert
 ...
 (let ((?x771907 ((_ extract 127 120) mem_8000000000000020_391_128)))
 (let (($x777890 (= (_ bv10 8) ?x771907)))
 (let ((?x2458896 (ite $x777890 (_ bv15 32) (_ bv64 32))))
 (let ((?x777294 ((_ extract 119 112) mem_8000000000000020_391_128)))
 (let (($x779460 (= (_ bv10 8) ?x777294)))
 (let ((?x2461048 (ite $x779460 (_ bv14 32) ?x2458896)))
 (let ((?x299708 ((_ extract 111 104) mem_8000000000000020_391_128)))
 (let (($x289265 (= (_ bv10 8) ?x299708)))
 (let ((?x2460878 (ite $x289265 (_ bv13 32) ?x2461048)))
 (let ((?x778015 ((_ extract 103 96) mem_8000000000000020_391_128)))
 (let (($x780154 (= (_ bv10 8) ?x778015)))
 (let ((?x2458715 (ite $x780154 (_ bv12 32) ?x2460878)))
 (let ((?x774255 ((_ extract 95 88) mem_8000000000000020_391_128)))
 (let (($x770403 (= (_ bv10 8) ?x774255)))
 (let ((?x2460530 (ite $x770403 (_ bv11 32) ?x2458715)))
 (let ((?x775664 ((_ extract 87 80) mem_8000000000000020_391_128)))
 (let (($x276653 (= (_ bv10 8) ?x775664)))
 (let ((?x2461305 (ite $x276653 (_ bv10 32) ?x2460530)))
 (let ((?x288079 ((_ extract 79 72) mem_8000000000000020_391_128)))
 (let (($x287815 (= (_ bv10 8) ?x288079)))
 (let ((?x2461309 (ite $x287815 (_ bv9 32) ?x2461305)))
 (let ((?x298686 ((_ extract 71 64) mem_8000000000000020_391_128)))
 (let (($x298688 (= (_ bv10 8) ?x298686)))
 (let ((?x2460166 (ite $x298688 (_ bv8 32) ?x2461309)))
 (let ((?x298148 ((_ extract 63 56) mem_8000000000000020_391_128)))
 (let (($x298153 (= (_ bv10 8) ?x298148)))
 (let ((?x2460121 (ite $x298153 (_ bv7 32) ?x2460166)))
 (let ((?x299097 ((_ extract 55 48) mem_8000000000000020_391_128)))
 (let (($x299303 (= (_ bv10 8) ?x299097)))
 (let ((?x2465922 (ite $x299303 (_ bv6 32) ?x2460121)))
 (let ((?x298559 ((_ extract 47 40) mem_8000000000000020_391_128)))
 (let (($x298687 (= (_ bv10 8) ?x298559)))
 (let ((?x2465457 (ite $x298687 (_ bv5 32) ?x2465922)))
 (let ((?x298685 ((_ extract 39 32) mem_8000000000000020_391_128)))
 (let (($x298270 (= (_ bv10 8) ?x298685)))
 (let ((?x2466249 (ite $x298270 (_ bv4 32) ?x2465457)))
 (let ((?x1110059 ((_ extract 31 24) mem_8000000000000020_391_128)))
 (let (($x772829 (= (_ bv10 8) ?x1110059)))
 (let ((?x2465542 (ite $x772829 (_ bv3 32) ?x2466249)))
 (let ((?x385676 ((_ extract 23 16) mem_8000000000000020_391_128)))
 (let (($x384759 (= (_ bv10 8) ?x385676)))
 (let ((?x2465647 (ite $x384759 (_ bv2 32) ?x2465542)))
 (let ((?x1111380 ((_ extract 15 8) mem_8000000000000020_391_128)))
 (let (($x1113896 (= (_ bv10 8) ?x1111380)))
 (let ((?x2466682 (ite $x1113896 (_ bv1 32) ?x2465647)))
 (let ((?x1109823 ((_ extract 7 0) mem_8000000000000020_391_128)))
 (let (($x1109795 (= (_ bv10 8) ?x1109823)))
 (let ((?x2459387 (ite $x1109795 (_ bv0 32) ?x2466682)))
 (let ((?x297244 (ite $x1109795 (_ bv1 1) (_ bv0 1))))
 (let ((?x296446 (ite $x1113896 (_ bv1 1) (_ bv0 1))))
 (let ((?x296735 (ite $x384759 (_ bv1 1) (_ bv0 1))))
 (let ((?x298378 (ite $x772829 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x297569 (ite $x780154 (_ bv1 1) (_ bv0 1))))
 (let ((?x297180 (ite $x289265 (_ bv1 1) (_ bv0 1))))
 (let ((?x1727690 (concat (concat (concat (_ bv0 16) (ite $x777890 (_ bv1 1) (_ bv0 1))) (ite $x779460 (_ bv1 1) (_ bv0 1))) ?x297180)))
 (let ((?x1711050 (concat (concat (concat (concat (concat ?x1727690 ?x297569) ?x299100) ?x297983) ?x771147) ?x299502)))
 (let ((?x1720612 (concat (concat (concat (concat (concat ?x1711050 ?x297169) ?x298133) ?x299911) ?x298132) ?x298378)))
 (let ((?x601714 (concat (concat (concat ?x1720612 ?x296735) ?x296446) ?x297244)))
 (let (($x2461491 (not $x777890)))
 (let (($x2461469 (not $x779460)))
 (let (($x2466667 (not $x289265)))
 (let (($x2459504 (not $x780154)))
 (let (($x2466127 (not $x770403)))
 (let (($x2465626 (not $x276653)))
 (let (($x2465346 (not $x287815)))
 (let (($x2465755 (not $x298688)))
 (let (($x2465233 (not $x298153)))
 (let (($x2466126 (not $x299303)))
 (let (($x2465874 (not $x298687)))
 (let (($x2464705 (not $x298270)))
 (let (($x2466433 (not $x772829)))
 (let (($x2464667 (not $x384759)))
 (let (($x2460921 (not $x1113896)))
 (let (($x2466049 (not $x1109795)))
 (let (($x2458977 (and $x2466049 $x2460921 $x2464667 $x2466433 $x2464705 $x2465874 $x2466126 $x2465233 $x2465755 $x2465346 $x2465626 $x2466127 $x2459504 $x2466667 $x2461469 $x2461491)))
 (let ((?x2464924 (ite $x2458977 ?x601714 ?x2459387)))
 (let ((?x2466677 (concat (_ bv0 32) ?x2464924)))
 (let ((?x2466066 (bvadd (bvadd (_ bv16 64) ?x2466677) ?x195888)))
 (and (distinct (_ bv0 64) ?x2466066) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
