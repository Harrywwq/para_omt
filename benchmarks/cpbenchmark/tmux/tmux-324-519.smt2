...
(assert
 ...
 (let ((?x599099 ((_ extract 127 120) mem_8000000000000010_333_128)))
 (let (($x594273 (= (_ bv10 8) ?x599099)))
 (let ((?x598538 (ite $x594273 (_ bv15 32) (_ bv64 32))))
 (let ((?x594183 ((_ extract 119 112) mem_8000000000000010_333_128)))
 (let (($x593490 (= (_ bv10 8) ?x594183)))
 (let ((?x1726643 (ite $x593490 (_ bv14 32) ?x598538)))
 (let ((?x285192 ((_ extract 111 104) mem_8000000000000010_333_128)))
 (let (($x597977 (= (_ bv10 8) ?x285192)))
 (let ((?x1766831 (ite $x597977 (_ bv13 32) ?x1726643)))
 (let ((?x593939 ((_ extract 103 96) mem_8000000000000010_333_128)))
 (let (($x593215 (= (_ bv10 8) ?x593939)))
 (let ((?x1722868 (ite $x593215 (_ bv12 32) ?x1766831)))
 (let ((?x593286 ((_ extract 95 88) mem_8000000000000010_333_128)))
 (let (($x594652 (= (_ bv10 8) ?x593286)))
 (let ((?x588031 (ite $x594652 (_ bv11 32) ?x1722868)))
 (let ((?x592704 ((_ extract 87 80) mem_8000000000000010_333_128)))
 (let (($x594477 (= (_ bv10 8) ?x592704)))
 (let ((?x599391 (ite $x594477 (_ bv10 32) ?x588031)))
 (let ((?x594676 ((_ extract 79 72) mem_8000000000000010_333_128)))
 (let (($x599578 (= (_ bv10 8) ?x594676)))
 (let ((?x1725978 (ite $x599578 (_ bv9 32) ?x599391)))
 (let ((?x593958 ((_ extract 71 64) mem_8000000000000010_333_128)))
 (let (($x597075 (= (_ bv10 8) ?x593958)))
 (let ((?x599417 (ite $x597075 (_ bv8 32) ?x1725978)))
 (let ((?x594456 ((_ extract 63 56) mem_8000000000000010_333_128)))
 (let (($x595067 (= (_ bv10 8) ?x594456)))
 (let ((?x1734937 (ite $x595067 (_ bv7 32) ?x599417)))
 (let ((?x591999 ((_ extract 55 48) mem_8000000000000010_333_128)))
 (let (($x595070 (= (_ bv10 8) ?x591999)))
 (let ((?x1405044 (ite $x595070 (_ bv6 32) ?x1734937)))
 (let ((?x594189 ((_ extract 47 40) mem_8000000000000010_333_128)))
 (let (($x594589 (= (_ bv10 8) ?x594189)))
 (let ((?x1727577 (ite $x594589 (_ bv5 32) ?x1405044)))
 (let ((?x595056 ((_ extract 39 32) mem_8000000000000010_333_128)))
 (let (($x592903 (= (_ bv10 8) ?x595056)))
 (let ((?x599458 (ite $x592903 (_ bv4 32) ?x1727577)))
 (let ((?x593808 ((_ extract 31 24) mem_8000000000000010_333_128)))
 (let (($x594125 (= (_ bv10 8) ?x593808)))
 (let ((?x1728365 (ite $x594125 (_ bv3 32) ?x599458)))
 (let ((?x593464 ((_ extract 23 16) mem_8000000000000010_333_128)))
 (let (($x594574 (= (_ bv10 8) ?x593464)))
 (let ((?x1728395 (ite $x594574 (_ bv2 32) ?x1728365)))
 (let ((?x593021 ((_ extract 15 8) mem_8000000000000010_333_128)))
 (let (($x591247 (= (_ bv10 8) ?x593021)))
 (let ((?x600110 (ite $x591247 (_ bv1 32) ?x1728395)))
 (let ((?x593144 ((_ extract 7 0) mem_8000000000000010_333_128)))
 (let (($x594129 (= (_ bv10 8) ?x593144)))
 (let ((?x1731348 (ite $x594129 (_ bv0 32) ?x600110)))
 (let ((?x593222 (ite $x594129 (_ bv1 1) (_ bv0 1))))
 (let ((?x594394 (ite $x591247 (_ bv1 1) (_ bv0 1))))
 (let ((?x604953 (ite $x594574 (_ bv1 1) (_ bv0 1))))
 (let ((?x593483 (ite $x594125 (_ bv1 1) (_ bv0 1))))
 ...
 (let ((?x308175 (ite $x593215 (_ bv1 1) (_ bv0 1))))
 (let ((?x308838 (ite $x597977 (_ bv1 1) (_ bv0 1))))
 (let ((?x1110927 (concat (concat (concat (_ bv0 16) (ite $x594273 (_ bv1 1) (_ bv0 1))) (ite $x593490 (_ bv1 1) (_ bv0 1))) ?x308838)))
 (let ((?x384025 (concat (concat (concat (concat (concat ?x1110927 ?x308175) ?x304350) ?x305874) ?x308133) ?x306976)))
 (let ((?x1099940 (concat (concat (concat (concat (concat ?x384025 ?x306774) ?x306422) ?x593770) ?x591674) ?x593483)))
 (let ((?x1113302 (concat (concat (concat ?x1099940 ?x604953) ?x594394) ?x593222)))
 (let (($x1725405 (not $x594273)))
 (let (($x1721301 (not $x593490)))
 (let (($x1735470 (not $x597977)))
 (let (($x1728184 (not $x593215)))
 (let (($x1728125 (not $x594652)))
 (let (($x1721408 (not $x594477)))
 (let (($x1720902 (not $x599578)))
 (let (($x1728030 (not $x597075)))
 (let (($x599386 (not $x595067)))
 (let (($x1710434 (not $x595070)))
 (let (($x1728117 (not $x594589)))
 (let (($x1728268 (not $x592903)))
 (let (($x1727465 (not $x594125)))
 (let (($x1726178 (not $x594574)))
 (let (($x593655 (not $x591247)))
 (let (($x1727052 (not $x594129)))
 (let (($x599836 (and $x1727052 $x593655 $x1726178 $x1727465 $x1728268 $x1728117 $x1710434 $x599386 $x1728030 $x1720902 $x1721408 $x1728125 $x1728184 $x1735470 $x1721301 $x1725405)))
 (let ((?x1727412 (ite $x599836 ?x1113302 ?x1731348)))
 (let ((?x1733002 (concat (_ bv0 32) ?x1727412)))
 (let ((?x598431 (bvadd ?x1733002 ?x195888)))
 (and (distinct (_ bv0 64) ?x598431) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
