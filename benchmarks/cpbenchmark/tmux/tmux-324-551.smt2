...
(declare-fun mem_fff8000000000000_784_64 () (_ BitVec 64))
(declare-fun mem_ffff000000000000_1118_64 () (_ BitVec 64))
(assert
...
(assert
 (= (_ bv18444492273895866368 64) mem_ffffffffffffffec_458_64))
(assert
 (= (_ bv18446462598732840960 64) mem_fff8000000000000_784_64))
(assert
 (and (distinct (_ bv0 64) mem_ffff000000000000_1118_64) true))
(maximize mem_ffff000000000000_1118_64)
...
(maximize mem_ffffffffffffffec_458_64)
...
(minimize mem_ffff000000000000_1118_64)
...
(minimize mem_fff8000000000000_784_64)
(minimize mem_ffffffffffffffec_458_64)
(maximize mem_ffe0000000000000_395_64)
(minimize mem_ffe0000000000000_395_64)
(maximize mem_fff8000000000000_784_64)
(check-sat)
(get-objectives)
