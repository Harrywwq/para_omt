...
(declare-fun syscall_stub_newfstatat_3006_64 () (_ BitVec 64))
(declare-fun syscall_stub_readlink_3246_64 () (_ BitVec 64))
...
(declare-fun syscall_stub_newfstatat_3511_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffef038_3690_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffeefa8_3695_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffeefa0_3774_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffef030_3771_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffef048_3852_32 () (_ BitVec 32))
(declare-fun mem_7fffffffffeefc8_4009_64 () (_ BitVec 64))
(declare-fun mem_7fffffffffef058_3998_64 () (_ BitVec 64))
(declare-fun access_7743_32 () (_ BitVec 32))
(declare-fun access_12265_32 () (_ BitVec 32))
(assert
...
(assert
 (let ((?x484387 ((_ extract 31 31) syscall_stub_ioctl_2475_32)))
 (= (_ bv0 1) ?x484387)))
(assert
 (let (($x482182 (= (_ bv0 32) syscall_stub_ioctl_2475_32)))
 (not $x482182)))
(assert
 (let ((?x494031 ((_ extract 31 0) syscall_stub_newfstatat_3006_64)))
 (bvule ?x494031 (_ bv4294963200 32))))
(assert
 (= (_ bv17870283321406196703 64) syscall_stub_readlink_3246_64))
(assert
 (let ((?x607277 (bvadd (_ bv576460752303354917 64) strlen_5188_64)))
...
(assert
 ...
 (= (_ bv47 8) ?x558577)))
(assert
 (let ((?x1285596 ((_ extract 5 0) strlen_5188_64)))
 (let ((?x1285582 (bvadd (_ bv1 6) ?x1285596)))
 (let (($x1285027 (bvule (_ bv31 64) strlen_5188_64)))
 (let (($x1285181 (bvule strlen_5188_64 (_ bv18446744073709551614 64))))
 (let (($x1285620 (and $x1285181 $x1285027)))
 (let ((?x1285661 (ite $x1285620 (_ bv32 6) ?x1285582)))
 (bvule ?x1285661 (_ bv32 6)))))))))
(assert
 (let ((?x1285178 (bvadd (_ bv1 64) strlen_5188_64)))
 (let (($x1285027 (bvule (_ bv31 64) strlen_5188_64)))
 (let (($x1285181 (bvule strlen_5188_64 (_ bv18446744073709551614 64))))
 (let (($x1285620 (and $x1285181 $x1285027)))
 (let ((?x1285521 (ite $x1285620 (_ bv32 64) ?x1285178)))
 (bvule (_ bv1 64) ?x1285521)))))))
(assert
 (let ((?x737380 ((_ extract 47 40) mem_7fffffffffef420_3328_64)))
 (let (($x1265724 (= (_ bv0 8) ?x737380)))
 (let ((?x737376 ((_ extract 55 48) mem_7fffffffffef420_3328_64)))
...
(assert
 (let (($x1285027 (bvule (_ bv31 64) strlen_5188_64)))
 (let (($x1285195 (not $x1285027)))
 (let (($x1285181 (bvule strlen_5188_64 (_ bv18446744073709551614 64))))
 (let (($x1285188 (not $x1285181)))
 (let (($x1285196 (or $x1285188 $x1285195)))
 (let (($x1285578 (not $x1285196)))
 (let ((?x1285178 (bvadd (_ bv1 64) strlen_5188_64)))
 (let ((?x1285476 ((_ extract 63 6) ?x1285178)))
 (let (($x1288370 (= (_ bv0 58) ?x1285476)))
 (or $x1288370 $x1285578)))))))))))
(assert
 (let ((?x607307 ((_ extract 31 0) syscall_stub_newfstatat_3511_64)))
 (bvule ?x607307 (_ bv4294963200 32))))
(assert
 (= mem_7fffffffffeefa8_3695_64 mem_7fffffffffef038_3690_64))
(assert
 (= mem_7fffffffffef030_3771_64 mem_7fffffffffeefa0_3774_64))
(assert
 (let ((?x897391 ((_ extract 15 12) mem_7fffffffffef048_3852_32)))
 (= (_ bv2 4) ?x897391)))
(assert
 (= mem_7fffffffffef058_3998_64 mem_7fffffffffeefc8_4009_64))
(assert
 (let (($x1400394 (= (_ bv4294967295 32) access_7743_32)))
 (let (($x1400397 (= (_ bv0 32) access_7743_32)))
 (or $x1400397 $x1400394))))
(assert
 (= (_ bv0 32) access_7743_32))
(assert
 (let (($x2267119 (= (_ bv4294967295 32) access_12265_32)))
 (let (($x2264845 (= (_ bv0 32) access_12265_32)))
 (or $x2264845 $x2267119))))
(assert
 (and (distinct (_ bv0 32) access_12265_32) true))
(maximize syscall_stub_ioctl_95_32)
(minimize syscall_stub_readlink_3246_64)
(minimize mem_7fffffffffef428_3344_32)
(minimize strlen_85_64)
(maximize strncmp_ret_84_32)
(maximize syscall_stub_newfstatat_3006_64)
(minimize mem_7fffffffffef058_3998_64)
(minimize mem_7fffffffffeefa8_3695_64)
(minimize mem_7fffffffffef42c_3370_8)
(minimize syscall_stub_newfstatat_3006_64)
...
(minimize mem_7fffffffffef048_3852_32)
...
(minimize args_1_8)
(maximize access_7743_32)
(maximize mem_7fffffffffef058_3998_64)
(maximize mem_7fffffffffeefa8_3695_64)
(minimize filesize_file_0_/proc/self/loginuid_88_64)
(maximize mem_7fffffffffef030_3771_64)
(maximize access_12265_32)
...
(maximize args_1_8)
(minimize access_7743_32)
(minimize strlen_83_64)
(maximize mem_7fffffffffef42d_3488_3576)
(maximize mem_7fffffffffeefa0_3774_64)
(minimize mem_7fffffffffeefc8_4009_64)
(maximize mem_7fffffffffeefc8_4009_64)
(minimize mem_7fffffffffef030_3771_64)
(maximize mem_7fffffffffef038_3690_64)
(maximize syscall_stub_readlink_3246_64)
(minimize access_12265_32)
(minimize strncmp_ret_84_32)
(minimize mem_7fffffffffeefa0_3774_64)
(check-sat)
(get-objectives)
