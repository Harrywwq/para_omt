...
(declare-fun access_12264_32 () (_ BitVec 32))
(assert
...
(assert
 (= (_ bv0 32) access_7726_32))
(assert
 (let (($x1400869 (= (_ bv4294967295 32) access_12264_32)))
 (let (($x2266295 (= (_ bv0 32) access_12264_32)))
 (or $x2266295 $x1400869))))
(assert
 (= (_ bv0 32) access_12264_32))
...
(minimize mem_7fffffffffeefa8_3691_64)
(minimize mem_7fffffffffeefc8_3997_64)
(minimize mem_7fffffffffeefa0_3770_64)
