...
(assert
 (let ((?x700 (bvadd (_ bv3221229376 64) mem_7fffffffffef6e8_78_64)))
 (bvult (_ bv3221229376 64) ?x700)))
(assert
 (let ((?x700 (bvadd (_ bv3221229376 64) mem_7fffffffffef6e8_78_64)))
(let ((?x420 (bvsub ?x700 (_ bv3221229376 64))))
(let (($x138937 (bvule ?x420 (_ bv73 64))))
(let ((?x138965 (ite $x138937 (_ bv1 1) (_ bv0 1))))
(let ((?x138921 (bvxor ?x138965 (_ bv1 1))))
(let (($x138925 (and (distinct (_ bv0 1) ?x138921) true)))
(let ((?x139038 (ite $x138925 (_ bv73 64) ?x420)))
(bvugt ?x139038 (_ bv20 64))))))))))
